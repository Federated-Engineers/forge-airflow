...
try:
    ...
    from pendulum._pendulum import (PreciseDiff, days_in_year, is_leap,
                                    is_long_year, local_time, precise_diff,
                                    week_day)
except ImportError:
    ...
    from pendulum._helpers import (days_in_year, is_leap, is_long_year,
                                   local_time, week_day)
