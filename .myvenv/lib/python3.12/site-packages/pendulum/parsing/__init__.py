...
try:
    ...
    from pendulum._pendulum import Duration, parse_iso8601
except ImportError:
    from pendulum.duration import \
        Duration  # type: ignore[assignment]  # noqa: TC001
    from pendulum.parsing.iso8601 import \
        parse_iso8601  # type: ignore[assignment]
