...
if TYPE_CHECKING:
    from mypy_boto3_rds_data.client import \
        BotocoreClientError  # type: ignore[attr-defined]
    from mypy_boto3_rds_data.type_defs import (
        BatchExecuteStatementResponseTypeDef, ExecuteStatementResponseTypeDef)
