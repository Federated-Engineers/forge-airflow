...
from awswrangler.s3._read import (
    _apply_partition_filter, _check_version_id, _concat_union_categoricals,
    _extract_partitions_dtypes_from_table_details, _get_num_output_blocks,
    _get_path_ignore_suffix, _get_path_root, _get_paths_for_glue_table,
    _InternalReadTableMetadataReturnValue, _TableMetadataReader)
from awswrangler.typing import (ArrowDecryptionConfiguration,
...
def read_parquet(
    ...
    * (matches everything), ? (matches any single character),
    ...
    partition_filter
        ...
        https://aws-sdk-pandas.readthedocs.io/en/3.14.0/tutorials/023%20-%20Flexible%20Partitions%20Filter.html
    columns
