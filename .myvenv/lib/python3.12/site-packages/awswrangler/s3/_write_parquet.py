...
from awswrangler.s3._write import (_COMPRESSION_2_EXT, _get_chunk_file_path,
                                   _get_file_path, _get_write_table_args,
                                   _S3WriteStrategy, _validate_args)
from awswrangler.s3._write_concurrent import _WriteProxy
from awswrangler.typing import (ArrowEncryptionConfiguration,
                                AthenaPartitionProjectionSettings,
                                BucketingInfoTuple, GlueTableSettings,
...
def to_parquet(
    ...
    concurrent_partitioning
        ...
        https://aws-sdk-pandas.readthedocs.io/en/3.14.0/tutorials/022%20-%20Writing%20Partitions%20Concurrently.html
    mode
        ``append`` (Default), ``overwrite``, ``overwrite_partitions``. Only takes effect if dataset=True.
        For details check the related tutorial:
        https://aws-sdk-pandas.readthedocs.io/en/3.14.0/tutorials/004%20-%20Parquet%20Datasets.html
    catalog_versioning
