...
from typing import TYPE_CHECKING, Annotated, ClassVar, Generic, Union, cast
...
from cadwyn._utils import (DATACLASS_KW_ONLY, DATACLASS_SLOTS, Sentinel,
                           UnionType, fully_unwrap_decorator,
...
from pydantic._internal._typing_extra import \
    try_eval_type as pydantic_try_eval_type
from pydantic.fields import ComputedFieldInfo, FieldInfo
from pydantic_core import PydanticUndefined
from typing_extensions import (Any, Doc, Self, TypeAlias, TypeAliasType,
                               TypeVar, _AnnotatedAlias, assert_never, final,
...
class _AnnotationTransformer:
    ...
    def _change_version_of_a_non_container_annotation(self, annotation: Any) -> Any:
        from typing_inspection.typing_objects import (is_any, is_newtype,
                                                      is_typealiastype)
