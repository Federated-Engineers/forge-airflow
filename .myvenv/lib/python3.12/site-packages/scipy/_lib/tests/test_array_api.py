...
from scipy._lib._array_api import (SCIPY_ARRAY_API, _asarray,
                                   _xp_copy_to_numpy, array_namespace,
                                   is_numpy, is_torch, np_compat,
                                   xp_assert_equal, xp_capabilities_table,
                                   xp_copy, xp_default_dtype, xp_result_type)
from scipy._lib._array_api_docs_tables import is_named_function_like_object
from scipy._lib._array_api_no_0d import \
    xp_assert_equal as xp_assert_equal_no_0d
