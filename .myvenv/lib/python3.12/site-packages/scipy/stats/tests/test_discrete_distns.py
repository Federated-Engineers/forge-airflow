...
from scipy.stats import (bernoulli, betabinom, betanbinom, binom, boltzmann,
                         hypergeom, nbinom, nchypergeom_fisher,
                         nchypergeom_wallenius, nhypergeom, poisson_binom,
                         randint, skellam, zipf, zipfian)
