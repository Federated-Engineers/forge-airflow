...
from .common_tests import (check_edge_support, check_entropy, check_freezing,
                           check_kurt_expect, check_mean_expect, check_moment,
                           check_named_args, check_normalization,
                           check_pickling, check_private_entropy,
