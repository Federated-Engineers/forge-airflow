...
from scipy._lib._array_api import (array_namespace, is_array_api_strict,
                                   make_xp_test_case, np_compat,
                                   xp_assert_close, xp_size)
from scipy.integrate import cubature
from scipy.integrate._cubature import _InfiniteLimitsTransform
from scipy.integrate._rules import (FixedRule, GaussKronrodQuadrature,
                                    GaussLegendreQuadrature, GenzMalikCubature,
                                    NestedFixedRule, Rule)
