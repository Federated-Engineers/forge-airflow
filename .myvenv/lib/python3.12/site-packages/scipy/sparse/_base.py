...
from ._sputils import (_todata, asmatrix, check_reshape_kwargs, check_shape,
                       get_sum_dtype, getdtype, is_pydata_spmatrix, isdense,
                       isscalarlike, matrix, validateaxis)
