...
cimport cython
from cpython cimport (Py_buffer, Py_DECREF, Py_INCREF, Py_SIZE, Py_XDECREF,
                      Py_XINCREF, PyBUF_SIMPLE, PyBUF_WRITABLE,
                      PyBuffer_Release, PyBytes_AS_STRING, PyBytes_AsString,
                      PyBytes_AsStringAndSize, PyBytes_CheckExact,
                      PyErr_CheckSignals, PyErr_Occurred, PyObject,
                      PyObject_GetBuffer, PyThread_get_thread_ident)
...
from .includes.python cimport (PY_VERSION_HEX, Context_CopyCurrent,
                               ...
                               PyMemoryView_FromObject, PyOS_AfterFork_Child,
                               PyOS_AfterFork_Parent, PyOS_BeforeFork,
                               PyUnicode_EncodeFSDefault, PyUnicode_FromString,
                               _Py_RestoreSignals)
