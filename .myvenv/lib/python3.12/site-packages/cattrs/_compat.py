...
from typing import Deque, Dict, Final, FrozenSet, Generic, List, Literal
...
from typing import (Tuple, Union, _AnnotatedAlias, _GenericAlias,
                    _SpecialGenericAlias, get_args, get_origin, get_type_hints)

from attrs import NOTHING, Attribute, Factory, NothingType
