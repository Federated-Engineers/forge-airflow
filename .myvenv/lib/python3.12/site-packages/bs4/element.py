...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Generic, Iterable,
                    Iterator, List, Mapping, MutableSequence, Optional,
                    Pattern, Set, Tuple, Type, TypeVar, Union, cast, overload)

from bs4._deprecation import (_deprecated, _deprecated_alias,
...
if TYPE_CHECKING:
    ...
    from bs4._typing import (_AtMostOneElement, _AtMostOneNavigableString,
                             _AtMostOneTag, _AttributeValue, _AttributeValues,
                             _Encoding, _InsertableElement, _OneElement,
                             _QueryResults, _RawOrProcessedAttributeValues,
                             _SomeNavigableStrings, _SomeTags,
                             _StrainableAttribute, _StrainableAttributes,
                             _StrainableElement, _StrainableString)
    from bs4.builder import TreeBuilder
    from bs4.filter import ElementFilter
    from bs4.formatter import _EntitySubstitutionFunction, _FormatterOrName
