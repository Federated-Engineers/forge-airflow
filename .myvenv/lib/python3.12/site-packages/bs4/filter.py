...
from bs4._typing import (_AtMostOneElement, _AttributeValue,
                         _NullableStringMatchFunction, _OneElement,
                         _PageElementMatchFunction, _QueryResults,
                         _RawAttributeValues, _RegularExpressionProtocol,
                         _StrainableAttribute, _StrainableElement,
                         _StrainableString, _StringMatchFunction,
                         _TagMatchFunction)
from bs4.element import (AttributeDict, NavigableString, PageElement,
                         ResultSet, Tag)
