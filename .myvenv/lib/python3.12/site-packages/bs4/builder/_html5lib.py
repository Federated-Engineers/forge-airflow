...
import html5lib
from bs4._typing import (_AttributeValue, _AttributeValues, _Encoding,
                         _Encodings, _NamespaceURL, _RawMarkup)
from bs4.builder import (HTML, HTML_5, PERMISSIVE, DetectsXMLParsedAsHTML,
                         HTMLTreeBuilder)
from bs4.element import (Comment, Doctype, NamespacedAttribute,
                         NavigableString, PageElement, Tag, nonwhitespace_re)
