...
from bs4.builder import (FAST, HTML, PERMISSIVE, XML, DetectsXMLParsedAsHTML,
                         HTMLTreeBuilder, TreeBuilder)
from bs4.dammit import EncodingDetector
from bs4.element import (AttributeDict, Comment, Doctype, NamespacedAttribute,
                         ProcessingInstruction, XMLAttributeDict,
...
if TYPE_CHECKING:
    ...
    from bs4._typing import (_Encoding, _Encodings, _InvertedNamespaceMapping,
                             _NamespaceMapping, _NamespacePrefix,
                             _NamespaceURL, _RawMarkup)
