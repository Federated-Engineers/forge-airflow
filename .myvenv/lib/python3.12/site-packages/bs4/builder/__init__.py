...
from typing import (TYPE_CHECKING, Any, Dict, Iterable, List, Optional,
                    Pattern, Set, Tuple, Type, cast)

from bs4._typing import _AttributeValues, _RawAttributeValue
from bs4._warnings import XMLParsedAsHTMLWarning
from bs4.element import (AttributeDict, AttributeValueList,
                         CharsetMetaAttributeValue, ContentMetaAttributeValue,
                         RubyParenthesisString, RubyTextString, Script,
                         Stylesheet, TemplateString, nonwhitespace_re)
...
if TYPE_CHECKING:
    ...
    from bs4._typing import (_AttributeValue, _Encoding, _Encodings,
                             _RawMarkup, _RawOrProcessedAttributeValues)
