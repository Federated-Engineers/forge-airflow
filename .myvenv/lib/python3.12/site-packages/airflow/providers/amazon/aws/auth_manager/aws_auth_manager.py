...
from airflow.providers.amazon.aws.auth_manager.avp.facade import (
    AwsAuthManagerAmazonVerifiedPermissionsFacade, IsAuthorizedRequest)
...
if TYPE_CHECKING:
    ...
    from airflow.api_fastapi.auth.managers.models.batch_apis import (
        IsAuthorizedConnectionRequest, IsAuthorizedDagRequest,
        IsAuthorizedPoolRequest, IsAuthorizedVariableRequest)
    from airflow.api_fastapi.auth.managers.models.resource_details import (
        AccessView, AssetAliasDetails, AssetDetails, BackfillDetails,
        ConfigurationDetails, ConnectionDetails, DagAccessEntity, DagDetails,
        PoolDetails, VariableDetails)
...
class AwsAuthManager(BaseAuthManager[AwsAuthManagerUser]):
    ...
    def get_cli_commands() -> list[CLICommand]:
        ...
        from airflow.providers.amazon.aws.cli.definition import \
            get_aws_cli_commands

        return get_aws_cli_commands()

    def get_fastapi_app(self) -> FastAPI | None:
        from airflow.providers.amazon.aws.auth_manager.routes.login import \
            login_router
