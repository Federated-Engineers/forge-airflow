...
from airflow.providers.amazon.aws.triggers.redshift_cluster import (
    RedshiftCreateClusterSnapshotTrigger, RedshiftCreateClusterTrigger,
    RedshiftDeleteClusterTrigger, RedshiftPauseClusterTrigger,
            ...
            if cluster:
                ...
                if self.delete_cluster_on_failure:
                    try:
                        ...
                        self.log.exception(
                            "Failed while attempting to delete Redshift cluster %s.",
                            self.cluster_identifier,
                        )
            raise
