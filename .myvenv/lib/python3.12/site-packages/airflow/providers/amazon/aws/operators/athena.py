...
if TYPE_CHECKING:
    from airflow.providers.common.compat.openlineage.facet import (
        BaseFacet, Dataset, DatasetFacet)
...
class AthenaOperator(AwsBaseOperator[AthenaHook]):
    ...
    def get_openlineage_facets_on_complete(self, _) -> OperatorLineage:
        ...
        """
        from airflow.providers.common.compat.openlineage.facet import (
            Dataset, Error, ExternalQueryRunFacet, ExtractionErrorRunFacet,
            SQLJobFacet)
    ...
    def get_openlineage_dataset(self, database, table) -> Dataset | None:
        from airflow.providers.common.compat.openlineage.facet import (
            Dataset, Identifier, SchemaDatasetFacet, SchemaDatasetFacetFields,
