...
from airflow.providers.standard.exceptions import (
    ...
    ExternalDagNotFoundError, ExternalTaskFailedError,
    ExternalTaskGroupFailedError, ExternalTaskGroupNotFoundError,
...
from airflow.providers.standard.utils.sensor_helper import (
    _get_count, _get_external_task_group_task_ids)
...
if AIRFLOW_V_3_2_PLUS:
    ...
    from airflow.models.dagbag import \
        DagBag  # type: ignore[attr-defined, no-redef]
...
class ExternalDagLink(BaseOperatorLink):
    ...
    def get_link(self, operator: BaseOperator, *, ti_key: TaskInstanceKey) -> str:
        ...
        if not AIRFLOW_V_3_0_PLUS:
            ...
            from airflow.models.taskinstancekey import \
                TaskInstanceKey as CoreTaskInstanceKey
        ...
        from airflow.utils.helpers import \
            build_airflow_url_with_query  # type:ignore[attr-defined]
