...
from airflow.providers.standard.utils.python_virtualenv import (
    _execute_in_subprocess, prepare_virtualenv, write_python_script)
...
if TYPE_CHECKING:
    ...
    from airflow.sdk.execution_time.callback_runner import (
        AsyncExecutionCallableRunner, ExecutionCallableRunner)
    ...
    def execute(self, context) -> Any:
        ...
        def __prepare_execution() -> tuple[ExecutionCallableRunner, OutletEventAccessorsProtocol] | None:
            ...
            from airflow.utils.context import \
                context_get_outlet_events  # type: ignore
...
def _get_current_context() -> Mapping[str, Any]:
    ...
    from airflow.models.taskinstance import \
        _CURRENT_CONTEXT  # type: ignore[attr-defined]
