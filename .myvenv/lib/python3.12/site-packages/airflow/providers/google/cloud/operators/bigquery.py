...
from airflow.providers.common.sql.operators.sql import (  # for _parse_boolean
    SQLCheckOperator, SQLColumnCheckOperator, SQLIntervalCheckOperator,
    SQLTableCheckOperator, SQLValueCheckOperator, _parse_boolean)
from airflow.providers.google.cloud.hooks.bigquery import (BigQueryHook,
                                                           BigQueryJob)
from airflow.providers.google.cloud.hooks.gcs import GCSHook, _parse_gcs_url
from airflow.providers.google.cloud.links.bigquery import (
    BigQueryDatasetLink, BigQueryJobDetailLink, BigQueryTableLink)
...
from airflow.providers.google.cloud.triggers.bigquery import (
    BigQueryCheckTrigger, BigQueryGetDataTrigger, BigQueryInsertJobTrigger,
    BigQueryIntervalCheckTrigger, BigQueryValueCheckTrigger)
...
class BigQueryCreateTableOperator(GoogleCloudBaseOperator):
    ...
    def get_openlineage_facets_on_complete(self, _):
        ...
        from airflow.providers.google.cloud.openlineage.utils import (
            BIGQUERY_NAMESPACE, get_facets_from_bq_table)
...
class BigQueryDeleteTableOperator(GoogleCloudBaseOperator):
    ...
    def get_openlineage_facets_on_complete(self, _):
        ...
        from airflow.providers.common.compat.openlineage.facet import (
            Dataset, LifecycleStateChange, LifecycleStateChangeDatasetFacet,
            PreviousIdentifier)
        from airflow.providers.google.cloud.openlineage.utils import \
            BIGQUERY_NAMESPACE
        from airflow.providers.openlineage.extractors import OperatorLineage
