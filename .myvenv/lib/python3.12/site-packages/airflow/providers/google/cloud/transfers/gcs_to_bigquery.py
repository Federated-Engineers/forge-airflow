...
from google.cloud.bigquery import (DEFAULT_RETRY, CopyJob, ExternalConfig,
                                   ExtractJob, LoadJob, QueryJob, SchemaField,
                                   UnknownJob)
...
class GCSToBigQueryOperator(BaseOperator):
    ...
    def get_openlineage_facets_on_complete(self, task_instance):
        ...
        from airflow.providers.common.compat.openlineage.facet import (
            Dataset, ExternalQueryRunFacet, Identifier, SymlinksDatasetFacet)
        from airflow.providers.google.cloud.openlineage.utils import (
            WILDCARD, extract_ds_name_from_gcs_path, get_facets_from_bq_table,
