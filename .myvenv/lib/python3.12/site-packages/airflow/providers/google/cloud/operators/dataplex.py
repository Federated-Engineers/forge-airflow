...
from airflow.providers.google.cloud.triggers.dataplex import (
    DataplexDataProfileJobTrigger, DataplexDataQualityJobTrigger)
...
from airflow.providers.google.cloud.links.dataplex import (
    DataplexCatalogAspectTypeLink, DataplexCatalogAspectTypesLink,
    DataplexCatalogEntryGroupLink, DataplexCatalogEntryGroupsLink,
    DataplexCatalogEntryLink, DataplexCatalogEntryTypeLink,
    DataplexCatalogEntryTypesLink, DataplexLakeLink, DataplexTaskLink,
    DataplexTasksLink)
...
from google.cloud.dataplex_v1.types import (AspectType, Asset, DataScan,
                                            DataScanJob, Entry, EntryGroup,
                                            EntryType, EntryView, Lake,
                                            ListAspectTypesResponse,
                                            ListEntriesResponse,
                                            ListEntryGroupsResponse,
                                            ListEntryTypesResponse,
                                            SearchEntriesResponse, Task, Zone)
