...
from airflow.providers.google.cloud.hooks.cloud_storage_transfer_service import (
    ACCESS_KEY_ID, AWS_ACCESS_KEY, AWS_ROLE_ARN, AWS_S3_DATA_SOURCE,
    BUCKET_NAME, DAY, DESCRIPTION, GCS_DATA_SINK, GCS_DATA_SOURCE, HOURS,
    HTTP_DATA_SOURCE, MINUTES, MONTH, NAME, OBJECT_CONDITIONS, PATH,
    PROJECT_ID, SCHEDULE, SCHEDULE_END_DATE, SCHEDULE_START_DATE, SECONDS,
    SECRET_ACCESS_KEY, START_TIME_OF_DAY, STATUS, TRANSFER_JOB,
    TRANSFER_OPTIONS, TRANSFER_SPEC, YEAR, CloudDataTransferServiceHook,
    GcpTransferJobsStatus)
from airflow.providers.google.cloud.links.cloud_storage_transfer import (
    CloudStorageTransferDetailsLink, CloudStorageTransferJobLink,
    ...
    **Example**:
    ...
    def get_openlineage_facets_on_complete(self, task_instance) -> OperatorLineage | None:
        ...
        from airflow.providers.google.cloud.openlineage.facets import (
            CloudStorageTransferJobFacet, CloudStorageTransferRunFacet)
        from airflow.providers.openlineage.extractors import OperatorLineage
