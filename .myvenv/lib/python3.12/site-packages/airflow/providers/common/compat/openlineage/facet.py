...
if TYPE_CHECKING:
    from openlineage.client.generated.base import (BaseFacet, Dataset,
                                                   DatasetFacet, InputDataset,
                                                   OutputDataset, RunFacet)
    from openlineage.client.generated.column_lineage_dataset import (
        ColumnLineageDatasetFacet, Fields, InputField)
    ...
    from openlineage.client.generated.symlinks_dataset import (
        Identifier, SymlinksDatasetFacet)
else:
    try:
        try:
            from openlineage.client.generated.base import (BaseFacet, Dataset,
            ...
            from openlineage.client.facet import BaseFacet as DatasetFacet
            ...
            from openlineage.client.facet import \
                ColumnLineageDatasetFacetFieldsAdditionalInputFields as \
                InputField
            from openlineage.client.facet import (DocumentationDatasetFacet,
                                                  ErrorMessageRunFacet,
                                                  ExternalQueryRunFacet)
            from openlineage.client.facet import ExtractionError as Error
            from openlineage.client.facet import (
                ExtractionErrorRunFacet, LifecycleStateChange,
                LifecycleStateChangeDatasetFacet)
            from openlineage.client.facet import \
                LifecycleStateChangeDatasetFacetPreviousIdentifier as \
                PreviousIdentifier
            from openlineage.client.facet import (
                OutputStatisticsOutputDatasetFacet, SchemaDatasetFacet)
            from openlineage.client.facet import \
                SchemaField as SchemaDatasetFacetFields
            from openlineage.client.facet import SqlJobFacet as SQLJobFacet
            from openlineage.client.facet import SymlinksDatasetFacet
            from openlineage.client.facet import \
                SymlinksDatasetFacetIdentifiers as Identifier
            from openlineage.client.run import (Dataset, InputDataset,
                                                OutputDataset)
    except ImportError:
