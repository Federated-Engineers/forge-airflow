...
from airflow.exceptions import (AirflowInactiveAssetInInletOrOutletException,
                                TaskDeferralError, TaskDeferred)
...
from sqlalchemy import (Column, Float, ForeignKey, ForeignKeyConstraint, Index,
                        Integer, PrimaryKeyConstraint, String, Text,
                        UniqueConstraint, and_, case, delete, extract, false,
                        func, inspect, or_, select, text, tuple_, update)
...
if TYPE_CHECKING:
    ...
    from airflow.sdk.definitions._internal.abstractoperator import (
        Operator, TaskStateChangeCallback)
...
class TaskInstance(Base, LoggingMixin):
    ...
    def get_template_context(
        ...
        from airflow.models.baseoperator import BaseOperator
        from airflow.sdk.api.datamodels._generated import DagRun as DagRunSDK
        from airflow.sdk.api.datamodels._generated import (
            PrevSuccessfulDagRunResponse, TIRunContext)
