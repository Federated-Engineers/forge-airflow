...
from airflow.utils.sqlalchemy import (ExtendedJSON, UtcDateTime, nulls_first,
                                      with_row_locks)
from airflow.utils.state import DagRunState, State, TaskInstanceState
from airflow.utils.strings import get_random_string
from airflow.utils.thread_safe_dict import ThreadSafeDict
from airflow.utils.types import NOTSET, DagRunTriggeredByType, DagRunType
from sqlalchemy import (JSON, Column, Enum, ForeignKey, ForeignKeyConstraint,
                        Index, Integer, PrimaryKeyConstraint, String, Text,
                        UniqueConstraint, and_, func, not_, or_, text, update)
    ...
    def _get_ready_tis(
        ...
        def _expand_mapped_task_if_needed(ti: TI) -> Iterable[TI] | None:
            ...
            from airflow.sdk.definitions.mappedoperator import \
                MappedOperator as TaskSDKMappedOperator
