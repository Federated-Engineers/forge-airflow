...
from airflow.sdk.definitions.asset import (Asset, AssetAlias, AssetAliasEvent,
                                           AssetAliasUniqueKey, AssetNameRef,
                                           AssetRef, AssetUniqueKey,
                                           AssetUriRef, BaseAssetUniqueKey)
...
if TYPE_CHECKING:
    ...
    from airflow.sdk.execution_time.comms import (
        AssetEventDagRunReferenceResult, AssetEventResult, AssetEventsResult,
        AssetResult, ConnectionResult, OKResponse,
        PrevSuccessfulDagRunResponse, VariableResult)
...
class InletEventsAccessors(Mapping[Union[int, Asset, AssetAlias, AssetRef], Any], _AssetEventAccessorsMixin):
    ...
    def __getitem__(self, key: int | Asset | AssetAlias | AssetRef) -> list[AssetEventResult]:
        from airflow.sdk.definitions.asset import Asset
        from airflow.sdk.execution_time.comms import (
            ErrorResponse, GetAssetEventByAsset, GetAssetEventByAssetAlias,
            ToSupervisor)
        from airflow.sdk.execution_time.task_runner import SUPERVISOR_COMMS
...
def get_previous_dagrun_success(ti_id: UUID) -> PrevSuccessfulDagRunResponse:
    ...
    from airflow.sdk.execution_time.comms import (GetPrevSuccessfulDagRun,
