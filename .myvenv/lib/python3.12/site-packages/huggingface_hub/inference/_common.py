...
from typing import (TYPE_CHECKING, Any, BinaryIO, Literal, NoReturn, Union,
                    overload)

import httpx
from huggingface_hub.errors import (GenerationError, HfHubHTTPError,
                                    IncompleteGenerationError, OverloadedError,
                                    TextGenerationError, UnknownError,
                                    ValidationError)

from ..utils import get_session, is_numpy_available, is_pillow_available
from ._generated.types import (ChatCompletionStreamOutput,
