...
from huggingface_hub.utils._xet import (
    XetTokenType, fetch_xet_connection_info_from_repo_info,
    reset_xet_connection_info_cache_for_repo)
from tqdm.auto import tqdm as base_tqdm
from tqdm.contrib.concurrent import thread_map

from . import constants
from ._buckets import (BucketFile, BucketFileMetadata, BucketFolder,
                       BucketInfo, BucketUrl, SyncPlan, _BucketAddFile,
                       _BucketCopyFile, _BucketDeleteFile,
                       _split_bucket_id_and_prefix, sync_bucket_internal)
from ._commit_api import (CommitOperation, CommitOperationAdd,
                          CommitOperationCopy, CommitOperationDelete,
                          _fetch_files_to_copy, _fetch_upload_modes,
                          _prepare_commit_payload, _upload_files,
                          _warn_on_overwriting_operations)
from ._dataset_viewer import DatasetParquetEntry
from ._eval_results import EvalResultEntry, parse_eval_result_entries
from ._inference_endpoints import (InferenceEndpoint,
                                   InferenceEndpointScalingMetric,
                                   InferenceEndpointType)
from ._jobs_api import (JobHardware, JobInfo, JobSpec, ScheduledJobInfo,
                        _create_job_spec)
from ._space_api import (SpaceHardware, SpaceRuntime, SpaceSearchResult,
                         SpaceStorage, SpaceVariable, Volume)
from ._upload_large_folder import upload_large_folder_internal
from .community import (Discussion, DiscussionComment, DiscussionStatusChange,
                        DiscussionTitleChange, DiscussionWithDetails,
                        deserialize_event)
from .errors import (BadRequestError, EntryNotFoundError, GatedRepoError,
                     HfHubHTTPError, LocalTokenNotFoundError,
                     RemoteEntryNotFoundError, RepositoryNotFoundError,
                     RevisionNotFoundError, XetAuthorizationError,
                     XetRefreshTokenError)
from .file_download import (DryRunFileInfo, HfFileMetadata,
                            get_hf_file_metadata, hf_hub_url)
from .repocard_data import DatasetCardData, ModelCardData, SpaceCardData
from .utils import (DEFAULT_IGNORE_PATTERNS, NotASafetensorsRepoError,
                    SafetensorsFileMetadata, SafetensorsParsingError,
                    SafetensorsRepoMetadata, TensorInfo,
                    are_progress_bars_disabled, build_hf_headers,
                    chunk_iterable, experimental, filter_repo_objects,
                    fix_hf_endpoint_in_url, get_session, get_token,
                    hf_raise_for_status, http_backoff, logging, paginate,
                    parse_datetime, parse_xet_file_data_from_response,
                    refresh_xet_connection_info, silent_tqdm)
    ...
    def download_bucket_files(
        ...
        *,
        ...
        Example:
            ...
            ```
        """
        from hf_xet import PyXetDownloadInfo  # type: ignore[no-redef]
