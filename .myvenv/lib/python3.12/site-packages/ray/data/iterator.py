...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Iterable, Iterator,
                    List, Literal, Optional, Tuple, TypeVar, Union)
...
from ray.data.collate_fn import (ArrowBatchCollateFn, CollateFn,
                                 DefaultCollateFn, NumpyBatchCollateFn,
                                 PandasBatchCollateFn, TensorBatchReturnType,
                                 TensorBatchType, is_tensor_batch_type)
...
if TYPE_CHECKING:
    ...
    from ray.data._internal.execution.streaming_executor import \
        StreamingExecutor
    from ray.data.dataset import (CollatedData, MaterializedDataset, Schema,
                                  TensorFlowTensorBatchType, TorchBatchType,
                                  TorchDeviceType)
...
class DataIterator(abc.ABC):
    ...
    def to_torch(
        ...
        * If ``feature_columns`` is a ``Dict[str, List[str]]``, the features
        ...
        """
        import torch
        from ray.data._internal.torch_iterable_dataset import \
    ...
    def to_tf(
        ...
        *,
        ...
        from ray.data._internal.utils.tensorflow_utils import (
            convert_ndarray_to_tf_tensor, get_type_spec)
