...
from ray.data.preprocessors.discretizer import (CustomKBinsDiscretizer,
                                                UniformKBinsDiscretizer)
from ray.data.preprocessors.encoder import (Categorizer, LabelEncoder,
                                            MultiHotEncoder, OneHotEncoder,
                                            OrdinalEncoder)
...
from ray.data.preprocessors.scaler import (MaxAbsScaler, MinMaxScaler,
...
from ray.data.preprocessors.vectorizer import (CountVectorizer,
                                               HashingVectorizer)
