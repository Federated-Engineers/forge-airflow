...
if TYPE_CHECKING:
    ...
    from ray.data.namespace_expressions.string_namespace import \
        _StringNamespace
    from ray.data.namespace_expressions.struct_namespace import \
        _StructNamespace
...
class Expr(ABC):
    ...
    def arr(self) -> "_ArrayNamespace":
        ...
        from ray.data.namespace_expressions.arr_namespace import \
            _ArrayNamespace
    ...
    def list(self) -> "_ListNamespace":
        ...
        """
        from ray.data.namespace_expressions.list_namespace import \
            _ListNamespace
    ...
    def dt(self) -> "_DatetimeNamespace":
        ...
        from ray.data.namespace_expressions.dt_namespace import \
            _DatetimeNamespace
...
class _CallableClassUDF:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        ...
        from ray.data.util.expression_utils import \
            _call_udf_instance_with_async_bridge
