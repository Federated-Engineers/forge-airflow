...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Generator, Iterable,
                    Iterator, List, Optional, Tuple, TypeVar, Union, overload)
...
from ray.data.context import (DEFAULT_READ_OP_MIN_NUM_BLOCKS, WARN_PREFIX,
                              DataContext)
...
if TYPE_CHECKING:
    ...
    from ray.data.block import (Block, BlockMetadataWithSchema, Schema,
                                UserDefinedFunction)
