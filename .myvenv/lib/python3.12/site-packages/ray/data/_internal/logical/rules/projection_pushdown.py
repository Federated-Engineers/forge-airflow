...
from ray.data._internal.logical.interfaces import (
    LogicalOperator, LogicalOperatorSupportsProjectionPushdown, LogicalPlan,
    Rule)
from ray.data._internal.logical.operators import Project
from ray.data._internal.planner.plan_expression.expression_visitors import (
    _ColumnReferenceCollector, _ColumnSubstitutionVisitor, _is_col_expr)
from ray.data.expressions import AliasExpr, ColumnExpr, Expr, StarExpr
...
def _try_fuse(upstream_project: Project, downstream_project: Project) -> Project:
    ...
    from ray.data._internal.logical.rules.operator_fusion import (
        FuseOperators, are_remote_args_compatible)
