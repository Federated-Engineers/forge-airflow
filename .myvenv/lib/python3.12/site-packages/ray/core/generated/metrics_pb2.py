...
from . import \
    resource_pb2 as opencensus_dot_proto_dot_resource_dot_v1_dot_resource__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'opencensus.proto.metrics.v1.metrics_pb2', globals())
