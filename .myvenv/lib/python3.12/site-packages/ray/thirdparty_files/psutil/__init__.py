...
from ._common import (AIX, BSD, CONN_CLOSE, CONN_CLOSE_WAIT, CONN_CLOSING,
                      ...
                      CONN_SYN_SENT, CONN_TIME_WAIT, FREEBSD, LINUX, MACOS,
                      NETBSD, NIC_DUPLEX_FULL, NIC_DUPLEX_HALF,
                      NIC_DUPLEX_UNKNOWN, OPENBSD, POSIX, POWER_TIME_UNKNOWN,
                      POWER_TIME_UNLIMITED, STATUS_DEAD, STATUS_DISK_SLEEP,
                      STATUS_IDLE, STATUS_LOCKED, STATUS_PARKED,
                      ...
                      NoSuchProcess, TimeoutExpired, ZombieProcess, debug,
