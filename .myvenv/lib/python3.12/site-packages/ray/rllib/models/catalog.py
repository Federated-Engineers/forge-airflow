...
from ray.rllib.models.tf.tf_action_dist import (Categorical, Deterministic,
                                                DiagGaussian, Dirichlet,
                                                MultiActionDistribution,
                                                MultiCategorical)
from ray.rllib.models.torch.torch_action_dist import (
    TorchCategorical, TorchDeterministic, TorchDiagGaussian, TorchDirichlet,
...
from ray.tune.registry import RLLIB_ACTION_DIST, RLLIB_MODEL, _global_registry
...
class ModelCatalog:
    ...
    def _get_v2_model_class(
        ...
        if framework in ["tf2", "tf"]:
            ...
            from ray.rllib.models.jax.fcnet import \
                FullyConnectedNetwork as FCNet
        else:
            raise ValueError(
