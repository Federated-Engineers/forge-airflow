...
from ray.rllib.algorithms.sac.sac_learner import (LOGPS_KEY, QF_PREDS,
                                                  QF_TARGET_NEXT)
...
from ray.rllib.algorithms.tqc.tqc_learner import (QF_LOSS_KEY, QF_MAX_KEY,
                                                  QF_MEAN_KEY, QF_MIN_KEY,
                                                  TD_ERROR_MEAN_KEY,
                                                  TQCLearner)
