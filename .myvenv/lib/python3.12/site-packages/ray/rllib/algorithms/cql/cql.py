...
from ray.rllib.connectors.learner.add_next_observations_from_episodes_to_train_batch import \
    AddNextObservationsFromEpisodesToTrainBatch  # noqa
...
from ray.rllib.utils.metrics import (LAST_TARGET_UPDATE_TS, LEARNER_RESULTS,
                                     LEARNER_UPDATE_TIMER,
                                     NUM_AGENT_STEPS_SAMPLED,
                                     NUM_AGENT_STEPS_TRAINED,
                                     NUM_ENV_STEPS_SAMPLED,
                                     NUM_ENV_STEPS_TRAINED, NUM_TARGET_UPDATES,
                                     OFFLINE_SAMPLING_TIMER, SAMPLE_TIMER,
                                     SYNCH_WORKER_WEIGHTS_TIMER,
                                     TARGET_NET_UPDATE_TIMER, TIMERS)
...
class CQLConfig(SACConfig):
    ...
    def get_default_learner_class(self) -> Union[Type["Learner"], str]:
        if self.framework_str == "torch":
            from ray.rllib.algorithms.cql.torch.cql_torch_learner import \
                CQLTorchLearner
