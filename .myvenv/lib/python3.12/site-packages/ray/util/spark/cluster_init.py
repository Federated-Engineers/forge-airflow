...
from .utils import (_get_cpu_cores, _get_local_ray_node_slots,
                    _get_num_physical_gpus, _wait_service_up,
                    calc_mem_ray_head_node, exec_cmd, gen_cmd_exec_failure_msg,
                    get_avail_mem_per_ray_worker_node,
                    get_configured_spark_executor_memory_bytes,
                    get_max_num_concurrent_tasks, get_random_unused_port,
                    get_spark_application_driver_host, get_spark_session,
                    get_spark_task_assigned_physical_gpus,
                    is_in_databricks_runtime, is_port_in_use)
    ...
    **kwargs,
    ...
    def _get_spark_worker_resources(_):
        from ray.util.spark.utils import (
            _get_cpu_cores, _get_num_physical_gpus,
...
class AutoscalingCluster:
    ...
    def start(
        ...
        from ray.util.spark.cluster_init import (
            RAY_ON_SPARK_COLLECT_LOG_TO_PATH, _append_resources_config,
