...
from ray.train._internal.session import (get_checkpoint, get_dataset_shard,
                                         report)
...
if is_v2_enabled():
    ...
    from ray.train.v2.api.config import CheckpointConfig  # noqa: F811
