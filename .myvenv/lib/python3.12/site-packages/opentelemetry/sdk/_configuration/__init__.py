...
from opentelemetry.sdk.environment_variables import (
    ...
    OTEL_PYTHON_LOGGER_CONFIGURATOR, OTEL_PYTHON_METER_CONFIGURATOR,
    OTEL_PYTHON_TRACER_CONFIGURATOR, OTEL_TRACES_SAMPLER,
...
def _init_logging(
    ...
    with warnings.catch_warnings():
        ...
        from opentelemetry._events import \
            set_event_logger_provider  # noqa: PLC0415
        from opentelemetry.sdk._events import \
            EventLoggerProvider  # noqa: PLC0415
