...
from opentelemetry.sdk._configuration.models import (
    ExporterDefaultHistogramAggregation, ExporterTemporalityPreference,
    InstrumentType)
from opentelemetry.sdk._configuration.models import \
...
from opentelemetry.sdk._configuration.models import View as ViewConfig
from opentelemetry.sdk.metrics import (AlwaysOffExemplarFilter,
                                       AlwaysOnExemplarFilter, Counter,
                                       Histogram, MeterProvider,
                                       ObservableCounter, ObservableGauge,
                                       ObservableUpDownCounter,
                                       TraceBasedExemplarFilter, UpDownCounter,
                                       _Gauge)
...
def _create_otlp_http_metric_exporter(
    ...
    try:
        ...
        from opentelemetry.exporter.otlp.proto.http import \
            Compression  # type: ignore[import-untyped]  # noqa: PLC0415
        from opentelemetry.exporter.otlp.proto.http.metric_exporter import \
            OTLPMetricExporter  # type: ignore[import-untyped]  # noqa: PLC0415
