...
from opentelemetry.sdk._configuration.models import Sampler as SamplerConfig
from opentelemetry.sdk._configuration.models import \
...
from opentelemetry.sdk.trace import (_DEFAULT_OTEL_EVENT_ATTRIBUTE_COUNT_LIMIT,
...
def _create_otlp_http_span_exporter(
    ...
    try:
        ...
        from opentelemetry.exporter.otlp.proto.http.trace_exporter import \
            OTLPSpanExporter  # type: ignore[import-untyped]  # noqa: PLC0415
