...
from typing import (Any, Callable, Dict, Generic, List, Literal,  # noqa: F401
                    NewType, Optional)
from typing import Sequence as TypingSequence
from typing import Tuple, Type, TypeVar, Union  # noqa: F401
from urllib.parse import urlparse

from google.rpc.error_details_pb2 import RetryInfo
from grpc import (ChannelCredentials, Compression, RpcError, StatusCode,
                  insecure_channel, secure_channel, ssl_channel_credentials)
from opentelemetry.exporter.otlp.proto.common._internal import \
    _get_resource_data
from opentelemetry.exporter.otlp.proto.grpc import _OTLP_GRPC_CHANNEL_OPTIONS
...
from opentelemetry.proto.collector.trace.v1.trace_service_pb2_grpc import \
    TraceServiceStub
from opentelemetry.proto.common.v1.common_pb2 import AnyValue  # noqa: F401
from opentelemetry.proto.common.v1.common_pb2 import ArrayValue, KeyValue
...
from opentelemetry.sdk.environment_variables import (
    ...
    OTEL_EXPORTER_OTLP_CLIENT_KEY, OTEL_EXPORTER_OTLP_COMPRESSION,
