...
from typing import (Callable, Final, Generator, Iterable, Optional, Sequence,
                    Union)

from opentelemetry.metrics import (CallbackOptions, Counter, Meter,
                                   ObservableGauge, Observation, UpDownCounter)
