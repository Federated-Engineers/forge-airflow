...
class SessionControllerClient(metaclass=SessionControllerClientMeta):
        ...
        *,
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                SessionControllerClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., SessionControllerTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dataproc_v1.SessionControllerClient`.",
                    extra={
    ...
    def create_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.CreateSessionRequest, dict]):
    ...
    def list_sessions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.ListSessionsRequest, dict]):
        ...
        Returns:
            google.cloud.dataproc_v1.services.session_controller.pagers.ListSessionsPager:
    ...
    def terminate_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.TerminateSessionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sessions.TerminateSessionRequest):
            request = sessions.TerminateSessionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.terminate_session]
    ...
    def delete_session(
        self,
        request: Optional[Union[sessions.DeleteSessionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Deletes the interactive session resource. If the
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.DeleteSessionRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, sessions.DeleteSessionRequest):
            request = sessions.DeleteSessionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def __enter__(self) -> "SessionControllerClient":
        return self
...
__all__ = ("SessionControllerClient",)
