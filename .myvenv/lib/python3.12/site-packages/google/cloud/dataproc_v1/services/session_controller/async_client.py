...
class SessionControllerAsyncClient:
    ...
    async def terminate_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataproc_v1.types.TerminateSessionRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.terminate_session
        ]
    ...
    async def delete_session(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataproc_v1.types.DeleteSessionRequest, dict]]):
    ...
    async def __aenter__(self) -> "SessionControllerAsyncClient":
        return self
...
__all__ = ("SessionControllerAsyncClient",)
