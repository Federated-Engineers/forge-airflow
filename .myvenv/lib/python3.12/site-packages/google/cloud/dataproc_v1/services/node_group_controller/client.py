...
class NodeGroupControllerClient(metaclass=NodeGroupControllerClientMeta):
    ...
    def create_node_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.CreateNodeGroupRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_node_group]
    ...
    def resize_node_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.ResizeNodeGroupRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resize_node_group]
    ...
    def get_node_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataproc_v1.types.GetNodeGroupRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_node_group]
...
__all__ = ("NodeGroupControllerClient",)
