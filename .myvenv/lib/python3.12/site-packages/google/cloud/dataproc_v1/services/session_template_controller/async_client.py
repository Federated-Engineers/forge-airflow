...
from google.cloud.dataproc_v1.services.session_template_controller import \
    pagers
...
class SessionTemplateControllerAsyncClient:
    ...
    async def list_session_templates(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataproc_v1.types.ListSessionTemplatesRequest, dict]]):
        ...
        response = pagers.ListSessionTemplatesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "SessionTemplateControllerAsyncClient":
        return self
...
__all__ = ("SessionTemplateControllerAsyncClient",)
