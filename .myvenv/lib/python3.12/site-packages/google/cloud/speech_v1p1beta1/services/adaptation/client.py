...
class AdaptationClient(metaclass=AdaptationClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AdaptationClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdaptationClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AdaptationClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdaptationClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AdaptationClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AdaptationClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdaptationTransport)
        if transport_provided:
            ...
            self._transport = cast(AdaptationTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AdaptationClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.speech_v1p1beta1.AdaptationClient`.",
                    extra={
