...
from google.cloud.texttospeech_v1.types.cloud_tts import (
    AdvancedVoiceOptions, AudioConfig, AudioEncoding,
    CustomPronunciationParams, CustomPronunciations, CustomVoiceParams,
    ListVoicesRequest, ListVoicesResponse, MultiSpeakerMarkup,
    MultispeakerPrebuiltVoice, MultiSpeakerVoiceConfig, SsmlVoiceGender,
    StreamingAudioConfig, StreamingSynthesisInput, StreamingSynthesizeConfig,
    StreamingSynthesizeRequest, StreamingSynthesizeResponse, SynthesisInput,
    SynthesizeSpeechRequest, SynthesizeSpeechResponse, Voice, VoiceCloneParams,
    VoiceSelectionParams)
from google.cloud.texttospeech_v1.types.cloud_tts_lrs import (
    SynthesizeLongAudioMetadata, SynthesizeLongAudioRequest,
