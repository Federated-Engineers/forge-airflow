...
class TagValuesAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            TagValuesClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(TagValuesAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            TagValuesClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(TagValuesAsyncClient, filename, *args, **kwargs)
        ...
        Args:
            ...
            name (:class:`str`):
                ...
                - ``42/foo/abc`` for a value with short name "abc" under
                  the key with short name "foo" under the organization
                  with ID 42
