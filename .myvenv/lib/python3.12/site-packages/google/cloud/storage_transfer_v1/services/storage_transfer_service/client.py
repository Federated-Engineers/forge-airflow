...
class StorageTransferServiceClient(metaclass=StorageTransferServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                StorageTransferServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = StorageTransferServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = StorageTransferServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = StorageTransferServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, StorageTransferServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(StorageTransferServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or StorageTransferServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.storagetransfer_v1.StorageTransferServiceClient`.",
                    extra={
    ...
    def create_agent_pool(
        ...
        *,
        ...
        flattened_params = [project_id, agent_pool, agent_pool_id]
    ...
    def update_agent_pool(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [agent_pool, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
