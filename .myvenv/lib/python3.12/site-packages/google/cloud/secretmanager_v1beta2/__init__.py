...
from .types.resources import (CustomerManagedEncryption,
                              ...
                              ReplicationStatus, Rotation, Secret,
                              SecretPayload, SecretVersion, Topic)
from .types.service import (AccessSecretVersionRequest,
                            ...
                            EnableSecretVersionRequest, GetSecretRequest,
                            GetSecretVersionRequest, ListSecretsRequest,
                            ListSecretsResponse, ListSecretVersionsRequest,
