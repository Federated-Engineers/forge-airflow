...
from google.cloud.managedkafka_v1.services.managed_kafka_connect import pagers
from google.cloud.managedkafka_v1.types import managed_kafka_connect, resources
from google.longrunning import operations_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, ManagedKafkaConnectTransport
from .transports.grpc import ManagedKafkaConnectGrpcTransport
from .transports.grpc_asyncio import ManagedKafkaConnectGrpcAsyncIOTransport
from .transports.rest import ManagedKafkaConnectRestTransport


class ManagedKafkaConnectClientMeta(type):
    """Metaclass for the ManagedKafkaConnect client.
    ...
    ) -> Type[ManagedKafkaConnectTransport]:
...
class ManagedKafkaConnectClient(metaclass=ManagedKafkaConnectClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ManagedKafkaConnectClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> ManagedKafkaConnectTransport:
        """Returns the transport used by the client instance.

        Returns:
            ManagedKafkaConnectTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def connect_cluster_path(
        project: str,
        location: str,
        connect_cluster: str,
    ) -> str:
        """Returns a fully-qualified connect_cluster string."""
        return "projects/{project}/locations/{location}/connectClusters/{connect_cluster}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_connect_cluster_path(path: str) -> Dict[str, str]:
        """Parses a connect_cluster path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/connectClusters/(?P<connect_cluster>.+?)$",
            path,
        )
    ...
    def connector_path(
        ...
        return "projects/{project}/locations/{location}/connectClusters/{connect_cluster}/connectors/{connector}".format(
            project=project,
            location=location,
            connect_cluster=connect_cluster,
            connector=connector,
    ...
    def parse_connector_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/connectClusters/(?P<connect_cluster>.+?)/connectors/(?P<connector>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ManagedKafkaConnectClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ManagedKafkaConnectClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ManagedKafkaConnectClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ManagedKafkaConnectClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,ManagedKafkaConnectTransport,Callable[..., ManagedKafkaConnectTransport]]]):
                ...
                arguments as used in the ManagedKafkaConnectTransport constructor.
        ...
        self._client_cert_source = ManagedKafkaConnectClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ManagedKafkaConnectClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ManagedKafkaConnectTransport)
        if transport_provided:
            # transport is a ManagedKafkaConnectTransport instance.
            ...
            self._transport = cast(ManagedKafkaConnectTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ManagedKafkaConnectClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ManagedKafkaConnectClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., ManagedKafkaConnectTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.managedkafka_v1.ManagedKafkaConnectClient`.",
                    extra={
    ...
    def list_connect_clusters(
        ...
        *,
    ...
    ) -> pagers.ListConnectClustersPager:
        r"""Lists the Kafka Connect clusters in a given project
        and location.
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.ListConnectClustersRequest, dict]):
                The request object. Request for ListConnectClusters.
            parent (str):
                Required. The parent project/location whose Connect
        ...
        if not isinstance(request, managed_kafka_connect.ListConnectClustersRequest):
            request = managed_kafka_connect.ListConnectClustersRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_connect_clusters]
        ...
        response = pagers.ListConnectClustersPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_connect_cluster(
        ...
        *,
        ...
        r"""Returns the properties of a single Kafka Connect
        cluster.
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.GetConnectClusterRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.GetConnectClusterRequest):
            request = managed_kafka_connect.GetConnectClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_connect_cluster]
    ...
    def create_connect_cluster(
        ...
        *,
        ...
        r"""Creates a new Kafka Connect cluster in a given
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.CreateConnectClusterRequest, dict]):
                The request object. Request for CreateConnectCluster.
            parent (str):
                Required. The parent project/location in which to create
                the Kafka Connect cluster. Structured like
                ``projects/{project}/locations/{location}/``.
            ...
            connect_cluster (google.cloud.managedkafka_v1.types.ConnectCluster):
                ...
                This corresponds to the ``connect_cluster`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            connect_cluster_id (str):
                Required. The ID to use for the Connect cluster, which
                will become the final component of the cluster's name.
                The ID must be 1-63 characters long, and match the
                regular expression ``[a-z]([-a-z0-9]*[a-z0-9])?`` to
                comply with RFC 1035.

                This value is structured like: ``my-cluster-id``.

                This corresponds to the ``connect_cluster_id`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.managedkafka_v1.types.ConnectCluster`
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.CreateConnectClusterRequest):
            request = managed_kafka_connect.CreateConnectClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
            if connect_cluster is not None:
                request.connect_cluster = connect_cluster
            if connect_cluster_id is not None:
                request.connect_cluster_id = connect_cluster_id

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_connect_cluster]
    ...
    def update_connect_cluster(
        ...
        *,
        ...
        r"""Updates the properties of a single Kafka Connect
        cluster.
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.UpdateConnectClusterRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.UpdateConnectClusterRequest):
            request = managed_kafka_connect.UpdateConnectClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if connect_cluster is not None:
                request.connect_cluster = connect_cluster
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_connect_cluster]
    ...
    def delete_connect_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.DeleteConnectClusterRequest, dict]):
                The request object. Request for DeleteConnectCluster.
            name (str):
                Required. The name of the Kafka Connect cluster to
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.DeleteConnectClusterRequest):
            request = managed_kafka_connect.DeleteConnectClusterRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_connect_cluster]
    ...
    def list_connectors(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.ListConnectorsRequest, dict]):
                The request object. Request for ListConnectors.
            parent (str):
                Required. The parent Connect cluster whose connectors
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.ListConnectorsRequest):
            request = managed_kafka_connect.ListConnectorsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def get_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.GetConnectorRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.GetConnectorRequest):
            request = managed_kafka_connect.GetConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def create_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.CreateConnectorRequest, dict]):
                The request object. Request for CreateConnector.
            parent (str):
                Required. The parent Connect cluster in which to create
                the connector. Structured like
                ``projects/{project}/locations/{location}/connectClusters/{connect_cluster_id}``.
            ...
            connector (google.cloud.managedkafka_v1.types.Connector):
                ...
                should not be set.
            connector_id (str):
                Required. The ID to use for the connector, which will
                become the final component of the connector's name. The
                ID must be 1-63 characters long, and match the regular
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.CreateConnectorRequest):
            request = managed_kafka_connect.CreateConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def update_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.UpdateConnectorRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.UpdateConnectorRequest):
            request = managed_kafka_connect.UpdateConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if connector is not None:
                request.connector = connector
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_connector]
    ...
    def delete_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.DeleteConnectorRequest, dict]):
                The request object. Request for DeleteConnector.
            name (str):
                Required. The name of the connector
                to delete. Structured like:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.DeleteConnectorRequest):
            request = managed_kafka_connect.DeleteConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def pause_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.PauseConnectorRequest, dict]):
                The request object. Request for PauseConnector.
            name (str):
                Required. The name of the connector
                to pause. Structured like:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.PauseConnectorRequest):
            request = managed_kafka_connect.PauseConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.pause_connector]
    ...
    def resume_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.ResumeConnectorRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.ResumeConnectorRequest):
            request = managed_kafka_connect.ResumeConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.resume_connector]
    ...
    def restart_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.RestartConnectorRequest, dict]):
                The request object. Request for RestartConnector.
            name (str):
                Required. The name of the connector
                to restart. Structured like:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.RestartConnectorRequest):
            request = managed_kafka_connect.RestartConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.restart_connector]
    ...
    def stop_connector(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.StopConnectorRequest, dict]):
                The request object. Request for StopConnector.
            name (str):
                Required. The name of the connector
                to stop. Structured like:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka_connect.StopConnectorRequest):
            request = managed_kafka_connect.StopConnectorRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stop_connector]
    ...
    def __enter__(self) -> "ManagedKafkaConnectClient":
        return self
...
__all__ = ("ManagedKafkaConnectClient",)
