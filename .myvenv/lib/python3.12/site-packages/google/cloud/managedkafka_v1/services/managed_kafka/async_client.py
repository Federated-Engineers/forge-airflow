...
from google.cloud.managedkafka_v1.services.managed_kafka import pagers
from google.cloud.managedkafka_v1.types import managed_kafka, resources
from google.longrunning import operations_pb2  # type: ignore

from .client import ManagedKafkaClient
from .transports.base import DEFAULT_CLIENT_INFO, ManagedKafkaTransport
from .transports.grpc_asyncio import ManagedKafkaGrpcAsyncIOTransport
...
class ManagedKafkaAsyncClient:
    """The service that a client application uses to manage Apache
    Kafka clusters, topics and consumer groups.
    """

    _client: ManagedKafkaClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = ManagedKafkaClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = ManagedKafkaClient.DEFAULT_MTLS_ENDPOINT
    _DEFAULT_ENDPOINT_TEMPLATE = ManagedKafkaClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = ManagedKafkaClient._DEFAULT_UNIVERSE
    ...
    parse_consumer_group_path = staticmethod(
        ManagedKafkaClient.parse_consumer_group_path
    )
    crypto_key_path = staticmethod(ManagedKafkaClient.crypto_key_path)
    parse_crypto_key_path = staticmethod(ManagedKafkaClient.parse_crypto_key_path)
    topic_path = staticmethod(ManagedKafkaClient.topic_path)
    parse_topic_path = staticmethod(ManagedKafkaClient.parse_topic_path)
    common_billing_account_path = staticmethod(
        ManagedKafkaClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        ManagedKafkaClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(ManagedKafkaClient.common_folder_path)
    parse_common_folder_path = staticmethod(ManagedKafkaClient.parse_common_folder_path)
    common_organization_path = staticmethod(ManagedKafkaClient.common_organization_path)
    parse_common_organization_path = staticmethod(
        ManagedKafkaClient.parse_common_organization_path
    )
    common_project_path = staticmethod(ManagedKafkaClient.common_project_path)
    parse_common_project_path = staticmethod(
        ManagedKafkaClient.parse_common_project_path
    )
    common_location_path = staticmethod(ManagedKafkaClient.common_location_path)
    parse_common_location_path = staticmethod(
        ManagedKafkaClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ManagedKafkaAsyncClient: The constructed client.
        """
        sa_info_func = (
            ManagedKafkaClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ManagedKafkaAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ManagedKafkaClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ManagedKafkaAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return ManagedKafkaClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore

    @property
    def transport(self) -> ManagedKafkaTransport:
        """Returns the transport used by the client instance.

        Returns:
            ManagedKafkaTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ManagedKafkaTransport, Callable[..., ManagedKafkaTransport]]
        ] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,ManagedKafkaTransport,Callable[..., ManagedKafkaTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ManagedKafkaTransport constructor.
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.managedkafka_v1.ManagedKafkaAsyncClient`.",
                extra={
    ...
    async def list_clusters(
        self,
        request: Optional[Union[managed_kafka.ListClustersRequest, dict]] = None,
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.ListClustersRequest, dict]]):
        ...
        if not isinstance(request, managed_kafka.ListClustersRequest):
            request = managed_kafka.ListClustersRequest(request)
    ...
    async def get_cluster(
        self,
        request: Optional[Union[managed_kafka.GetClusterRequest, dict]] = None,
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.GetClusterRequest):
            request = managed_kafka.GetClusterRequest(request)
    ...
    async def create_cluster(
        self,
        request: Optional[Union[managed_kafka.CreateClusterRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.CreateClusterRequest, dict]]):
                The request object. Request for CreateCluster.
            parent (:class:`str`):
                Required. The parent region in which to create the
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cluster (:class:`google.cloud.managedkafka_v1.types.Cluster`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.managedkafka_v1.types.Cluster` An
                Apache Kafka cluster deployed in a location.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.CreateClusterRequest):
            request = managed_kafka.CreateClusterRequest(request)
    ...
    async def update_cluster(
        self,
        request: Optional[Union[managed_kafka.UpdateClusterRequest, dict]] = None,
        *,
        cluster: Optional[resources.Cluster] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.UpdateClusterRequest, dict]]):
                The request object. Request for UpdateCluster.
            cluster (:class:`google.cloud.managedkafka_v1.types.Cluster`):
                Required. The cluster to update. Its ``name`` field must
                be populated.
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                overwritten if it is in the mask. The mask is required
                and a value of \* will update all fields.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.UpdateClusterRequest):
            request = managed_kafka.UpdateClusterRequest(request)
    ...
    async def delete_cluster(
        self,
        request: Optional[Union[managed_kafka.DeleteClusterRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.DeleteClusterRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.DeleteClusterRequest):
            request = managed_kafka.DeleteClusterRequest(request)
    ...
    async def list_topics(
        self,
        request: Optional[Union[managed_kafka.ListTopicsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.ListTopicsRequest, dict]]):
                The request object. Request for ListTopics.
            parent (:class:`str`):
                Required. The parent cluster whose topics are to be
                listed. Structured like
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.ListTopicsRequest):
            request = managed_kafka.ListTopicsRequest(request)
    ...
    async def get_topic(
        self,
        request: Optional[Union[managed_kafka.GetTopicRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            ...
            name (:class:`str`):
                ...
                configuration to return. Structured
                like:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.GetTopicRequest):
            request = managed_kafka.GetTopicRequest(request)
    ...
    async def create_topic(
        self,
        request: Optional[Union[managed_kafka.CreateTopicRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        topic: Optional[resources.Topic] = None,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.CreateTopicRequest, dict]]):
                The request object. Request for CreateTopic.
            parent (:class:`str`):
                Required. The parent cluster in which to create the
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            topic (:class:`google.cloud.managedkafka_v1.types.Topic`):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.CreateTopicRequest):
            request = managed_kafka.CreateTopicRequest(request)
    ...
    async def update_topic(
        self,
        request: Optional[Union[managed_kafka.UpdateTopicRequest, dict]] = None,
        *,
        topic: Optional[resources.Topic] = None,
        update_mask: Optional[field_mask_pb2.FieldMask] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.UpdateTopicRequest, dict]]):
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                Required. Field mask is used to specify the fields to be
                overwritten in the Topic resource by the update. The
                fields specified in the update_mask are relative to the
                resource, not the full request. A field will be
                overwritten if it is in the mask. The mask is required
                and a value of \* will update all fields.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.UpdateTopicRequest):
            request = managed_kafka.UpdateTopicRequest(request)
    ...
    async def delete_topic(
        self,
        request: Optional[Union[managed_kafka.DeleteTopicRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.DeleteTopicRequest):
            request = managed_kafka.DeleteTopicRequest(request)
    ...
    async def list_consumer_groups(
        self,
        request: Optional[Union[managed_kafka.ListConsumerGroupsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListConsumerGroupsAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.ListConsumerGroupsRequest, dict]]):
                The request object. Request for ListConsumerGroups.
            parent (:class:`str`):
                Required. The parent cluster whose consumer groups are
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.ListConsumerGroupsRequest):
            request = managed_kafka.ListConsumerGroupsRequest(request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_consumer_groups
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListConsumerGroupsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_consumer_group(
        self,
        request: Optional[Union[managed_kafka.GetConsumerGroupRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.GetConsumerGroupRequest, dict]]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.GetConsumerGroupRequest):
            request = managed_kafka.GetConsumerGroupRequest(request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_consumer_group
        ]
    ...
    async def update_consumer_group(
        self,
        request: Optional[Union[managed_kafka.UpdateConsumerGroupRequest, dict]] = None,
        *,
        consumer_group: Optional[resources.ConsumerGroup] = None,
        update_mask: Optional[field_mask_pb2.FieldMask] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.UpdateConsumerGroupRequest, dict]]):
                The request object. Request for UpdateConsumerGroup.
            consumer_group (:class:`google.cloud.managedkafka_v1.types.ConsumerGroup`):
                Required. The consumer group to update. Its ``name``
                field must be populated.

                This corresponds to the ``consumer_group`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                Required. Field mask is used to specify the fields to be
                overwritten in the ConsumerGroup resource by the update.
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.UpdateConsumerGroupRequest):
            request = managed_kafka.UpdateConsumerGroupRequest(request)

        # If we have keyword arguments corresponding to fields on the
        # request, apply these.
        if consumer_group is not None:
            request.consumer_group = consumer_group
        if update_mask is not None:
            request.update_mask = update_mask
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_consumer_group
        ]
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (("consumer_group.name", request.consumer_group.name),)
            ),
        )
    ...
    async def delete_consumer_group(
        self,
        request: Optional[Union[managed_kafka.DeleteConsumerGroupRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, managed_kafka.DeleteConsumerGroupRequest):
            request = managed_kafka.DeleteConsumerGroupRequest(request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_consumer_group
        ]
    ...
    async def list_acls(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.ListAclsRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_acls
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListAclsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_acl(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.GetAclRequest, dict]]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_acl]
    ...
    async def create_acl(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.CreateAclRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            acl (:class:`google.cloud.managedkafka_v1.types.Acl`):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.create_acl
        ]
    ...
    async def update_acl(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.UpdateAclRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_acl
        ]
    ...
    async def delete_acl(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.DeleteAclRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_acl
        ]
    ...
    async def add_acl_entry(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.AddAclEntryRequest, dict]]):
            ...
            acl (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            acl_entry (:class:`google.cloud.managedkafka_v1.types.AclEntry`):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.add_acl_entry
        ]
    ...
    async def remove_acl_entry(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.managedkafka_v1.types.RemoveAclEntryRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.remove_acl_entry
        ]
    ...
    async def __aenter__(self) -> "ManagedKafkaAsyncClient":
        return self
...
__all__ = ("ManagedKafkaAsyncClient",)
