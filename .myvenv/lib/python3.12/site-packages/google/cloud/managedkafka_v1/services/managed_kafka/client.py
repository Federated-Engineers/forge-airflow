...
from .transports.grpc import ManagedKafkaGrpcTransport
from .transports.grpc_asyncio import ManagedKafkaGrpcAsyncIOTransport
from .transports.rest import ManagedKafkaRestTransport


class ManagedKafkaClientMeta(type):
    """Metaclass for the ManagedKafka client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[ManagedKafkaTransport]]
    _transport_registry["grpc"] = ManagedKafkaGrpcTransport
    _transport_registry["grpc_asyncio"] = ManagedKafkaGrpcAsyncIOTransport
    _transport_registry["rest"] = ManagedKafkaRestTransport

    def get_transport_class(
        cls,
        label: Optional[str] = None,
    ) -> Type[ManagedKafkaTransport]:
...
class ManagedKafkaClient(metaclass=ManagedKafkaClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ManagedKafkaClient: The constructed client.
        """
    ...
    def transport(self) -> ManagedKafkaTransport:
        ...
        Returns:
            ManagedKafkaTransport: The transport used by the client
                instance.
        """
    ...
    def consumer_group_path(
        ...
        return "projects/{project}/locations/{location}/clusters/{cluster}/consumerGroups/{consumer_group}".format(
            project=project,
            location=location,
            cluster=cluster,
    ...
    @staticmethod
    def parse_consumer_group_path(path: str) -> Dict[str, str]:
        """Parses a consumer_group path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/consumerGroups/(?P<consumer_group>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def topic_path(
        ...
        return "projects/{project}/locations/{location}/clusters/{cluster}/topics/{topic}".format(
            project=project,
            location=location,
            cluster=cluster,
            topic=topic,
    ...
    def parse_topic_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/clusters/(?P<cluster>.+?)/topics/(?P<topic>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ManagedKafkaClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ManagedKafkaClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ManagedKafkaClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ManagedKafkaClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = ManagedKafkaClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ManagedKafkaClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ManagedKafkaTransport)
        if transport_provided:
            # transport is a ManagedKafkaTransport instance.
            ...
            self._transport = cast(ManagedKafkaTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or ManagedKafkaClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.managedkafka_v1.ManagedKafkaClient`.",
                    extra={
    ...
    def get_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.GetClusterRequest, dict]):
    ...
    def create_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.CreateClusterRequest, dict]):
    ...
    def update_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.UpdateClusterRequest, dict]):
    ...
    def delete_cluster(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.DeleteClusterRequest, dict]):
    ...
    def list_topics(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.ListTopicsRequest, dict]):
    ...
    def get_topic(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.GetTopicRequest, dict]):
    ...
    def create_topic(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.CreateTopicRequest, dict]):
    ...
    def update_topic(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.UpdateTopicRequest, dict]):
    ...
    def delete_topic(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.DeleteTopicRequest, dict]):
    ...
    def list_consumer_groups(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListConsumerGroupsPager:
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.ListConsumerGroupsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_consumer_groups]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListConsumerGroupsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_consumer_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.GetConsumerGroupRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_consumer_group]
    ...
    def update_consumer_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.UpdateConsumerGroupRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_consumer_group]
    ...
    def delete_consumer_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.managedkafka_v1.types.DeleteConsumerGroupRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_consumer_group]
