...
from .types.managed_kafka import (AddAclEntryRequest, AddAclEntryResponse,
                                  ...
                                  GetTopicRequest, ListAclsRequest,
                                  ListAclsResponse, ListClustersRequest,
...
from .types.resources import (AccessConfig, Acl, AclEntry, CapacityConfig,
                              Cluster, ConnectAccessConfig, ConnectCluster,
                              ConnectGcpConfig, ConnectNetworkConfig,
                              Connector, ConsumerGroup,
                              ConsumerPartitionMetadata, ConsumerTopicMetadata,
                              GcpConfig, NetworkConfig, OperationMetadata,
                              RebalanceConfig, TaskRetryPolicy, TlsConfig,
                              Topic, TrustConfig)

if hasattr(api_core, "check_python_version") and hasattr(
    api_core, "check_dependency_versions"
):  # pragma: NO COVER
    api_core.check_python_version("google.cloud.managedkafka_v1")  # type: ignore
    api_core.check_dependency_versions("google.cloud.managedkafka_v1")  # type: ignore
else:  # pragma: NO COVER
    ...
    try:
        ...
        _package_label = "google.cloud.managedkafka_v1"
