...
from google.cloud.compute_v1.services.advice.client import AdviceClient
from google.cloud.compute_v1.services.autoscalers.client import \
    AutoscalersClient
from google.cloud.compute_v1.services.backend_buckets.client import \
    BackendBucketsClient
from google.cloud.compute_v1.services.backend_services.client import \
    BackendServicesClient
from google.cloud.compute_v1.services.cross_site_networks.client import \
...
from google.cloud.compute_v1.services.future_reservations.client import \
...
from google.cloud.compute_v1.services.health_checks.client import \
    HealthChecksClient
...
from google.cloud.compute_v1.services.instance_groups.client import \
...
from google.cloud.compute_v1.services.interconnects.client import \
    InterconnectsClient
from google.cloud.compute_v1.services.license_codes.client import \
    LicenseCodesClient
from google.cloud.compute_v1.services.licenses.client import LicensesClient
from google.cloud.compute_v1.services.machine_images.client import \
    MachineImagesClient
from google.cloud.compute_v1.services.machine_types.client import \
    MachineTypesClient
...
from google.cloud.compute_v1.services.node_groups.client import \
    NodeGroupsClient
from google.cloud.compute_v1.services.node_templates.client import \
    NodeTemplatesClient
...
from google.cloud.compute_v1.services.region_composite_health_checks.client import \
...
from google.cloud.compute_v1.services.region_disks.client import \
    RegionDisksClient
from google.cloud.compute_v1.services.region_health_aggregation_policies.client import \
...
from google.cloud.compute_v1.services.region_health_sources.client import \
...
from google.cloud.compute_v1.services.region_url_maps.client import \
    RegionUrlMapsClient
from google.cloud.compute_v1.services.region_zones.client import \
    RegionZonesClient
...
from google.cloud.compute_v1.services.reservation_slots.client import \
...
from google.cloud.compute_v1.services.reservations.client import \
    ReservationsClient
...
from google.cloud.compute_v1.services.ssl_policies.client import \
    SslPoliciesClient
from google.cloud.compute_v1.services.storage_pool_types.client import \
    StoragePoolTypesClient
from google.cloud.compute_v1.services.storage_pools.client import \
    StoragePoolsClient
from google.cloud.compute_v1.services.subnetworks.client import \
    SubnetworksClient
...
from google.cloud.compute_v1.services.target_pools.client import \
    TargetPoolsClient
...
from google.cloud.compute_v1.services.vpn_gateways.client import \
    VpnGatewaysClient
from google.cloud.compute_v1.services.vpn_tunnels.client import \
    VpnTunnelsClient
from google.cloud.compute_v1.services.wire_groups.client import \
    WireGroupsClient
from google.cloud.compute_v1.services.zone_operations.client import \
...
from google.cloud.compute_v1.types.compute import (
    ...
    AbandonInstancesRegionInstanceGroupManagerRequest, AcceleratorConfig,
    Accelerators, AcceleratorTopologiesInfo,
    AcceleratorTopologiesInfoAcceleratorTopologyInfo,
    AcceleratorTopologiesInfoAcceleratorTopologyInfoInfoPerTopologyState,
    AcceleratorType, AcceleratorTypeAggregatedList, AcceleratorTypeList,
    AcceleratorTypesScopedList, AccessConfig, AddAccessConfigInstanceRequest,
    ...
    AddHealthCheckTargetPoolRequest, AddInstancesInstanceGroupRequest,
    AddInstanceTargetPoolRequest, AddNetworkInterfaceInstanceRequest,
    AddNodesNodeGroupRequest,
    AddPacketMirroringRuleNetworkFirewallPolicyRequest,
    AddPeeringNetworkRequest, AddResourcePoliciesDiskRequest,
    AddResourcePoliciesInstanceRequest, AddResourcePoliciesRegionDiskRequest,
    Address, AddressAggregatedList, AddressesScopedList, AddressList,
    AddRuleFirewallPolicyRequest, AddRuleNetworkFirewallPolicyRequest,
    AddRuleOrganizationSecurityPolicyRequest,
    AddRuleRegionNetworkFirewallPolicyRequest,
    AddRuleRegionSecurityPolicyRequest, AddRuleSecurityPolicyRequest,
    AddSignedUrlKeyBackendBucketRequest, AddSignedUrlKeyBackendServiceRequest,
    AdvancedMachineFeatures, AggregatedListAcceleratorTypesRequest,
    AggregatedListAddressesRequest, AggregatedListAutoscalersRequest,
    AggregatedListBackendServicesRequest, AggregatedListDisksRequest,
    AggregatedListDiskTypesRequest, AggregatedListForwardingRulesRequest,
    AggregatedListFutureReservationsRequest,
    AggregatedListGlobalOperationsRequest, AggregatedListHealthChecksRequest,
    AggregatedListInstanceGroupManagersRequest,
    AggregatedListInstanceGroupsRequest, AggregatedListInstancesRequest,
    AggregatedListInstanceTemplatesRequest,
    AggregatedListInstantSnapshotsRequest,
    AggregatedListInterconnectAttachmentsRequest,
    AggregatedListMachineTypesRequest, AggregatedListNetworkAttachmentsRequest,
    ...
    AggregatedListNodeGroupsRequest, AggregatedListNodeTemplatesRequest,
    AggregatedListNodeTypesRequest, AggregatedListPacketMirroringsRequest,
    ...
    AggregatedListReservationsRequest, AggregatedListResourcePoliciesRequest,
    AggregatedListRoutersRequest, AggregatedListSecurityPoliciesRequest,
    AggregatedListServiceAttachmentsRequest,
    AggregatedListSslCertificatesRequest, AggregatedListSslPoliciesRequest,
    AggregatedListStoragePoolsRequest, AggregatedListStoragePoolTypesRequest,
    AggregatedListSubnetworksRequest, AggregatedListTargetHttpProxiesRequest,
    AggregatedListTargetHttpsProxiesRequest,
    AggregatedListTargetInstancesRequest, AggregatedListTargetPoolsRequest,
    AggregatedListTargetTcpProxiesRequest,
    AggregatedListTargetVpnGatewaysRequest, AggregatedListUrlMapsRequest,
    AggregatedListVpnGatewaysRequest, AggregatedListVpnTunnelsRequest,
    AliasIpRange, AllocationAggregateReservation,
    ...
    AttachDiskInstanceRequest, AttachedDisk, AttachedDiskInitializeParams,
    AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest,
    AttachNetworkEndpointsNetworkEndpointGroupRequest,
    AttachNetworkEndpointsRegionNetworkEndpointGroupRequest, AuditConfig,
    AuditLogConfig, Autoscaler, AutoscalerAggregatedList, AutoscalerList,
    AutoscalersScopedList, AutoscalerStatusDetails, AutoscalingPolicy,
    AutoscalingPolicyCpuUtilization, AutoscalingPolicyCustomMetricUtilization,
    ...
    BackendBackendOrchestrationInfo, BackendBucket, BackendBucketCdnPolicy,
    BackendBucketCdnPolicyBypassCacheOnRequestHeader,
    BackendBucketCdnPolicyCacheKeyPolicy,
    BackendBucketCdnPolicyNegativeCachingPolicy, BackendBucketList,
    BackendBucketParams, BackendBucketUsedBy, BackendCustomMetric,
    BackendService, BackendServiceAggregatedList, BackendServiceCdnPolicy,
    BackendServiceCdnPolicyBypassCacheOnRequestHeader,
    BackendServiceCdnPolicyNegativeCachingPolicy,
    BackendServiceConnectionTrackingPolicy, BackendServiceCustomMetric,
    BackendServiceFailoverPolicy, BackendServiceGroupHealth,
    BackendServiceHAPolicy, BackendServiceHAPolicyLeader,
    BackendServiceHAPolicyLeaderNetworkEndpoint, BackendServiceHttpCookie,
    BackendServiceIAP, BackendServiceList, BackendServiceListUsable,
    BackendServiceLocalityLoadBalancingPolicyConfig,
    BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicy,
    BackendServiceLocalityLoadBalancingPolicyConfigPolicy,
    BackendServiceLogConfig, BackendServiceNetworkPassThroughLbTrafficPolicy,
    BackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity,
    BackendServiceOrchestrationInfo, BackendServiceParams,
    BackendServiceReference, BackendServicesScopedList,
    BackendServiceTlsSettings, BackendServiceTlsSettingsSubjectAltName,
    BackendServiceUsedBy, BfdPacket, BfdStatus, BfdStatusPacketCounts,
    BgpRoute, BgpRouteAsPath, BgpRouteNetworkLayerReachabilityInformation,
    Binding, BulkInsertDiskRequest, BulkInsertDiskResource,
    BulkInsertInstanceRequest, BulkInsertInstanceResource,
    BulkInsertInstanceResourcePerInstanceProperties, BulkInsertOperationStatus,
    BulkInsertRegionDiskRequest, BulkInsertRegionInstanceRequest,
    BulkSetLabelsDiskRequest, BulkSetLabelsRequest, BulkZoneSetLabelsRequest,
    BundledLocalSsds, CacheInvalidationRule, CacheKeyPolicy,
    CalendarModeAdviceRequest, CalendarModeAdviceResponse,
    CalendarModeAdviceRpcRequest, CalendarModeRecommendation,
    CancelFutureReservationRequest,
    CancelInstanceGroupManagerResizeRequestRequest, CircuitBreakers,
    CloneRulesFirewallPolicyRequest, CloneRulesNetworkFirewallPolicyRequest,
    CloneRulesRegionNetworkFirewallPolicyRequest, Commitment,
    CommitmentAggregatedList, CommitmentList, CommitmentResourceStatus,
    CommitmentsScopedList, CompositeHealthCheck,
    CompositeHealthCheckAggregatedList, CompositeHealthCheckList,
    CompositeHealthChecksScopedList, ConfidentialInstanceConfig,
    ConnectionDraining, ConsistentHashLoadBalancerSettings,
    ConsistentHashLoadBalancerSettingsHttpCookie,
    CopyRulesOrganizationSecurityPolicyRequest, CorsPolicy,
    CreateInstancesInstanceGroupManagerRequest,
    CreateInstancesRegionInstanceGroupManagerRequest,
    CreateMembersInterconnectGroupRequest, CreateSnapshotDiskRequest,
    CreateSnapshotRegionDiskRequest, CrossSiteNetwork, CrossSiteNetworkList,
    CustomerEncryptionKey, CustomerEncryptionKeyProtectedDisk,
    CustomErrorResponsePolicy,
    CustomErrorResponsePolicyCustomErrorResponseRule, Data, Date,
    DeleteAccessConfigInstanceRequest, DeleteAddressRequest,
    DeleteAutoscalerRequest, DeleteBackendBucketRequest,
    DeleteBackendServiceRequest, DeleteCrossSiteNetworkRequest,
    DeleteDiskRequest, DeleteExternalVpnGatewayRequest,
    DeleteFirewallPolicyRequest, DeleteFirewallRequest,
    DeleteForwardingRuleRequest, DeleteFutureReservationRequest,
    DeleteGlobalAddressRequest, DeleteGlobalForwardingRuleRequest,
    DeleteGlobalNetworkEndpointGroupRequest, DeleteGlobalOperationRequest,
    DeleteGlobalOperationResponse, DeleteGlobalOrganizationOperationRequest,
    DeleteGlobalOrganizationOperationResponse,
    DeleteGlobalPublicDelegatedPrefixeRequest, DeleteHealthCheckRequest,
    DeleteImageRequest, DeleteInstanceGroupManagerRequest,
    DeleteInstanceGroupManagerResizeRequestRequest, DeleteInstanceGroupRequest,
    DeleteInstanceRequest, DeleteInstancesInstanceGroupManagerRequest,
    DeleteInstancesRegionInstanceGroupManagerRequest,
    DeleteInstanceTemplateRequest, DeleteInstantSnapshotRequest,
    DeleteInterconnectAttachmentGroupRequest,
    DeleteInterconnectAttachmentRequest, DeleteInterconnectGroupRequest,
    DeleteInterconnectRequest, DeleteLicenseRequest, DeleteMachineImageRequest,
    DeleteNetworkAttachmentRequest, DeleteNetworkEdgeSecurityServiceRequest,
    DeleteNetworkEndpointGroupRequest, DeleteNetworkFirewallPolicyRequest,
    DeleteNetworkInterfaceInstanceRequest, DeleteNetworkRequest,
    DeleteNodeGroupRequest, DeleteNodesNodeGroupRequest,
    DeleteNodeTemplateRequest, DeleteOrganizationSecurityPolicyRequest,
    ...
    DeleteRegionAutoscalerRequest, DeleteRegionBackendServiceRequest,
    DeleteRegionCompositeHealthCheckRequest, DeleteRegionDiskRequest,
    DeleteRegionHealthAggregationPolicyRequest, DeleteRegionHealthCheckRequest,
    DeleteRegionHealthCheckServiceRequest, DeleteRegionHealthSourceRequest,
    DeleteRegionInstanceGroupManagerRequest,
    DeleteRegionInstanceTemplateRequest, DeleteRegionInstantSnapshotRequest,
    DeleteRegionNetworkEndpointGroupRequest,
    DeleteRegionNetworkFirewallPolicyRequest,
    DeleteRegionNotificationEndpointRequest, DeleteRegionOperationRequest,
    DeleteRegionOperationResponse, DeleteRegionSecurityPolicyRequest,
    DeleteRegionSslCertificateRequest, DeleteRegionSslPolicyRequest,
    DeleteRegionTargetHttpProxyRequest, DeleteRegionTargetHttpsProxyRequest,
    DeleteRegionTargetTcpProxyRequest, DeleteRegionUrlMapRequest,
    DeleteReservationRequest, DeleteResourcePolicyRequest,
    DeleteRoutePolicyRouterRequest, DeleteRouteRequest, DeleteRouterRequest,
    DeleteSecurityPolicyRequest, DeleteServiceAttachmentRequest,
    DeleteSignedUrlKeyBackendBucketRequest,
    DeleteSignedUrlKeyBackendServiceRequest, DeleteSnapshotRequest,
    DeleteSslCertificateRequest, DeleteSslPolicyRequest,
    DeleteStoragePoolRequest, DeleteSubnetworkRequest,
    DeleteTargetGrpcProxyRequest, DeleteTargetHttpProxyRequest,
    DeleteTargetHttpsProxyRequest, DeleteTargetInstanceRequest,
    DeleteTargetPoolRequest, DeleteTargetSslProxyRequest,
    DeleteTargetTcpProxyRequest, DeleteTargetVpnGatewayRequest,
    DeleteUrlMapRequest, DeleteVpnGatewayRequest, DeleteVpnTunnelRequest,
    DeleteWireGroupRequest, DeleteZoneOperationRequest,
    DeleteZoneOperationResponse, Denied, DeprecateImageRequest,
    DeprecationStatus, DetachDiskInstanceRequest,
    ...
    DisableXpnHostProjectRequest, DisableXpnResourceProjectRequest, Disk,
    DiskAggregatedList, DiskAsyncReplication, DiskAsyncReplicationList,
    DiskInstantiationConfig, DiskList, DiskMoveRequest, DiskParams,
    DiskResourceStatus, DiskResourceStatusAsyncReplicationStatus,
    DisksAddResourcePoliciesRequest, DisksRemoveResourcePoliciesRequest,
    DisksResizeRequest, DisksScopedList, DisksStartAsyncReplicationRequest,
    DisksStopGroupAsyncReplicationResource, DiskType, DiskTypeAggregatedList,
    DiskTypeList, DiskTypesScopedList, DisplayDevice, DistributionPolicy,
    DistributionPolicyZoneConfiguration, Duration, EnableXpnHostProjectRequest,
    EnableXpnResourceProjectRequest, Error, ErrorDetails, ErrorInfo, Errors,
    ExchangedPeeringRoute, ExchangedPeeringRoutesList,
    ExpandIpCidrRangeSubnetworkRequest, Expr, ExternalVpnGateway,
    ExternalVpnGatewayInterface, ExternalVpnGatewayList,
    ExternalVpnGatewayParams, FileContentBuffer, Firewall, FirewallList,
    FirewallLogConfig, FirewallParams,
    FirewallPoliciesListAssociationsResponse, FirewallPoliciesScopedList,
    FirewallPolicy, FirewallPolicyAssociation, FirewallPolicyList,
    FirewallPolicyRule, FirewallPolicyRuleMatcher,
    FirewallPolicyRuleMatcherLayer4Config, FirewallPolicyRuleSecureTag,
    FixedOrPercent, FlexibleTimeRange, ForwardingRule,
    ForwardingRuleAggregatedList, ForwardingRuleList, ForwardingRuleReference,
    ForwardingRuleServiceDirectoryRegistration, ForwardingRulesScopedList,
    FutureReservation, FutureReservationCommitmentInfo,
    FutureReservationsAggregatedListResponse, FutureReservationsListResponse,
    FutureReservationSpecificSKUProperties, FutureReservationsScopedList,
    FutureReservationStatus, FutureReservationStatusExistingMatchingUsageInfo,
    FutureReservationStatusLastKnownGoodState,
    FutureReservationStatusLastKnownGoodStateFutureReservationSpecs,
    FutureReservationStatusSpecificSKUProperties, FutureReservationTimeWindow,
    FutureResourcesRecommendation, FutureResourcesRecommendationOtherLocation,
    FutureResourcesSpec, FutureResourcesSpecAggregateResources,
    FutureResourcesSpecLocalSsdPartition, FutureResourcesSpecLocationPolicy,
    ...
    GetAddressRequest, GetAssociationFirewallPolicyRequest,
    GetAssociationNetworkFirewallPolicyRequest,
    GetAssociationOrganizationSecurityPolicyRequest,
    GetAssociationRegionNetworkFirewallPolicyRequest, GetAutoscalerRequest,
    GetBackendBucketRequest, GetBackendServiceRequest,
    GetCrossSiteNetworkRequest, GetDiagnosticsInterconnectRequest,
    GetDiskRequest, GetDiskTypeRequest, GetEffectiveFirewallsInstanceRequest,
    ...
    GetExternalVpnGatewayRequest, GetFirewallPolicyRequest, GetFirewallRequest,
    GetForwardingRuleRequest, GetFromFamilyImageRequest,
    GetFutureReservationRequest, GetGlobalAddressRequest,
    GetGlobalForwardingRuleRequest, GetGlobalNetworkEndpointGroupRequest,
    GetGlobalOperationRequest, GetGlobalOrganizationOperationRequest,
    GetGlobalPublicDelegatedPrefixeRequest, GetGuestAttributesInstanceRequest,
    GetHealthBackendServiceRequest, GetHealthCheckRequest,
    GetHealthRegionBackendServiceRequest, GetHealthTargetPoolRequest,
    GetIamPolicyBackendBucketRequest, GetIamPolicyBackendServiceRequest,
    GetIamPolicyDiskRequest, GetIamPolicyFirewallPolicyRequest,
    GetIamPolicyImageRequest, GetIamPolicyInstanceRequest,
    GetIamPolicyInstanceTemplateRequest, GetIamPolicyInstantSnapshotRequest,
    GetIamPolicyInterconnectAttachmentGroupRequest,
    GetIamPolicyInterconnectGroupRequest, GetIamPolicyLicenseRequest,
    GetIamPolicyMachineImageRequest, GetIamPolicyNetworkAttachmentRequest,
    GetIamPolicyNetworkFirewallPolicyRequest, GetIamPolicyNodeGroupRequest,
    GetIamPolicyNodeTemplateRequest, GetIamPolicyRegionBackendServiceRequest,
    ...
    GetIamPolicyReservationSubBlockRequest, GetIamPolicyResourcePolicyRequest,
    GetIamPolicyServiceAttachmentRequest, GetIamPolicySnapshotRequest,
    GetIamPolicyStoragePoolRequest, GetIamPolicySubnetworkRequest,
    GetImageFamilyViewRequest, GetImageRequest, GetInstanceGroupManagerRequest,
    GetInstanceGroupManagerResizeRequestRequest, GetInstanceGroupRequest,
    GetInstanceRequest, GetInstanceSettingRequest, GetInstanceTemplateRequest,
    GetInstantSnapshotRequest, GetInterconnectAttachmentGroupRequest,
    GetInterconnectAttachmentRequest, GetInterconnectGroupRequest,
    GetInterconnectLocationRequest, GetInterconnectRemoteLocationRequest,
    GetInterconnectRequest, GetLicenseCodeRequest, GetLicenseRequest,
    GetMachineImageRequest, GetMachineTypeRequest,
    GetMacsecConfigInterconnectRequest, GetNatIpInfoRouterRequest,
    GetNatMappingInfoRoutersRequest, GetNetworkAttachmentRequest,
    GetNetworkEdgeSecurityServiceRequest, GetNetworkEndpointGroupRequest,
    GetNetworkFirewallPolicyRequest, GetNetworkProfileRequest,
    GetNetworkRequest, GetNodeGroupRequest, GetNodeTemplateRequest,
    GetNodeTypeRequest, GetOperationalStatusInterconnectAttachmentGroupRequest,
    GetOperationalStatusInterconnectGroupRequest,
    GetOrganizationSecurityPolicyRequest, GetPacketMirroringRequest,
    GetPacketMirroringRuleNetworkFirewallPolicyRequest,
    GetPreviewFeatureRequest, GetProjectRequest,
    GetPublicAdvertisedPrefixeRequest, GetPublicDelegatedPrefixeRequest,
    GetRegionAutoscalerRequest, GetRegionBackendServiceRequest,
    GetRegionCommitmentRequest, GetRegionCompositeHealthCheckRequest,
    GetRegionDiskRequest, GetRegionDiskTypeRequest,
    GetRegionHealthAggregationPolicyRequest, GetRegionHealthCheckRequest,
    GetRegionHealthCheckServiceRequest, GetRegionHealthSourceRequest,
    GetRegionInstanceGroupManagerRequest, GetRegionInstanceGroupRequest,
    GetRegionInstanceTemplateRequest, GetRegionInstantSnapshotRequest,
    GetRegionNetworkEndpointGroupRequest,
    GetRegionNetworkFirewallPolicyRequest,
    GetRegionNotificationEndpointRequest, GetRegionOperationRequest,
    GetRegionRequest, GetRegionSecurityPolicyRequest,
    GetRegionSslCertificateRequest, GetRegionSslPolicyRequest,
    GetRegionTargetHttpProxyRequest, GetRegionTargetHttpsProxyRequest,
    GetRegionTargetTcpProxyRequest, GetRegionUrlMapRequest,
    GetReservationBlockRequest, GetReservationRequest,
    GetReservationSlotRequest, GetReservationSubBlockRequest,
    GetResourcePolicyRequest, GetRoutePolicyRouterRequest, GetRouteRequest,
    GetRouterRequest, GetRouterStatusRouterRequest,
    GetRuleFirewallPolicyRequest, GetRuleNetworkFirewallPolicyRequest,
    GetRuleOrganizationSecurityPolicyRequest,
    GetRuleRegionNetworkFirewallPolicyRequest,
    GetRuleRegionSecurityPolicyRequest, GetRuleSecurityPolicyRequest,
    GetScreenshotInstanceRequest, GetSecurityPolicyRequest,
    GetSerialPortOutputInstanceRequest, GetServiceAttachmentRequest,
    GetShieldedInstanceIdentityInstanceRequest, GetSnapshotRequest,
    GetSnapshotSettingRequest, GetSslCertificateRequest, GetSslPolicyRequest,
    GetStatusVpnGatewayRequest, GetStoragePoolRequest,
    GetStoragePoolTypeRequest, GetSubnetworkRequest, GetTargetGrpcProxyRequest,
    GetTargetHttpProxyRequest, GetTargetHttpsProxyRequest,
    GetTargetInstanceRequest, GetTargetPoolRequest, GetTargetSslProxyRequest,
    GetTargetTcpProxyRequest, GetTargetVpnGatewayRequest, GetUrlMapRequest,
    GetVersionOperationMetadata, GetVersionOperationMetadataSbomInfo,
    GetVersionReservationSlotRequest, GetVersionReservationSubBlockRequest,
    GetVpnGatewayRequest, GetVpnTunnelRequest, GetWireGroupRequest,
    GetXpnHostProjectRequest, GetXpnResourcesProjectsRequest,
    GetZoneOperationRequest, GetZoneRequest, GlobalAddressesMoveRequest,
    GlobalNetworkEndpointGroupsAttachEndpointsRequest,
    GlobalNetworkEndpointGroupsDetachEndpointsRequest,
    GlobalOrganizationSetPolicyRequest, GlobalSetLabelsRequest,
    GlobalSetPolicyRequest, GroupMaintenanceInfo, GRPCHealthCheck,
    GRPCTLSHealthCheck, GuestAttributes, GuestAttributesEntry,
    GuestAttributesValue, GuestOsFeature, HealthAggregationPoliciesScopedList,
    HealthAggregationPolicy, HealthAggregationPolicyAggregatedList,
    HealthAggregationPolicyList, HealthCheck, HealthCheckList,
    HealthCheckLogConfig, HealthCheckReference, HealthChecksAggregatedList,
    HealthCheckService, HealthCheckServiceAggregatedList,
    HealthCheckServiceReference, HealthCheckServicesList,
    HealthCheckServicesScopedList, HealthChecksScopedList, HealthSource,
    HealthSourceAggregatedList, HealthSourceList, HealthSourcesScopedList,
    HealthStatus, HealthStatusForNetworkEndpoint, Help, HelpLink, HostRule,
    HTTP2HealthCheck, HttpFaultAbort, HttpFaultDelay, HttpFaultInjection,
    HttpHeaderAction, HttpHeaderMatch, HttpHeaderOption, HTTPHealthCheck,
    HttpQueryParameterMatch, HttpRedirectAction, HttpRetryPolicy,
    HttpRouteAction, HttpRouteRule, HttpRouteRuleMatch, HTTPSHealthCheck,
    Image, ImageFamilyView, ImageList, ImageParams, InitialStateConfig,
    InsertAddressRequest, InsertAutoscalerRequest, InsertBackendBucketRequest,
    InsertBackendServiceRequest, InsertCrossSiteNetworkRequest,
    InsertDiskRequest, InsertExternalVpnGatewayRequest,
    InsertFirewallPolicyRequest, InsertFirewallRequest,
    InsertForwardingRuleRequest, InsertFutureReservationRequest,
    InsertGlobalAddressRequest, InsertGlobalForwardingRuleRequest,
    InsertGlobalNetworkEndpointGroupRequest,
    InsertGlobalPublicDelegatedPrefixeRequest, InsertHealthCheckRequest,
    InsertImageRequest, InsertInstanceGroupManagerRequest,
    InsertInstanceGroupManagerResizeRequestRequest, InsertInstanceGroupRequest,
    InsertInstanceRequest, InsertInstanceTemplateRequest,
    InsertInstantSnapshotRequest, InsertInterconnectAttachmentGroupRequest,
    InsertInterconnectAttachmentRequest, InsertInterconnectGroupRequest,
    InsertInterconnectRequest, InsertLicenseRequest, InsertMachineImageRequest,
    InsertNetworkAttachmentRequest, InsertNetworkEdgeSecurityServiceRequest,
    ...
    InsertOrganizationSecurityPolicyRequest, InsertPacketMirroringRequest,
    InsertPublicAdvertisedPrefixeRequest, InsertPublicDelegatedPrefixeRequest,
    InsertRegionAutoscalerRequest, InsertRegionBackendServiceRequest,
    InsertRegionCommitmentRequest, InsertRegionCompositeHealthCheckRequest,
    InsertRegionDiskRequest, InsertRegionHealthAggregationPolicyRequest,
    InsertRegionHealthCheckRequest, InsertRegionHealthCheckServiceRequest,
    InsertRegionHealthSourceRequest, InsertRegionInstanceGroupManagerRequest,
    InsertRegionInstanceTemplateRequest, InsertRegionInstantSnapshotRequest,
    ...
    InsertRegionSslCertificateRequest, InsertRegionSslPolicyRequest,
    InsertRegionTargetHttpProxyRequest, InsertRegionTargetHttpsProxyRequest,
    InsertRegionTargetTcpProxyRequest, InsertRegionUrlMapRequest,
    InsertReservationRequest, InsertResourcePolicyRequest, InsertRouteRequest,
    InsertRouterRequest, InsertSecurityPolicyRequest,
    InsertServiceAttachmentRequest, InsertSnapshotRequest,
    InsertSslCertificateRequest, InsertSslPolicyRequest,
    InsertStoragePoolRequest, InsertSubnetworkRequest,
    InsertTargetGrpcProxyRequest, InsertTargetHttpProxyRequest,
    InsertTargetHttpsProxyRequest, InsertTargetInstanceRequest,
    InsertTargetPoolRequest, InsertTargetSslProxyRequest,
    InsertTargetTcpProxyRequest, InsertTargetVpnGatewayRequest,
    InsertUrlMapRequest, InsertVpnGatewayRequest, InsertVpnTunnelRequest,
    InsertWireGroupRequest, Instance, InstanceAggregatedList,
    InstanceConsumptionData, InstanceConsumptionInfo,
    InstanceFlexibilityPolicy, InstanceFlexibilityPolicyInstanceSelection,
    InstanceGroup, InstanceGroupAggregatedList, InstanceGroupList,
    InstanceGroupManager, InstanceGroupManagerActionsSummary,
    InstanceGroupManagerAggregatedList, InstanceGroupManagerAllInstancesConfig,
    InstanceGroupManagerAutoHealingPolicy,
    InstanceGroupManagerInstanceFlexibilityPolicy,
    InstanceGroupManagerInstanceFlexibilityPolicyInstanceSelection,
    InstanceGroupManagerInstanceLifecyclePolicy, InstanceGroupManagerList,
    ...
    InstanceGroupManagerStandbyPolicy, InstanceGroupManagerStatus,
    ...
    InstanceGroupManagerTargetSizePolicy, InstanceGroupManagerUpdatePolicy,
    InstanceGroupManagerVersion, InstanceGroupsAddInstancesRequest,
    InstanceGroupsListInstances, InstanceGroupsListInstancesRequest,
    InstanceGroupsRemoveInstancesRequest, InstanceGroupsScopedList,
    InstanceGroupsSetNamedPortsRequest, InstanceList, InstanceListReferrers,
    InstanceManagedByIgmError, InstanceManagedByIgmErrorInstanceActionDetails,
    InstanceManagedByIgmErrorManagedInstanceError, InstanceMoveRequest,
    InstanceParams, InstanceProperties, InstancePropertiesPatch,
    InstanceReference, InstancesAddResourcePoliciesRequest,
    InstancesBulkInsertOperationMetadata, InstanceSettings,
    InstanceSettingsMetadata, InstancesGetEffectiveFirewallsResponse,
    InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy,
    InstancesRemoveResourcePoliciesRequest, InstancesReportHostAsFaultyRequest,
    InstancesReportHostAsFaultyRequestFaultReason, InstancesScopedList,
    InstancesSetLabelsRequest, InstancesSetMachineResourcesRequest,
    InstancesSetMachineTypeRequest, InstancesSetMinCpuPlatformRequest,
    InstancesSetNameRequest, InstancesSetSecurityPolicyRequest,
    InstancesSetServiceAccountRequest, InstancesStartWithEncryptionKeyRequest,
    InstanceTemplate, InstanceTemplateAggregatedList, InstanceTemplateList,
    InstanceTemplatesScopedList, InstanceWithNamedPorts, InstantSnapshot,
    InstantSnapshotAggregatedList, InstantSnapshotList, InstantSnapshotParams,
    InstantSnapshotResourceStatus, InstantSnapshotsScopedList, Int64RangeMatch,
    Interconnect, InterconnectApplicationAwareInterconnect,
    ...
    InterconnectAttachment, InterconnectAttachmentAggregatedList,
    InterconnectAttachmentConfigurationConstraints,
    InterconnectAttachmentConfigurationConstraintsBgpPeerASNRange,
    InterconnectAttachmentGroup, InterconnectAttachmentGroupAttachment,
    ...
    InterconnectAttachmentParams, InterconnectAttachmentPartnerMetadata,
    InterconnectAttachmentPrivateInfo, InterconnectAttachmentsScopedList,
    InterconnectCircuitInfo, InterconnectDiagnostics,
    InterconnectDiagnosticsARPEntry, InterconnectDiagnosticsLinkLACPStatus,
    InterconnectDiagnosticsLinkOpticalPower, InterconnectDiagnosticsLinkStatus,
    InterconnectDiagnosticsMacsecStatus, InterconnectGroup,
    InterconnectGroupConfigured, InterconnectGroupConfiguredTopologyCapability,
    InterconnectGroupConfiguredTopologyCapabilityIntendedCapabilityBlockers,
    InterconnectGroupIntent, InterconnectGroupInterconnect,
    ...
    InterconnectGroupsListResponse, InterconnectGroupsOperationalStatus,
    InterconnectGroupsOperationalStatusInterconnectStatus, InterconnectList,
    InterconnectLocation, InterconnectLocationCrossSiteInterconnectInfo,
    InterconnectLocationList, InterconnectLocationRegionInfo,
    InterconnectMacsec, InterconnectMacsecConfig,
    InterconnectMacsecConfigPreSharedKey, InterconnectMacsecPreSharedKey,
    InterconnectOutageNotification, InterconnectParams,
    InterconnectRemoteLocation, InterconnectRemoteLocationConstraints,
    ...
    InvalidateCacheUrlMapRequest, Items, License, LicenseCode,
    LicenseCodeLicenseAlias, LicenseParams, LicenseResourceCommitment,
    LicenseResourceRequirements, LicensesListResponse,
    ListAcceleratorTypesRequest, ListAddressesRequest,
    ListAssociationsFirewallPolicyRequest,
    ListAssociationsOrganizationSecurityPolicyRequest, ListAutoscalersRequest,
    ListAvailableFeaturesRegionSslPoliciesRequest,
    ListAvailableFeaturesSslPoliciesRequest, ListBackendBucketsRequest,
    ListBackendServicesRequest, ListBgpRoutesRoutersRequest,
    ListCrossSiteNetworksRequest, ListDisksRequest,
    ListDisksStoragePoolsRequest, ListDiskTypesRequest,
    ListErrorsInstanceGroupManagersRequest,
    ListErrorsRegionInstanceGroupManagersRequest,
    ListExternalVpnGatewaysRequest, ListFirewallPoliciesRequest,
    ListFirewallsRequest, ListForwardingRulesRequest,
    ListFutureReservationsRequest, ListGlobalAddressesRequest,
    ListGlobalForwardingRulesRequest, ListGlobalNetworkEndpointGroupsRequest,
    ListGlobalOperationsRequest, ListGlobalOrganizationOperationsRequest,
    ListGlobalPublicDelegatedPrefixesRequest, ListHealthChecksRequest,
    ListImagesRequest, ListInstanceGroupManagerResizeRequestsRequest,
    ListInstanceGroupManagersRequest, ListInstanceGroupsRequest,
    ListInstancesInstanceGroupsRequest,
    ListInstancesRegionInstanceGroupsRequest, ListInstancesRequest,
    ListInstanceTemplatesRequest, ListInstantSnapshotsRequest,
    ListInterconnectAttachmentGroupsRequest,
    ListInterconnectAttachmentsRequest, ListInterconnectGroupsRequest,
    ListInterconnectLocationsRequest, ListInterconnectRemoteLocationsRequest,
    ListInterconnectsRequest, ListLicensesRequest, ListMachineImagesRequest,
    ListMachineTypesRequest, ListManagedInstancesInstanceGroupManagersRequest,
    ListManagedInstancesRegionInstanceGroupManagersRequest,
    ListNetworkAttachmentsRequest, ListNetworkEndpointGroupsRequest,
    ...
    ListNetworkFirewallPoliciesRequest, ListNetworkProfilesRequest,
    ListNetworksRequest, ListNodeGroupsRequest, ListNodesNodeGroupsRequest,
    ListNodeTemplatesRequest, ListNodeTypesRequest,
    ListOrganizationSecurityPoliciesRequest, ListPacketMirroringsRequest,
    ...
    ListPreviewFeaturesRequest, ListPublicAdvertisedPrefixesRequest,
    ListPublicDelegatedPrefixesRequest, ListReferrersInstancesRequest,
    ListRegionAutoscalersRequest, ListRegionBackendServicesRequest,
    ListRegionCommitmentsRequest, ListRegionCompositeHealthChecksRequest,
    ListRegionDisksRequest, ListRegionDiskTypesRequest,
    ListRegionHealthAggregationPoliciesRequest,
    ListRegionHealthCheckServicesRequest, ListRegionHealthChecksRequest,
    ListRegionHealthSourcesRequest, ListRegionInstanceGroupManagersRequest,
    ListRegionInstanceGroupsRequest, ListRegionInstanceTemplatesRequest,
    ...
    ListRegionSecurityPoliciesRequest, ListRegionsRequest,
    ListRegionSslCertificatesRequest, ListRegionSslPoliciesRequest,
    ListRegionTargetHttpProxiesRequest, ListRegionTargetHttpsProxiesRequest,
    ListRegionTargetTcpProxiesRequest, ListRegionUrlMapsRequest,
    ListRegionZonesRequest, ListReservationBlocksRequest,
    ListReservationSlotsRequest, ListReservationsRequest,
    ListReservationSubBlocksRequest, ListResourcePoliciesRequest,
    ListRoutePoliciesRoutersRequest, ListRoutersRequest, ListRoutesRequest,
    ListSecurityPoliciesRequest, ListServiceAttachmentsRequest,
    ListSnapshotsRequest, ListSslCertificatesRequest, ListSslPoliciesRequest,
    ListStoragePoolsRequest, ListStoragePoolTypesRequest,
    ListSubnetworksRequest, ListTargetGrpcProxiesRequest,
    ListTargetHttpProxiesRequest, ListTargetHttpsProxiesRequest,
    ListTargetInstancesRequest, ListTargetPoolsRequest,
    ListTargetSslProxiesRequest, ListTargetTcpProxiesRequest,
    ListTargetVpnGatewaysRequest, ListUrlMapsRequest,
    ListUsableBackendServicesRequest, ListUsableRegionBackendServicesRequest,
    ListUsableSubnetworksRequest, ListVpnGatewaysRequest,
    ListVpnTunnelsRequest, ListWireGroupsRequest, ListXpnHostsProjectsRequest,
    ListZoneOperationsRequest, ListZonesRequest, LocalDisk, LocalizedMessage,
    LocationPolicy, LocationPolicyLocation, LocationPolicyLocationConstraints,
    LocationPolicyZoneConfiguration, MachineImage, MachineImageList,
    MachineImageParams, MachineType, MachineTypeAggregatedList,
    MachineTypeList, MachineTypesScopedList, ManagedInstance,
    ManagedInstanceInstanceHealth, ManagedInstanceLastAttempt,
    ManagedInstanceLastAttemptErrors,
    ManagedInstancePropertiesFromFlexibilityPolicy, ManagedInstanceVersion,
    Metadata, MetadataFilter, MetadataFilterLabelMatch, MoveAddressRequest,
    MoveDiskProjectRequest, MoveFirewallPolicyRequest,
    MoveGlobalAddressRequest, MoveInstanceProjectRequest,
    MoveOrganizationSecurityPolicyRequest, NamedPort, NatIpInfo,
    NatIpInfoNatIpInfoMapping, NatIpInfoResponse, Network, NetworkAttachment,
    NetworkAttachmentAggregatedList, NetworkAttachmentConnectedEndpoint,
    NetworkAttachmentList, NetworkAttachmentsScopedList,
    NetworkEdgeSecurityService, NetworkEdgeSecurityServiceAggregatedList,
    NetworkEdgeSecurityServicesScopedList, NetworkEndpoint,
    NetworkEndpointGroup, NetworkEndpointGroupAggregatedList,
    NetworkEndpointGroupAppEngine, NetworkEndpointGroupCloudFunction,
    NetworkEndpointGroupCloudRun, NetworkEndpointGroupList,
    NetworkEndpointGroupPscData, NetworkEndpointGroupsAttachEndpointsRequest,
    NetworkEndpointGroupsDetachEndpointsRequest,
    NetworkEndpointGroupsListEndpointsRequest,
    NetworkEndpointGroupsListNetworkEndpoints, NetworkEndpointGroupsScopedList,
    NetworkEndpointWithHealthStatus, NetworkFirewallPolicyAggregatedList,
    NetworkInterface, NetworkList, NetworkParams, NetworkPeering,
    ...
    NetworkPerformanceConfig, NetworkProfile, NetworkProfileLocation,
    NetworkProfileNetworkFeatures,
    NetworkProfileNetworkFeaturesPredefinedSubnetworkRange,
    NetworkProfileProfileType, NetworkProfilesListResponse,
    NetworkRoutingConfig, NetworksAddPeeringRequest,
    NetworksGetEffectiveFirewallsResponse,
    NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy,
    NetworksRemovePeeringRequest, NetworksRequestRemovePeeringRequest,
    NetworksUpdatePeeringRequest, NodeGroup, NodeGroupAggregatedList,
    NodeGroupAutoscalingPolicy, NodeGroupList, NodeGroupMaintenanceWindow,
    NodeGroupNode, NodeGroupsAddNodesRequest, NodeGroupsDeleteNodesRequest,
    NodeGroupsListNodes, NodeGroupsPerformMaintenanceRequest,
    NodeGroupsScopedList, NodeGroupsSetNodeTemplateRequest,
    NodeGroupsSimulateMaintenanceEventRequest, NodeTemplate,
    NodeTemplateAggregatedList, NodeTemplateList,
    NodeTemplateNodeTypeFlexibility, NodeTemplatesScopedList, NodeType,
    NodeTypeAggregatedList, NodeTypeList, NodeTypesScopedList,
    NotificationEndpoint, NotificationEndpointAggregatedList,
    NotificationEndpointGrpcSettings, NotificationEndpointList,
    NotificationEndpointsScopedList, Operation, OperationAggregatedList,
    OperationList, OperationsScopedList,
    OrganizationSecurityPoliciesListAssociationsResponse, OutlierDetection,
    PacketIntervals, PacketMirroring, PacketMirroringAggregatedList,
    PacketMirroringFilter, PacketMirroringForwardingRuleInfo,
    PacketMirroringList, PacketMirroringMirroredResourceInfo,
    PacketMirroringMirroredResourceInfoInstanceInfo,
    PacketMirroringMirroredResourceInfoSubnetInfo, PacketMirroringNetworkInfo,
    PacketMirroringsScopedList, PatchAutoscalerRequest,
    PatchBackendBucketRequest, PatchBackendServiceRequest,
    PatchCrossSiteNetworkRequest, PatchFirewallPolicyRequest,
    PatchFirewallRequest, PatchForwardingRuleRequest,
    PatchGlobalForwardingRuleRequest, PatchGlobalPublicDelegatedPrefixeRequest,
    PatchHealthCheckRequest, PatchImageRequest,
    PatchInstanceGroupManagerRequest, PatchInstanceSettingRequest,
    PatchInterconnectAttachmentGroupRequest,
    PatchInterconnectAttachmentRequest, PatchInterconnectGroupRequest,
    PatchInterconnectRequest, PatchNetworkAttachmentRequest,
    PatchNetworkEdgeSecurityServiceRequest, PatchNetworkFirewallPolicyRequest,
    PatchNetworkRequest, PatchNodeGroupRequest,
    PatchOrganizationSecurityPolicyRequest, PatchPacketMirroringRequest,
    ...
    PatchPublicAdvertisedPrefixeRequest, PatchPublicDelegatedPrefixeRequest,
    PatchRegionAutoscalerRequest, PatchRegionBackendServiceRequest,
    PatchRegionCompositeHealthCheckRequest,
    PatchRegionHealthAggregationPolicyRequest, PatchRegionHealthCheckRequest,
    PatchRegionHealthCheckServiceRequest, PatchRegionHealthSourceRequest,
    PatchRegionInstanceGroupManagerRequest,
    PatchRegionNetworkFirewallPolicyRequest, PatchRegionSecurityPolicyRequest,
    PatchRegionSslPolicyRequest, PatchRegionTargetHttpsProxyRequest,
    PatchRegionUrlMapRequest, PatchResourcePolicyRequest,
    PatchRoutePolicyRouterRequest, PatchRouterRequest,
    PatchRuleFirewallPolicyRequest, PatchRuleNetworkFirewallPolicyRequest,
    PatchRuleOrganizationSecurityPolicyRequest,
    PatchRuleRegionNetworkFirewallPolicyRequest,
    PatchRuleRegionSecurityPolicyRequest, PatchRuleSecurityPolicyRequest,
    PatchSecurityPolicyRequest, PatchServiceAttachmentRequest,
    PatchSnapshotSettingRequest, PatchSslPolicyRequest, PatchSubnetworkRequest,
    PatchTargetGrpcProxyRequest, PatchTargetHttpProxyRequest,
    PatchTargetHttpsProxyRequest, PatchUrlMapRequest, PatchWireGroupRequest,
    PathMatcher, PathRule, PerformMaintenanceInstanceRequest,
    PerformMaintenanceNodeGroupRequest,
    PerformMaintenanceReservationBlockRequest,
    PerformMaintenanceReservationRequest,
    PerformMaintenanceReservationSubBlockRequest, PerInstanceConfig, Policy,
    PreconfiguredWafSet, PreservedState, PreservedStatePreservedDisk,
    PreservedStatePreservedNetworkIp,
    PreservedStatePreservedNetworkIpIpAddress, PreviewFeature,
    PreviewFeatureList, PreviewFeatureRolloutOperation,
    PreviewFeatureRolloutOperationRolloutInput, PreviewFeatureStatus,
    PreviewFeatureStatusReleaseStatus, PreviewRouterRequest, Project,
    ProjectsDisableXpnResourceRequest, ProjectsEnableXpnResourceRequest,
    ProjectsGetXpnResources, ProjectsListXpnHostsRequest,
    ProjectsSetCloudArmorTierRequest, ProjectsSetDefaultNetworkTierRequest,
    PublicAdvertisedPrefix, PublicAdvertisedPrefixList,
    PublicAdvertisedPrefixPublicDelegatedPrefix, PublicDelegatedPrefix,
    PublicDelegatedPrefixAggregatedList, PublicDelegatedPrefixesScopedList,
    PublicDelegatedPrefixList, PublicDelegatedPrefixPublicDelegatedSubPrefix,
    Quota, QuotaExceededInfo, QuotaStatusWarning, RawDisk,
    RecreateInstancesInstanceGroupManagerRequest,
    RecreateInstancesRegionInstanceGroupManagerRequest, Reference, Region,
    RegionAddressesMoveRequest, RegionAutoscalerList,
    RegionDisksAddResourcePoliciesRequest,
    RegionDisksRemoveResourcePoliciesRequest, RegionDisksResizeRequest,
    RegionDisksStartAsyncReplicationRequest, RegionDiskTypeList,
    RegionInstanceGroupList, RegionInstanceGroupManagerDeleteInstanceConfigReq,
    ...
    RegionInstanceGroupsSetNamedPortsRequest, RegionList,
    ...
    RemoveHealthCheckTargetPoolRequest, RemoveInstancesInstanceGroupRequest,
    RemoveInstanceTargetPoolRequest,
    RemovePacketMirroringRuleNetworkFirewallPolicyRequest,
    RemovePeeringNetworkRequest, RemoveResourcePoliciesDiskRequest,
    RemoveResourcePoliciesInstanceRequest,
    RemoveResourcePoliciesRegionDiskRequest, RemoveRuleFirewallPolicyRequest,
    ...
    ReportFaultyReservationSubBlockRequest, ReportHostAsFaultyInstanceRequest,
    RequestMirrorPolicy, RequestRemovePeeringNetworkRequest, Reservation,
    ReservationAdvancedDeploymentControl, ReservationAffinity,
    ReservationAggregatedList, ReservationBlock, ReservationBlockHealthInfo,
    ReservationBlockPhysicalTopology, ReservationBlockPhysicalTopologyInstance,
    ReservationBlockPhysicalTopologyInstancePhysicalHostTopology,
    ReservationBlocksGetResponse, ReservationBlocksListResponse,
    ReservationList, ReservationParams,
    ReservationsBlocksPerformMaintenanceRequest, ReservationSlot,
    ReservationSlotPhysicalTopology, ReservationSlotsGetResponse,
    ReservationSlotsGetVersionRequest, ReservationSlotsListResponse,
    ReservationSlotStatus, ReservationsPerformMaintenanceRequest,
    ReservationsResizeRequest, ReservationsScopedList, ReservationSubBlock,
    ReservationSubBlockHealthInfo, ReservationSubBlockPhysicalTopology,
    ReservationSubBlocksGetResponse, ReservationSubBlocksGetVersionRequest,
    ReservationSubBlocksListResponse, ReservationSubBlocksReportFaultyRequest,
    ReservationSubBlocksReportFaultyRequestFaultReason, ResetInstanceRequest,
    ResizeDiskRequest, ResizeInstanceGroupManagerRequest,
    ResizeRegionDiskRequest, ResizeRegionInstanceGroupManagerRequest,
    ResizeReservationRequest, ResourceCommitment, ResourceGroupReference,
    ResourcePoliciesScopedList, ResourcePolicy, ResourcePolicyAggregatedList,
    ResourcePolicyDailyCycle, ResourcePolicyDiskConsistencyGroupPolicy,
    ResourcePolicyGroupPlacementPolicy, ResourcePolicyHourlyCycle,
    ResourcePolicyInstanceSchedulePolicy,
    ResourcePolicyInstanceSchedulePolicySchedule, ResourcePolicyList,
    ...
    ResourcePolicyWorkloadPolicy, ResourceStatus,
    ResourceStatusEffectiveInstanceMetadata,
    ResourceStatusPhysicalHostTopology,
    ResourceStatusReservationConsumptionInfo, ResourceStatusScheduling,
    ResumeInstanceRequest, ResumeInstancesInstanceGroupManagerRequest,
    ResumeInstancesRegionInstanceGroupManagerRequest, Route, RouteAsPath,
    RouteList, RouteParams, RoutePolicy, RoutePolicyPolicyTerm, Router,
    RouterAdvertisedIpRange, RouterAggregatedList, RouterBgp, RouterBgpPeer,
    RouterBgpPeerBfd, RouterBgpPeerCustomLearnedIpRange, RouterInterface,
    RouterList, RouterMd5AuthenticationKey, RouterNat, RouterNatLogConfig,
    RouterNatRule, RouterNatRuleAction, RouterNatSubnetworkToNat,
    RouterNatSubnetworkToNat64, RouterParams, RoutersGetRoutePolicyResponse,
    RoutersListBgpRoutes, RoutersListRoutePolicies, RoutersPreviewResponse,
    RoutersScopedList, RouterStatus, RouterStatusBgpPeerStatus,
    RouterStatusNatStatus, RouterStatusNatStatusNatRuleStatus,
    RouterStatusResponse, SavedAttachedDisk, SavedDisk, ScalingScheduleStatus,
    Scheduling, SchedulingNodeAffinity, SchedulingOnInstanceStopAction,
    Screenshot, SecurityPoliciesAggregatedList,
    SecurityPoliciesListPreconfiguredExpressionSetsResponse,
    SecurityPoliciesScopedList, SecurityPoliciesWafConfig, SecurityPolicy,
    ...
    SecurityPolicyAssociation, SecurityPolicyDdosProtectionConfig,
    SecurityPolicyList, SecurityPolicyRecaptchaOptionsConfig,
    SecurityPolicyReference, SecurityPolicyRule,
    SecurityPolicyRuleHttpHeaderAction,
    SecurityPolicyRuleHttpHeaderActionHttpHeaderOption,
    SecurityPolicyRuleMatcher, SecurityPolicyRuleMatcherConfig,
    ...
    SecurityPolicyRuleRedirectOptions, SecurityPolicyUserDefinedField,
    SecuritySettings, SendDiagnosticInterruptInstanceRequest,
    SendDiagnosticInterruptInstanceResponse, SerialPortOutput, ServerBinding,
    ServiceAccount, ServiceAttachment, ServiceAttachmentAggregatedList,
    ServiceAttachmentConnectedEndpoint, ServiceAttachmentConsumerProjectLimit,
    ServiceAttachmentList, ServiceAttachmentsScopedList,
    ...
    SetCertificateMapTargetSslProxyRequest, SetCloudArmorTierProjectRequest,
    SetCommonInstanceMetadataOperationMetadata,
    SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo,
    SetCommonInstanceMetadataProjectRequest,
    SetDefaultNetworkTierProjectRequest, SetDeletionProtectionInstanceRequest,
    SetDiskAutoDeleteInstanceRequest,
    SetEdgeSecurityPolicyBackendBucketRequest,
    SetEdgeSecurityPolicyBackendServiceRequest,
    SetIamPolicyBackendBucketRequest, SetIamPolicyBackendServiceRequest,
    SetIamPolicyDiskRequest, SetIamPolicyFirewallPolicyRequest,
    SetIamPolicyImageRequest, SetIamPolicyInstanceRequest,
    SetIamPolicyInstanceTemplateRequest, SetIamPolicyInstantSnapshotRequest,
    SetIamPolicyInterconnectAttachmentGroupRequest,
    SetIamPolicyInterconnectGroupRequest, SetIamPolicyLicenseRequest,
    SetIamPolicyMachineImageRequest, SetIamPolicyNetworkAttachmentRequest,
    SetIamPolicyNetworkFirewallPolicyRequest, SetIamPolicyNodeGroupRequest,
    ...
    SetIamPolicyReservationSubBlockRequest, SetIamPolicyResourcePolicyRequest,
    SetIamPolicyServiceAttachmentRequest, SetIamPolicySnapshotRequest,
    SetIamPolicyStoragePoolRequest, SetIamPolicySubnetworkRequest,
    SetInstanceTemplateInstanceGroupManagerRequest,
    SetInstanceTemplateRegionInstanceGroupManagerRequest,
    SetLabelsAddressRequest, SetLabelsDiskRequest,
    SetLabelsExternalVpnGatewayRequest, SetLabelsForwardingRuleRequest,
    SetLabelsGlobalAddressRequest, SetLabelsGlobalForwardingRuleRequest,
    SetLabelsImageRequest, SetLabelsInstanceRequest,
    SetLabelsInstantSnapshotRequest, SetLabelsInterconnectAttachmentRequest,
    SetLabelsInterconnectRequest, SetLabelsMachineImageRequest,
    SetLabelsRegionDiskRequest, SetLabelsRegionInstantSnapshotRequest,
    SetLabelsRegionSecurityPolicyRequest, SetLabelsSecurityPolicyRequest,
    SetLabelsSnapshotRequest, SetLabelsTargetVpnGatewayRequest,
    SetLabelsVpnGatewayRequest, SetLabelsVpnTunnelRequest,
    SetMachineResourcesInstanceRequest, SetMachineTypeInstanceRequest,
    SetMetadataInstanceRequest, SetMinCpuPlatformInstanceRequest,
    SetNamedPortsInstanceGroupRequest, SetNamedPortsRegionInstanceGroupRequest,
    SetNameInstanceRequest, SetNodeTemplateNodeGroupRequest,
    SetPrivateIpGoogleAccessSubnetworkRequest,
    SetProxyHeaderTargetSslProxyRequest, SetProxyHeaderTargetTcpProxyRequest,
    SetQuicOverrideTargetHttpsProxyRequest, SetSchedulingInstanceRequest,
    SetSecurityPolicyBackendServiceRequest, SetSecurityPolicyInstanceRequest,
    SetSecurityPolicyRegionBackendServiceRequest,
    SetSecurityPolicyTargetInstanceRequest, SetSecurityPolicyTargetPoolRequest,
    ...
    SetSslPolicyTargetHttpsProxyRequest, SetSslPolicyTargetSslProxyRequest,
    SetTagsInstanceRequest, SetTargetForwardingRuleRequest,
    ...
    SetUrlMapRegionTargetHttpsProxyRequest, SetUrlMapTargetHttpProxyRequest,
    SetUrlMapTargetHttpsProxyRequest, SetUsageExportBucketProjectRequest,
    ShareSettings, ShareSettingsProjectConfig, ShieldedInstanceConfig,
    ShieldedInstanceIdentity, ShieldedInstanceIdentityEntry,
    ShieldedInstanceIntegrityPolicy, SignedUrlKey,
    SimulateMaintenanceEventInstanceRequest,
    SimulateMaintenanceEventNodeGroupRequest, Snapshot, SnapshotList,
    SnapshotParams, SnapshotSettings, SnapshotSettingsStorageLocationSettings,
    SnapshotSettingsStorageLocationSettingsStorageLocationPreference,
    SourceDiskEncryptionKey, SourceInstanceParams, SourceInstanceProperties,
    SslCertificate, SslCertificateAggregatedList, SslCertificateList,
    SslCertificateManagedSslCertificate,
    SslCertificateSelfManagedSslCertificate, SslCertificatesScopedList,
    SSLHealthCheck, SslPoliciesAggregatedList, SslPoliciesList,
    SslPoliciesListAvailableFeaturesResponse, SslPoliciesScopedList, SslPolicy,
    SslPolicyReference, StartAsyncReplicationDiskRequest,
    StartAsyncReplicationRegionDiskRequest, StartInstanceRequest,
    StartInstancesInstanceGroupManagerRequest,
    StartInstancesRegionInstanceGroupManagerRequest,
    StartWithEncryptionKeyInstanceRequest, StatefulPolicy,
    StatefulPolicyPreservedState, StatefulPolicyPreservedStateDiskDevice,
    StatefulPolicyPreservedStateNetworkIp, Status,
    StopAsyncReplicationDiskRequest, StopAsyncReplicationRegionDiskRequest,
    StopGroupAsyncReplicationDiskRequest,
    StopGroupAsyncReplicationRegionDiskRequest, StopInstanceRequest,
    StopInstancesInstanceGroupManagerRequest,
    StopInstancesRegionInstanceGroupManagerRequest, StoragePool,
    StoragePoolAggregatedList, StoragePoolDisk,
    StoragePoolExapoolProvisionedCapacityGb, StoragePoolList,
    StoragePoolListDisks, StoragePoolParams, StoragePoolResourceStatus,
    StoragePoolsScopedList, StoragePoolType, StoragePoolTypeAggregatedList,
    StoragePoolTypeList, StoragePoolTypesScopedList, Subnetwork,
    SubnetworkAggregatedList, SubnetworkList, SubnetworkLogConfig,
    SubnetworkParams, SubnetworkSecondaryRange,
    SubnetworksExpandIpCidrRangeRequest, SubnetworksScopedList,
    SubnetworksScopedWarning, SubnetworksSetPrivateIpGoogleAccessRequest,
    SubnetworkUtilizationDetails, SubnetworkUtilizationDetailsIPV4Utilization,
    SubnetworkUtilizationDetailsIPV6Utilization, Subsetting,
    SuspendInstanceRequest, SuspendInstancesInstanceGroupManagerRequest,
    SuspendInstancesRegionInstanceGroupManagerRequest,
    SwitchToCustomModeNetworkRequest, Tags, TargetGrpcProxy,
    TargetGrpcProxyList, TargetHttpProxiesScopedList, TargetHttpProxy,
    TargetHttpProxyAggregatedList, TargetHttpProxyList,
    TargetHttpsProxiesScopedList, TargetHttpsProxiesSetCertificateMapRequest,
    TargetHttpsProxiesSetQuicOverrideRequest,
    TargetHttpsProxiesSetSslCertificatesRequest, TargetHttpsProxy,
    TargetHttpsProxyAggregatedList, TargetHttpsProxyList, TargetInstance,
    TargetInstanceAggregatedList, TargetInstanceList,
    TargetInstancesScopedList, TargetPool, TargetPoolAggregatedList,
    TargetPoolInstanceHealth, TargetPoolList, TargetPoolsAddHealthCheckRequest,
    TargetPoolsAddInstanceRequest, TargetPoolsRemoveHealthCheckRequest,
    TargetPoolsRemoveInstanceRequest, TargetPoolsScopedList, TargetReference,
    TargetSslProxiesSetBackendServiceRequest,
    TargetSslProxiesSetCertificateMapRequest,
    TargetSslProxiesSetProxyHeaderRequest,
    TargetSslProxiesSetSslCertificatesRequest, TargetSslProxy,
    TargetSslProxyList, TargetTcpProxiesScopedList,
    TargetTcpProxiesSetBackendServiceRequest,
    TargetTcpProxiesSetProxyHeaderRequest, TargetTcpProxy,
    TargetTcpProxyAggregatedList, TargetTcpProxyList, TargetVpnGateway,
    TargetVpnGatewayAggregatedList, TargetVpnGatewayList,
    TargetVpnGatewayParams, TargetVpnGatewaysScopedList, TCPHealthCheck,
    TestFailure, TestIamPermissionsAddressRequest,
    TestIamPermissionsAutoscalerRequest,
    TestIamPermissionsBackendBucketRequest,
    TestIamPermissionsBackendServiceRequest, TestIamPermissionsDiskRequest,
    TestIamPermissionsExternalVpnGatewayRequest,
    TestIamPermissionsFirewallPolicyRequest, TestIamPermissionsFirewallRequest,
    TestIamPermissionsGlobalAddressRequest,
    TestIamPermissionsHealthCheckRequest, TestIamPermissionsImageRequest,
    TestIamPermissionsInstanceGroupRequest, TestIamPermissionsInstanceRequest,
    ...
    TestIamPermissionsLicenseCodeRequest, TestIamPermissionsLicenseRequest,
    ...
    TestIamPermissionsNodeGroupRequest, TestIamPermissionsNodeTemplateRequest,
    ...
    TestIamPermissionsResourcePolicyRequest, TestIamPermissionsRouteRequest,
    TestIamPermissionsServiceAttachmentRequest,
    TestIamPermissionsSnapshotRequest, TestIamPermissionsStoragePoolRequest,
    ...
    TestIamPermissionsTargetTcpProxyRequest, TestIamPermissionsUrlMapRequest,
    TestIamPermissionsVpnGatewayRequest, TestPermissionsRequest,
    TestPermissionsResponse, Uint128, UpcomingMaintenance,
    UpdateAccessConfigInstanceRequest, UpdateAutoscalerRequest,
    UpdateBackendBucketRequest, UpdateBackendServiceRequest, UpdateDiskRequest,
    UpdateDisplayDeviceInstanceRequest, UpdateFirewallRequest,
    UpdateFutureReservationRequest, UpdateHealthCheckRequest,
    UpdateInstanceRequest, UpdateLicenseRequest,
    UpdateNetworkInterfaceInstanceRequest, UpdatePeeringNetworkRequest,
    UpdatePerInstanceConfigsInstanceGroupManagerRequest,
    UpdatePerInstanceConfigsRegionInstanceGroupManagerRequest,
    UpdatePreviewFeatureRequest, UpdateRegionAutoscalerRequest,
    UpdateRegionBackendServiceRequest, UpdateRegionCommitmentRequest,
    UpdateRegionDiskRequest, UpdateRegionHealthCheckRequest,
    UpdateRegionUrlMapRequest, UpdateReservationRequest,
    UpdateReservationSlotRequest, UpdateRoutePolicyRouterRequest,
    UpdateRouterRequest, UpdateShieldedInstanceConfigInstanceRequest,
    UpdateStoragePoolRequest, UpdateUrlMapRequest, UrlMap, UrlMapList,
    UrlMapReference, UrlMapsAggregatedList, UrlMapsScopedList,
    UrlMapsValidateRequest, UrlMapsValidateResponse, UrlMapTest,
    UrlMapTestHeader, UrlMapValidationResult, UrlRewrite, UsableSubnetwork,
    UsableSubnetworksAggregatedList, UsableSubnetworkSecondaryRange,
    UsageExportLocation, ValidateRegionUrlMapRequest, ValidateUrlMapRequest,
    VmEndpointNatMappings, VmEndpointNatMappingsInterfaceNatMappings,
    VmEndpointNatMappingsInterfaceNatMappingsNatRuleMappings,
    VmEndpointNatMappingsList, VpnGateway, VpnGatewayAggregatedList,
    VpnGatewayList, VpnGatewayParams, VpnGatewaysGetStatusResponse,
    VpnGatewaysScopedList, VpnGatewayStatus,
    VpnGatewayStatusHighAvailabilityRequirementState, VpnGatewayStatusTunnel,
    VpnGatewayStatusVpnConnection, VpnGatewayVpnGatewayInterface, VpnTunnel,
    VpnTunnelAggregatedList, VpnTunnelCipherSuite, VpnTunnelList,
    VpnTunnelParams, VpnTunnelPhase1Algorithms, VpnTunnelPhase2Algorithms,
    VpnTunnelsScopedList, WafExpressionSet, WafExpressionSetExpression,
    WaitGlobalOperationRequest, WaitRegionOperationRequest,
    WaitZoneOperationRequest, Warning, Warnings, WeightedBackendService, Wire,
    WireEndpoint, WireGroup, WireGroupEndpoint, WireGroupEndpointInterconnect,
    WireGroupList, WireGroupTopology, WireGroupTopologyEndpoint,
    WireProperties, WithdrawPublicAdvertisedPrefixeRequest,
    WithdrawPublicDelegatedPrefixeRequest, WorkloadIdentityConfig, XpnHostList,
    XpnResourceId, Zone, ZoneList, ZoneSetLabelsRequest,
    ZoneSetNestedPolicyRequest, ZoneSetPolicyRequest)
