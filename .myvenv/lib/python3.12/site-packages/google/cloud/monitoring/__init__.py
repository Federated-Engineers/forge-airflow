...
from google.cloud.monitoring_v3.services.group_service.client import \
    GroupServiceClient
...
from google.cloud.monitoring_v3.services.query_service.client import \
    QueryServiceClient
...
from google.cloud.monitoring_v3.types.group_service import (
    CreateGroupRequest, DeleteGroupRequest, GetGroupRequest,
    ListGroupMembersRequest, ListGroupMembersResponse, ListGroupsRequest,
    ListGroupsResponse, UpdateGroupRequest)
from google.cloud.monitoring_v3.types.metric import (LabelValue, Point,
                                                     QueryError, TextLocator,
                                                     TimeSeries,
                                                     TimeSeriesData,
                                                     TimeSeriesDescriptor)
from google.cloud.monitoring_v3.types.metric_service import (
    CreateMetricDescriptorRequest, CreateTimeSeriesError,
    CreateTimeSeriesRequest, CreateTimeSeriesSummary,
    DeleteMetricDescriptorRequest, GetMetricDescriptorRequest,
    GetMonitoredResourceDescriptorRequest, ListMetricDescriptorsRequest,
    ListMetricDescriptorsResponse, ListMonitoredResourceDescriptorsRequest,
    ListMonitoredResourceDescriptorsResponse, ListTimeSeriesRequest,
    ListTimeSeriesResponse, QueryErrorList, QueryTimeSeriesRequest,
...
from google.cloud.monitoring_v3.types.notification import (
    NotificationChannel, NotificationChannelDescriptor)
from google.cloud.monitoring_v3.types.notification_service import (
    ...
    GetNotificationChannelDescriptorRequest, GetNotificationChannelRequest,
    ...
    UpdateNotificationChannelRequest, VerifyNotificationChannelRequest)
from google.cloud.monitoring_v3.types.service import (BasicSli,
                                                      DistributionCut, Range,
                                                      RequestBasedSli, Service,
                                                      ServiceLevelIndicator,
                                                      ServiceLevelObjective,
                                                      TimeSeriesRatio,
                                                      WindowsBasedSli)
from google.cloud.monitoring_v3.types.service_service import (
    CreateServiceLevelObjectiveRequest, CreateServiceRequest,
    DeleteServiceLevelObjectiveRequest, DeleteServiceRequest,
    GetServiceLevelObjectiveRequest, GetServiceRequest,
    ListServiceLevelObjectivesRequest, ListServiceLevelObjectivesResponse,
    ListServicesRequest, ListServicesResponse,
    UpdateServiceLevelObjectiveRequest, UpdateServiceRequest)
from google.cloud.monitoring_v3.types.snooze import Snooze
from google.cloud.monitoring_v3.types.snooze_service import (
    CreateSnoozeRequest, GetSnoozeRequest, ListSnoozesRequest,
    ListSnoozesResponse, UpdateSnoozeRequest)
...
from google.cloud.monitoring_v3.types.uptime_service import (
    CreateUptimeCheckConfigRequest, DeleteUptimeCheckConfigRequest,
    GetUptimeCheckConfigRequest, ListUptimeCheckConfigsRequest,
    ListUptimeCheckConfigsResponse, ListUptimeCheckIpsRequest,
    ListUptimeCheckIpsResponse, UpdateUptimeCheckConfigRequest)
