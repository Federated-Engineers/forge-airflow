...
from .types.storage_control import (
    AnywhereCache, CommonLongRunningOperationMetadata,
    CreateAnywhereCacheMetadata, CreateAnywhereCacheRequest,
    CreateFolderRequest, CreateManagedFolderRequest,
    DeleteFolderRecursiveMetadata, DeleteFolderRecursiveRequest,
    DeleteFolderRequest, DeleteManagedFolderRequest,
    DisableAnywhereCacheRequest, Folder, GetAnywhereCacheRequest,
    GetFolderIntelligenceConfigRequest, GetFolderRequest,
    GetManagedFolderRequest, GetOrganizationIntelligenceConfigRequest,
    GetProjectIntelligenceConfigRequest, GetStorageLayoutRequest,
    IntelligenceConfig, ListAnywhereCachesRequest, ListAnywhereCachesResponse,
    ListFoldersRequest, ListFoldersResponse, ListManagedFoldersRequest,
    ListManagedFoldersResponse, ManagedFolder, PauseAnywhereCacheRequest,
    PendingRenameInfo, RenameFolderMetadata, RenameFolderRequest,
    ResumeAnywhereCacheRequest, StorageLayout, UpdateAnywhereCacheMetadata,
    UpdateAnywhereCacheRequest, UpdateFolderIntelligenceConfigRequest,
