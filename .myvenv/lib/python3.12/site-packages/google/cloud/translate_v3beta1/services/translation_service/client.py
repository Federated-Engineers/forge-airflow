...
class TranslationServiceClient(metaclass=TranslationServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = TranslationServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.translation_v3beta1.TranslationServiceClient`.",
                    extra={
    ...
    def detect_language(
        ...
        *,
        ...
        flattened_params = [parent, model, mime_type]
    ...
    def get_supported_languages(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, display_language_code, model]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def refine_text(
        self,
        request: Optional[Union[translation_service.RefineTextRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> translation_service.RefineTextResponse:
        r"""Refines the input translated text to improve the
        quality.
        ...
        .. code-block:: python
            ...
            def sample_refine_text():
                # Create a client
                client = translate_v3beta1.TranslationServiceClient()

                # Initialize request argument(s)
                refinement_entries = translate_v3beta1.RefinementEntry()
                refinement_entries.source_text = "source_text_value"
                refinement_entries.original_translation = "original_translation_value"

                request = translate_v3beta1.RefineTextRequest(
                    parent="parent_value",
                ...
                # Make the request
                response = client.refine_text(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.translate_v3beta1.types.RefineTextRequest, dict]):
                The request object. Request message for RefineText.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
        ...
        Returns:
            google.cloud.translate_v3beta1.types.RefineTextResponse:
                Response message for RefineText.
        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, translation_service.RefineTextRequest):
            request = translation_service.RefineTextRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.refine_text]
