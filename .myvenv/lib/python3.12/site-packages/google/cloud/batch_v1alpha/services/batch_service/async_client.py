...
class BatchServiceAsyncClient:
    ...
    resource_allowance_path = staticmethod(BatchServiceClient.resource_allowance_path)
    parse_resource_allowance_path = staticmethod(
        BatchServiceClient.parse_resource_allowance_path
    )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.batch_v1alpha.BatchServiceAsyncClient`.",
                extra={
    ...
    async def delete_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.DeleteJobRequest, dict]]):
    ...
    async def create_resource_allowance(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.CreateResourceAllowanceRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            resource_allowance (:class:`google.cloud.batch_v1alpha.types.ResourceAllowance`):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.create_resource_allowance
        ]
    ...
    async def get_resource_allowance(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.GetResourceAllowanceRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.get_resource_allowance
        ]
    ...
    async def delete_resource_allowance(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.DeleteResourceAllowanceRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.delete_resource_allowance
        ]
    ...
    async def list_resource_allowances(
        self,
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListResourceAllowancesAsyncPager:
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.ListResourceAllowancesRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.list_resource_allowances
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListResourceAllowancesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def update_resource_allowance(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.batch_v1alpha.types.UpdateResourceAllowanceRequest, dict]]):
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.update_resource_allowance
        ]
