        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.speech_v1.SpeechClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.speech.v1.Speech",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.speech_v1.SpeechAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.speech.v1.Speech",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.speech_v1.SpeechClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.speech.v1.Speech",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.speech_v1.SpeechAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.speech.v1.Speech",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
