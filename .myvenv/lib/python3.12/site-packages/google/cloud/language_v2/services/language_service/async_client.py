...
class LanguageServiceAsyncClient:
    ...
    async def annotate_text(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.language_v2.types.AnnotateTextRequest, dict]]):
            ...
            document (:class:`google.cloud.language_v2.types.Document`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            features (:class:`google.cloud.language_v2.types.AnnotateTextRequest.Features`):
