...
from google.cloud.metastore_v1.services.dataproc_metastore_federation import \
    pagers
...
class DataprocMetastoreFederationClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.metastore_v1.DataprocMetastoreFederationClient`.",
                    extra={
    ...
    def list_federations(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.metastore_v1.types.ListFederationsRequest, dict]):
    ...
    def get_federation(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.metastore_v1.types.GetFederationRequest, dict]):
