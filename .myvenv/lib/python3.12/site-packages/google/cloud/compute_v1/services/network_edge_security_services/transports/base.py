...
class NetworkEdgeSecurityServicesTransport(abc.ABC):
    """Abstract transport class for NetworkEdgeSecurityServices."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.NetworkEdgeSecurityServiceAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[
            ...
            Awaitable[compute.NetworkEdgeSecurityService],
        ],
    ]:
        raise NotImplementedError()
