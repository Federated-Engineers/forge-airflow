...
from .transports.rest import RegionNetworkFirewallPoliciesRestTransport


class RegionNetworkFirewallPoliciesClientMeta(type):
    """Metaclass for the RegionNetworkFirewallPolicies client.
...
class RegionNetworkFirewallPoliciesClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionNetworkFirewallPoliciesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionNetworkFirewallPoliciesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionNetworkFirewallPoliciesTransport: The transport used by the client
                instance.
        """
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionNetworkFirewallPoliciesClient`.",
                    extra={
    ...
    def __enter__(self) -> "RegionNetworkFirewallPoliciesClient":
        return self
