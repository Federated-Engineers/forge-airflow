        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetVpnGatewaysClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                    target_vpn_gateway="target_vpn_gateway_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListTargetVpnGatewaysRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_labels():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetLabelsTargetVpnGatewayRequest(
                    project="project_value",
                    region="region_value",
