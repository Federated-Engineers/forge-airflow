        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.CrossSiteNetworksClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.CrossSiteNetworksClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.CrossSiteNetworksClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.CrossSiteNetworksClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.CrossSiteNetworksClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.CrossSiteNetworksClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.CrossSiteNetworksClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.CrossSiteNetworks",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
...
__all__ = ("CrossSiteNetworksRestTransport",)
