...
class AggregatedListPager:
    ...
    :class:`google.cloud.compute_v1.types.SecurityPoliciesAggregatedList` object, and
    ...
    All the usual :class:`google.cloud.compute_v1.types.SecurityPoliciesAggregatedList`
    ...
    def __init__(
        self,
        method: Callable[..., compute.SecurityPoliciesAggregatedList],
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.compute_v1.types.AggregatedListSecurityPoliciesRequest):
                The initial request object.
            response (google.cloud.compute_v1.types.SecurityPoliciesAggregatedList):
        ...
        """
        self._method = method
        self._request = compute.AggregatedListSecurityPoliciesRequest(request)
    ...
    @property
    def pages(self) -> Iterator[compute.SecurityPoliciesAggregatedList]:
    ...
    def __iter__(self) -> Iterator[Tuple[str, compute.SecurityPoliciesScopedList]]:
        for page in self.pages:
            yield from page.items.items()

    def get(self, key: str) -> Optional[compute.SecurityPoliciesScopedList]:
...
class ListPager:
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._method = method
        self._request = compute.ListSecurityPoliciesRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
