...
class RegionZonesClient(metaclass=RegionZonesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionZonesClient._use_client_cert_effective()
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, RegionZonesTransport, Callable[..., RegionZonesTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionZonesTransport,Callable[..., RegionZonesTransport]]]):
                ...
                arguments as used in the RegionZonesTransport constructor.
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[RegionZonesTransport], Callable[..., RegionZonesTransport]
            ] = (
                RegionZonesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionZonesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionZonesClient`.",
                    extra={
