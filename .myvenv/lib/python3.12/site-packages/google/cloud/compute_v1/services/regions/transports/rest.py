...
class RegionsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_with_metadata(
        self,
        response: compute.Region,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.Region, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the Regions server but before it is returned to user code.
    ...
    def post_list_with_metadata(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.RegionList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionsRestInterceptor]): Interceptor used
