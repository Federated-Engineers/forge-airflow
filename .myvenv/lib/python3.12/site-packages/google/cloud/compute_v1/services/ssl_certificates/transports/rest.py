...
class SslCertificatesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list_with_metadata(
        ...
        compute.SslCertificateAggregatedList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for aggregated_list

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the SslCertificates server but before it is returned to user code.
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[SslCertificatesRestInterceptor]): Interceptor used
    ...
    class _AggregatedList(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseSslCertificatesRestTransport._BaseAggregatedList._get_http_options()
