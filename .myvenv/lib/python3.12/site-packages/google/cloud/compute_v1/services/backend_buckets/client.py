...
from .transports.base import DEFAULT_CLIENT_INFO, BackendBucketsTransport
from .transports.rest import BackendBucketsRestTransport


class BackendBucketsClientMeta(type):
    """Metaclass for the BackendBuckets client.
...
class BackendBucketsClient(metaclass=BackendBucketsClientMeta):
    ...
    @property
    def transport(self) -> BackendBucketsTransport:
        """Returns the transport used by the client instance.

        Returns:
            BackendBucketsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = BackendBucketsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = BackendBucketsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = BackendBucketsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = BackendBucketsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = BackendBucketsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = BackendBucketsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = BackendBucketsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, BackendBucketsTransport)
        if transport_provided:
            # transport is a BackendBucketsTransport instance.
            ...
            self._transport = cast(BackendBucketsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BackendBucketsClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                BackendBucketsClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.BackendBucketsClient`.",
                    extra={
    ...
    def add_signed_url_key_unary(
        self,
        request: Optional[
            Union[compute.AddSignedUrlKeyBackendBucketRequest, dict]
        ] = None,
        *,
        ...
        flattened_params = [project, backend_bucket, signed_url_key_resource]
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, backend_bucket]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def delete_signed_url_key_unary(
        self,
        request: Optional[
            Union[compute.DeleteSignedUrlKeyBackendBucketRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, backend_bucket, key_name]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def get(
        self,
        request: Optional[Union[compute.GetBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def get_iam_policy(
        self,
        request: Optional[Union[compute.GetIamPolicyBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetIamPolicyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, backend_bucket_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def list(
        self,
        request: Optional[Union[compute.ListBackendBucketsRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        backend_bucket_resource: Optional[compute.BackendBucket] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, backend_bucket, backend_bucket_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def set_edge_security_policy_unary(
        self,
        request: Optional[
            Union[compute.SetEdgeSecurityPolicyBackendBucketRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, backend_bucket, security_policy_reference_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def set_iam_policy(
        self,
        request: Optional[Union[compute.SetIamPolicyBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetIamPolicyBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsBackendBucketRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsBackendBucketRequest, dict]):
                The request object. A request message for
    ...
    def update_unary(
        self,
        request: Optional[Union[compute.UpdateBackendBucketRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        backend_bucket: Optional[str] = None,
        backend_bucket_resource: Optional[compute.BackendBucket] = None,
