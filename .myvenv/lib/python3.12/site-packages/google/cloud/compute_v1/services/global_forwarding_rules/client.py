...
class GlobalForwardingRulesClientMeta(type):
    """Metaclass for the GlobalForwardingRules client.
...
class GlobalForwardingRulesClient(metaclass=GlobalForwardingRulesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GlobalForwardingRulesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> GlobalForwardingRulesTransport:
        """Returns the transport used by the client instance.

        Returns:
            GlobalForwardingRulesTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = GlobalForwardingRulesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = GlobalForwardingRulesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                GlobalForwardingRulesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GlobalForwardingRulesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = GlobalForwardingRulesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, GlobalForwardingRulesTransport)
        if transport_provided:
            # transport is a GlobalForwardingRulesTransport instance.
        ...
        self._api_endpoint = (
            self._api_endpoint
            or GlobalForwardingRulesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.GlobalForwardingRulesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        flattened_params = [project, forwarding_rule]
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, forwarding_rule_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, forwarding_rule, forwarding_rule_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def set_target_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, forwarding_rule, target_reference_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
