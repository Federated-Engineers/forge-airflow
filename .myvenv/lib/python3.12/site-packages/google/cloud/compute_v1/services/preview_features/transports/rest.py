...
from .rest_base import _BasePreviewFeaturesRestTransport
...
class PreviewFeaturesRestInterceptor:
    """Interceptor for PreviewFeatures.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the PreviewFeaturesRestTransport.

    .. code-block:: python
        class MyCustomPreviewFeaturesInterceptor(PreviewFeaturesRestInterceptor):
        ...
        transport = PreviewFeaturesRestTransport(interceptor=MyCustomPreviewFeaturesInterceptor())
        client = PreviewFeaturesClient(transport=transport)
    ...
    def pre_get(
        ...
        before they are sent to the PreviewFeatures server.
        """
        return request, metadata

    def post_get(self, response: compute.PreviewFeature) -> compute.PreviewFeature:
        ...
        after it is returned by the PreviewFeatures server but before
    ...
    def post_get_with_metadata(
        ...
        is returned by the PreviewFeatures server but before it is returned to user code.
...
class PreviewFeaturesRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: PreviewFeaturesRestInterceptor


class PreviewFeaturesRestTransport(_BasePreviewFeaturesRestTransport):
    """REST backend synchronous transport for PreviewFeatures.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[PreviewFeaturesRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[PreviewFeaturesRestInterceptor]): Interceptor used
    ...
    class _Get(_BasePreviewFeaturesRestTransport._BaseGet, PreviewFeaturesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.PreviewFeaturesClient.Get",
                    extra={
            ...
            # Return the response
            resp = compute.PreviewFeature()
            pb_resp = compute.PreviewFeature.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.PreviewFeaturesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.PreviewFeatures",
                        "rpcName": "Get",
    ...
    class _List(_BasePreviewFeaturesRestTransport._BaseList, PreviewFeaturesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.PreviewFeaturesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.PreviewFeatures",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.PreviewFeatureList()
            pb_resp = compute.PreviewFeatureList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.PreviewFeaturesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.PreviewFeatures",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.PreviewFeaturesClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.PreviewFeatures",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.PreviewFeaturesClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.PreviewFeatures",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
...
__all__ = ("PreviewFeaturesRestTransport",)
