...
class RegionSecurityPoliciesClientMeta(type):
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[RegionSecurityPoliciesTransport]]
...
class RegionSecurityPoliciesClient(metaclass=RegionSecurityPoliciesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionSecurityPoliciesClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionSecurityPoliciesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, security_policy]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, security_policy_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, security_policy, security_policy_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def set_labels_unary(
        self,
        request: Optional[
            Union[compute.SetLabelsRegionSecurityPolicyRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetLabelsRegionSecurityPolicyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetLabelsRegionSecurityPolicyRequest):
            request = compute.SetLabelsRegionSecurityPolicyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
