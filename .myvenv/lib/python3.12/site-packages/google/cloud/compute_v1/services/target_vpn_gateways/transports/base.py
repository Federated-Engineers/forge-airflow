...
class TargetVpnGatewaysTransport(abc.ABC):
    """Abstract transport class for TargetVpnGateways."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.TargetVpnGatewayAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.TargetVpnGateway, Awaitable[compute.TargetVpnGateway]],
    ]:
        raise NotImplementedError()
