...
from .rest_base import _BaseRegionDiskTypesRestTransport
...
class RegionDiskTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_get(
        ...
        compute.GetRegionDiskTypeRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_get_with_metadata(
        ...
        is returned by the RegionDiskTypes server but before it is returned to user code.
    ...
    def pre_list(
        ...
        compute.ListRegionDiskTypesRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    def post_list(
        self, response: compute.RegionDiskTypeList
    ...
    def post_list_with_metadata(
        self,
        response: compute.RegionDiskTypeList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.RegionDiskTypeList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
...
class RegionDiskTypesRestTransport(_BaseRegionDiskTypesRestTransport):
    """REST backend synchronous transport for RegionDiskTypes.
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionDiskTypesRestInterceptor]): Interceptor used
    ...
    class _Get(_BaseRegionDiskTypesRestTransport._BaseGet, RegionDiskTypesRestStub):
        def __hash__(self):
            return hash("RegionDiskTypesRestTransport.Get")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionDiskTypesRestTransport._BaseGet._get_http_options()
            )

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = (
                _BaseRegionDiskTypesRestTransport._BaseGet._get_transcoded_request(
            ...
            query_params = (
                _BaseRegionDiskTypesRestTransport._BaseGet._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionDiskTypesClient.Get",
                    extra={
            ...
            # Send the request
            response = RegionDiskTypesRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionDiskTypesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionDiskTypes",
                        "rpcName": "Get",
    ...
    class _List(_BaseRegionDiskTypesRestTransport._BaseList, RegionDiskTypesRestStub):
        def __hash__(self):
            return hash("RegionDiskTypesRestTransport.List")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseRegionDiskTypesRestTransport._BaseList._get_http_options()
            )

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = (
                _BaseRegionDiskTypesRestTransport._BaseList._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseRegionDiskTypesRestTransport._BaseList._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionDiskTypesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionDiskTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.RegionDiskTypeList()
            pb_resp = compute.RegionDiskTypeList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.RegionDiskTypeList.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionDiskTypesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionDiskTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    @property
    def get(self) -> Callable[[compute.GetRegionDiskTypeRequest], compute.DiskType]:
    ...
    def list(
        self,
    ) -> Callable[[compute.ListRegionDiskTypesRequest], compute.RegionDiskTypeList]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
