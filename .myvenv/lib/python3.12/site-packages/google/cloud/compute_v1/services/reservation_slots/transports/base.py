...
class ReservationSlotsTransport(abc.ABC):
    """Abstract transport class for ReservationSlots."""
    ...
    def get(
        ...
        [compute.GetReservationSlotRequest],
        Union[
    ...
    def list(
        ...
        [compute.ListReservationSlotsRequest],
        Union[
            compute.ReservationSlotsListResponse,
            Awaitable[compute.ReservationSlotsListResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def update(
        ...
        [compute.UpdateReservationSlotRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
...
__all__ = ("ReservationSlotsTransport",)
