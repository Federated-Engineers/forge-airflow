...
from .rest_base import _BaseTargetVpnGatewaysRestTransport
...
class TargetVpnGatewaysRestInterceptor:
    """Interceptor for TargetVpnGateways.
    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        ...
        transport = TargetVpnGatewaysRestTransport(interceptor=MyCustomTargetVpnGatewaysInterceptor())
    ...
    def pre_aggregated_list(
        ...
        before they are sent to the TargetVpnGateways server.
        """
        return request, metadata
...
class TargetVpnGatewaysRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: TargetVpnGatewaysRestInterceptor


class TargetVpnGatewaysRestTransport(_BaseTargetVpnGatewaysRestTransport):
    """REST backend synchronous transport for TargetVpnGateways.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[TargetVpnGatewaysRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[TargetVpnGatewaysRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.AggregatedList",
                    extra={
            ...
            # Return the response
            resp = compute.TargetVpnGatewayAggregatedList()
            pb_resp = compute.TargetVpnGatewayAggregatedList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
    ...
    class _Get(_BaseTargetVpnGatewaysRestTransport._BaseGet, TargetVpnGatewaysRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.TargetVpnGateway()
            pb_resp = compute.TargetVpnGateway.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.TargetVpnGatewayList()
            pb_resp = compute.TargetVpnGatewayList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetVpnGatewaysClient.SetLabels",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetVpnGatewaysClient.set_labels",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetVpnGateways",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
