...
from .base import DEFAULT_CLIENT_INFO, SecurityPoliciesTransport


class _BaseSecurityPoliciesRestTransport(SecurityPoliciesTransport):
    """Base REST backend transport for SecurityPolicies.
    ...
    class _BaseSetLabels:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/v1/projects/{project}/global/securityPolicies/{resource}/setLabels",
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.SetLabelsSecurityPolicyRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
...
__all__ = ("_BaseSecurityPoliciesRestTransport",)
