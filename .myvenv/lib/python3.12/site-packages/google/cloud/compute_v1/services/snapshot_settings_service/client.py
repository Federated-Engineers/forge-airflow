        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.SnapshotSettingsServiceClient`.",
                    extra={
    ...
    def get(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                # Create a client
                client = compute_v1.SnapshotSettingsServiceClient()

                # Initialize request argument(s)
                request = compute_v1.GetSnapshotSettingRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetSnapshotSettingRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1.PatchSnapshotSettingRequest(
                    project="project_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.PatchSnapshotSettingRequest, dict]):
                The request object. A request message for
