...
from .transports.base import DEFAULT_CLIENT_INFO, PacketMirroringsTransport
from .transports.rest import PacketMirroringsRestTransport


class PacketMirroringsClientMeta(type):
    """Metaclass for the PacketMirrorings client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[PacketMirroringsTransport]]
    _transport_registry["rest"] = PacketMirroringsRestTransport
...
class PacketMirroringsClient(metaclass=PacketMirroringsClientMeta):
    ...
    @property
    def transport(self) -> PacketMirroringsTransport:
        """Returns the transport used by the client instance.

        Returns:
            PacketMirroringsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PacketMirroringsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = PacketMirroringsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = PacketMirroringsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = PacketMirroringsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = PacketMirroringsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            PacketMirroringsClient._read_environment_variables()
        )
        self._client_cert_source = PacketMirroringsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = PacketMirroringsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, PacketMirroringsTransport)
        if transport_provided:
            # transport is a PacketMirroringsTransport instance.
            ...
            self._transport = cast(PacketMirroringsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or PacketMirroringsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.PacketMirroringsClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, packet_mirroring]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, packet_mirroring_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
