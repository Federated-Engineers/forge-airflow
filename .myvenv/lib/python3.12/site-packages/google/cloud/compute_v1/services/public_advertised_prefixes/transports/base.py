...
class PublicAdvertisedPrefixesTransport(abc.ABC):
    """Abstract transport class for PublicAdvertisedPrefixes."""
    ...
    def get(
        ...
        Union[
            compute.PublicAdvertisedPrefix, Awaitable[compute.PublicAdvertisedPrefix]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.PublicAdvertisedPrefixList],
        ],
    ]:
        raise NotImplementedError()
