...
class StoragePoolTypesTransport(abc.ABC):
    """Abstract transport class for StoragePoolTypes."""
    ...
    def get(
        ...
        [compute.GetStoragePoolTypeRequest],
        Union[compute.StoragePoolType, Awaitable[compute.StoragePoolType]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.StoragePoolTypeList, Awaitable[compute.StoragePoolTypeList]],
    ]:
        raise NotImplementedError()
...
__all__ = ("StoragePoolTypesTransport",)
