...
class RoutesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[compute.DeleteRouteRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_get(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.GetRouteRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get(self, response: compute.Route) -> compute.Route:
    ...
    def post_get_with_metadata(
        self, response: compute.Route, metadata: Sequence[Tuple[str, Union[str, bytes]]]
    ) -> Tuple[compute.Route, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def pre_insert(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.InsertRouteRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.ListRoutesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list(self, response: compute.RouteList) -> compute.RouteList:
    ...
    def post_list_with_metadata(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.RouteList, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list
    ...
    def pre_test_iam_permissions(
        self,
        request: compute.TestIamPermissionsRouteRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.TestIamPermissionsRouteRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
...
class RoutesRestTransport(_BaseRoutesRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RoutesRestInterceptor]): Interceptor used
    ...
    class _Delete(_BaseRoutesRestTransport._BaseDelete, RoutesRestStub):
        def __hash__(self):
            return hash("RoutesRestTransport.Delete")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRoutesRestTransport._BaseDelete._get_http_options()

            request, metadata = self._interceptor.pre_delete(request, metadata)
            transcoded_request = (
                _BaseRoutesRestTransport._BaseDelete._get_transcoded_request(
                    http_options, request
                )
            )

            # Jsonify the query params
            query_params = _BaseRoutesRestTransport._BaseDelete._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RoutesClient.Delete",
                    extra={
            ...
            # Send the request
            response = RoutesRestTransport._Delete._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RoutesClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "Delete",
    ...
    class _Get(_BaseRoutesRestTransport._BaseGet, RoutesRestStub):
        def __hash__(self):
            return hash("RoutesRestTransport.Get")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRoutesRestTransport._BaseGet._get_http_options()

            request, metadata = self._interceptor.pre_get(request, metadata)
            transcoded_request = (
                _BaseRoutesRestTransport._BaseGet._get_transcoded_request(
                    http_options, request
                )
            )

            # Jsonify the query params
            query_params = _BaseRoutesRestTransport._BaseGet._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RoutesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RoutesRestTransport._Get._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RoutesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _Insert(_BaseRoutesRestTransport._BaseInsert, RoutesRestStub):
        def __hash__(self):
            return hash("RoutesRestTransport.Insert")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRoutesRestTransport._BaseInsert._get_http_options()

            request, metadata = self._interceptor.pre_insert(request, metadata)
            transcoded_request = (
                _BaseRoutesRestTransport._BaseInsert._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseRoutesRestTransport._BaseInsert._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseRoutesRestTransport._BaseInsert._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RoutesClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = RoutesRestTransport._Insert._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RoutesClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseRoutesRestTransport._BaseList, RoutesRestStub):
        def __hash__(self):
            return hash("RoutesRestTransport.List")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseRoutesRestTransport._BaseList._get_http_options()

            request, metadata = self._interceptor.pre_list(request, metadata)
            transcoded_request = (
                _BaseRoutesRestTransport._BaseList._get_transcoded_request(
                    http_options, request
                )
            )

            # Jsonify the query params
            query_params = _BaseRoutesRestTransport._BaseList._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RoutesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.RouteList()
            pb_resp = compute.RouteList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RoutesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(
        _BaseRoutesRestTransport._BaseTestIamPermissions, RoutesRestStub
    ):
        def __hash__(self):
            return hash("RoutesRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                ...
                Routes.TestIamPermissions. See the
            ...
            http_options = (
                _BaseRoutesRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseRoutesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = (
                _BaseRoutesRestTransport._BaseTestIamPermissions._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseRoutesRestTransport._BaseTestIamPermissions._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RoutesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
            ...
            # Send the request
            response = RoutesRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RoutesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Routes",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
    ...
    @property
    def delete(self) -> Callable[[compute.DeleteRouteRequest], compute.Operation]:
    ...
    @property
    def insert(self) -> Callable[[compute.InsertRouteRequest], compute.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsRouteRequest], compute.TestPermissionsResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
