...
class InterconnectAttachmentsTransport(abc.ABC):
    """Abstract transport class for InterconnectAttachments."""
    ...
    def get(
        ...
        Union[
            compute.InterconnectAttachment, Awaitable[compute.InterconnectAttachment]
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.InterconnectAttachmentList],
        ],
    ]:
        raise NotImplementedError()
