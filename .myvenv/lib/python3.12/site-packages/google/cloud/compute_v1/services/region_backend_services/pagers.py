...
class ListPager:
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._method = method
        self._request = compute.ListRegionBackendServicesRequest(request)
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.compute_v1.types.ListUsableRegionBackendServicesRequest):
                The initial request object.
        ...
        """
        self._method = method
        self._request = compute.ListUsableRegionBackendServicesRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
