...
from .transports.base import DEFAULT_CLIENT_INFO, SnapshotsTransport
...
class SnapshotsClient(metaclass=SnapshotsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SnapshotsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, SnapshotsTransport, Callable[..., SnapshotsTransport]]
        ] = None,
        ...
        self._client_cert_source = SnapshotsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SnapshotsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or SnapshotsClient._get_api_endpoint(
    ...
    def insert_unary(
        ...
        *,
        ...
        as this method supports more features, such as creating
        snapshots in a project different from the source disk
        project.
