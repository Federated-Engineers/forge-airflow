...
class RegionHealthCheckServicesTransport(abc.ABC):
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.HealthCheckServiceAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.HealthCheckService, Awaitable[compute.HealthCheckService]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            compute.HealthCheckServicesList, Awaitable[compute.HealthCheckServicesList]
        ],
    ]:
        raise NotImplementedError()
