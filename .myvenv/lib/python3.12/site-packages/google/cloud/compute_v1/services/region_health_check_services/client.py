...
class RegionHealthCheckServicesClient(metaclass=RegionHealthCheckServicesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionHealthCheckServicesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_aggregated_list():
                ...
                request = compute_v1.AggregatedListRegionHealthCheckServicesRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.AggregatedListRegionHealthCheckServicesRequest, dict]):
        ...
        Returns:
            google.cloud.compute_v1.services.region_health_check_services.pagers.AggregatedListPager:
                Contains a list of
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsRegionHealthCheckServiceRequest, dict]):
                The request object. A request message for
