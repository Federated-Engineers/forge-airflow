...
from .transports.base import DEFAULT_CLIENT_INFO, SslCertificatesTransport
from .transports.rest import SslCertificatesRestTransport


class SslCertificatesClientMeta(type):
    """Metaclass for the SslCertificates client.
...
class SslCertificatesClient(metaclass=SslCertificatesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            SslCertificatesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> SslCertificatesTransport:
        """Returns the transport used by the client instance.

        Returns:
            SslCertificatesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = SslCertificatesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = SslCertificatesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = SslCertificatesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = SslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SslCertificatesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, SslCertificatesTransport, Callable[..., SslCertificatesTransport]
            ]
        ] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            SslCertificatesClient._read_environment_variables()
        )
        self._client_cert_source = SslCertificatesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = SslCertificatesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, SslCertificatesTransport)
        if transport_provided:
            # transport is a SslCertificatesTransport instance.
            ...
            self._transport = cast(SslCertificatesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SslCertificatesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.SslCertificatesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, ssl_certificate]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, ssl_certificate_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
