...
class RegionSslPoliciesTransport(abc.ABC):
    """Abstract transport class for RegionSslPolicies."""
    ...
    def delete(
        ...
        [compute.DeleteRegionSslPolicyRequest],
    ...
    def insert(
        ...
        [compute.InsertRegionSslPolicyRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
...
__all__ = ("RegionSslPoliciesTransport",)
