...
class AdviceClient(metaclass=AdviceClientMeta):
        ...
        *,
        ...
        Args:
            ...
            region (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            calendar_mode_advice_request_resource (google.cloud.compute_v1.types.CalendarModeAdviceRequest):
                The body resource for this request
                This corresponds to the ``calendar_mode_advice_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
        ...
        Returns:
            google.cloud.compute_v1.types.CalendarModeAdviceResponse:
        ...
        flattened_params = [project, region, calendar_mode_advice_request_resource]
        ...
        if not isinstance(request, compute.CalendarModeAdviceRpcRequest):
            request = compute.CalendarModeAdviceRpcRequest(request)
            ...
            if calendar_mode_advice_request_resource is not None:
                request.calendar_mode_advice_request_resource = (
                    calendar_mode_advice_request_resource
                )

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.calendar_mode]
    ...
    def __enter__(self) -> "AdviceClient":
        return self
