...
class RegionInstantSnapshotsClient(metaclass=RegionInstantSnapshotsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionInstantSnapshotsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RegionInstantSnapshotsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionInstantSnapshotsClient._get_client_cert_source(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionInstantSnapshotsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionInstantSnapshotsClient`.",
                    extra={
    ...
    def delete_unary(
        self,
        request: Optional[
            Union[compute.DeleteRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1.DeleteRegionInstantSnapshotRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DeleteRegionInstantSnapshotRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetRegionInstantSnapshotRequest(
                    instant_snapshot="instant_snapshot_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def get_iam_policy(
        self,
        request: Optional[
            Union[compute.GetIamPolicyRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetIamPolicyRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def insert_unary(
        self,
        request: Optional[
            Union[compute.InsertRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.InsertRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def list(
        self,
        request: Optional[
            Union[compute.ListRegionInstantSnapshotsRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListRegionInstantSnapshotsRequest, dict]):
                The request object. A request message for
    ...
    def set_iam_policy(
        self,
        request: Optional[
            Union[compute.SetIamPolicyRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetIamPolicyRegionInstantSnapshotRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetIamPolicyRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def set_labels_unary(
        self,
        request: Optional[
            Union[compute.SetLabelsRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetLabelsRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsRegionInstantSnapshotRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsRegionInstantSnapshotRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsRegionInstantSnapshotRequest, dict]):
                The request object. A request message for
...
__all__ = ("RegionInstantSnapshotsClient",)
