...
class PublicAdvertisedPrefixesClient(metaclass=PublicAdvertisedPrefixesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PublicAdvertisedPrefixesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = PublicAdvertisedPrefixesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = PublicAdvertisedPrefixesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                PublicAdvertisedPrefixesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = PublicAdvertisedPrefixesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,PublicAdvertisedPrefixesTransport,Callable[..., PublicAdvertisedPrefixesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the PublicAdvertisedPrefixesTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            PublicAdvertisedPrefixesClient._read_environment_variables()
        )
        self._client_cert_source = (
            PublicAdvertisedPrefixesClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = PublicAdvertisedPrefixesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, PublicAdvertisedPrefixesTransport)
        if transport_provided:
            ...
            self._transport = cast(PublicAdvertisedPrefixesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or PublicAdvertisedPrefixesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                PublicAdvertisedPrefixesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., PublicAdvertisedPrefixesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.PublicAdvertisedPrefixesClient`.",
                    extra={
    ...
    def announce_unary(
        self,
        request: Optional[
            Union[compute.AnnouncePublicAdvertisedPrefixeRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_announce():
                ...
                request = compute_v1.AnnouncePublicAdvertisedPrefixeRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.AnnouncePublicAdvertisedPrefixeRequest, dict]):
            ...
            public_advertised_prefix (str):
                The name of the public advertised
        ...
        if not isinstance(request, compute.AnnouncePublicAdvertisedPrefixeRequest):
            request = compute.AnnouncePublicAdvertisedPrefixeRequest(request)
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata(
                (
                    ...
                    ("public_advertised_prefix", request.public_advertised_prefix),
                )
            ),
        )
    ...
    def withdraw_unary(
        self,
        request: Optional[
            Union[compute.WithdrawPublicAdvertisedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        public_advertised_prefix: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_withdraw():
                ...
                # Initialize request argument(s)
                request = compute_v1.WithdrawPublicAdvertisedPrefixeRequest(
                    project="project_value",
                    public_advertised_prefix="public_advertised_prefix_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.WithdrawPublicAdvertisedPrefixeRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.WithdrawPublicAdvertisedPrefixeRequest):
            request = compute.WithdrawPublicAdvertisedPrefixeRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
