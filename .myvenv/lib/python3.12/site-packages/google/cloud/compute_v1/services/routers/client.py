...
from .transports.base import DEFAULT_CLIENT_INFO, RoutersTransport
from .transports.rest import RoutersRestTransport


class RoutersClientMeta(type):
    """Metaclass for the Routers client.
...
class RoutersClient(metaclass=RoutersClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RoutersClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RoutersTransport:
        """Returns the transport used by the client instance.

        Returns:
            RoutersTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RoutersClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = RoutersClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = RoutersClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RoutersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RoutersClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RoutersClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RoutersClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RoutersTransport)
        if transport_provided:
            # transport is a RoutersTransport instance.
            ...
            self._transport = cast(RoutersTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RoutersClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                RoutersClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RoutersClient`.",
                    extra={
    ...
    def get_nat_ip_info(
        self,
        request: Optional[Union[compute.GetNatIpInfoRouterRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        router: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetNatIpInfoRouterRequest, dict]):
                The request object. A request message for
            ...
            router (str):
                ...
                for Nat IP information. The name should
                conform to RFC1035.
        ...
        Returns:
            google.cloud.compute_v1.types.NatIpInfoResponse:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_nat_ip_info]
    ...
    def get_nat_mapping_info(
        ...
        *,
        ...
        Args:
            ...
            router (str):
                Name of the Router resource to query
                for Nat Mapping information of VM
                endpoints.
    ...
    def get_router_status(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.RouterStatusResponse:
    ...
    def preview(
        ...
        *,
        ...
        Returns:
            google.cloud.compute_v1.types.RoutersPreviewResponse:
