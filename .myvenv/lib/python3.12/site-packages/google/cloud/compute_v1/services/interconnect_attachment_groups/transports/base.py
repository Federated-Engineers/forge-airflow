...
class InterconnectAttachmentGroupsTransport(abc.ABC):
    """Abstract transport class for InterconnectAttachmentGroups."""
    ...
    def get(
        ...
        Union[
            ...
            Awaitable[compute.InterconnectAttachmentGroup],
        ],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.InterconnectAttachmentGroupsListResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("InterconnectAttachmentGroupsTransport",)
