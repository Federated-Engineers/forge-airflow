...
class NetworkAttachmentsTransport(abc.ABC):
    """Abstract transport class for NetworkAttachments."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.NetworkAttachmentAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.NetworkAttachment, Awaitable[compute.NetworkAttachment]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.NetworkAttachmentList, Awaitable[compute.NetworkAttachmentList]],
    ]:
        raise NotImplementedError()
...
__all__ = ("NetworkAttachmentsTransport",)
