...
class FirewallsClient(metaclass=FirewallsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = FirewallsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = FirewallsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = FirewallsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = FirewallsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FirewallsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = FirewallsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or FirewallsClient._get_api_endpoint(
