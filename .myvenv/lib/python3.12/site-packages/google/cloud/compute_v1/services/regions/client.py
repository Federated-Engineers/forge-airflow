...
from .transports.base import DEFAULT_CLIENT_INFO, RegionsTransport
...
class RegionsClient(metaclass=RegionsClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, RegionsTransport, Callable[..., RegionsTransport]]
        ] = None,
        ...
        self._client_cert_source = RegionsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionsClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or RegionsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionsClient`.",
                    extra={
