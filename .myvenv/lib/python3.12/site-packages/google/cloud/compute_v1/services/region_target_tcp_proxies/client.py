...
from google.cloud.compute_v1.services.region_target_tcp_proxies import pagers
from google.cloud.compute_v1.types import compute

from .transports.base import (DEFAULT_CLIENT_INFO,
                              RegionTargetTcpProxiesTransport)
from .transports.rest import RegionTargetTcpProxiesRestTransport


class RegionTargetTcpProxiesClientMeta(type):
    """Metaclass for the RegionTargetTcpProxies client.
...
class RegionTargetTcpProxiesClient(metaclass=RegionTargetTcpProxiesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionTargetTcpProxiesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionTargetTcpProxiesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionTargetTcpProxiesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionTargetTcpProxiesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = RegionTargetTcpProxiesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = RegionTargetTcpProxiesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                RegionTargetTcpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RegionTargetTcpProxiesClient._DEFAULT_UNIVERSE
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionTargetTcpProxiesTransport,Callable[..., RegionTargetTcpProxiesTransport]]]):
                ...
                arguments as used in the RegionTargetTcpProxiesTransport constructor.
        ...
        self._client_cert_source = RegionTargetTcpProxiesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionTargetTcpProxiesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RegionTargetTcpProxiesTransport)
        if transport_provided:
            # transport is a RegionTargetTcpProxiesTransport instance.
            ...
            self._transport = cast(RegionTargetTcpProxiesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RegionTargetTcpProxiesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                RegionTargetTcpProxiesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., RegionTargetTcpProxiesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionTargetTcpProxiesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1.DeleteRegionTargetTcpProxyRequest(
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.DeleteRegionTargetTcpProxyRequest, dict]):
        ...
        flattened_params = [project, region, target_tcp_proxy]
        ...
        if not isinstance(request, compute.DeleteRegionTargetTcpProxyRequest):
            request = compute.DeleteRegionTargetTcpProxyRequest(request)
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetRegionTargetTcpProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_tcp_proxy="target_tcp_proxy_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetRegionTargetTcpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetRegionTargetTcpProxyRequest):
            request = compute.GetRegionTargetTcpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertRegionTargetTcpProxyRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.InsertRegionTargetTcpProxyRequest, dict]):
                The request object. A request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, target_tcp_proxy_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.InsertRegionTargetTcpProxyRequest):
            request = compute.InsertRegionTargetTcpProxyRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListRegionTargetTcpProxiesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListRegionTargetTcpProxiesRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListRegionTargetTcpProxiesRequest):
            request = compute.ListRegionTargetTcpProxiesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
...
__all__ = ("RegionTargetTcpProxiesClient",)
