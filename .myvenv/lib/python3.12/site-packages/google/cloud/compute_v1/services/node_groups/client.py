...
from .transports.base import DEFAULT_CLIENT_INFO, NodeGroupsTransport
from .transports.rest import NodeGroupsRestTransport


class NodeGroupsClientMeta(type):
    """Metaclass for the NodeGroups client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NodeGroupsTransport]]
    _transport_registry["rest"] = NodeGroupsRestTransport
...
class NodeGroupsClient(metaclass=NodeGroupsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            NodeGroupsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> NodeGroupsTransport:
        """Returns the transport used by the client instance.

        Returns:
            NodeGroupsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = NodeGroupsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = NodeGroupsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = NodeGroupsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = NodeGroupsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = NodeGroupsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            NodeGroupsClient._read_environment_variables()
        )
        self._client_cert_source = NodeGroupsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = NodeGroupsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, NodeGroupsTransport)
        if transport_provided:
            # transport is a NodeGroupsTransport instance.
            ...
            self._transport = cast(NodeGroupsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or NodeGroupsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.NodeGroupsClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def get(
        ...
        *,
        ...
        available NodeGroups by making a list() request. Note:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, initial_node_count, node_group_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, node_group, node_group_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
