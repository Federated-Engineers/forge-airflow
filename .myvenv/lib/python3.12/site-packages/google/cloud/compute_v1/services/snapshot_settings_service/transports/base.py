...
class SnapshotSettingsServiceTransport(abc.ABC):
    """Abstract transport class for SnapshotSettingsService."""
    ...
    def get(
        ...
        [compute.GetSnapshotSettingRequest],
        Union[compute.SnapshotSettings, Awaitable[compute.SnapshotSettings]],
    ]:
        raise NotImplementedError()
...
__all__ = ("SnapshotSettingsServiceTransport",)
