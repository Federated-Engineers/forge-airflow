...
class InterconnectAttachmentsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_with_metadata(
        self,
        response: compute.InterconnectAttachment,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[compute.InterconnectAttachment, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get
    ...
    def post_list_with_metadata(
        self,
        response: compute.InterconnectAttachmentList,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        compute.InterconnectAttachmentList, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for list
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[InterconnectAttachmentsRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.AggregatedList",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "AggregatedList",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InterconnectAttachmentsClient.SetLabels",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "SetLabels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InterconnectAttachmentsClient.set_labels",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InterconnectAttachments",
                        "rpcName": "SetLabels",
                        "metadata": http_response["headers"],
