...
class NetworkFirewallPoliciesClientMeta(type):
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[NetworkFirewallPoliciesTransport]]
...
class NetworkFirewallPoliciesClient(metaclass=NetworkFirewallPoliciesClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,NetworkFirewallPoliciesTransport,Callable[..., NetworkFirewallPoliciesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the NetworkFirewallPoliciesTransport constructor.
        ...
        transport_provided = isinstance(transport, NetworkFirewallPoliciesTransport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.NetworkFirewallPoliciesClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        (global and regional) and grouping the results per scope.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_clone_rules():
                ...
                # Initialize request argument(s)
                request = compute_v1.CloneRulesNetworkFirewallPolicyRequest(
                    firewall_policy="firewall_policy_value",
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetIamPolicyNetworkFirewallPolicyRequest(
                    project="project_value",
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_rule():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetRuleNetworkFirewallPolicyRequest(
                    firewall_policy="firewall_policy_value",
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertNetworkFirewallPolicyRequest(
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListNetworkFirewallPoliciesRequest(
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_remove_association():
                ...
                # Initialize request argument(s)
                request = compute_v1.RemoveAssociationNetworkFirewallPolicyRequest(
                    firewall_policy="firewall_policy_value",
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_remove_rule():
                ...
                # Initialize request argument(s)
                request = compute_v1.RemoveRuleNetworkFirewallPolicyRequest(
                    firewall_policy="firewall_policy_value",
                    project="project_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetIamPolicyNetworkFirewallPolicyRequest(
                    project="project_value",
                    resource="resource_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsNetworkFirewallPolicyRequest(
                    project="project_value",
                    resource="resource_value",
                )
