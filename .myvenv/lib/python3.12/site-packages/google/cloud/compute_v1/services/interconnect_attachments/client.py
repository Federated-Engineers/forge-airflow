...
class InterconnectAttachmentsClientMeta(type):
    """Metaclass for the InterconnectAttachments client.
...
class InterconnectAttachmentsClient(metaclass=InterconnectAttachmentsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            InterconnectAttachmentsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> InterconnectAttachmentsTransport:
        """Returns the transport used by the client instance.

        Returns:
            InterconnectAttachmentsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = InterconnectAttachmentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = InterconnectAttachmentsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = InterconnectAttachmentsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                InterconnectAttachmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = InterconnectAttachmentsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,InterconnectAttachmentsTransport,Callable[..., InterconnectAttachmentsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the InterconnectAttachmentsTransport constructor.
        ...
        self._universe_domain = InterconnectAttachmentsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, InterconnectAttachmentsTransport)
        if transport_provided:
            # transport is a InterconnectAttachmentsTransport instance.
            ...
            self._transport = cast(InterconnectAttachmentsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or InterconnectAttachmentsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.InterconnectAttachmentsClient`.",
                    extra={
    ...
    def set_labels_unary(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetLabelsInterconnectAttachmentRequest):
            request = compute.SetLabelsInterconnectAttachmentRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
