...
from .base import DEFAULT_CLIENT_INFO, NodeGroupsTransport


class _BaseNodeGroupsRestTransport(NodeGroupsTransport):
    """Base REST backend transport for NodeGroups.
...
__all__ = ("_BaseNodeGroupsRestTransport",)
