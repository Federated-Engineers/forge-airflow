...
from .base import DEFAULT_CLIENT_INFO, LicensesTransport


class _BaseLicensesRestTransport(LicensesTransport):
    """Base REST backend transport for Licenses.
    ...
    class _BaseUpdate:
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = compute.UpdateLicenseRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
...
__all__ = ("_BaseLicensesRestTransport",)
