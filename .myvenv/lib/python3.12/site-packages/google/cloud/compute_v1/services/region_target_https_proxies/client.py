...
class RegionTargetHttpsProxiesClient(metaclass=RegionTargetHttpsProxiesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionTargetHttpsProxiesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                RegionTargetHttpsProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str,
                RegionTargetHttpsProxiesTransport,
                Callable[..., RegionTargetHttpsProxiesTransport],
            ]
        ] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            RegionTargetHttpsProxiesClient._read_environment_variables()
        )
        self._client_cert_source = (
            RegionTargetHttpsProxiesClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = RegionTargetHttpsProxiesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionTargetHttpsProxiesClient._get_api_endpoint(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete():
                ...
                request = compute_v1.DeleteRegionTargetHttpsProxyRequest(
    ...
    def get(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.GetRegionTargetHttpsProxyRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list():
                ...
                # Initialize request argument(s)
                request = compute_v1.ListRegionTargetHttpsProxiesRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListRegionTargetHttpsProxiesRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1.PatchRegionTargetHttpsProxyRequest(
                    project="project_value",
                    region="region_value",
                    target_https_proxy="target_https_proxy_value",
                )
