...
from .base import DEFAULT_CLIENT_INFO, StoragePoolsTransport


class _BaseStoragePoolsRestTransport(StoragePoolsTransport):
    """Base REST backend transport for StoragePools.
...
__all__ = ("_BaseStoragePoolsRestTransport",)
