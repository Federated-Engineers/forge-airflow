...
class TargetGrpcProxiesTransport(abc.ABC):
    """Abstract transport class for TargetGrpcProxies."""
    ...
    def get(
        ...
        Union[compute.TargetGrpcProxy, Awaitable[compute.TargetGrpcProxy]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.TargetGrpcProxyList, Awaitable[compute.TargetGrpcProxyList]],
    ]:
        raise NotImplementedError()
