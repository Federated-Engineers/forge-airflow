...
from .rest_base import _BaseNodeTypesRestTransport
...
class NodeTypesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list_with_metadata(
        ...
        is returned by the NodeTypes server but before it is returned to user code.
...
class NodeTypesRestTransport(_BaseNodeTypesRestTransport):
    """REST backend synchronous transport for NodeTypes.
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[NodeTypesRestInterceptor]): Interceptor used
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.NodeTypesClient.AggregatedList",
                    extra={
            ...
            # Return the response
            resp = compute.NodeTypeAggregatedList()
            pb_resp = compute.NodeTypeAggregatedList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.NodeTypesClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.NodeTypes",
                        "rpcName": "AggregatedList",
    ...
    class _Get(_BaseNodeTypesRestTransport._BaseGet, NodeTypesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.NodeTypesClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.NodeTypes",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.NodeType()
            pb_resp = compute.NodeType.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.NodeTypesClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.NodeTypes",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
    ...
    class _List(_BaseNodeTypesRestTransport._BaseList, NodeTypesRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.NodeTypesClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.NodeTypes",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            # Return the response
            resp = compute.NodeTypeList()
            pb_resp = compute.NodeTypeList.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.NodeTypesClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.NodeTypes",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
