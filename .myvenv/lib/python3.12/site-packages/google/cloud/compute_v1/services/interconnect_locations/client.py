...
class InterconnectLocationsClientMeta(type):
    """Metaclass for the InterconnectLocations client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[InterconnectLocationsTransport]]
...
class InterconnectLocationsClient(metaclass=InterconnectLocationsClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            InterconnectLocationsClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> InterconnectLocationsTransport:
        """Returns the transport used by the client instance.

        Returns:
            InterconnectLocationsTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = InterconnectLocationsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = InterconnectLocationsClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = InterconnectLocationsClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                InterconnectLocationsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = InterconnectLocationsClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,InterconnectLocationsTransport,Callable[..., InterconnectLocationsTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the InterconnectLocationsTransport constructor.
        ...
        self._client_cert_source = InterconnectLocationsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = InterconnectLocationsClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, InterconnectLocationsTransport)
        if transport_provided:
            # transport is a InterconnectLocationsTransport instance.
            ...
            self._transport = cast(InterconnectLocationsTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or InterconnectLocationsClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.InterconnectLocationsClient`.",
                    extra={
        ...
        *,
        ...
        Args:
            ...
            interconnect_location (str):
                Name of the interconnect location to
                return.
        ...
        flattened_params = [project, interconnect_location]
        ...
        if not isinstance(request, compute.GetInterconnectLocationRequest):
            ...
            if interconnect_location is not None:
                request.interconnect_location = interconnect_location
