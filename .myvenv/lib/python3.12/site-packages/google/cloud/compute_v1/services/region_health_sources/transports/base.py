...
class RegionHealthSourcesTransport(abc.ABC):
    """Abstract transport class for RegionHealthSources."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.HealthSourceAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def insert(
        ...
        [compute.InsertRegionHealthSourceRequest],
        Union[compute.Operation, Awaitable[compute.Operation]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListRegionHealthSourcesRequest],
        Union[compute.HealthSourceList, Awaitable[compute.HealthSourceList]],
    ]:
        raise NotImplementedError()
...
__all__ = ("RegionHealthSourcesTransport",)
