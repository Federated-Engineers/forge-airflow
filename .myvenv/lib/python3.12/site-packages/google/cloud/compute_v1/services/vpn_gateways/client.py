...
class VpnGatewaysClient(metaclass=VpnGatewaysClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = VpnGatewaysClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = VpnGatewaysClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = VpnGatewaysClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = VpnGatewaysClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = VpnGatewaysClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, VpnGatewaysTransport, Callable[..., VpnGatewaysTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,VpnGatewaysTransport,Callable[..., VpnGatewaysTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the VpnGatewaysTransport constructor.
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            VpnGatewaysClient._read_environment_variables()
        )
        self._client_cert_source = VpnGatewaysClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = VpnGatewaysClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, VpnGatewaysTransport)
        if transport_provided:
            ...
            self._transport = cast(VpnGatewaysTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or VpnGatewaysClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[VpnGatewaysTransport], Callable[..., VpnGatewaysTransport]
            ] = (
                VpnGatewaysClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., VpnGatewaysTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.VpnGatewaysClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, vpn_gateway]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, vpn_gateway_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
