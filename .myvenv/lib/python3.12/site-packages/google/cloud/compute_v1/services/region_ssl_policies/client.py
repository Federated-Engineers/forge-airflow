...
from google.cloud.compute_v1.services.region_ssl_policies import pagers
from google.cloud.compute_v1.types import compute

from .transports.base import DEFAULT_CLIENT_INFO, RegionSslPoliciesTransport
from .transports.rest import RegionSslPoliciesRestTransport


class RegionSslPoliciesClientMeta(type):
    """Metaclass for the RegionSslPolicies client.
...
class RegionSslPoliciesClient(metaclass=RegionSslPoliciesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionSslPoliciesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionSslPoliciesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionSslPoliciesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionSslPoliciesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = RegionSslPoliciesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = RegionSslPoliciesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RegionSslPoliciesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RegionSslPoliciesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            RegionSslPoliciesClient._read_environment_variables()
        )
        self._client_cert_source = RegionSslPoliciesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionSslPoliciesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RegionSslPoliciesTransport)
        if transport_provided:
            # transport is a RegionSslPoliciesTransport instance.
            ...
            self._transport = cast(RegionSslPoliciesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RegionSslPoliciesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionSslPoliciesClient`.",
                    extra={
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteRegionSslPolicyRequest, dict]] = None,
        *,
        ...
        flattened_params = [project, region, ssl_policy]
    ...
    def get(
        self,
        request: Optional[Union[compute.GetRegionSslPolicyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ssl_policy: Optional[str] = None,
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertRegionSslPolicyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_insert():
                ...
                # Initialize request argument(s)
                request = compute_v1.InsertRegionSslPolicyRequest(
                    project="project_value",
                    region="region_value",
                )
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, ssl_policy_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def list(
        self,
        request: Optional[Union[compute.ListRegionSslPoliciesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def list_available_features(
        self,
        request: Optional[
            Union[compute.ListAvailableFeaturesRegionSslPoliciesRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Returns:
            google.cloud.compute_v1.types.SslPoliciesListAvailableFeaturesResponse:
        ...
        if not isinstance(
            ...
            request = compute.ListAvailableFeaturesRegionSslPoliciesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_available_features]
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchRegionSslPolicyRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ssl_policy: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_patch():
                ...
                # Initialize request argument(s)
                request = compute_v1.PatchRegionSslPolicyRequest(
                    project="project_value",
                    region="region_value",
                    ssl_policy="ssl_policy_value",
                )
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, ssl_policy, ssl_policy_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def __enter__(self) -> "RegionSslPoliciesClient":
        return self
