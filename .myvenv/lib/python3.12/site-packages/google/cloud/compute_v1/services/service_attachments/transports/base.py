...
class ServiceAttachmentsTransport(abc.ABC):
    """Abstract transport class for ServiceAttachments."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.ServiceAttachmentAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.ServiceAttachment, Awaitable[compute.ServiceAttachment]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.ServiceAttachmentList, Awaitable[compute.ServiceAttachmentList]],
    ]:
        raise NotImplementedError()
