...
from .transports.base import DEFAULT_CLIENT_INFO, ForwardingRulesTransport
...
class ForwardingRulesClient(metaclass=ForwardingRulesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ForwardingRulesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = ForwardingRulesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = ForwardingRulesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ForwardingRulesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ForwardingRulesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, ForwardingRulesTransport, Callable[..., ForwardingRulesTransport]
            ]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,ForwardingRulesTransport,Callable[..., ForwardingRulesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the ForwardingRulesTransport constructor.
        ...
        self._client_cert_source = ForwardingRulesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = ForwardingRulesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ForwardingRulesTransport)
        if transport_provided:
            ...
            self._transport = cast(ForwardingRulesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ForwardingRulesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.ForwardingRulesClient`.",
                    extra={
    ...
    def aggregated_list(
        self,
        request: Optional[
            Union[compute.AggregatedListForwardingRulesRequest, dict]
        ] = None,
        *,
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
    ...
    def get(
        self,
        request: Optional[Union[compute.GetForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        forwarding_rule: Optional[str] = None,
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def list(
        self,
        request: Optional[Union[compute.ListForwardingRulesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def patch_unary(
        self,
        request: Optional[Union[compute.PatchForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        forwarding_rule: Optional[str] = None,
    ...
    def set_labels_unary(
        self,
        request: Optional[Union[compute.SetLabelsForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
    ...
    def set_target_unary(
        self,
        request: Optional[Union[compute.SetTargetForwardingRuleRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        forwarding_rule: Optional[str] = None,
