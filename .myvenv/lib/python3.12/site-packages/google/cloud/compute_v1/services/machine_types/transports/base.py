...
class MachineTypesTransport(abc.ABC):
    """Abstract transport class for MachineTypes."""
    ...
    def aggregated_list(
        ...
        Union[
            ...
            Awaitable[compute.MachineTypeAggregatedList],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.MachineType, Awaitable[compute.MachineType]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.MachineTypeList, Awaitable[compute.MachineTypeList]],
    ]:
        raise NotImplementedError()
