...
class RegionCompositeHealthChecksTransport(abc.ABC):
    """Abstract transport class for RegionCompositeHealthChecks."""
    ...
    def get(
        ...
        Union[compute.CompositeHealthCheck, Awaitable[compute.CompositeHealthCheck]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.CompositeHealthCheckList],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("RegionCompositeHealthChecksTransport",)
