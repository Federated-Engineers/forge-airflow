        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.AddInstances",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.add_instances",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "AddInstances",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.AggregatedList",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.aggregated_list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "AggregatedList",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.ListInstances",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.list_instances",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "ListInstances",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.RemoveInstances",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.remove_instances",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "RemoveInstances",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.SetNamedPorts",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.set_named_ports",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "SetNamedPorts",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.InstanceGroupsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.InstanceGroupsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.InstanceGroups",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
