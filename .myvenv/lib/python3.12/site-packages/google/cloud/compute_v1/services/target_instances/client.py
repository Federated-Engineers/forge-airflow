...
from .transports.base import DEFAULT_CLIENT_INFO, TargetInstancesTransport
from .transports.rest import TargetInstancesRestTransport


class TargetInstancesClientMeta(type):
    """Metaclass for the TargetInstances client.
    ...
    _transport_registry = OrderedDict()  # type: Dict[str, Type[TargetInstancesTransport]]
    _transport_registry["rest"] = TargetInstancesRestTransport
...
class TargetInstancesClient(metaclass=TargetInstancesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            TargetInstancesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> TargetInstancesTransport:
        """Returns the transport used by the client instance.

        Returns:
            TargetInstancesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = TargetInstancesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = TargetInstancesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = TargetInstancesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TargetInstancesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = TargetInstancesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, TargetInstancesTransport, Callable[..., TargetInstancesTransport]
            ]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,TargetInstancesTransport,Callable[..., TargetInstancesTransport]]]):
                ...
                arguments as used in the TargetInstancesTransport constructor.
        ...
        self._client_cert_source = TargetInstancesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TargetInstancesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, TargetInstancesTransport)
        if transport_provided:
            # transport is a TargetInstancesTransport instance.
            ...
            self._transport = cast(TargetInstancesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or TargetInstancesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[TargetInstancesTransport], Callable[..., TargetInstancesTransport]
            ] = (
                TargetInstancesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., TargetInstancesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetInstancesClient`.",
                    extra={
    ...
    def aggregated_list(
        ...
        *,
        ...
        if not isinstance(request, compute.AggregatedListTargetInstancesRequest):
            request = compute.AggregatedListTargetInstancesRequest(request)
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, target_instance]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def get(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.GetTargetInstanceRequest):
            request = compute.GetTargetInstanceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, zone, target_instance_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def list(
        ...
        *,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.ListTargetInstancesRequest):
            request = compute.ListTargetInstancesRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def set_security_policy_unary(
        self,
        request: Optional[
            Union[compute.SetSecurityPolicyTargetInstanceRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetSecurityPolicyTargetInstanceRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.SetSecurityPolicyTargetInstanceRequest):
            request = compute.SetSecurityPolicyTargetInstanceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsTargetInstanceRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        zone: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsTargetInstanceRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsTargetInstanceRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsTargetInstanceRequest):
            request = compute.TestIamPermissionsTargetInstanceRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
