...
class PreviewFeaturesTransport(abc.ABC):
    """Abstract transport class for PreviewFeatures."""
    ...
    def get(
        ...
        [compute.GetPreviewFeatureRequest],
        Union[compute.PreviewFeature, Awaitable[compute.PreviewFeature]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        [compute.ListPreviewFeaturesRequest],
        Union[compute.PreviewFeatureList, Awaitable[compute.PreviewFeatureList]],
    ]:
        raise NotImplementedError()
    ...
    def update(
        ...
        [compute.UpdatePreviewFeatureRequest],
...
__all__ = ("PreviewFeaturesTransport",)
