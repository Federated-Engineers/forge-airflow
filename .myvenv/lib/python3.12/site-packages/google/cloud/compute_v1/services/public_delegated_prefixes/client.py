...
class PublicDelegatedPrefixesClient(metaclass=PublicDelegatedPrefixesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = PublicDelegatedPrefixesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                PublicDelegatedPrefixesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = PublicDelegatedPrefixesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or PublicDelegatedPrefixesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.PublicDelegatedPrefixesClient`.",
                    extra={
    ...
    def announce_unary(
        self,
        request: Optional[
            Union[compute.AnnouncePublicDelegatedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.AnnouncePublicDelegatedPrefixeRequest, dict]):
                The request object. A request message for
    ...
    def withdraw_unary(
        self,
        request: Optional[
            Union[compute.WithdrawPublicDelegatedPrefixeRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        region: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.WithdrawPublicDelegatedPrefixeRequest, dict]):
                The request object. A request message for
