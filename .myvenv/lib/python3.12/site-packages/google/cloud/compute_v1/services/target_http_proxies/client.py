...
from .transports.base import DEFAULT_CLIENT_INFO, TargetHttpProxiesTransport
...
class TargetHttpProxiesClient(metaclass=TargetHttpProxiesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = TargetHttpProxiesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = TargetHttpProxiesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = TargetHttpProxiesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TargetHttpProxiesClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or TargetHttpProxiesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.TargetHttpProxiesClient`.",
                    extra={
