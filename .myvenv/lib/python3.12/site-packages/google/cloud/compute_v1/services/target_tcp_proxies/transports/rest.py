...
class TargetTcpProxiesRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_aggregated_list_with_metadata(
        ...
        is returned by the TargetTcpProxies server but before it is returned to user code.
    ...
    def pre_test_iam_permissions(
        self,
        request: compute.TestIamPermissionsTargetTcpProxyRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
...
class TargetTcpProxiesRestTransport(_BaseTargetTcpProxiesRestTransport):
        ...
        *,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[TargetTcpProxiesRestInterceptor]): Interceptor used
    ...
    class _TestIamPermissions(
        _BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions,
        TargetTcpProxiesRestStub,
    ):
        def __hash__(self):
            return hash("TargetTcpProxiesRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = _BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions._get_http_options()

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseTargetTcpProxiesRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetTcpProxiesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetTcpProxies",
            ...
            # Send the request
            response = TargetTcpProxiesRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetTcpProxiesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetTcpProxies",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
