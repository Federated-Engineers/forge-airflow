...
class RoutesClientMeta(type):
    """Metaclass for the Routes client.
...
class RoutesClient(metaclass=RoutesClientMeta):
    """The Routes API."""
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RoutesClient: The constructed client.
        """
    ...
    def transport(self) -> RoutesTransport:
        ...
        Returns:
            RoutesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RoutesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RoutesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = RoutesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RoutesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RoutesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RoutesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RoutesTransport)
        if transport_provided:
            # transport is a RoutesTransport instance.
            ...
            self._transport = cast(RoutesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or RoutesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RoutesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        flattened_params = [project, route]
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, route_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def test_iam_permissions(
        self,
        request: Optional[Union[compute.TestIamPermissionsRouteRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsRouteRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsRouteRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsRouteRequest):
            request = compute.TestIamPermissionsRouteRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
