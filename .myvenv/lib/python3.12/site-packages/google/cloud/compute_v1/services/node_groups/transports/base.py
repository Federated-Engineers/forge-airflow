...
class NodeGroupsTransport(abc.ABC):
    """Abstract transport class for NodeGroups."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.add_nodes: gapic_v1.method.wrap_method(
                self.add_nodes,
            ...
            self.delete_nodes: gapic_v1.method.wrap_method(
                self.delete_nodes,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.set_node_template: gapic_v1.method.wrap_method(
                self.set_node_template,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def aggregated_list(
        ...
        Union[
            compute.NodeGroupAggregatedList, Awaitable[compute.NodeGroupAggregatedList]
        ],
    ]:
        raise NotImplementedError()
    ...
    def get(
        ...
        Union[compute.NodeGroup, Awaitable[compute.NodeGroup]],
    ]:
        raise NotImplementedError()
    ...
    def list(
        ...
        Union[compute.NodeGroupList, Awaitable[compute.NodeGroupList]],
    ]:
        raise NotImplementedError()
    ...
    def list_nodes(
        ...
        Union[compute.NodeGroupsListNodes, Awaitable[compute.NodeGroupsListNodes]],
    ]:
        raise NotImplementedError()
