...
from .transports.base import DEFAULT_CLIENT_INFO, RegionCommitmentsTransport
...
class RegionCommitmentsClient(metaclass=RegionCommitmentsClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionCommitmentsClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = RegionCommitmentsClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = RegionCommitmentsClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionCommitmentsClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or RegionCommitmentsClient._get_api_endpoint(
