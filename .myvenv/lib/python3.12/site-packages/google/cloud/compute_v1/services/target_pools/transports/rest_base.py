...
from .base import DEFAULT_CLIENT_INFO, TargetPoolsTransport
    ...
    class _BaseTestIamPermissions:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/compute/v1/projects/{project}/regions/{region}/targetPools/{resource}/testIamPermissions",
...
__all__ = ("_BaseTargetPoolsRestTransport",)
