...
class RegionSslCertificatesClientMeta(type):
    """Metaclass for the RegionSslCertificates client.
...
class RegionSslCertificatesClient(metaclass=RegionSslCertificatesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            RegionSslCertificatesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> RegionSslCertificatesTransport:
        """Returns the transport used by the client instance.

        Returns:
            RegionSslCertificatesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = RegionSslCertificatesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = RegionSslCertificatesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = RegionSslCertificatesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                RegionSslCertificatesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = RegionSslCertificatesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str,RegionSslCertificatesTransport,Callable[..., RegionSslCertificatesTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the RegionSslCertificatesTransport constructor.
        ...
        self._client_cert_source = RegionSslCertificatesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = RegionSslCertificatesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, RegionSslCertificatesTransport)
        if transport_provided:
            # transport is a RegionSslCertificatesTransport instance.
            ...
            self._transport = cast(RegionSslCertificatesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or RegionSslCertificatesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionSslCertificatesClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        flattened_params = [project, region, ssl_certificate]
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, region, ssl_certificate_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def __enter__(self) -> "RegionSslCertificatesClient":
        return self
...
__all__ = ("RegionSslCertificatesClient",)
