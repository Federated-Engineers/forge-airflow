...
class RegionBackendServicesClient(metaclass=RegionBackendServicesClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.RegionBackendServicesClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.GetIamPolicyRegionBackendServiceRequest(
                    project="project_value",
                    region="region_value",
    ...
    def list_usable(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.ListUsableRegionBackendServicesRequest, dict]):
                The request object. A request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_iam_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetIamPolicyRegionBackendServiceRequest(
                    project="project_value",
                    region="region_value",
                    resource="resource_value",
                )
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_set_security_policy():
                ...
                # Initialize request argument(s)
                request = compute_v1.SetSecurityPolicyRegionBackendServiceRequest(
                    backend_service="backend_service_value",
                    project="project_value",
                    region="region_value",
                )
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.SetSecurityPolicyRegionBackendServiceRequest, dict]):
                The request object. A request message for
    ...
    def test_iam_permissions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsRegionBackendServiceRequest, dict]):
                The request object. A request message for
