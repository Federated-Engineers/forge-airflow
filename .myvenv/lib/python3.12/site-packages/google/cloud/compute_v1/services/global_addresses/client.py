...
from .transports.base import DEFAULT_CLIENT_INFO, GlobalAddressesTransport
from .transports.rest import GlobalAddressesRestTransport


class GlobalAddressesClientMeta(type):
    """Metaclass for the GlobalAddresses client.
...
class GlobalAddressesClient(metaclass=GlobalAddressesClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            GlobalAddressesClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> GlobalAddressesTransport:
        """Returns the transport used by the client instance.

        Returns:
            GlobalAddressesTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = GlobalAddressesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = GlobalAddressesClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = GlobalAddressesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = GlobalAddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GlobalAddressesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = (
            GlobalAddressesClient._read_environment_variables()
        )
        self._client_cert_source = GlobalAddressesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = GlobalAddressesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, GlobalAddressesTransport)
        if transport_provided:
            # transport is a GlobalAddressesTransport instance.
            ...
            self._transport = cast(GlobalAddressesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or GlobalAddressesClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.GlobalAddressesClient`.",
                    extra={
    ...
    def delete_unary(
        self,
        request: Optional[Union[compute.DeleteGlobalAddressRequest, dict]] = None,
        *,
        ...
        flattened_params = [project, address]
    ...
    def get(
        self,
        request: Optional[Union[compute.GetGlobalAddressRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        address: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def insert_unary(
        self,
        request: Optional[Union[compute.InsertGlobalAddressRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, address_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def list(
        self,
        request: Optional[Union[compute.ListGlobalAddressesRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def move_unary(
        self,
        request: Optional[Union[compute.MoveGlobalAddressRequest, dict]] = None,
        *,
        project: Optional[str] = None,
        address: Optional[str] = None,
        global_addresses_move_request_resource: Optional[
            compute.GlobalAddressesMoveRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> compute.Operation:
        r"""Moves the specified address resource from one project
        to another project.
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.MoveGlobalAddressRequest, dict]):
                The request object. A request message for
            ...
            address (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            global_addresses_move_request_resource (google.cloud.compute_v1.types.GlobalAddressesMoveRequest):
                The body resource for this request
                This corresponds to the ``global_addresses_move_request_resource`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, address, global_addresses_move_request_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        if not isinstance(request, compute.MoveGlobalAddressRequest):
            ...
            if address is not None:
                request.address = address
            if global_addresses_move_request_resource is not None:
    ...
    def set_labels_unary(
        self,
        request: Optional[Union[compute.SetLabelsGlobalAddressRequest, dict]] = None,
        *,
        project: Optional[str] = None,
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsGlobalAddressRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        resource: Optional[str] = None,
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsGlobalAddressRequest, dict]):
                The request object. A request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsGlobalAddressRequest):
            request = compute.TestIamPermissionsGlobalAddressRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
