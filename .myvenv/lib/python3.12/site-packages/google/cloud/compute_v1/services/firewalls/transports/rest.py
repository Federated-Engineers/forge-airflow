...
class FirewallsRestTransport(_BaseFirewallsRestTransport):
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.Firewall.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = compute.FirewallList.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.Patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Patch",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.patch",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Patch",
                        "metadata": http_response["headers"],
    ...
    class _TestIamPermissions(
        _BaseFirewallsRestTransport._BaseTestIamPermissions, FirewallsRestStub
    ):
        def __hash__(self):
            return hash("FirewallsRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseFirewallsRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseFirewallsRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseFirewallsRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseFirewallsRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
            ...
            # Send the request
            response = FirewallsRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FirewallsClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FirewallsClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.Firewalls",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
    ...
    def test_iam_permissions(
        ...
        [compute.TestIamPermissionsFirewallRequest], compute.TestPermissionsResponse
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
