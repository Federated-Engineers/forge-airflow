...
from .transports.base import DEFAULT_CLIENT_INFO, AddressesTransport
...
class AddressesClient(metaclass=AddressesClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AddressesClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AddressesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AddressesTransport, Callable[..., AddressesTransport]]
        ] = None,
        ...
        self._client_cert_source = AddressesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AddressesClient._get_universe_domain(
        ...
        self._api_endpoint = self._api_endpoint or AddressesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AddressesTransport], Callable[..., AddressesTransport]
            ] = (
    ...
    def move_unary(
        ...
        *,
        ...
        region: Optional[str] = None,
        address: Optional[str] = None,
        region_addresses_move_request_resource: Optional[
            compute.RegionAddressesMoveRequest
        ] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
