        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.TargetSslProxiesClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetSslProxies",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.TargetSslProxiesClient.test_iam_permissions",
                    extra={
                        "serviceName": "google.cloud.compute.v1.TargetSslProxies",
                        "rpcName": "TestIamPermissions",
                        "metadata": http_response["headers"],
