...
class ReservationBlocksTransport(abc.ABC):
    """Abstract transport class for ReservationBlocks."""
    ...
    def list(
        ...
        Union[
            ...
            Awaitable[compute.ReservationBlocksListResponse],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("ReservationBlocksTransport",)
