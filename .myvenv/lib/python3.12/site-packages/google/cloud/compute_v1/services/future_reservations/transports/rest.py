        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.Cancel",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Cancel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.cancel",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Cancel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.Delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Delete",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.delete",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Delete",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.Get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Get",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.get",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Get",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.Insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Insert",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Insert",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.List",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "List",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.list",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "List",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.FutureReservationsClient.Update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Update",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.FutureReservationsClient.update",
                    extra={
                        "serviceName": "google.cloud.compute.v1.FutureReservations",
                        "rpcName": "Update",
                        "metadata": http_response["headers"],
