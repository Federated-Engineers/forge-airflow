...
from .rest_base import _BaseRegionInstancesRestTransport
...
class RegionInstancesRestInterceptor:
    """Interceptor for RegionInstances.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the RegionInstancesRestTransport.
    ...
    def pre_bulk_insert(
        ...
        compute.BulkInsertRegionInstanceRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for bulk_insert

        Override in a subclass to manipulate the request or metadata
        before they are sent to the RegionInstances server.
        """
        return request, metadata
...
class RegionInstancesRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: RegionInstancesRestInterceptor


class RegionInstancesRestTransport(_BaseRegionInstancesRestTransport):
    """REST backend synchronous transport for RegionInstances.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[RegionInstancesRestInterceptor] = None,
        ...
        this library's repository. Thank you!
         ...
         Args:
             ...
             interceptor (Optional[RegionInstancesRestInterceptor]): Interceptor used
        ...
        self._interceptor = interceptor or RegionInstancesRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _BulkInsert(
        _BaseRegionInstancesRestTransport._BaseBulkInsert, RegionInstancesRestStub
    ):
        def __hash__(self):
            return hash("RegionInstancesRestTransport.BulkInsert")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.compute_v1.RegionInstancesClient.BulkInsert",
                    extra={
            ...
            # Send the request
            response = RegionInstancesRestTransport._BulkInsert._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.compute_v1.RegionInstancesClient.bulk_insert",
                    extra={
                        "serviceName": "google.cloud.compute.v1.RegionInstances",
                        "rpcName": "BulkInsert",
...
__all__ = ("RegionInstancesRestTransport",)
