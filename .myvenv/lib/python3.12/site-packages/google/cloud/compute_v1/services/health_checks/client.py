...
class HealthChecksClientMeta(type):
    """Metaclass for the HealthChecks client.
...
class HealthChecksClient(metaclass=HealthChecksClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            HealthChecksClient: The constructed client.
        """
    ...
    @property
    def transport(self) -> HealthChecksTransport:
        """Returns the transport used by the client instance.

        Returns:
            HealthChecksTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = HealthChecksClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = HealthChecksClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = HealthChecksClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = HealthChecksClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = HealthChecksClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, HealthChecksTransport, Callable[..., HealthChecksTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,HealthChecksTransport,Callable[..., HealthChecksTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the HealthChecksTransport constructor.
        ...
        self._client_cert_source = HealthChecksClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = HealthChecksClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, HealthChecksTransport)
        if transport_provided:
            # transport is a HealthChecksTransport instance.
            ...
            self._transport = cast(HealthChecksTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or HealthChecksClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.compute_v1.HealthChecksClient`.",
                    extra={
    ...
    def delete_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, health_check]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def insert_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, health_check_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_unary(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project, health_check, health_check_resource]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def test_iam_permissions(
        self,
        request: Optional[
            Union[compute.TestIamPermissionsHealthCheckRequest, dict]
        ] = None,
        *,
        project: Optional[str] = None,
        ...
        .. code-block:: python
            ...
            def sample_test_iam_permissions():
                ...
                # Initialize request argument(s)
                request = compute_v1.TestIamPermissionsHealthCheckRequest(
                    project="project_value",
        ...
        Args:
            request (Union[google.cloud.compute_v1.types.TestIamPermissionsHealthCheckRequest, dict]):
                The request object. A request message for
                HealthChecks.TestIamPermissions. See the
                method description for details.
            project (str):
                Project ID for this request.
                This corresponds to the ``project`` field
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, compute.TestIamPermissionsHealthCheckRequest):
            request = compute.TestIamPermissionsHealthCheckRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if project is not None:
                request.project = project
