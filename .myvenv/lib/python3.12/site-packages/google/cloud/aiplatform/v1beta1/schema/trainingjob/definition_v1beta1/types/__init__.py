...
#
from .automl_image_classification import (AutoMlImageClassification,
...
from .automl_image_segmentation import (AutoMlImageSegmentation,
                                        AutoMlImageSegmentationInputs,
                                        AutoMlImageSegmentationMetadata)
from .automl_tables import (AutoMlTables, AutoMlTablesInputs,
                            AutoMlTablesMetadata)
from .automl_text_classification import (AutoMlTextClassification,
                                         AutoMlTextClassificationInputs)
from .automl_text_extraction import (AutoMlTextExtraction,
                                     AutoMlTextExtractionInputs)
from .automl_text_sentiment import (AutoMlTextSentiment,
                                    AutoMlTextSentimentInputs)
from .automl_time_series_forecasting import (AutoMlForecasting,
...
from .automl_video_classification import (AutoMlVideoClassification,
                                          AutoMlVideoClassificationInputs)
from .automl_video_object_tracking import (AutoMlVideoObjectTracking,
