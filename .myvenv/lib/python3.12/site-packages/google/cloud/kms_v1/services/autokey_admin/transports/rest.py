        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.ShowEffectiveAutokeyConfig",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "ShowEffectiveAutokeyConfig",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Return the response
            resp = autokey_admin.ShowEffectiveAutokeyConfigResponse()
            pb_resp = autokey_admin.ShowEffectiveAutokeyConfigResponse.pb(resp)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminClient.show_effective_autokey_config",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "ShowEffectiveAutokeyConfig",
                        "metadata": http_response["headers"],
    ...
    class _UpdateAutokeyConfig(
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update autokey config method over HTTP.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.UpdateAutokeyConfig",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "UpdateAutokeyConfig",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminClient.update_autokey_config",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "UpdateAutokeyConfig",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.kms_v1.AutokeyAdminClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.kms_v1.AutokeyAdminAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.kms.v1.AutokeyAdmin",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
...
__all__ = ("AutokeyAdminRestTransport",)
