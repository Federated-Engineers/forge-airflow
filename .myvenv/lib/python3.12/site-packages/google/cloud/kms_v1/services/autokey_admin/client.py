...
class AutokeyAdminClient(metaclass=AutokeyAdminClientMeta):
    ...
    def update_autokey_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_autokey_config():
                # Create a client
        ...
        Args:
            request (Union[google.cloud.kms_v1.types.UpdateAutokeyConfigRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.update_autokey_config]
    ...
    def get_autokey_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.kms_v1.types.GetAutokeyConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_autokey_config]
    ...
    def show_effective_autokey_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_show_effective_autokey_config():
                # Create a client
                client = kms_v1.AutokeyAdminClient()
                ...
                # Make the request
                response = client.show_effective_autokey_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.kms_v1.types.ShowEffectiveAutokeyConfigRequest, dict]):
                The request object. Request message for
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.show_effective_autokey_config
        ]
    ...
    def __enter__(self) -> "AutokeyAdminClient":
        return self
