...
class DataformGrpcAsyncIOTransport(DataformTransport):
    ...
    def get_team_folder(
        self,
    ) -> Callable[[dataform.GetTeamFolderRequest], Awaitable[dataform.TeamFolder]]:
    ...
    def create_team_folder(
        self,
    ) -> Callable[[dataform.CreateTeamFolderRequest], Awaitable[dataform.TeamFolder]]:
    ...
    def update_team_folder(
        self,
    ) -> Callable[[dataform.UpdateTeamFolderRequest], Awaitable[dataform.TeamFolder]]:
    ...
    def delete_team_folder(
        self,
    ) -> Callable[[dataform.DeleteTeamFolderRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def query_team_folder_contents(
        ...
        Returns:
            Callable[[~.QueryTeamFolderContentsRequest],
                    Awaitable[~.QueryTeamFolderContentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "query_team_folder_contents" not in self._stubs:
            self._stubs["query_team_folder_contents"] = (
    ...
    def search_team_folders(
        ...
        Returns:
            Callable[[~.SearchTeamFoldersRequest],
                    Awaitable[~.SearchTeamFoldersResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_folder(
        self,
    ) -> Callable[[dataform.GetFolderRequest], Awaitable[dataform.Folder]]:
    ...
    def create_folder(
        self,
    ) -> Callable[[dataform.CreateFolderRequest], Awaitable[dataform.Folder]]:
    ...
    def update_folder(
        self,
    ) -> Callable[[dataform.UpdateFolderRequest], Awaitable[dataform.Folder]]:
    ...
    def delete_folder(
        self,
    ) -> Callable[[dataform.DeleteFolderRequest], Awaitable[empty_pb2.Empty]]:
    ...
    def query_folder_contents(
        ...
        Returns:
            Callable[[~.QueryFolderContentsRequest],
                    Awaitable[~.QueryFolderContentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def query_user_root_contents(
        ...
        Returns:
            Callable[[~.QueryUserRootContentsRequest],
                    Awaitable[~.QueryUserRootContentsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def move_folder(
        self,
    ) -> Callable[[dataform.MoveFolderRequest], Awaitable[operations_pb2.Operation]]:
    ...
    def move_repository(
        ...
        [dataform.MoveRepositoryRequest], Awaitable[operations_pb2.Operation]
    ]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_team_folder: self._wrap_method(
                self.get_team_folder,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_team_folder: self._wrap_method(
                self.create_team_folder,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_team_folder: self._wrap_method(
                self.update_team_folder,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_team_folder: self._wrap_method(
            ...
            self.search_team_folders: self._wrap_method(
            ...
            self.query_folder_contents: self._wrap_method(
                self.query_folder_contents,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_user_root_contents: self._wrap_method(
            ...
            self.move_repository: self._wrap_method(
