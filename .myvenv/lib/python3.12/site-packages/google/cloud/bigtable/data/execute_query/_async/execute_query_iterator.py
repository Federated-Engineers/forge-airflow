...
from google.cloud.bigtable.data.exceptions import (EarlyMetadataCallError,
...
if TYPE_CHECKING:
    if CrossSync.is_async:
        from google.cloud.bigtable.data import \
            BigtableDataClientAsync as DataClientType
    else:
        from google.cloud.bigtable.data import \
            BigtableDataClient as DataClientType
