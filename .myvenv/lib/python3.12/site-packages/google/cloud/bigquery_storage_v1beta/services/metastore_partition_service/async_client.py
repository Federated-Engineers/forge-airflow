...
from google.cloud.bigquery_storage_v1beta import \
...
class MetastorePartitionServiceAsyncClient:
    ...
    def stream_metastore_partitions(
        self,
        requests: Optional[
            AsyncIterator[metastore_partition.StreamMetastorePartitionsRequest]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        AsyncIterable[metastore_partition.StreamMetastorePartitionsResponse]
    ]:
        ...
        Args:
            requests (AsyncIterator[`google.cloud.bigquery_storage_v1beta.types.StreamMetastorePartitionsRequest`]):
        ...
        Returns:
            AsyncIterable[google.cloud.bigquery_storage_v1beta.types.StreamMetastorePartitionsResponse]:
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.stream_metastore_partitions
        ]
