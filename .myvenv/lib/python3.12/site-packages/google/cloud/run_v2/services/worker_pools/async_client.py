...
from google.cloud.run_v2.types import (condition, instance_split,
                                       vendor_settings)
...
class WorkerPoolsAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            WorkerPoolsClient.from_service_account_info.__func__  # type: ignore
        )
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            WorkerPoolsClient.from_service_account_file.__func__  # type: ignore
        )
