    ...
    class _ListOperations(_BaseBuildsRestTransport._BaseListOperations, BuildsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseBuildsRestTransport._BaseListOperations._get_http_options()
            )

            request, metadata = self._interceptor.pre_list_operations(request, metadata)
            transcoded_request = (
                _BaseBuildsRestTransport._BaseListOperations._get_transcoded_request(
                    http_options, request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseBuildsRestTransport._BaseListOperations._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.run_v2.BuildsClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.run.v2.Builds",
            ...
            # Send the request
            response = BuildsRestTransport._ListOperations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.run_v2.BuildsAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.run.v2.Builds",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(_BaseBuildsRestTransport._BaseWaitOperation, BuildsRestStub):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseBuildsRestTransport._BaseWaitOperation._get_http_options()
            )

            request, metadata = self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = (
                _BaseBuildsRestTransport._BaseWaitOperation._get_transcoded_request(
                    http_options, request
                )
            )

            body = _BaseBuildsRestTransport._BaseWaitOperation._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = (
                _BaseBuildsRestTransport._BaseWaitOperation._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.run_v2.BuildsClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.run.v2.Builds",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.run_v2.BuildsAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.run.v2.Builds",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
