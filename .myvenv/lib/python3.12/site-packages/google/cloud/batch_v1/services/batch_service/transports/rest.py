        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.CancelJob",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.cancel_job",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "CancelJob",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.CreateJob",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "CreateJob",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.create_job",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "CreateJob",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.DeleteJob",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "DeleteJob",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.delete_job",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "DeleteJob",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.GetJob",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetJob",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.get_job",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetJob",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.GetTask",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetTask",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.get_task",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetTask",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.ListJobs",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListJobs",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.list_jobs",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListJobs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.ListTasks",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListTasks",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceClient.list_tasks",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListTasks",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.batch_v1.BatchServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.batch_v1.BatchServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.batch.v1.BatchService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
