...
from google.cloud.workflows_v1.types.workflows import (
    CreateWorkflowRequest, DeleteWorkflowRequest, ExecutionHistoryLevel,
    GetWorkflowRequest, ListWorkflowRevisionsRequest,
    ListWorkflowRevisionsResponse, ListWorkflowsRequest, ListWorkflowsResponse,
    OperationMetadata, UpdateWorkflowRequest, Workflow)
