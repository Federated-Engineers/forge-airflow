...
class CmekServiceClient(metaclass=CmekServiceClientMeta):
    ...
    def create_encryption_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataplex_v1.types.CreateEncryptionConfigRequest, dict]):
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_encryption_config]
    ...
    def update_encryption_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.dataplex_v1.types.UpdateEncryptionConfigRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_encryption_config]
    ...
    def delete_encryption_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_encryption_config():
                # Create a client
                client = dataplex_v1.CmekServiceClient()
        ...
        Args:
            request (Union[google.cloud.dataplex_v1.types.DeleteEncryptionConfigRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_encryption_config]
    ...
    def list_encryption_configs(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListEncryptionConfigsPager:
        ...
        Args:
            request (Union[google.cloud.dataplex_v1.types.ListEncryptionConfigsRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_encryption_configs]
        ...
        response = pagers.ListEncryptionConfigsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def get_encryption_config(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_encryption_config():
                # Create a client
                client = dataplex_v1.CmekServiceClient()
                ...
                # Make the request
                response = client.get_encryption_config(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.dataplex_v1.types.GetEncryptionConfigRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_encryption_config]
    ...
    def __enter__(self) -> "CmekServiceClient":
        return self
