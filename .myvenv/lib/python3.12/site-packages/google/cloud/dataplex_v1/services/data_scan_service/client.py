...
from google.cloud.dataplex_v1.types import (data_discovery, data_documentation,
                                            data_profile, data_quality,
                                            datascans, processing, resources,
                                            service)
...
class DataScanServiceClient(metaclass=DataScanServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DataScanServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DataScanServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = DataScanServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = DataScanServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = DataScanServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, DataScanServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(DataScanServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or DataScanServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.dataplex_v1.DataScanServiceClient`.",
                    extra={
    ...
    def generate_data_quality_rules(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.generate_data_quality_rules
        ]
