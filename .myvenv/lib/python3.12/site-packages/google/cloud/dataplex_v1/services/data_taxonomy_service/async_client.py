...
class DataTaxonomyServiceAsyncClient:
    ...
    parse_data_attribute_binding_path = staticmethod(
        DataTaxonomyServiceClient.parse_data_attribute_binding_path
    )
    data_taxonomy_path = staticmethod(DataTaxonomyServiceClient.data_taxonomy_path)
    parse_data_taxonomy_path = staticmethod(
        DataTaxonomyServiceClient.parse_data_taxonomy_path
    )
    common_billing_account_path = staticmethod(
        DataTaxonomyServiceClient.common_billing_account_path
    )
    parse_common_billing_account_path = staticmethod(
        DataTaxonomyServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(DataTaxonomyServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        DataTaxonomyServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        DataTaxonomyServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        DataTaxonomyServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(DataTaxonomyServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        DataTaxonomyServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(DataTaxonomyServiceClient.common_location_path)
    parse_common_location_path = staticmethod(
        DataTaxonomyServiceClient.parse_common_location_path
    )
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            DataTaxonomyServiceAsyncClient: The constructed client.
        """
        sa_info_func = (
            DataTaxonomyServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(DataTaxonomyServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            DataTaxonomyServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(DataTaxonomyServiceAsyncClient, filename, *args, **kwargs)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return DataTaxonomyServiceClient.get_mtls_endpoint_and_cert_source(
            client_options
        )  # type: ignore
    ...
    get_transport_class = DataTaxonomyServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.dataplex_v1.DataTaxonomyServiceAsyncClient`.",
                extra={
    ...
    async def create_data_taxonomy(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            data_taxonomy (:class:`google.cloud.dataplex_v1.types.DataTaxonomy`):
    ...
    async def update_data_taxonomy(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.UpdateDataTaxonomyRequest, dict]]):
    ...
    async def delete_data_taxonomy(
        self,
    ...
    async def list_data_taxonomies(
        self,
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.ListDataTaxonomiesRequest, dict]]):
        ...
        response = pagers.ListDataTaxonomiesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def create_data_attribute_binding(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            data_attribute_binding (:class:`google.cloud.dataplex_v1.types.DataAttributeBinding`):
    ...
    async def update_data_attribute_binding(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.UpdateDataAttributeBindingRequest, dict]]):
    ...
    async def delete_data_attribute_binding(
        self,
        request: Optional[
    ...
    async def list_data_attribute_bindings(
        self,
        request: Optional[
        ...
        *,
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDataAttributeBindingsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def get_data_attribute_binding(
        self,
        request: Optional[
        ...
        *,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            data_attribute (:class:`google.cloud.dataplex_v1.types.DataAttribute`):
    ...
    async def update_data_attribute(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.dataplex_v1.types.UpdateDataAttributeRequest, dict]]):
    ...
    async def delete_data_attribute(
        self,
    ...
    async def list_data_attributes(
        ...
        *,
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDataAttributesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    async def __aenter__(self) -> "DataTaxonomyServiceAsyncClient":
        return self
