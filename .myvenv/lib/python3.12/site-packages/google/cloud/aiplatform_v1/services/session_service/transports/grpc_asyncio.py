...
class SessionServiceGrpcAsyncIOTransport(SessionServiceTransport):
    ...
    def create_session(
        ...
        [session_service.CreateSessionRequest], Awaitable[operations_pb2.Operation]
    ]:
        ...
        if "create_session" not in self._stubs:
            self._stubs["create_session"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.CreateSessionRequest.serialize,
    ...
    def get_session(
        self,
    ) -> Callable[[session_service.GetSessionRequest], Awaitable[session.Session]]:
        ...
        if "get_session" not in self._stubs:
            self._stubs["get_session"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.GetSessionRequest.serialize,
    ...
    def list_sessions(
        ...
        Awaitable[session_service.ListSessionsResponse],
    ]:
        r"""Return a callable for the list sessions method over gRPC.

        Lists [Sessions][google.cloud.aiplatform.v1.Session] in a given
        reasoning engine.
        ...
        if "list_sessions" not in self._stubs:
            self._stubs["list_sessions"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.ListSessionsRequest.serialize,
                response_deserializer=session_service.ListSessionsResponse.deserialize,
            )
    ...
    def update_session(
        ...
        [session_service.UpdateSessionRequest], Awaitable[gca_session.Session]
    ]:
        ...
        if "update_session" not in self._stubs:
            self._stubs["update_session"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.UpdateSessionRequest.serialize,
                response_deserializer=gca_session.Session.deserialize,
            )
    ...
    def delete_session(
        ...
        [session_service.DeleteSessionRequest], Awaitable[operations_pb2.Operation]
    ]:
        ...
        if "delete_session" not in self._stubs:
            self._stubs["delete_session"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.DeleteSessionRequest.serialize,
                response_deserializer=operations_pb2.Operation.FromString,
            )
    ...
    def list_events(
        ...
        Awaitable[session_service.ListEventsResponse],
    ]:
        ...
        if "list_events" not in self._stubs:
            self._stubs["list_events"] = self._logged_channel.unary_unary(
                ...
                request_serializer=session_service.ListEventsRequest.serialize,
                response_deserializer=session_service.ListEventsResponse.deserialize,
            )
    ...
    def append_event(
        ...
        Awaitable[session_service.AppendEventResponse],
    ]:
        r"""Return a callable for the append event method over gRPC.

        Appends an event to a given session.

        Returns:
            Callable[[~.AppendEventRequest],
                    Awaitable[~.AppendEventResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "append_event" not in self._stubs:
            self._stubs["append_event"] = self._logged_channel.unary_unary(
                "/google.cloud.aiplatform.v1.SessionService/AppendEvent",
                request_serializer=session_service.AppendEventRequest.serialize,
                response_deserializer=session_service.AppendEventResponse.deserialize,
            )
        return self._stubs["append_event"]
...
__all__ = ("SessionServiceGrpcAsyncIOTransport",)
