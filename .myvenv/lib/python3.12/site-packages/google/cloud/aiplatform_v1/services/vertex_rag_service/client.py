...
from google.cloud.aiplatform_v1.types import tool, vertex_rag_service
from google.cloud.location import locations_pb2  # type: ignore
from google.iam.v1 import iam_policy_pb2  # type: ignore
from google.iam.v1 import policy_pb2  # type: ignore
from google.longrunning import operations_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, VertexRagServiceTransport
...
try:
    from .transports.rest_asyncio import AsyncVertexRagServiceRestTransport
...
class VertexRagServiceClient(metaclass=VertexRagServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = VertexRagServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.VertexRagServiceClient`.",
                    extra=(
                        {
    ...
    def retrieve_contexts(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.RetrieveContextsRequest, dict]):
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_augment_prompt():
                ...
                # Make the request
                response = client.augment_prompt(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1.types.AugmentPromptRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.augment_prompt]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_corroborate_content():
                ...
                # Make the request
                response = client.corroborate_content(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1.types.CorroborateContentRequest, dict]):
                The request object. Request message for
                CorroborateContent.
            parent (str):
                Required. The resource name of the Location from which
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.corroborate_content]
    ...
    def ask_contexts(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.AskContextsRequest, dict]):
        ...
        Returns:
            google.cloud.aiplatform_v1.types.AskContextsResponse:
                Response message for
                   [VertexRagService.AskContexts][google.cloud.aiplatform.v1.VertexRagService.AskContexts].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.ask_contexts]
    ...
    def async_retrieve_contexts(
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_async_retrieve_contexts():
                # Create a client
                client = aiplatform_v1.VertexRagServiceClient()
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.AsyncRetrieveContextsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.aiplatform_v1.types.AsyncRetrieveContextsResponse` Response message for
                   [VertexRagService.AsyncRetrieveContexts][google.cloud.aiplatform.v1.VertexRagService.AsyncRetrieveContexts].
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.async_retrieve_contexts]
