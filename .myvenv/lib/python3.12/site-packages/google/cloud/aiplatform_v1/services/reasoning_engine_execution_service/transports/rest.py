        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineExecutionServiceClient.query_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineExecutionService",
                        "rpcName": "QueryReasoningEngine",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineExecutionServiceClient.stream_query_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineExecutionService",
                        "rpcName": "StreamQueryReasoningEngine",
                        "metadata": http_response["headers"],
