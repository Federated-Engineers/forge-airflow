...
class ListRagCorporaPager:
    ...
    :class:`google.cloud.aiplatform_v1.types.ListRagCorporaResponse` object, and
    ...
    All the usual :class:`google.cloud.aiplatform_v1.types.ListRagCorporaResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1.types.ListRagCorporaRequest):
                The initial request object.
            response (google.cloud.aiplatform_v1.types.ListRagCorporaResponse):
...
class ListRagFilesPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.aiplatform_v1.types.ListRagFilesResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ``rag_files`` field.
    ...
    All the usual :class:`google.cloud.aiplatform_v1.types.ListRagFilesResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.aiplatform_v1.types.ListRagFilesRequest):
                The initial request object.
            response (google.cloud.aiplatform_v1.types.ListRagFilesResponse):
                The initial response object.
            retry (google.api_core.retry.Retry): Designation of what errors,
                if any, should be retried.
            timeout (float): The timeout for this request.
