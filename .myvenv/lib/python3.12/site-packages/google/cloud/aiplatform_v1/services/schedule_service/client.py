...
from .transports.base import DEFAULT_CLIENT_INFO, ScheduleServiceTransport
...
class ScheduleServiceClient(metaclass=ScheduleServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ScheduleServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.ScheduleServiceClient`.",
                    extra=(
                        {
    ...
    def create_schedule(
        ...
        *,
        ...
        flattened_params = [parent, schedule]
    ...
    def resume_schedule(
        ...
        *,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [name, catch_up]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
