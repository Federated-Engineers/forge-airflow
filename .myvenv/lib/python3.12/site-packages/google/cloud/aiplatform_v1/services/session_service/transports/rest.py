        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.append_event",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "AppendEvent",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.create_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "CreateSession",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.delete_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "DeleteSession",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.get_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetSession",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.list_events",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListEvents",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.list_sessions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListSessions",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceClient.update_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "UpdateSession",
                        "metadata": http_response["headers"],
