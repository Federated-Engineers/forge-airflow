...
class ReasoningEngineServiceAsyncClient:
    ...
    get_transport_class = ReasoningEngineServiceClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1.ReasoningEngineServiceAsyncClient`.",
                extra=(
                    {
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_reasoning_engine():
                # Create a client
                client = aiplatform_v1.ReasoningEngineServiceAsyncClient()

                # Initialize request argument(s)
                reasoning_engine = aiplatform_v1.ReasoningEngine()
                reasoning_engine.display_name = "display_name_value"

                request = aiplatform_v1.CreateReasoningEngineRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.CreateReasoningEngineRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            reasoning_engine (:class:`google.cloud.aiplatform_v1.types.ReasoningEngine`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.aiplatform_v1.types.ReasoningEngine` ReasoningEngine provides a customizable runtime for models to determine
        ...
        flattened_params = [parent, reasoning_engine]
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_reasoning_engine():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.GetReasoningEngineRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.GetReasoningEngineRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.types.ReasoningEngine:
    ...
    async def list_reasoning_engines(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ListReasoningEnginesRequest, dict]]):
                The request object. Request message for
    ...
    async def update_reasoning_engine(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.UpdateReasoningEngineRequest, dict]]):
                The request object. Request message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [reasoning_engine, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    async def delete_reasoning_engine(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.DeleteReasoningEngineRequest, dict]]):
                The request object. Request message for
