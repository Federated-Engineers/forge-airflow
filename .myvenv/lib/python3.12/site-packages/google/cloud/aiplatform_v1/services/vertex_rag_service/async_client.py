...
class VertexRagServiceAsyncClient:
    ...
    async def ask_contexts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.AskContextsRequest, dict]]):
    ...
    async def async_retrieve_contexts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.AsyncRetrieveContextsRequest, dict]]):
                The request object. Request message for
