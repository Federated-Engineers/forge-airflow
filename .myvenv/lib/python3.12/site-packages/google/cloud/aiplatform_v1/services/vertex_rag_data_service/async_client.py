...
class VertexRagDataServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1.VertexRagDataServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def create_rag_corpus(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.CreateRagCorpusRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            rag_corpus (:class:`google.cloud.aiplatform_v1.types.RagCorpus`):
    ...
    async def update_rag_corpus(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.UpdateRagCorpusRequest, dict]]):
                The request object. Request message for
    ...
    async def get_rag_corpus(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.GetRagCorpusRequest, dict]]):
                The request object. Request message for
    ...
    async def list_rag_corpora(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ListRagCorporaRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_rag_corpus(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.DeleteRagCorpusRequest, dict]]):
                The request object. Request message for
    ...
    async def upload_rag_file(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.UploadRagFileRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            rag_file (:class:`google.cloud.aiplatform_v1.types.RagFile`):
                Required. The RagFile to upload.
                This corresponds to the ``rag_file`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            upload_rag_file_config (:class:`google.cloud.aiplatform_v1.types.UploadRagFileConfig`):
    ...
    async def import_rag_files(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ImportRagFilesRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            import_rag_files_config (:class:`google.cloud.aiplatform_v1.types.ImportRagFilesConfig`):
    ...
    async def get_rag_file(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.GetRagFileRequest, dict]]):
                The request object. Request message for
    ...
    async def list_rag_files(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ListRagFilesRequest, dict]]):
                The request object. Request message for
    ...
    async def delete_rag_file(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.DeleteRagFileRequest, dict]]):
                The request object. Request message for
