    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomVertexRagServiceInterceptor(VertexRagServiceRestInterceptor):
            def pre_ask_contexts(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_ask_contexts(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_async_retrieve_contexts(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_async_retrieve_contexts(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def post_ask_contexts_with_metadata(
        self,
    ...
    def pre_async_retrieve_contexts(
        self,
    ...
    def post_async_retrieve_contexts(
    ...
    def post_async_retrieve_contexts_with_metadata(
        self,
...
class VertexRagServiceRestTransport(_BaseVertexRagServiceRestTransport):
    ...
    class _AskContexts(
        _BaseVertexRagServiceRestTransport._BaseAskContexts, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.AskContexts")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_ask_contexts(request, metadata)
            ...
            # Send the request
            response = VertexRagServiceRestTransport._AskContexts._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_ask_contexts(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_ask_contexts_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceClient.ask_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AskContexts",
    ...
    class _AsyncRetrieveContexts(
        ...
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.AsyncRetrieveContexts")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_async_retrieve_contexts(
                request, metadata
            )
            ...
            # Send the request
            response = (
                VertexRagServiceRestTransport._AsyncRetrieveContexts._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            resp = self._interceptor.post_async_retrieve_contexts(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_async_retrieve_contexts_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceClient.async_retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AsyncRetrieveContexts",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceClient.augment_prompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AugmentPrompt",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceClient.corroborate_content",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "CorroborateContent",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceClient.retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "RetrieveContexts",
                        "metadata": http_response["headers"],
