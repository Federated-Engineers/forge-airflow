...
from google.cloud.aiplatform_v1.types import encryption_spec, io
...
try:
    from .transports.rest_asyncio import AsyncVertexRagDataServiceRestTransport
...
class VertexRagDataServiceClient(metaclass=VertexRagDataServiceClientMeta):
    ...
    def rag_engine_config_path(
        ...
        return "projects/{project}/locations/{location}/ragEngineConfig".format(
            project=project,
            location=location,
        )

    @staticmethod
    def parse_rag_engine_config_path(path: str) -> Dict[str, str]:
        """Parses a rag_engine_config path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/ragEngineConfig$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = VertexRagDataServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.VertexRagDataServiceClient`.",
                    extra=(
                        {
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_rag_corpus():
                # Create a client
                client = aiplatform_v1.VertexRagDataServiceClient()

                # Initialize request argument(s)
                rag_corpus = aiplatform_v1.RagCorpus()
                rag_corpus.display_name = "display_name_value"

                request = aiplatform_v1.CreateRagCorpusRequest(
                    parent="parent_value",
                    rag_corpus=rag_corpus,
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.CreateRagCorpusRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            rag_corpus (google.cloud.aiplatform_v1.types.RagCorpus):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.aiplatform_v1.types.RagCorpus` A RagCorpus is a RagFile container and a project can have multiple
                   RagCorpora.
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_rag_corpus():
                ...
                request = aiplatform_v1.UpdateRagCorpusRequest(
                    rag_corpus=rag_corpus,
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.UpdateRagCorpusRequest, dict]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_rag_corpus():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.GetRagCorpusRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetRagCorpusRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.types.RagCorpus:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_rag_corpora():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.ListRagCorporaRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListRagCorporaRequest, dict]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_rag_corpus():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.DeleteRagCorpusRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.DeleteRagCorpusRequest, dict]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_upload_rag_file():
                ...
                request = aiplatform_v1.UploadRagFileRequest(
                    parent="parent_value",
                    rag_file=rag_file,
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.UploadRagFileRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            rag_file (google.cloud.aiplatform_v1.types.RagFile):
                Required. The RagFile to upload.
                This corresponds to the ``rag_file`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            upload_rag_file_config (google.cloud.aiplatform_v1.types.UploadRagFileConfig):
        ...
        Returns:
            google.cloud.aiplatform_v1.types.UploadRagFileResponse:
                Response message for
                   [VertexRagDataService.UploadRagFile][google.cloud.aiplatform.v1.VertexRagDataService.UploadRagFile].
    ...
    def import_rag_files(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ImportRagFilesRequest, dict]):
                The request object. Request message for
            ...
            parent (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            import_rag_files_config (google.cloud.aiplatform_v1.types.ImportRagFilesConfig):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`google.cloud.aiplatform_v1.types.ImportRagFilesResponse` Response message for
                   [VertexRagDataService.ImportRagFiles][google.cloud.aiplatform.v1.VertexRagDataService.ImportRagFiles].
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_rag_file():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.GetRagFileRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetRagFileRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.types.RagFile:
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_list_rag_files():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.ListRagFilesRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListRagFilesRequest, dict]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_delete_rag_file():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.DeleteRagFileRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.DeleteRagFileRequest, dict]):
                The request object. Request message for
    ...
    def update_rag_engine_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.UpdateRagEngineConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_rag_engine_config]
    ...
    def get_rag_engine_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetRagEngineConfigRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_rag_engine_config]
