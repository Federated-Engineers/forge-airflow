    ...
    class _BaseCreateRagCorpus:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/ragCorpora",
                    "body": "rag_corpus",
                },
            ]
            return http_options
    ...
    class _BaseDeleteRagCorpus:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/ragCorpora/*}",
                },
            ]
            return http_options
    ...
    class _BaseDeleteRagFile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1/{name=projects/*/locations/*/ragCorpora/*/ragFiles/*}",
                },
            ]
            return http_options
    ...
    class _BaseGetRagEngineConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/ragEngineConfig}",
                },
            ]
            return http_options
    ...
    class _BaseImportRagFiles:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:import",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseListRagFiles:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles",
                },
            ]
            return http_options
    ...
    class _BaseUpdateRagCorpus:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{rag_corpus.name=projects/*/locations/*/ragCorpora/*}",
                    "body": "rag_corpus",
                },
            ]
            return http_options
    ...
    class _BaseUpdateRagEngineConfig:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1/{rag_engine_config.name=projects/*/locations/*/ragEngineConfig}",
    ...
    class _BaseUploadRagFile:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*/ragCorpora/*}/ragFiles:upload",
                    "body": "*",
                },
            ]
            return http_options
