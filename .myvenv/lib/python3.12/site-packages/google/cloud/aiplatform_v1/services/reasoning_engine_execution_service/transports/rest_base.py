...
from .base import DEFAULT_CLIENT_INFO, ReasoningEngineExecutionServiceTransport
    ...
    class _BaseQueryReasoningEngine:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/reasoningEngines/*}:query",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseStreamQueryReasoningEngine:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/reasoningEngines/*}:streamQuery",
                    "body": "*",
                },
            ]
            return http_options
