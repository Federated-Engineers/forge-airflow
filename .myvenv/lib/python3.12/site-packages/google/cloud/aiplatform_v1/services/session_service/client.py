...
class SessionServiceClient(metaclass=SessionServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1.SessionServiceClient`.",
                    extra=(
                        {
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_session():
                # Create a client
                client = aiplatform_v1.SessionServiceClient()
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.CreateSessionRequest, dict]):
            ...
            parent (str):
                ...
                should not be set.
            session (google.cloud.aiplatform_v1.types.Session):
    ...
    def get_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.GetSessionRequest, dict]):
                The request object. Request message for
    ...
    def list_sessions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListSessionsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.services.session_service.pagers.ListSessionsPager:
    ...
    def update_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.UpdateSessionRequest, dict]):
                The request object. Request message for
    ...
    def delete_session(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.DeleteSessionRequest, dict]):
                The request object. Request message for
    ...
    def list_events(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ListEventsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.services.session_service.pagers.ListEventsPager:
                Response message for
                   [SessionService.ListEvents][google.cloud.aiplatform.v1.SessionService.ListEvents].
    ...
    def append_event(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.AppendEventRequest, dict]):
                The request object. Request message for
            ...
            name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            event (google.cloud.aiplatform_v1.types.SessionEvent):
