...
class _BaseVertexRagServiceRestTransport(VertexRagServiceTransport):
    ...
    class _BaseAskContexts:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}:askContexts",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = vertex_rag_service.AskContextsRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseVertexRagServiceRestTransport._BaseAskContexts._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseAsyncRetrieveContexts:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}:asyncRetrieveContexts",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = vertex_rag_service.AsyncRetrieveContextsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseAugmentPrompt:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}:augmentPrompt",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseCorroborateContent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}:corroborateContent",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseRetrieveContexts:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}:retrieveContexts",
                    "body": "*",
                },
            ]
            return http_options
