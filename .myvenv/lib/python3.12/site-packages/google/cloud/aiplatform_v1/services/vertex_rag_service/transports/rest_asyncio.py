    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomVertexRagServiceInterceptor(VertexRagServiceRestInterceptor):
            async def pre_ask_contexts(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_ask_contexts(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_async_retrieve_contexts(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_async_retrieve_contexts(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    async def pre_ask_contexts(
        self,
        request: vertex_rag_service.AskContextsRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        vertex_rag_service.AskContextsRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for ask_contexts
    ...
    async def post_ask_contexts(
        self, response: vertex_rag_service.AskContextsResponse
    ) -> vertex_rag_service.AskContextsResponse:
        """Post-rpc interceptor for ask_contexts

        DEPRECATED. Please use the `post_ask_contexts_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the VertexRagService server but before
        it is returned to user code. This `post_ask_contexts` interceptor runs
        before the `post_ask_contexts_with_metadata` interceptor.
        """
        return response

    async def post_ask_contexts_with_metadata(
        self,
        response: vertex_rag_service.AskContextsResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        vertex_rag_service.AskContextsResponse, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Post-rpc interceptor for ask_contexts
        ...
        We recommend only using this `post_ask_contexts_with_metadata`
        interceptor in new development instead of the `post_ask_contexts` interceptor.
        When both interceptors are used, this `post_ask_contexts_with_metadata` interceptor runs after the
        `post_ask_contexts` interceptor. The (possibly modified) response returned by
        `post_ask_contexts` will be passed to
        `post_ask_contexts_with_metadata`.
        """
        return response, metadata

    async def pre_async_retrieve_contexts(
        self,
        request: vertex_rag_service.AsyncRetrieveContextsRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        vertex_rag_service.AsyncRetrieveContextsRequest,
        Sequence[Tuple[str, Union[str, bytes]]],
    ]:
        """Pre-rpc interceptor for async_retrieve_contexts
    ...
    async def post_async_retrieve_contexts(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for async_retrieve_contexts

        DEPRECATED. Please use the `post_async_retrieve_contexts_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the VertexRagService server but before
        it is returned to user code. This `post_async_retrieve_contexts` interceptor runs
        before the `post_async_retrieve_contexts_with_metadata` interceptor.
        """
        return response

    async def post_async_retrieve_contexts_with_metadata(
        self,
        ...
        We recommend only using this `post_async_retrieve_contexts_with_metadata`
        interceptor in new development instead of the `post_async_retrieve_contexts` interceptor.
        When both interceptors are used, this `post_async_retrieve_contexts_with_metadata` interceptor runs after the
        `post_async_retrieve_contexts` interceptor. The (possibly modified) response returned by
        `post_async_retrieve_contexts` will be passed to
        `post_async_retrieve_contexts_with_metadata`.
        """
        return response, metadata
    ...
    async def post_augment_prompt_with_metadata(
        self,
    ...
    async def post_corroborate_content_with_metadata(
        self,
    ...
    async def post_retrieve_contexts_with_metadata(
        self,
...
class AsyncVertexRagServiceRestTransport(_BaseVertexRagServiceRestTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.ask_contexts: self._wrap_method(
                self.ask_contexts,
                default_timeout=None,
                client_info=client_info,
            ),
            self.async_retrieve_contexts: self._wrap_method(
    ...
    class _AskContexts(
        _BaseVertexRagServiceRestTransport._BaseAskContexts,
        AsyncVertexRagServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncVertexRagServiceRestTransport.AskContexts")
        ...
        async def __call__(
            ...
            *,
            ...
            r"""Call the ask contexts method over HTTP.
            ...
            http_options = (
                _BaseVertexRagServiceRestTransport._BaseAskContexts._get_http_options()
            )

            request, metadata = await self._interceptor.pre_ask_contexts(
                request, metadata
            )
            transcoded_request = _BaseVertexRagServiceRestTransport._BaseAskContexts._get_transcoded_request(
                http_options, request
            )

            body = _BaseVertexRagServiceRestTransport._BaseAskContexts._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseVertexRagServiceRestTransport._BaseAskContexts._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.AskContexts",
                    extra={
            ...
            # Send the request
            response = (
                await AsyncVertexRagServiceRestTransport._AskContexts._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            # Return the response
            resp = vertex_rag_service.AskContextsResponse()
            pb_resp = vertex_rag_service.AskContextsResponse.pb(resp)
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_ask_contexts(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_ask_contexts_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = vertex_rag_service.AskContextsResponse.to_json(
                        response
                    )
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.ask_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AskContexts",
    ...
    class _AsyncRetrieveContexts(
        _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts,
        AsyncVertexRagServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncVertexRagServiceRestTransport.AsyncRetrieveContexts")
        ...
        async def __call__(
            ...
            *,
            ...
            r"""Call the async retrieve contexts method over HTTP.
            ...
            http_options = (
                _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts._get_http_options()
            )

            request, metadata = await self._interceptor.pre_async_retrieve_contexts(
                request, metadata
            )
            transcoded_request = _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts._get_transcoded_request(
                http_options, request
            )

            body = _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseVertexRagServiceRestTransport._BaseAsyncRetrieveContexts._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.AsyncRetrieveContexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AsyncRetrieveContexts",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = await AsyncVertexRagServiceRestTransport._AsyncRetrieveContexts._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_async_retrieve_contexts(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = (
                await self._interceptor.post_async_retrieve_contexts_with_metadata(
                    resp, response_metadata
                )
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.async_retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AsyncRetrieveContexts",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.AugmentPrompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_augment_prompt_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.augment_prompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "AugmentPrompt",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.CorroborateContent",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_corroborate_content_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.corroborate_content",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "CorroborateContent",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.RetrieveContexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_retrieve_contexts_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "RetrieveContexts",
                        "metadata": http_response["headers"],
    ...
    def ask_contexts(
        ...
        [vertex_rag_service.AskContextsRequest], vertex_rag_service.AskContextsResponse
    ]:
        return self._AskContexts(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def async_retrieve_contexts(
        self,
    ) -> Callable[
        [vertex_rag_service.AsyncRetrieveContextsRequest], operations_pb2.Operation
    ]:
        return self._AsyncRetrieveContexts(self._session, self._host, self._interceptor)  # type: ignore
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.VertexRagServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.VertexRagServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.VertexRagService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
