...
from google.cloud.aiplatform_v1.types import session
from google.cloud.aiplatform_v1.types import session as gca_session
from google.cloud.aiplatform_v1.types import session_service
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.AppendEvent",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "AppendEvent",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.append_event",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "AppendEvent",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.CreateSession",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.create_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "CreateSession",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.DeleteSession",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.delete_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "DeleteSession",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.GetSession",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetSession",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.get_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetSession",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.ListEvents",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListEvents",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.list_events",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListEvents",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.ListSessions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.list_sessions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListSessions",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.UpdateSession",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.update_session",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "UpdateSession",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.SessionServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SessionServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SessionService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
