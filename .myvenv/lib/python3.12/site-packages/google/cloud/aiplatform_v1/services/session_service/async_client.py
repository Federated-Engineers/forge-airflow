...
from google.cloud.aiplatform_v1.services.session_service import pagers
...
class SessionServiceAsyncClient:
    ...
    parse_session_event_path = staticmethod(
        SessionServiceClient.parse_session_event_path
    )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1.SessionServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def create_session(
        ...
        *,
        ...
        r"""Creates a new [Session][google.cloud.aiplatform.v1.Session].
        ...
        .. code-block:: python
            ...
            async def sample_create_session():
                # Create a client
                client = aiplatform_v1.SessionServiceAsyncClient()

                # Initialize request argument(s)
                session = aiplatform_v1.Session()
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.CreateSessionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            session (:class:`google.cloud.aiplatform_v1.types.Session`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.aiplatform_v1.types.Session` A
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_session():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.GetSessionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.GetSessionRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.types.Session:
    ...
    async def list_sessions(
        ...
        *,
        ...
        r"""Lists [Sessions][google.cloud.aiplatform.v1.Session] in a given
        reasoning engine.
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ListSessionsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.services.session_service.pagers.ListSessionsAsyncPager:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_update_session():
                ...
                request = aiplatform_v1.UpdateSessionRequest(
                    session=session,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.UpdateSessionRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_delete_session():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.DeleteSessionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.DeleteSessionRequest, dict]]):
                The request object. Request message for
    ...
    async def list_events(
        ...
        *,
        ...
        r"""Lists [Events][google.cloud.aiplatform.v1.Event] in a given
        session.
        ...
        .. code-block:: python
            ...
            async def sample_list_events():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.ListEventsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.ListEventsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1.services.session_service.pagers.ListEventsAsyncPager:
                Response message for
                   [SessionService.ListEvents][google.cloud.aiplatform.v1.SessionService.ListEvents].
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_append_event():
                ...
                # Initialize request argument(s)
                event = aiplatform_v1.SessionEvent()
                event.author = "author_value"
                event.invocation_id = "invocation_id_value"

                request = aiplatform_v1.AppendEventRequest(
                    name="name_value",
                    event=event,
                )

                # Make the request
                response = await client.append_event(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.AppendEventRequest, dict]]):
                The request object. Request message for
            ...
            name (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            event (:class:`google.cloud.aiplatform_v1.types.SessionEvent`):
        ...
        Returns:
            google.cloud.aiplatform_v1.types.AppendEventResponse:
                Response message for
                   [SessionService.AppendEvent][google.cloud.aiplatform.v1.SessionService.AppendEvent].
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.append_event
        ]
