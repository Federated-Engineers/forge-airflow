...
from google.cloud.aiplatform_v1.types import model_evaluation_slice, operation
...
class ListModelVersionCheckpointsResponse(proto.Message):
    ...
    Attributes:
        checkpoints (MutableSequence[google.cloud.aiplatform_v1.types.ModelVersionCheckpoint]):
