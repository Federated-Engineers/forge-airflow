...
from google.cloud.aiplatform_v1.types import operation, vertex_rag_data
...
class ListRagCorporaResponse(proto.Message):
    ...
    Attributes:
        rag_corpora (MutableSequence[google.cloud.aiplatform_v1.types.RagCorpus]):
...
class ListRagFilesResponse(proto.Message):
    ...
    Attributes:
        rag_files (MutableSequence[google.cloud.aiplatform_v1.types.RagFile]):
