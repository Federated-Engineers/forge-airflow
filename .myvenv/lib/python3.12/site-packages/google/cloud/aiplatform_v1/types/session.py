...
class SessionEvent(proto.Message):
    ...
    Attributes:
        ...
        actions (google.cloud.aiplatform_v1.types.EventActions):
        ...
        error_message (str):
            ...
            error.
        event_metadata (google.cloud.aiplatform_v1.types.EventMetadata):
...
class EventMetadata(proto.Message):
    ...
    Attributes:
        ...
        input_transcription (google.cloud.aiplatform_v1.types.Transcription):
            Optional. Audio transcription of user input.
        output_transcription (google.cloud.aiplatform_v1.types.Transcription):
