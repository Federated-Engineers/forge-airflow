...
from .types.cloud_redis import (CreateInstanceRequest, DeleteInstanceRequest,
                                ExportInstanceRequest, FailoverInstanceRequest,
                                GcsDestination, GcsSource,
                                GetInstanceAuthStringRequest,
                                GetInstanceRequest, ImportInstanceRequest,
                                InputConfig, Instance, InstanceAuthString,
                                ListInstancesRequest, ListInstancesResponse,
                                LocationMetadata, MaintenancePolicy,
                                MaintenanceSchedule, NodeInfo,
                                OperationMetadata, OutputConfig,
                                PersistenceConfig,
