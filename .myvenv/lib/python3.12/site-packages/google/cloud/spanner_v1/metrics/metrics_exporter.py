...
from google.api.distribution_pb2 import \
    Distribution  # pylint: disable=no-name-in-module
# pylint: disable=no-name-in-module
from google.api.metric_pb2 import \
    Metric as GMetric  # pylint: disable=no-name-in-module
from google.api.metric_pb2 import MetricDescriptor
from google.api.monitored_resource_pb2 import \
    MonitoredResource  # pylint: disable=no-name-in-module
...
from .constants import (BUILT_IN_METRICS_METER_NAME, METRIC_LABELS,
                        METRIC_NAMES, MONITORED_RESOURCE_LABELS,
                        NATIVE_METRICS_PREFIX, SPANNER_RESOURCE_TYPE)

try:
    from google.cloud.monitoring_v3 import (CreateTimeSeriesRequest,
                                            MetricServiceClient, Point,
                                            TimeInterval, TimeSeries,
                                            TypedValue)
    from google.cloud.monitoring_v3.services.metric_service.transports.grpc import \
        MetricServiceGrpcTransport
    from opentelemetry.sdk.metrics.export import (Gauge, Histogram,
                                                  HistogramDataPoint, Metric,
                                                  MetricExporter,
                                                  MetricExportResult,
                                                  MetricsData, NumberDataPoint,
                                                  Sum)
