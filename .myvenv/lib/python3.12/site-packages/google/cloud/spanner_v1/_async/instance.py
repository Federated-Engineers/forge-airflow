...
from google.cloud.spanner_admin_database_v1 import (
    DatabaseDialect, ListBackupOperationsRequest, ListBackupsRequest,
    ListDatabaseOperationsRequest, ListDatabasesRequest)
from google.cloud.spanner_admin_database_v1.types import (
    backup, spanner_database_admin)
...
if CrossSync.is_async:
    from google.cloud.spanner_v1._async.testing.database_test import \
        TestDatabase
else:
