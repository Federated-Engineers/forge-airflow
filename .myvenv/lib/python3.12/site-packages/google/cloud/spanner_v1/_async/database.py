...
from google.cloud.spanner_admin_database_v1 import (
    EncryptionConfig, ListDatabaseRolesRequest,
...
from google.cloud.spanner_v1._async.database_sessions_manager import (
    DatabaseSessionsManager, TransactionType)
...
from google.cloud.spanner_v1._helpers import (
    _augment_errors_with_request_id, _merge_query_options,
    _metadata_with_leader_aware_routing, _metadata_with_prefix,
    _metadata_with_request_id, _metadata_with_request_id_and_req_id)
...
from google.cloud.spanner_v1._opentelemetry_tracing import (add_span_event,
                                                            get_current_span,
                                                            trace_call)
        ...
        if self._spanner_api is None:
            ...
            if self._experimental_host is not None:
                from google.cloud.spanner_v1._async._helpers import \
                    _create_experimental_host_transport as \
                    _create_experimental_host_transport_async
                from google.cloud.spanner_v1._helpers import \
                    _create_experimental_host_transport as \
                    _create_experimental_host_transport_sync
