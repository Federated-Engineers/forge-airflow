...
class ListClustersResponse(proto.Message):
    ...
    Attributes:
        clusters (MutableSequence[google.cloud.alloydb_v1beta.types.Cluster]):
            The list of Cluster
        next_page_token (str):
            A token identifying a page of results the
            server should return.
...
class UpgradeClusterRequest(proto.Message):
    ...
    Attributes:
        name (str):
            Required. The resource name of the cluster.
        version (google.cloud.alloydb_v1beta.types.DatabaseVersion):
...
class UpgradeClusterResponse(proto.Message):
    ...
    Attributes:
        ...
        cluster_upgrade_details (MutableSequence[google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.ClusterUpgradeDetails]):
    ...
    class StageInfo(proto.Message):
        ...
        Attributes:
            stage (google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.Stage):
                The stage.
            status (google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.Status):
                Status of the stage.
            logs_url (str):
    ...
    class InstanceUpgradeDetails(proto.Message):
        ...
        Attributes:
            ...
            upgrade_status (google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.Status):
    ...
    class ClusterUpgradeDetails(proto.Message):
        ...
        Attributes:
            ...
            cluster_type (google.cloud.alloydb_v1beta.types.Cluster.ClusterType):
            ...
            database_version (google.cloud.alloydb_v1beta.types.DatabaseVersion):
                ...
                operation.
            stage_info (MutableSequence[google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.StageInfo]):
                Array containing stage info associated with
                this cluster.
            instance_upgrade_details (MutableSequence[google.cloud.alloydb_v1beta.types.UpgradeClusterResponse.InstanceUpgradeDetails]):
...
class RestoreClusterRequest(proto.Message):
    ...
    Attributes:
        backup_source (google.cloud.alloydb_v1beta.types.BackupSource):
            Backup source.

            This field is a member of `oneof`_ ``source``.
        continuous_backup_source (google.cloud.alloydb_v1beta.types.ContinuousBackupSource):
...
class ListInstancesResponse(proto.Message):
    ...
    Attributes:
        instances (MutableSequence[google.cloud.alloydb_v1beta.types.Instance]):
...
class GetInstanceRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            required format, see the comment on the
            Instance.name field.
        view (google.cloud.alloydb_v1beta.types.InstanceView):
...
class CreateInstanceRequests(proto.Message):
    ...
    Attributes:
        create_instance_requests (MutableSequence[google.cloud.alloydb_v1beta.types.CreateInstanceRequest]):
...
class BatchCreateInstancesRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            Required. The name of the parent resource.
        requests (google.cloud.alloydb_v1beta.types.CreateInstanceRequests):
...
class BatchCreateInstanceStatus(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.alloydb_v1beta.types.Instance.InstanceType):
...
class ExecuteSqlResponse(proto.Message):
    ...
    Attributes:
        sql_results (MutableSequence[google.cloud.alloydb_v1beta.types.SqlResult]):
            SqlResult represents the results for the
            execution of sql statements.
        metadata (google.cloud.alloydb_v1beta.types.ExecuteSqlMetadata):
...
class ExecuteSqlMetadata(proto.Message):
    ...
    Attributes:
        ...
        sql_statement_execution_duration (google.protobuf.duration_pb2.Duration):
            ...
            statement.
        status (google.cloud.alloydb_v1beta.types.ExecuteSqlMetadata.Status):
...
class ListBackupsResponse(proto.Message):
    ...
    Attributes:
        backups (MutableSequence[google.cloud.alloydb_v1beta.types.Backup]):
            The list of Backup
        next_page_token (str):
            A token identifying a page of results the
            server should return.
...
class ListSupportedDatabaseFlagsResponse(proto.Message):
    ...
    Attributes:
        supported_database_flags (MutableSequence[google.cloud.alloydb_v1beta.types.SupportedDatabaseFlag]):
...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        batch_create_instances_metadata (google.cloud.alloydb_v1beta.types.BatchCreateInstancesMetadata):
            Output only. BatchCreateInstances related
            metadata.

            This field is a member of `oneof`_ ``request_specific``.
        promote_cluster_status (google.cloud.alloydb_v1beta.types.PromoteClusterStatus):
            Output only. PromoteClusterStatus related
            metadata.

            This field is a member of `oneof`_ ``request_specific``.
        upgrade_cluster_status (google.cloud.alloydb_v1beta.types.UpgradeClusterStatus):
...
class UpgradeClusterStatus(proto.Message):
    ...
    Attributes:
        ...
        source_version (google.cloud.alloydb_v1beta.types.DatabaseVersion):
            Source database major version.
        target_version (google.cloud.alloydb_v1beta.types.DatabaseVersion):
            Target database major version.
        stages (MutableSequence[google.cloud.alloydb_v1beta.types.UpgradeClusterStatus.StageStatus]):
    ...
    class StageStatus(proto.Message):
        ...
        Attributes:
            read_pool_instances_upgrade (google.cloud.alloydb_v1beta.types.UpgradeClusterStatus.ReadPoolInstancesUpgradeStageStatus):
    ...
    class ReadPoolInstancesUpgradeStageStatus(proto.Message):
        ...
        Attributes:
            upgrade_stats (google.cloud.alloydb_v1beta.types.UpgradeClusterStatus.ReadPoolInstancesUpgradeStageStatus.Stats):
