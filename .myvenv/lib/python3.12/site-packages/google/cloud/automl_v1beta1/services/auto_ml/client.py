...
from google.cloud.automl_v1beta1.types import (model_evaluation, operations,
                                               regression, service)
...
from google.cloud.automl_v1beta1.types import (tables, text, text_extraction,
                                               text_sentiment, translation,
                                               video)
...
class AutoMlClient(metaclass=AutoMlClientMeta):
    ...
    def parse_column_spec_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/tableSpecs/(?P<table_spec>.+?)/columnSpecs/(?P<column_spec>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_table_spec_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/datasets/(?P<dataset>.+?)/tableSpecs/(?P<table_spec>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AutoMlClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AutoMlClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AutoMlClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = AutoMlClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = AutoMlClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AutoMlTransport)
        if transport_provided:
            ...
            self._transport = cast(AutoMlTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or AutoMlClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.automl_v1beta1.AutoMlClient`.",
                    extra={
    ...
    def export_evaluated_examples(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.export_evaluated_examples
        ]
