    ...
    class _BaseRemoveIamPolicy:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{resource=projects/*/locations/*/services/*/**}:removeIamPolicy",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseRestoreService:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{service=projects/*/locations/*/services/*}:restore",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpdateMetadataImport:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{metadata_import.name=projects/*/locations/*/services/*/metadataImports/*}",
                    "body": "metadata_import",
                },
            ]
            return http_options
    ...
    class _BaseUpdateService:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{service.name=projects/*/locations/*/services/*}",
                    "body": "service",
                },
            ]
            return http_options
...
__all__ = ("_BaseDataprocMetastoreRestTransport",)
