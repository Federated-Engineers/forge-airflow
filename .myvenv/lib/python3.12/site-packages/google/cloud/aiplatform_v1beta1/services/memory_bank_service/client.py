...
from .transports.grpc import MemoryBankServiceGrpcTransport
from .transports.grpc_asyncio import MemoryBankServiceGrpcAsyncIOTransport
from .transports.rest import MemoryBankServiceRestTransport

try:
    from .transports.rest_asyncio import AsyncMemoryBankServiceRestTransport
...
class MemoryBankServiceClientMeta(type):
    """Metaclass for the MemoryBankService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[MemoryBankServiceTransport]]
    ...
    ) -> Type[MemoryBankServiceTransport]:
...
class MemoryBankServiceClient(metaclass=MemoryBankServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            MemoryBankServiceClient: The constructed client.
        """
    ...
    def transport(self) -> MemoryBankServiceTransport:
        ...
        Returns:
            MemoryBankServiceTransport: The transport used by the client
                instance.
        """
    ...
    def memory_path(
        ...
        return "projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/memories/{memory}".format(
            project=project,
            location=location,
    ...
    @staticmethod
    def parse_memory_path(path: str) -> Dict[str, str]:
        """Parses a memory path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/reasoningEngines/(?P<reasoning_engine>.+?)/memories/(?P<memory>.+?)$",
            path,
        )
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = MemoryBankServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = MemoryBankServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = MemoryBankServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = MemoryBankServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = MemoryBankServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, MemoryBankServiceTransport)
        if transport_provided:
            # transport is a MemoryBankServiceTransport instance.
            ...
            self._transport = cast(MemoryBankServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or MemoryBankServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            transport_init: Union[
                ...
                MemoryBankServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., MemoryBankServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.MemoryBankServiceClient`.",
                    extra=(
                        {
    ...
    def create_memory(
        ...
        *,
        ...
        rpc = self._transport._wrapped_methods[self._transport.create_memory]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_memory():
                ...
                # Make the request
                response = client.get_memory(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetMemoryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_memory]
    ...
    def update_memory(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateMemoryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_memory]
    ...
    def list_memories(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListMemoriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_memories]
        ...
        response = pagers.ListMemoriesPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_memory(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.DeleteMemoryRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_memory]
    ...
    def generate_memories(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GenerateMemoriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.generate_memories]
    ...
    def retrieve_memories(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.RetrieveMemoriesRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.retrieve_memories]
    ...
    def __enter__(self) -> "MemoryBankServiceClient":
        return self
...
__all__ = ("MemoryBankServiceClient",)
