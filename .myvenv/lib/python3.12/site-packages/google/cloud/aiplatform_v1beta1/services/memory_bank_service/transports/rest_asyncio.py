...
class AsyncMemoryBankServiceRestInterceptor:
    """Asynchronous Interceptor for MemoryBankService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the AsyncMemoryBankServiceRestTransport.

    .. code-block:: python
        class MyCustomMemoryBankServiceInterceptor(MemoryBankServiceRestInterceptor):
            async def pre_create_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_create_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_delete_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_delete_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_generate_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_generate_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_get_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_get_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_list_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_list_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_retrieve_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_retrieve_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_update_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_update_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = AsyncMemoryBankServiceRestTransport(interceptor=MyCustomMemoryBankServiceInterceptor())
        client = async MemoryBankServiceClient(transport=transport)


    """

    async def pre_create_memory(
        self,
    ...
    async def post_create_memory_with_metadata(
        self,
    ...
    async def post_delete_memory_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def pre_generate_memories(
        self,
    ...
    async def post_generate_memories(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
    ...
    async def post_generate_memories_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_get_memory(self, response: memory_bank.Memory) -> memory_bank.Memory:
    ...
    async def post_get_memory_with_metadata(
        self,
    ...
    async def post_list_memories_with_metadata(
        self,
    ...
    async def pre_retrieve_memories(
        self,
    ...
    async def post_retrieve_memories(
    ...
    async def post_retrieve_memories_with_metadata(
        self,
    ...
    async def post_update_memory_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
...
class AsyncMemoryBankServiceRestStub:
    _session: AsyncAuthorizedSession
    _host: str
    _interceptor: AsyncMemoryBankServiceRestInterceptor


class AsyncMemoryBankServiceRestTransport(_BaseMemoryBankServiceRestTransport):
    """Asynchronous REST backend transport for MemoryBankService.
    ...
    def __init__(
        ...
        *,
        ...
        self._interceptor = interceptor or AsyncMemoryBankServiceRestInterceptor()
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_memory: self._wrap_method(
                self.create_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_memory: self._wrap_method(
                self.get_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_memory: self._wrap_method(
                self.update_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_memories: self._wrap_method(
                self.list_memories,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_memory: self._wrap_method(
                self.delete_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_memories: self._wrap_method(
                self.generate_memories,
                default_timeout=None,
                client_info=client_info,
            ),
            self.retrieve_memories: self._wrap_method(
    ...
    class _CreateMemory(
        ...
        AsyncMemoryBankServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.CreateMemory")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._CreateMemory._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            resp = await self._interceptor.post_create_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_create_memory_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.create_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "CreateMemory",
    ...
    class _DeleteMemory(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.DeleteMemory")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._DeleteMemory._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_delete_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_delete_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.delete_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "DeleteMemory",
                        "metadata": http_response["headers"],
    ...
    class _GenerateMemories(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.GenerateMemories")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncMemoryBankServiceRestTransport._GenerateMemories._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_generate_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_generate_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.generate_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GenerateMemories",
                        "metadata": http_response["headers"],
    ...
    class _GetMemory(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.GetMemory")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._GetMemory._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_get_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.get_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetMemory",
                        "metadata": http_response["headers"],
    ...
    class _ListMemories(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.ListMemories")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._ListMemories._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_list_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.list_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "ListMemories",
                        "metadata": http_response["headers"],
    ...
    class _RetrieveMemories(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.RetrieveMemories")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncMemoryBankServiceRestTransport._RetrieveMemories._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_retrieve_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_retrieve_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.retrieve_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "RetrieveMemories",
                        "metadata": http_response["headers"],
    ...
    class _UpdateMemory(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.UpdateMemory")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._UpdateMemory._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            content = await response.read()
            json_format.Parse(content, pb_resp, ignore_unknown_fields=True)
            resp = await self._interceptor.post_update_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_update_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.update_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "UpdateMemory",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.GetLocation")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._GetLocation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ListLocations(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.ListLocations")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._ListLocations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetIamPolicy(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.GetIamPolicy")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._GetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _SetIamPolicy(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.SetIamPolicy")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._SetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.TestIamPermissions")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncMemoryBankServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.CancelOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncMemoryBankServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.DeleteOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = await AsyncMemoryBankServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetOperation(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.GetOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._GetOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ListOperations(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.ListOperations")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._ListOperations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _WaitOperation(
        ...
        def __hash__(self):
            return hash("AsyncMemoryBankServiceRestTransport.WaitOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                await AsyncMemoryBankServiceRestTransport._WaitOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
