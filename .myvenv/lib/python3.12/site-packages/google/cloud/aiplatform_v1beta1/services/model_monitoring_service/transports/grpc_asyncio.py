...
class ModelMonitoringServiceGrpcAsyncIOTransport(ModelMonitoringServiceTransport):
    """gRPC AsyncIO backend transport for ModelMonitoringService.
    ...
    def get_model_monitor(
        ...
        Awaitable[model_monitor.ModelMonitor],
    ]:
    ...
    def list_model_monitors(
        ...
        Returns:
            Callable[[~.ListModelMonitorsRequest],
                    Awaitable[~.ListModelMonitorsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_model_monitoring_jobs(
        ...
        Returns:
            Callable[[~.ListModelMonitoringJobsRequest],
                    Awaitable[~.ListModelMonitoringJobsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def search_model_monitoring_stats(
        ...
        Returns:
            Callable[[~.SearchModelMonitoringStatsRequest],
                    Awaitable[~.SearchModelMonitoringStatsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def search_model_monitoring_alerts(
        ...
        Returns:
            Callable[[~.SearchModelMonitoringAlertsRequest],
                    Awaitable[~.SearchModelMonitoringAlertsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
