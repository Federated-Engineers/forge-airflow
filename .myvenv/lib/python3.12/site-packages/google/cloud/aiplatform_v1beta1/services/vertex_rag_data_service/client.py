...
class VertexRagDataServiceClient(metaclass=VertexRagDataServiceClientMeta):
    ...
    def update_rag_engine_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateRagEngineConfigRequest, dict]):
                The request object. Request message for
    ...
    def get_rag_engine_config(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetRagEngineConfigRequest, dict]):
                The request object. Request message for
