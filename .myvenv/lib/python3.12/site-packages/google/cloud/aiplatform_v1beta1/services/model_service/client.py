...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ModelServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_recommend_spec():
                ...
                # Make the request
                response = client.recommend_spec(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.RecommendSpecRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.recommend_spec]
