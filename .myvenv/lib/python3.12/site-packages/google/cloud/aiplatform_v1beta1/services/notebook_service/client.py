...
from google.cloud.aiplatform_v1beta1.types import (encryption_spec, job_state,
                                                   machine_resources,
                                                   network_spec,
                                                   notebook_euc_config)
...
from google.cloud.aiplatform_v1beta1.types import (
    notebook_runtime_template_ref, notebook_service, notebook_software_config)
...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.NotebookServiceClient`.",
                    extra=(
                        {
    ...
    def update_notebook_runtime_template(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateNotebookRuntimeTemplateRequest, dict]):
                The request object. Request message for
    ...
    def stop_notebook_runtime(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.StopNotebookRuntimeRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stop_notebook_runtime]
    ...
    def create_notebook_execution_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.CreateNotebookExecutionJobRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.create_notebook_execution_job
        ]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_notebook_execution_job():
                ...
                # Make the request
                response = client.get_notebook_execution_job(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetNotebookExecutionJobRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_notebook_execution_job
        ]
    ...
    def list_notebook_execution_jobs(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> pagers.ListNotebookExecutionJobsPager:
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListNotebookExecutionJobsRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_notebook_execution_jobs
        ]
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__iter__` convenience method.
        response = pagers.ListNotebookExecutionJobsPager(
            method=rpc,
            request=request,
            response=response,
            retry=retry,
    ...
    def delete_notebook_execution_job(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.DeleteNotebookExecutionJobRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.delete_notebook_execution_job
        ]
