...
class AsyncExtensionRegistryServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    async def post_delete_extension_with_metadata(
        self,
    ...
    async def post_get_extension_with_metadata(
        self,
    ...
    async def post_import_extension_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    async def post_list_extensions_with_metadata(
        self,
    ...
    async def post_update_extension_with_metadata(
        self,
    ...
    class _DeleteExtension(
        ...
        async def __call__(
            ...
            *,
            ...
            resp, _ = await self._interceptor.post_delete_extension_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ExtensionRegistryServiceAsyncClient.delete_extension",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ExtensionRegistryService",
                        "rpcName": "DeleteExtension",
    ...
    class _GetExtension(
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_get_extension_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ExtensionRegistryServiceAsyncClient.get_extension",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ExtensionRegistryService",
                        "rpcName": "GetExtension",
                        "metadata": http_response["headers"],
    ...
    class _ImportExtension(
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_import_extension_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ExtensionRegistryServiceAsyncClient.import_extension",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ExtensionRegistryService",
                        "rpcName": "ImportExtension",
                        "metadata": http_response["headers"],
    ...
    class _ListExtensions(
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_list_extensions_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ExtensionRegistryServiceAsyncClient.list_extensions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ExtensionRegistryService",
                        "rpcName": "ListExtensions",
                        "metadata": http_response["headers"],
    ...
    class _UpdateExtension(
        ...
        async def __call__(
            ...
            *,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_update_extension_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ExtensionRegistryServiceAsyncClient.update_extension",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ExtensionRegistryService",
                        "rpcName": "UpdateExtension",
                        "metadata": http_response["headers"],
