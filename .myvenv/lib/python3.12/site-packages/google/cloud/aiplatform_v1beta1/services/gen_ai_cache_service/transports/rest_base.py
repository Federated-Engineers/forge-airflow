...
from .base import DEFAULT_CLIENT_INFO, GenAiCacheServiceTransport
    ...
    class _BaseCreateCachedContent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}/cachedContents",
                    "body": "cached_content",
                },
            ]
            return http_options
    ...
    class _BaseDeleteCachedContent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta1/{name=projects/*/locations/*/cachedContents/*}",
                },
            ]
            return http_options
    ...
    class _BaseUpdateCachedContent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta1/{cached_content.name=projects/*/locations/*/cachedContents/*}",
                    "body": "cached_content",
                },
            ]
            return http_options
