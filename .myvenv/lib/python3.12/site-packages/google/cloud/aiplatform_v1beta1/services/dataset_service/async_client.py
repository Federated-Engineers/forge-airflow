...
from google.cloud.aiplatform_v1beta1.types import (annotation, annotation_spec,
                                                   data_item)
...
from .transports.base import DEFAULT_CLIENT_INFO, DatasetServiceTransport
...
class DatasetServiceAsyncClient:
    ...
    template_path = staticmethod(DatasetServiceClient.template_path)
    parse_template_path = staticmethod(DatasetServiceClient.parse_template_path)
