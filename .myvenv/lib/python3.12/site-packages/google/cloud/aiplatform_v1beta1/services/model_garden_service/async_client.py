...
from google.cloud.aiplatform_v1beta1.services.model_garden_service import \
    pagers
from google.cloud.aiplatform_v1beta1.types import (model, model_garden_service,
                                                   publisher_model)
...
from .transports.base import DEFAULT_CLIENT_INFO, ModelGardenServiceTransport
...
class ModelGardenServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            ModelGardenServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(ModelGardenServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            ModelGardenServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(ModelGardenServiceAsyncClient, filename, *args, **kwargs)
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1beta1.ModelGardenServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def export_publisher_model(
        self,
        request: Optional[
            Union[model_garden_service.ExportPublisherModelRequest, dict]
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Exports a publisher model to a user provided Google
        ...
        .. code-block:: python
            ...
            async def sample_export_publisher_model():
                ...
                # Initialize request argument(s)
                destination = aiplatform_v1beta1.GcsDestination()
                destination.output_uri_prefix = "output_uri_prefix_value"

                request = aiplatform_v1beta1.ExportPublisherModelRequest(
                    name="name_value",
                ...
                # Make the request
                operation = client.export_publisher_model(request=request)
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.ExportPublisherModelRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.aiplatform_v1beta1.types.ExportPublisherModelResponse` Response message for
                   [ModelGardenService.ExportPublisherModel][google.cloud.aiplatform.v1beta1.ModelGardenService.ExportPublisherModel].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_garden_service.ExportPublisherModelRequest):
            request = model_garden_service.ExportPublisherModelRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.export_publisher_model
        ]
        ...
        response = operation_async.from_gapic(
            response,
            self._client._transport.operations_client,
            model_garden_service.ExportPublisherModelResponse,
            metadata_type=model_garden_service.ExportPublisherModelOperationMetadata,
        )

        # Done; return the response.
        return response

    async def check_publisher_model_eula_acceptance(
        self,
        request: Optional[
            Union[model_garden_service.CheckPublisherModelEulaAcceptanceRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        ...
        r"""Checks the EULA acceptance status of a publisher
        model.
        ...
        .. code-block:: python
            ...
            async def sample_check_publisher_model_eula_acceptance():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.CheckPublisherModelEulaAcceptanceRequest(
                    parent="parent_value",
                    publisher_model="publisher_model_value",
                )

                # Make the request
                response = await client.check_publisher_model_eula_acceptance(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CheckPublisherModelEulaAcceptanceRequest, dict]]):
                The request object. Request message for
                [ModelGardenService.CheckPublisherModelEula][].
            parent (:class:`str`):
                Required. The project requesting access for named model.
                The format is ``projects/{project}``.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            publisher_model (:class:`str`):
                Required. The name of the PublisherModel resource.
                Format:
                ``publishers/{publisher}/models/{publisher_model}``, or
                ``publishers/hf-{hugging-face-author}/models/{hugging-face-model-name}``

                This corresponds to the ``publisher_model`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.PublisherModelEulaAcceptance:
                Response message for
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, publisher_model]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        if publisher_model is not None:
            request.publisher_model = publisher_model

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.check_publisher_model_eula_acceptance
        ]
    ...
    async def accept_publisher_model_eula(
        self,
        request: Optional[
            Union[model_garden_service.AcceptPublisherModelEulaRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        publisher_model: Optional[str] = None,
        ...
        r"""Accepts the EULA acceptance status of a publisher
        model.
        ...
        .. code-block:: python
            ...
            async def sample_accept_publisher_model_eula():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.AcceptPublisherModelEulaRequest(
                    parent="parent_value",
                    publisher_model="publisher_model_value",
                )

                # Make the request
                response = await client.accept_publisher_model_eula(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.AcceptPublisherModelEulaRequest, dict]]):
                The request object. Request message for
        ...
        if not isinstance(
            ...
            request = model_garden_service.AcceptPublisherModelEulaRequest(request)
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.accept_publisher_model_eula
        ]
