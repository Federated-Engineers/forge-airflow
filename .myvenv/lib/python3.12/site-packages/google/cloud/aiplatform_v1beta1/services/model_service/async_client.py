...
class ModelServiceAsyncClient:
    ...
    reservation_path = staticmethod(ModelServiceClient.reservation_path)
    parse_reservation_path = staticmethod(ModelServiceClient.parse_reservation_path)
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1beta1.ModelServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def list_model_version_checkpoints(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.ListModelVersionCheckpointsRequest, dict]]):
                The request object. Request message for
    ...
    async def recommend_spec(
        self,
        request: Optional[Union[model_service.RecommendSpecRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> model_service.RecommendSpecResponse:
        r"""Gets a Model's spec recommendations.
        ...
        .. code-block:: python
            ...
            async def sample_recommend_spec():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.RecommendSpecRequest(
                    parent="parent_value",
                    gcs_uri="gcs_uri_value",
                )

                # Make the request
                response = await client.recommend_spec(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.RecommendSpecRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.RecommendSpecResponse:
                Response message for
                   [ModelService.RecommendSpec][google.cloud.aiplatform.v1beta1.ModelService.RecommendSpec].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, model_service.RecommendSpecRequest):
            request = model_service.RecommendSpecRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.recommend_spec
        ]
