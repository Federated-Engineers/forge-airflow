    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomEvaluationServiceInterceptor(EvaluationServiceRestInterceptor):
            async def pre_evaluate_dataset(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_evaluate_dataset(self, response):
    ...
    async def pre_evaluate_dataset(
        self,
    ...
    async def post_evaluate_dataset(
    ...
    async def post_evaluate_dataset_with_metadata(
        self,
...
class AsyncEvaluationServiceRestTransport(_BaseEvaluationServiceRestTransport):
    ...
    class _EvaluateDataset(
        ...
        def __hash__(self):
            return hash("AsyncEvaluationServiceRestTransport.EvaluateDataset")
        ...
        async def __call__(
            ...
            *,
            ...
            request, metadata = await self._interceptor.pre_evaluate_dataset(
                request, metadata
            )
            ...
            # Send the request
            response = await AsyncEvaluationServiceRestTransport._EvaluateDataset._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = await self._interceptor.post_evaluate_dataset(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = await self._interceptor.post_evaluate_dataset_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.evaluate_dataset",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "EvaluateDataset",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.evaluate_instances",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "EvaluateInstances",
                        "metadata": http_response["headers"],
