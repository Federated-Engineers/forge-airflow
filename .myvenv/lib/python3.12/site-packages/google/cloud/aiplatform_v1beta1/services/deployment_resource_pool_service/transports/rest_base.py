...
from .base import DEFAULT_CLIENT_INFO, DeploymentResourcePoolServiceTransport
    ...
    class _BaseUpdateDeploymentResourcePool:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta1/{deployment_resource_pool.name=projects/*/locations/*/deploymentResourcePools/*}",
