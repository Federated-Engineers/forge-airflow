        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MatchServiceAsyncClient.find_neighbors",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MatchService",
                        "rpcName": "FindNeighbors",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MatchServiceAsyncClient.read_index_datapoints",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MatchService",
                        "rpcName": "ReadIndexDatapoints",
                        "metadata": http_response["headers"],
