        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.AskContexts",
                    extra={
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.ask_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "AskContexts",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.AsyncRetrieveContexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.async_retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "AsyncRetrieveContexts",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.augment_prompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "AugmentPrompt",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.corroborate_content",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "CorroborateContent",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "RetrieveContexts",
                        "metadata": http_response["headers"],
