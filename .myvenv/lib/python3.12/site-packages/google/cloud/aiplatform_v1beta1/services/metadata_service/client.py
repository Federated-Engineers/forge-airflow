...
from google.cloud.aiplatform_v1beta1.types import encryption_spec, event
...
class MetadataServiceClient(metaclass=MetadataServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = MetadataServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.MetadataServiceClient`.",
                    extra=(
                        {
