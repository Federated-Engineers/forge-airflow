...
class ReasoningEngineServiceClient(metaclass=ReasoningEngineServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.ReasoningEngineServiceClient`.",
                    extra=(
                        {
    ...
    def update_reasoning_engine(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateReasoningEngineRequest, dict]):
                The request object. Request message for
