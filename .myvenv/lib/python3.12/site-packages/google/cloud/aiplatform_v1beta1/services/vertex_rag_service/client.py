...
from google.cloud.aiplatform_v1beta1.types import tool, vertex_rag_service
...
class VertexRagServiceClient(metaclass=VertexRagServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.VertexRagServiceClient`.",
                    extra=(
                        {
    ...
    def augment_prompt(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.AugmentPromptRequest, dict]):
    ...
    def corroborate_content(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.CorroborateContentRequest, dict]):
                The request object. Request message for
                CorroborateContent.
            parent (str):
                Required. The resource name of the Location from which
    ...
    def ask_contexts(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.AskContextsRequest, dict]):
    ...
    def async_retrieve_contexts(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.AsyncRetrieveContextsRequest, dict]):
                The request object. Request message for
