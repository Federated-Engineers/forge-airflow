...
from .rest_base import _BaseMemoryBankServiceRestTransport
...
class MemoryBankServiceRestInterceptor:
    """Interceptor for MemoryBankService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the MemoryBankServiceRestTransport.

    .. code-block:: python
        class MyCustomMemoryBankServiceInterceptor(MemoryBankServiceRestInterceptor):
            def pre_create_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_generate_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_generate_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_retrieve_memories(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_retrieve_memories(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_memory(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_memory(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = MemoryBankServiceRestTransport(interceptor=MyCustomMemoryBankServiceInterceptor())
        client = MemoryBankServiceClient(transport=transport)


    """

    def pre_create_memory(
        self,
        request: memory_bank_service.CreateMemoryRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        memory_bank_service.CreateMemoryRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for create_memory

        Override in a subclass to manipulate the request or metadata
        before they are sent to the MemoryBankService server.
        """
        return request, metadata

    def post_create_memory(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for create_memory

        DEPRECATED. Please use the `post_create_memory_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_create_memory` interceptor runs
        before the `post_create_memory_with_metadata` interceptor.
        """
        return response

    def post_create_memory_with_metadata(
        self,
        ...
        is returned by the MemoryBankService server but before it is returned to user code.

        We recommend only using this `post_create_memory_with_metadata`
        interceptor in new development instead of the `post_create_memory` interceptor.
        When both interceptors are used, this `post_create_memory_with_metadata` interceptor runs after the
        `post_create_memory` interceptor. The (possibly modified) response returned by
        `post_create_memory` will be passed to
        `post_create_memory_with_metadata`.
        """
        return response, metadata

    def pre_delete_memory(
        self,
        request: memory_bank_service.DeleteMemoryRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        memory_bank_service.DeleteMemoryRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for delete_memory
    ...
    def post_delete_memory(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for delete_memory

        DEPRECATED. Please use the `post_delete_memory_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_delete_memory` interceptor runs
        before the `post_delete_memory_with_metadata` interceptor.
        """
        return response

    def post_delete_memory_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_delete_memory_with_metadata`
        interceptor in new development instead of the `post_delete_memory` interceptor.
        When both interceptors are used, this `post_delete_memory_with_metadata` interceptor runs after the
        `post_delete_memory` interceptor. The (possibly modified) response returned by
        `post_delete_memory` will be passed to
        `post_delete_memory_with_metadata`.
        """
        return response, metadata

    def pre_generate_memories(
        self,
        ...
        """Pre-rpc interceptor for generate_memories
    ...
    def post_generate_memories(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for generate_memories

        DEPRECATED. Please use the `post_generate_memories_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_generate_memories` interceptor runs
        before the `post_generate_memories_with_metadata` interceptor.
        """
        return response

    def post_generate_memories_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_generate_memories_with_metadata`
        interceptor in new development instead of the `post_generate_memories` interceptor.
        When both interceptors are used, this `post_generate_memories_with_metadata` interceptor runs after the
        `post_generate_memories` interceptor. The (possibly modified) response returned by
        `post_generate_memories` will be passed to
    ...
    def pre_get_memory(
        ...
        memory_bank_service.GetMemoryRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for get_memory
    ...
    def post_get_memory(self, response: memory_bank.Memory) -> memory_bank.Memory:
        """Post-rpc interceptor for get_memory

        DEPRECATED. Please use the `post_get_memory_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_get_memory` interceptor runs
        before the `post_get_memory_with_metadata` interceptor.
        """
        return response

    def post_get_memory_with_metadata(
        self,
        response: memory_bank.Memory,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[memory_bank.Memory, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_memory

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the MemoryBankService server but before it is returned to user code.

        We recommend only using this `post_get_memory_with_metadata`
        interceptor in new development instead of the `post_get_memory` interceptor.
        When both interceptors are used, this `post_get_memory_with_metadata` interceptor runs after the
        `post_get_memory` interceptor. The (possibly modified) response returned by
        `post_get_memory` will be passed to
        `post_get_memory_with_metadata`.
        """
        return response, metadata

    def pre_list_memories(
        self,
        request: memory_bank_service.ListMemoriesRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        memory_bank_service.ListMemoriesRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for list_memories
    ...
    def post_list_memories(
        self, response: memory_bank_service.ListMemoriesResponse
    ) -> memory_bank_service.ListMemoriesResponse:
        """Post-rpc interceptor for list_memories

        DEPRECATED. Please use the `post_list_memories_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_list_memories` interceptor runs
        before the `post_list_memories_with_metadata` interceptor.
        """
        return response

    def post_list_memories_with_metadata(
        self,
        response: memory_bank_service.ListMemoriesResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        memory_bank_service.ListMemoriesResponse,
        Sequence[Tuple[str, Union[str, bytes]]],
        ...
        We recommend only using this `post_list_memories_with_metadata`
        interceptor in new development instead of the `post_list_memories` interceptor.
        When both interceptors are used, this `post_list_memories_with_metadata` interceptor runs after the
        `post_list_memories` interceptor. The (possibly modified) response returned by
        `post_list_memories` will be passed to
        `post_list_memories_with_metadata`.
        """
        return response, metadata

    def pre_retrieve_memories(
        self,
        ...
        """Pre-rpc interceptor for retrieve_memories
    ...
    def post_retrieve_memories(
        self, response: memory_bank_service.RetrieveMemoriesResponse
    ) -> memory_bank_service.RetrieveMemoriesResponse:
        """Post-rpc interceptor for retrieve_memories

        DEPRECATED. Please use the `post_retrieve_memories_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_retrieve_memories` interceptor runs
        before the `post_retrieve_memories_with_metadata` interceptor.
        """
        return response

    def post_retrieve_memories_with_metadata(
        self,
        response: memory_bank_service.RetrieveMemoriesResponse,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        memory_bank_service.RetrieveMemoriesResponse,
        Sequence[Tuple[str, Union[str, bytes]]],
        ...
        We recommend only using this `post_retrieve_memories_with_metadata`
        interceptor in new development instead of the `post_retrieve_memories` interceptor.
        When both interceptors are used, this `post_retrieve_memories_with_metadata` interceptor runs after the
        `post_retrieve_memories` interceptor. The (possibly modified) response returned by
        `post_retrieve_memories` will be passed to
    ...
    def pre_update_memory(
        ...
        memory_bank_service.UpdateMemoryRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
        """Pre-rpc interceptor for update_memory
    ...
    def post_update_memory(
        ...
        """Post-rpc interceptor for update_memory

        DEPRECATED. Please use the `post_update_memory_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the MemoryBankService server but before
        it is returned to user code. This `post_update_memory` interceptor runs
        before the `post_update_memory_with_metadata` interceptor.
        """
        return response

    def post_update_memory_with_metadata(
        self,
        response: operations_pb2.Operation,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[operations_pb2.Operation, Sequence[Tuple[str, Union[str, bytes]]]]:
        ...
        We recommend only using this `post_update_memory_with_metadata`
        interceptor in new development instead of the `post_update_memory` interceptor.
        When both interceptors are used, this `post_update_memory_with_metadata` interceptor runs after the
        `post_update_memory` interceptor. The (possibly modified) response returned by
        `post_update_memory` will be passed to
...
class MemoryBankServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: MemoryBankServiceRestInterceptor


class MemoryBankServiceRestTransport(_BaseMemoryBankServiceRestTransport):
    """REST backend synchronous transport for MemoryBankService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[MemoryBankServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or MemoryBankServiceRestInterceptor()
    ...
    class _CreateMemory(
        _BaseMemoryBankServiceRestTransport._BaseCreateMemory, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.CreateMemory")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the create memory method over HTTP.
            ...
            request, metadata = self._interceptor.pre_create_memory(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.CreateMemory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "CreateMemory",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._CreateMemory._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_create_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_create_memory_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.create_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "CreateMemory",
    ...
    class _DeleteMemory(
        _BaseMemoryBankServiceRestTransport._BaseDeleteMemory, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.DeleteMemory")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the delete memory method over HTTP.
            ...
            request, metadata = self._interceptor.pre_delete_memory(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.DeleteMemory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "DeleteMemory",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._DeleteMemory._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_delete_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_delete_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.delete_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "DeleteMemory",
                        "metadata": http_response["headers"],
    ...
    class _GenerateMemories(
        _BaseMemoryBankServiceRestTransport._BaseGenerateMemories,
        MemoryBankServiceRestStub,
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.GenerateMemories")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the generate memories method over HTTP.
            ...
            request, metadata = self._interceptor.pre_generate_memories(
                request, metadata
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.GenerateMemories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GenerateMemories",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._GenerateMemories._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_generate_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_generate_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.generate_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GenerateMemories",
                        "metadata": http_response["headers"],
    ...
    class _GetMemory(
        _BaseMemoryBankServiceRestTransport._BaseGetMemory, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.GetMemory")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the get memory method over HTTP.
            ...
            request, metadata = self._interceptor.pre_get_memory(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.GetMemory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetMemory",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._GetMemory._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = memory_bank.Memory()
            pb_resp = memory_bank.Memory.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_get_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = memory_bank.Memory.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.get_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetMemory",
                        "metadata": http_response["headers"],
    ...
    class _ListMemories(
        _BaseMemoryBankServiceRestTransport._BaseListMemories, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.ListMemories")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the list memories method over HTTP.
            ...
            request, metadata = self._interceptor.pre_list_memories(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.ListMemories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "ListMemories",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._ListMemories._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = memory_bank_service.ListMemoriesResponse()
            pb_resp = memory_bank_service.ListMemoriesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_list_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = memory_bank_service.ListMemoriesResponse.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.list_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "ListMemories",
                        "metadata": http_response["headers"],
    ...
    class _RetrieveMemories(
        _BaseMemoryBankServiceRestTransport._BaseRetrieveMemories,
        MemoryBankServiceRestStub,
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.RetrieveMemories")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the retrieve memories method over HTTP.
            ...
            request, metadata = self._interceptor.pre_retrieve_memories(
                request, metadata
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.RetrieveMemories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "RetrieveMemories",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._RetrieveMemories._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = memory_bank_service.RetrieveMemoriesResponse()
            pb_resp = memory_bank_service.RetrieveMemoriesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_retrieve_memories(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_retrieve_memories_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = (
                        memory_bank_service.RetrieveMemoriesResponse.to_json(response)
                    )
                except:
                    response_payload = None
                http_response = {
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.retrieve_memories",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "RetrieveMemories",
                        "metadata": http_response["headers"],
    ...
    class _UpdateMemory(
        _BaseMemoryBankServiceRestTransport._BaseUpdateMemory, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.UpdateMemory")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the update memory method over HTTP.
            ...
            request, metadata = self._interceptor.pre_update_memory(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.UpdateMemory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "UpdateMemory",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._UpdateMemory._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_update_memory(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_update_memory_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.update_memory",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "UpdateMemory",
                        "metadata": http_response["headers"],
    ...
    def create_memory(
        self,
    ) -> Callable[[memory_bank_service.CreateMemoryRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._CreateMemory(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def delete_memory(
        self,
    ) -> Callable[[memory_bank_service.DeleteMemoryRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._DeleteMemory(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def generate_memories(
        self,
    ) -> Callable[
        [memory_bank_service.GenerateMemoriesRequest], operations_pb2.Operation
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._GenerateMemories(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get_memory(
        self,
    ) -> Callable[[memory_bank_service.GetMemoryRequest], memory_bank.Memory]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._GetMemory(self._session, self._host, self._interceptor)  # type: ignore
    ...
    def list_memories(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._ListMemories(self._session, self._host, self._interceptor)  # type: ignore
    ...
    def retrieve_memories(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._RetrieveMemories(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def update_memory(
        self,
    ) -> Callable[[memory_bank_service.UpdateMemoryRequest], operations_pb2.Operation]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpdateMemory(self._session, self._host, self._interceptor)  # type: ignore
    ...
    class _GetLocation(
        _BaseMemoryBankServiceRestTransport._BaseGetLocation, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.GetLocation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._GetLocation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.ListLocations")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._ListLocations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(
        _BaseMemoryBankServiceRestTransport._BaseGetIamPolicy, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseMemoryBankServiceRestTransport._BaseSetIamPolicy, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.DeleteOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetOperation(
        _BaseMemoryBankServiceRestTransport._BaseGetOperation, MemoryBankServiceRestStub
    ):
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.GetOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._GetOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.ListOperations")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._ListOperations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(
        ...
        def __hash__(self):
            return hash("MemoryBankServiceRestTransport.WaitOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.MemoryBankServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
            ...
            # Send the request
            response = MemoryBankServiceRestTransport._WaitOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.MemoryBankServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.MemoryBankService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
...
__all__ = ("MemoryBankServiceRestTransport",)
