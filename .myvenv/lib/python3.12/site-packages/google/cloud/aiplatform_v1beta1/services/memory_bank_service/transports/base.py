...
class MemoryBankServiceTransport(abc.ABC):
    """Abstract transport class for MemoryBankService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_memory: gapic_v1.method.wrap_method(
                self.create_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_memory: gapic_v1.method.wrap_method(
                self.get_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_memory: gapic_v1.method.wrap_method(
                self.update_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_memories: gapic_v1.method.wrap_method(
                self.list_memories,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_memory: gapic_v1.method.wrap_method(
                self.delete_memory,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_memories: gapic_v1.method.wrap_method(
                self.generate_memories,
                default_timeout=None,
                client_info=client_info,
            ),
            self.retrieve_memories: gapic_v1.method.wrap_method(
    ...
    def get_memory(
        ...
        Union[memory_bank.Memory, Awaitable[memory_bank.Memory]],
    ]:
        raise NotImplementedError()
...
__all__ = ("MemoryBankServiceTransport",)
