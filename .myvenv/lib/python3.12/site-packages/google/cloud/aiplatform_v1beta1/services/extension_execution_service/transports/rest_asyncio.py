...
class AsyncExtensionExecutionServiceRestInterceptor:
    """Asynchronous Interceptor for ExtensionExecutionService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the AsyncExtensionExecutionServiceRestTransport.

    .. code-block:: python
        class MyCustomExtensionExecutionServiceInterceptor(ExtensionExecutionServiceRestInterceptor):
            async def pre_execute_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_execute_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_query_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_query_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = AsyncExtensionExecutionServiceRestTransport(interceptor=MyCustomExtensionExecutionServiceInterceptor())
        client = async ExtensionExecutionServiceClient(transport=transport)
...
class AsyncExtensionExecutionServiceRestTransport(
    ...
    """Asynchronous REST backend transport for ExtensionExecutionService.
