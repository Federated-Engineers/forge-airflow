...
class ModelMonitoringServiceClient(metaclass=ModelMonitoringServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ModelMonitoringServiceClient._use_client_cert_effective()
        ...
        *,
        ...
        if not transport_provided:
            transport_init: Union[
                ...
                ModelMonitoringServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.ModelMonitoringServiceClient`.",
                    extra=(
                        {
