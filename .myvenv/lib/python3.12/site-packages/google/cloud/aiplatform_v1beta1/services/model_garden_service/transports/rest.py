...
class ModelGardenServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_deploy_publisher_model(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
...
class ModelGardenServiceRestTransport(_BaseModelGardenServiceRestTransport):
    ...
    class _DeployPublisherModel(
        ...
        def __hash__(self):
            return hash("ModelGardenServiceRestTransport.DeployPublisherModel")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_deploy_publisher_model(
                request, metadata
            )
            ...
            # Send the request
            response = (
                ModelGardenServiceRestTransport._DeployPublisherModel._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ModelGardenServiceClient.deploy_publisher_model",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ModelGardenService",
                        "rpcName": "DeployPublisherModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ModelGardenServiceClient.get_publisher_model",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ModelGardenService",
                        "rpcName": "GetPublisherModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.ModelGardenServiceClient.list_publisher_models",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.ModelGardenService",
                        "rpcName": "ListPublisherModels",
                        "metadata": http_response["headers"],
