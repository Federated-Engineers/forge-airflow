...
from google.cloud.aiplatform_v1beta1.types import explanation, tool, types
from google.cloud.aiplatform_v1beta1.types import \
    usage_metadata as gca_usage_metadata
...
class EmbedContentResponse(proto.Message):
    ...
    Attributes:
        embedding (google.cloud.aiplatform_v1beta1.types.EmbedContentResponse.Embedding):
