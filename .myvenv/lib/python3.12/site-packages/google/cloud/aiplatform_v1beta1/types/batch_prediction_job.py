...
from google.cloud.aiplatform_v1beta1.types import (explanation, io, job_state,
                                                   machine_resources)
from google.cloud.aiplatform_v1beta1.types import \
    manual_batch_tuning_parameters as gca_manual_batch_tuning_parameters
from google.cloud.aiplatform_v1beta1.types import (
    model_deployment_monitoring_job, model_monitoring)
from google.cloud.aiplatform_v1beta1.types import \
    ...
    class InputConfig(proto.Message):
        ...
        Attributes:
            ...
            bigquery_source (google.cloud.aiplatform_v1beta1.types.BigQuerySource):
                ...
                This field is a member of `oneof`_ ``source``.
            vertex_multimodal_dataset_source (google.cloud.aiplatform_v1beta1.types.VertexMultimodalDatasetSource):
    ...
    class OutputConfig(proto.Message):
        ...
        Attributes:
            ...
            bigquery_destination (google.cloud.aiplatform_v1beta1.types.BigQueryDestination):
                ...
                This field is a member of `oneof`_ ``destination``.
            vertex_multimodal_dataset_destination (google.cloud.aiplatform_v1beta1.types.VertexMultimodalDatasetDestination):
