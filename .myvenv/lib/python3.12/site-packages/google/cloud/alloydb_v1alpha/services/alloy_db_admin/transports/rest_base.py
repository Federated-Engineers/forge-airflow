    ...
    class _BaseImportCluster:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{name=projects/*/locations/*/clusters/*}:import",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseSwitchoverCluster:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1alpha/{name=projects/*/locations/*/clusters/*}:switchover",
                    "body": "*",
                },
            ]
            return http_options
    ...
    class _BaseUpgradeCluster:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1alpha/{name=projects/*/locations/*/clusters/*}:upgrade",
                    "body": "*",
                },
            ]
            return http_options
