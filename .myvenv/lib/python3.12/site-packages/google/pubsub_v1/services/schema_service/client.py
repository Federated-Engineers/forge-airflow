...
class SchemaServiceClient(metaclass=SchemaServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SchemaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = SchemaServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SchemaServiceClient._get_api_endpoint(
