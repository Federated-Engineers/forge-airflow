...
class _BaseYouTubeVideoUploadServiceRestResumableTransport(
    ...
    """Base REST Resumable backend transport for YouTubeVideoUploadService.
    ...
    def __init__(
        ...
        *,
        ...
        maybe_url_match = re.match(
            "^(?P<scheme>http(?:s)?://)?(?P<host>.*)$", host
        )
        ...
        host = (
            f"{url_scheme}://{host}" if not url_match_items["scheme"] else host
        )
    ...
    class _BaseCreateYouTubeVideoUploadRequest:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v23/customers/{customer_id=*}/youTubeVideoUploads:create",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = (
                youtube_video_upload_service.CreateYouTubeVideoUploadRequest.pb(
                    request
                )
            )
