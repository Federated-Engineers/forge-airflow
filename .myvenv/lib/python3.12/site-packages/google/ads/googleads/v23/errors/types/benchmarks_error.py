...
class BenchmarksErrorEnum(proto.Message):
    r"""Container for enum describing possible errors returned from
    the BenchmarksService.

    """

    class BenchmarksError(proto.Enum):
        r"""Enum describing possible errors from BenchmarksService.
        ...
        Values:
            ...
            MAX_QUERY_COMPLEXITY_EXCEEDED (2):
                The combination of inputs to generate
                benchmarks is too complex. To reduce complexity,
