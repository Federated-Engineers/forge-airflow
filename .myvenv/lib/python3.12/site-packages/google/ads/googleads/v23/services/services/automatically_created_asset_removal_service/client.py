...
class AutomaticallyCreatedAssetRemovalServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AutomaticallyCreatedAssetRemovalServiceClient`.",
                    extra=(
                        {
    ...
    def remove_campaign_automatically_created_asset(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.RemoveCampaignAutomaticallyCreatedAssetRequest, dict]):
