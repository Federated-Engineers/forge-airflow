...
class CustomerLifecycleGoalServiceGrpcTransport(
    CustomerLifecycleGoalServiceTransport
):
    """gRPC backend transport for CustomerLifecycleGoalService.
...
__all__ = ("CustomerLifecycleGoalServiceGrpcTransport",)
