...
class CampaignCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.CampaignCustomizer):
...
class MutateCampaignCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCampaignCustomizerResult]):
