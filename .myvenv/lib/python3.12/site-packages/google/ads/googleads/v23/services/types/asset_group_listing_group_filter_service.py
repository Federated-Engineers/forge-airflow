...
class AssetGroupListingGroupFilterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.AssetGroupListingGroupFilter):
            Create operation: No resource name is
            expected for the new asset group listing group
            filter.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.AssetGroupListingGroupFilter):
...
class MutateAssetGroupListingGroupFiltersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAssetGroupListingGroupFilterResult]):
