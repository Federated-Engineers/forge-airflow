...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v23.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateConversionGoalCampaignConfigResult]):
