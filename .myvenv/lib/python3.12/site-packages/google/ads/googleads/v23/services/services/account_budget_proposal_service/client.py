...
class AccountBudgetProposalServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AccountBudgetProposalServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAccountBudgetProposalRequest, dict]):
