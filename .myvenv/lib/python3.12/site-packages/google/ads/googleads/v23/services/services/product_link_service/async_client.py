...
class ProductLinkServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.ProductLinkServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def create_product_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.CreateProductLinkRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            product_link (:class:`google.ads.googleads.v23.resources.types.ProductLink`):
    ...
    async def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.RemoveProductLinkRequest, dict]]):
                The request object. Request message for
