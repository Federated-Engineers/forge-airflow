...
from google.ads.googleads.v23.enums.types import (conversion_customer_type,
...
class UploadClickConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (MutableSequence[google.ads.googleads.v23.services.types.ClickConversionResult]):
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v23.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (MutableSequence[google.ads.googleads.v23.services.types.CustomVariable]):
            The custom variables associated with this
            conversion.
        cart_data (google.ads.googleads.v23.services.types.CartData):
        ...
        conversion_environment (google.ads.googleads.v23.enums.types.ConversionEnvironmentEnum.ConversionEnvironment):
        ...
        customer_type (google.ads.googleads.v23.enums.types.ConversionCustomerTypeEnum.ConversionCustomerType):
...
class CartData(proto.Message):
    ...
    Attributes:
        ...
        items (MutableSequence[google.ads.googleads.v23.services.types.CartData.Item]):
...
class SessionAttributesKeyValuePairs(proto.Message):
    ...
    Attributes:
        key_value_pairs (MutableSequence[google.ads.googleads.v23.services.types.SessionAttributeKeyValuePair]):
