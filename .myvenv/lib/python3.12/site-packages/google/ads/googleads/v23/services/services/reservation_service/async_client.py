...
class ReservationServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.ReservationServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def quote_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.QuoteCampaignsRequest, dict]]):
    ...
    async def book_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.BookCampaignsRequest, dict]]):
                The request object. Request message for
