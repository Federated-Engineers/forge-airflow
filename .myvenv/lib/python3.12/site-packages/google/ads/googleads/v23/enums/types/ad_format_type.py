    ...
    class AdFormatType(proto.Enum):
        ...
        Values:
            ...
            VERTICAL_ADS_PROMOTION (13):
                An ad format that promotes a specific entity
                within a vertical, for example, a hotel ad in
                the Travel vertical on Search.
            VERTICAL_ADS_BOOKING_LINK (14):
                An ad format for a booking link
                call-to-action within a vertical ad, for example
                a 'Book Now' link for a hotel ad.
            TEXT (15):
                A standard text ad format. This is currently
                only used for ads on the Search network.
        """
