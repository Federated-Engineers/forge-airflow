...
class AdGroupCriterionCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.AdGroupCriterionCustomizer):
...
class MutateAdGroupCriterionCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAdGroupCriterionCustomizerResult]):
