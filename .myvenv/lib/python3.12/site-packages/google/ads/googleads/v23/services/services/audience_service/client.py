...
class AudienceServiceClient(metaclass=AudienceServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AudienceServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_audiences(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAudiencesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.AudienceOperation]):
