...
class IdentityVerificationServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.IdentityVerificationServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def start_identity_verification(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.StartIdentityVerificationRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            verification_program (:class:`google.ads.googleads.v23.enums.types.IdentityVerificationProgramEnum.IdentityVerificationProgram`):
    ...
    async def get_identity_verification(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.GetIdentityVerificationRequest, dict]]):
                The request object. Request message for
