...
from google.ads.googleads.v23.enums.types import (experiment_metric,
                                                  experiment_metric_direction)
...
class MetricGoal(proto.Message):
    ...
    Attributes:
        metric (google.ads.googleads.v23.enums.types.ExperimentMetricEnum.ExperimentMetric):
            The metric of the goal. For example, clicks,
            impressions, cost, conversions, etc.
        direction (google.ads.googleads.v23.enums.types.ExperimentMetricDirectionEnum.ExperimentMetricDirection):
