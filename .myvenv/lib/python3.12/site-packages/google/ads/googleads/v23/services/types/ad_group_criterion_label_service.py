...
from google.ads.googleads.v23.resources.types import ad_group_criterion_label
...
class AdGroupCriterionLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.AdGroupCriterionLabel):
...
class MutateAdGroupCriterionLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAdGroupCriterionLabelResult]):
