...
from google.ads.googleads.v23.enums.types import (customizer_attribute_status,
...
class CustomizerAttribute(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            (case insensitive).
        type_ (google.ads.googleads.v23.enums.types.CustomizerAttributeTypeEnum.CustomizerAttributeType):
            Immutable. The type of the customizer
            attribute.
        status (google.ads.googleads.v23.enums.types.CustomizerAttributeStatusEnum.CustomizerAttributeStatus):
