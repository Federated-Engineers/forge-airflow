...
class CustomerUserAccessInvitationServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CustomerUserAccessInvitationServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCustomerUserAccessInvitationRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v23.services.types.CustomerUserAccessInvitationOperation):
