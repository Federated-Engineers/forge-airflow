...
from .base import DEFAULT_CLIENT_INFO, UserListCustomerTypeServiceTransport
...
class UserListCustomerTypeServiceGrpcTransport(
    UserListCustomerTypeServiceTransport
):
    """gRPC backend transport for UserListCustomerTypeService.
        ...
        if "mutate_user_list_customer_types" not in self._stubs:
            self._stubs["mutate_user_list_customer_types"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.UserListCustomerTypeService/MutateUserListCustomerTypes",
...
__all__ = ("UserListCustomerTypeServiceGrpcTransport",)
