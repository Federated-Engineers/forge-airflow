...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v23.resources.types.CallReportingSetting):
            Call reporting setting for a customer. Only mutable in an
            ``update`` operation.
        conversion_tracking_setting (google.ads.googleads.v23.resources.types.ConversionTrackingSetting):
            Conversion tracking setting for a customer.
        remarketing_setting (google.ads.googleads.v23.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (MutableSequence[google.ads.googleads.v23.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        status (google.ads.googleads.v23.enums.types.CustomerStatusEnum.CustomerStatus):
        ...
        customer_agreement_setting (google.ads.googleads.v23.resources.types.CustomerAgreementSetting):
            ...
            customer.
        local_services_settings (google.ads.googleads.v23.resources.types.LocalServicesSettings):
        ...
        video_customer (google.ads.googleads.v23.resources.types.VideoCustomer):
...
class LocalServicesSettings(proto.Message):
    ...
    Attributes:
        granular_license_statuses (MutableSequence[google.ads.googleads.v23.resources.types.GranularLicenseStatus]):
            Output only. A read-only list of geo vertical
            level license statuses.
        granular_insurance_statuses (MutableSequence[google.ads.googleads.v23.resources.types.GranularInsuranceStatus]):
            Output only. A read-only list of geo vertical
...
class GranularLicenseStatus(proto.Message):
    ...
    Attributes:
        ...
        verification_status (google.ads.googleads.v23.enums.types.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus):
...
class VideoCustomer(proto.Message):
    ...
    Attributes:
        third_party_integration_partners (google.ads.googleads.v23.common.types.CustomerThirdPartyIntegrationPartners):
