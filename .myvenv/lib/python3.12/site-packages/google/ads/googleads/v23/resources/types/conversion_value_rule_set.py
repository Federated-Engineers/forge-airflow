...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (MutableSequence[google.ads.googleads.v23.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        owner_customer (str):
            ...
            \*\* Read-only \*\*
        attachment_type (google.ads.googleads.v23.enums.types.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType):
        ...
        campaign (str):
            ...
            campaign.
        status (google.ads.googleads.v23.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
            Output only. The status of the conversion value rule set.
            \*\* Read-only \*\*
        conversion_action_categories (MutableSequence[google.ads.googleads.v23.enums.types.ConversionActionCategoryEnum.ConversionActionCategory]):
