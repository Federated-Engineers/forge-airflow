...
class MutateAssetsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (MutableSequence[google.ads.googleads.v23.services.types.AssetOperation]):
...
class AssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.Asset):
            Create operation: No resource name is
            expected for the new asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.Asset):
...
class MutateAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAssetResult]):
