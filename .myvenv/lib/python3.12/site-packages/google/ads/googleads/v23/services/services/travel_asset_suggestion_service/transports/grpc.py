...
from .base import DEFAULT_CLIENT_INFO, TravelAssetSuggestionServiceTransport
...
class TravelAssetSuggestionServiceGrpcTransport(
    TravelAssetSuggestionServiceTransport
):
    """gRPC backend transport for TravelAssetSuggestionService.
        ...
        if "suggest_travel_assets" not in self._stubs:
            self._stubs["suggest_travel_assets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.TravelAssetSuggestionService/SuggestTravelAssets",
