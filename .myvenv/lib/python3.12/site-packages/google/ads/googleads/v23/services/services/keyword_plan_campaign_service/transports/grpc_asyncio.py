...
from .base import DEFAULT_CLIENT_INFO, KeywordPlanCampaignServiceTransport
...
class KeywordPlanCampaignServiceGrpcAsyncIOTransport(
    ...
    """gRPC AsyncIO backend transport for KeywordPlanCampaignService.
    ...
    def mutate_keyword_plan_campaigns(
        ...
        Returns:
            Callable[[~.MutateKeywordPlanCampaignsRequest],
                    Awaitable[~.MutateKeywordPlanCampaignsResponse]]:
        ...
        if "mutate_keyword_plan_campaigns" not in self._stubs:
            self._stubs["mutate_keyword_plan_campaigns"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v23.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_keyword_plan_campaigns: self._wrap_method(
