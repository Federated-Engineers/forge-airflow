...
class KeywordPlanAdGroupKeywordServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.KeywordPlanAdGroupKeywordOperation]):
