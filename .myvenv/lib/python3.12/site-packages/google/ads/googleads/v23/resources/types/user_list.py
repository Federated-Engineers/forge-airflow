...
from google.ads.googleads.v23.common.types import user_lists
from google.ads.googleads.v23.enums.types import \
    access_reason as gage_access_reason
from google.ads.googleads.v23.enums.types import (user_list_access_status,
...
class UserList(proto.Message):
    ...
    Attributes:
        ...
        size_range_for_display (google.ads.googleads.v23.enums.types.UserListSizeRangeEnum.UserListSizeRange):
        ...
        size_range_for_search (google.ads.googleads.v23.enums.types.UserListSizeRangeEnum.UserListSizeRange):
            Output only. Size range in terms of number of
        ...
        type_ (google.ads.googleads.v23.enums.types.UserListTypeEnum.UserListType):
            ...
            This field is read-only.
        closing_reason (google.ads.googleads.v23.enums.types.UserListClosingReasonEnum.UserListClosingReason):
        ...
        access_reason (google.ads.googleads.v23.enums.types.AccessReasonEnum.AccessReason):
            ...
            This field is read-only.
        account_user_list_status (google.ads.googleads.v23.enums.types.UserListAccessStatusEnum.UserListAccessStatus):
        ...
        crm_based_user_list (google.ads.googleads.v23.common.types.CrmBasedUserListInfo):
            User list of CRM users provided by the
            advertiser.

            This field is a member of `oneof`_ ``user_list``.
        similar_user_list (google.ads.googleads.v23.common.types.SimilarUserListInfo):
            ...
            This field is a member of `oneof`_ ``user_list``.
        rule_based_user_list (google.ads.googleads.v23.common.types.RuleBasedUserListInfo):
            User list generated by a rule.

            This field is a member of `oneof`_ ``user_list``.
        logical_user_list (google.ads.googleads.v23.common.types.LogicalUserListInfo):
            User list that is a custom combination of
            user lists and user interests.

            This field is a member of `oneof`_ ``user_list``.
        basic_user_list (google.ads.googleads.v23.common.types.BasicUserListInfo):
            User list targeting as a collection of
            conversion or remarketing actions.

            This field is a member of `oneof`_ ``user_list``.
        lookalike_user_list (google.ads.googleads.v23.common.types.LookalikeUserListInfo):
