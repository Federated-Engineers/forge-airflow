...
class CustomerAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.CustomerAssetSet):
...
class MutateCustomerAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCustomerAssetSetResult]):
