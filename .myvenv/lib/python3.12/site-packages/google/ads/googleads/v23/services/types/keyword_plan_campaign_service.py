...
from google.ads.googleads.v23.resources.types import keyword_plan_campaign
...
class KeywordPlanCampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.KeywordPlanCampaign):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.KeywordPlanCampaign):
...
class MutateKeywordPlanCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateKeywordPlanCampaignResult]):
