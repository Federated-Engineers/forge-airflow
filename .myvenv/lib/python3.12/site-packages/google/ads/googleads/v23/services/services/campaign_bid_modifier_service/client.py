...
class CampaignBidModifierServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CampaignBidModifierServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCampaignBidModifiersRequest, dict]):
