...
from google.ads.googleads.v23.enums.types import keyword_plan_forecast_interval
...
class KeywordPlan(proto.Message):
    ...
    Attributes:
        ...
        forecast_period (google.ads.googleads.v23.resources.types.KeywordPlanForecastPeriod):
