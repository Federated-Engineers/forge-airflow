...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.AdGroupCriterion):
            Create operation: No resource name is
            expected for the new criterion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.AdGroupCriterion):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateAdGroupCriterionResult]):
