...
class CustomizerAttributeOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCustomizerAttributeResult]):
