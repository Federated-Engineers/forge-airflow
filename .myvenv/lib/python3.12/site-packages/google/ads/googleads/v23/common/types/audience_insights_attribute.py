...
from google.ads.googleads.v23.enums.types import youtube_video_property
...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    Attributes:
        ...
        attribute (google.ads.googleads.v23.common.types.AudienceInsightsAttribute):
        ...
        viewer_share (float):
            ...
            1. This field is not populated in every
                response.
        youtube_channel_metadata (google.ads.googleads.v23.common.types.YouTubeChannelAttributeMetadata):
            Special metadata for a YouTube channel.

            This field is a member of `oneof`_ ``dimension_metadata``.
        youtube_video_metadata (google.ads.googleads.v23.common.types.YouTubeVideoAttributeMetadata):
            Special metadata for a YouTube video.

            This field is a member of `oneof`_ ``dimension_metadata``.
        lineup_attribute_metadata (google.ads.googleads.v23.common.types.LineupAttributeMetadata):
            Special metadata for a YouTube Lineup.

            This field is a member of `oneof`_ ``dimension_metadata``.
        location_attribute_metadata (google.ads.googleads.v23.common.types.LocationAttributeMetadata):
            Special metadata for a Location.

            This field is a member of `oneof`_ ``dimension_metadata``.
        user_interest_attribute_metadata (google.ads.googleads.v23.common.types.UserInterestAttributeMetadata):
            Special metadata for a User Interest.

            This field is a member of `oneof`_ ``dimension_metadata``.
        knowledge_graph_attribute_metadata (google.ads.googleads.v23.common.types.KnowledgeGraphAttributeMetadata):
            Special metadata for a Knowledge Graph
            Entity.

            This field is a member of `oneof`_ ``dimension_metadata``.
        user_list_attribute_metadata (google.ads.googleads.v23.common.types.UserListAttributeMetadata):
...
class AudienceInsightsAttribute(proto.Message):
    ...
    Attributes:
        ...
        user_interest (google.ads.googleads.v23.common.types.UserInterestInfo):
            ...
            This field is a member of `oneof`_ ``attribute``.
        entity (google.ads.googleads.v23.common.types.AudienceInsightsEntity):
            An audience attribute defined by interest in
            a topic represented by a Knowledge Graph entity.

            This field is a member of `oneof`_ ``attribute``.
        category (google.ads.googleads.v23.common.types.AudienceInsightsCategory):
            An audience attribute defined by interest in
            a Product & Service category.

            This field is a member of `oneof`_ ``attribute``.
        lineup (google.ads.googleads.v23.common.types.AudienceInsightsLineup):
            A YouTube Lineup.
...
class YouTubeVideoAttributeMetadata(proto.Message):
    ...
    Attributes:
        ...
        video_properties (MutableSequence[google.ads.googleads.v23.enums.types.YouTubeVideoPropertyEnum.YouTubeVideoProperty]):
...
class LineupAttributeMetadata(proto.Message):
    ...
    Attributes:
        inventory_country (google.ads.googleads.v23.common.types.LocationInfo):
        ...
        sample_channels (MutableSequence[google.ads.googleads.v23.common.types.LineupAttributeMetadata.SampleChannel]):
