...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        monthly_search_volumes (MutableSequence[google.ads.googleads.v23.common.types.MonthlySearchVolume]):
            Approximate number of searches on this query
            for the past twelve months.
        competition (google.ads.googleads.v23.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
...
class HistoricalMetricsOptions(proto.Message):
    ...
    Attributes:
        year_month_range (google.ads.googleads.v23.common.types.YearMonthRange):
...
class MonthlySearchVolume(proto.Message):
    ...
    Attributes:
        ...
        month (google.ads.googleads.v23.enums.types.MonthOfYearEnum.MonthOfYear):
...
class KeywordPlanAggregateMetrics(proto.Message):
    ...
    Attributes:
        aggregate_metric_types (MutableSequence[google.ads.googleads.v23.enums.types.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType]):
...
class KeywordPlanAggregateMetricResults(proto.Message):
    ...
    Attributes:
        device_searches (MutableSequence[google.ads.googleads.v23.common.types.KeywordPlanDeviceSearches]):
...
class KeywordAnnotations(proto.Message):
    ...
    Attributes:
        concepts (MutableSequence[google.ads.googleads.v23.common.types.KeywordConcept]):
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v23.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v23.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
