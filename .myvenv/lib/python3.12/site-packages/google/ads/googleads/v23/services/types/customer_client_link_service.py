...
from google.ads.googleads.v23.resources.types import customer_client_link
...
class CustomerClientLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.CustomerClientLink):
            Create operation: No resource name is
            expected for the new link.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.CustomerClientLink):
...
class MutateCustomerClientLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v23.services.types.MutateCustomerClientLinkResult):
