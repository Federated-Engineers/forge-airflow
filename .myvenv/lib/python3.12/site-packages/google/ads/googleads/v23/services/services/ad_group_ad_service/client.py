...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AdGroupAdServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAdGroupAdsRequest, dict]):
    ...
    def remove_automatically_created_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.RemoveAutomaticallyCreatedAssetsRequest, dict]):
                The request object. Request message for
