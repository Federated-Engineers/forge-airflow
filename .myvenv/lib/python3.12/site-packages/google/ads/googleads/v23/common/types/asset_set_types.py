...
from google.ads.googleads.v23.enums.types import chain_relationship_type
from google.ads.googleads.v23.enums.types import \
    location_ownership_type as gage_location_ownership_type
from google.ads.googleads.v23.enums.types import location_string_filter_type
...
class LocationSet(proto.Message):
    ...
    Attributes:
        ...
        business_profile_location_set (google.ads.googleads.v23.common.types.BusinessProfileLocationSet):
            Data used to configure a location set
            populated from Google Business Profile
            locations.

            This field is a member of `oneof`_ ``source``.
        chain_location_set (google.ads.googleads.v23.common.types.ChainSet):
            Data used to configure a location on chain
            set populated with the specified chains.

            This field is a member of `oneof`_ ``source``.
        maps_location_set (google.ads.googleads.v23.common.types.MapsLocationSet):
...
class ChainSet(proto.Message):
    ...
    Attributes:
        ...
        chains (MutableSequence[google.ads.googleads.v23.common.types.ChainFilter]):
...
class MapsLocationSet(proto.Message):
    ...
    Attributes:
        maps_locations (MutableSequence[google.ads.googleads.v23.common.types.MapsLocationInfo]):
...
class BusinessProfileLocationGroup(proto.Message):
    ...
    Attributes:
        dynamic_business_profile_location_group_filter (google.ads.googleads.v23.common.types.DynamicBusinessProfileLocationGroupFilter):
...
class DynamicBusinessProfileLocationGroupFilter(proto.Message):
    ...
    Attributes:
        label_filters (MutableSequence[str]):
            ...
            filters are OR'ed together.
        business_name_filter (google.ads.googleads.v23.common.types.BusinessProfileBusinessNameFilter):
            Used to filter Business Profile locations by
            business name.
...
class BusinessProfileBusinessNameFilter(proto.Message):
    ...
    Attributes:
        ...
        filter_type (google.ads.googleads.v23.enums.types.LocationStringFilterTypeEnum.LocationStringFilterType):
...
class ChainLocationGroup(proto.Message):
    ...
    Attributes:
        dynamic_chain_location_group_filters (MutableSequence[google.ads.googleads.v23.common.types.ChainFilter]):
