...
from .base import DEFAULT_CLIENT_INFO, UserDataServiceTransport
...
class UserDataServiceGrpcAsyncIOTransport(UserDataServiceTransport):
    """gRPC AsyncIO backend transport for UserDataService.
    ...
    def upload_user_data(
        ...
        Returns:
            Callable[[~.UploadUserDataRequest],
                    Awaitable[~.UploadUserDataResponse]]:
        ...
        if "upload_user_data" not in self._stubs:
            self._stubs["upload_user_data"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v23.services.UserDataService/UploadUserData",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.upload_user_data: self._wrap_method(
...
__all__ = ("UserDataServiceGrpcAsyncIOTransport",)
