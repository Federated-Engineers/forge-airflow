...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v23.resources.types.CustomerCustomizer):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateCustomerCustomizerResult]):
