...
class BiddingSeasonalityAdjustmentServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v23.services.BiddingSeasonalityAdjustmentServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v23.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v23.services.types.BiddingSeasonalityAdjustmentOperation]`):
