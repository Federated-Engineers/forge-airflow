...
from google.ads.googleads.v23.enums.types import served_asset_field_type
...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        ...
        pinned_field (google.ads.googleads.v23.enums.types.ServedAssetFieldTypeEnum.ServedAssetFieldType):
        ...
        asset_performance_label (google.ads.googleads.v23.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v23.common.types.AdAssetPolicySummary):
...
class AdVideoAsset(proto.Message):
    ...
    Attributes:
        asset (str):
            ...
            This field is a member of `oneof`_ ``_asset``.
        ad_video_asset_info (google.ads.googleads.v23.common.types.AdVideoAssetInfo):
...
class AdVideoAssetInfo(proto.Message):
    ...
    Attributes:
        ad_video_asset_inventory_preferences (google.ads.googleads.v23.common.types.AdVideoAssetInventoryPreferences):
        ...
        ad_video_asset_feature_control (google.ads.googleads.v23.common.types.AdVideoAssetLinkFeatureControl):
