...
class CustomerClientLinkServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.CustomerClientLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateCustomerClientLinkRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v23.services.types.CustomerClientLinkOperation):
