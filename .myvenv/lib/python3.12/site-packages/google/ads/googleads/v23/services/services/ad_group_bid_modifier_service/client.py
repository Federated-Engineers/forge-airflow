...
class AdGroupBidModifierServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v23.services.AdGroupBidModifierServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v23.services.types.MutateAdGroupBidModifiersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v23.services.types.AdGroupBidModifierOperation]):
