...
from google.ads.googleads.v23.resources.types import remarketing_action
...
class RemarketingActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v23.resources.types.RemarketingAction):
            Create operation: No resource name is
            expected for the new remarketing action.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v23.resources.types.RemarketingAction):
...
class MutateRemarketingActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v23.services.types.MutateRemarketingActionResult]):
