...
class CampaignCustomizerServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.CampaignCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateCampaignCustomizersRequest, dict]):
