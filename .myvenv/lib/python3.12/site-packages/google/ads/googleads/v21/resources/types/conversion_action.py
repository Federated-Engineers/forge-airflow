...
from google.ads.googleads.v21.common.types import tag_snippet
...
class ConversionAction(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v21.enums.types.ConversionActionStatusEnum.ConversionActionStatus):
            The status of this conversion action for
            conversion event accrual.
        type_ (google.ads.googleads.v21.enums.types.ConversionActionTypeEnum.ConversionActionType):
            Immutable. The type of this conversion
            action.
        origin (google.ads.googleads.v21.enums.types.ConversionOriginEnum.ConversionOrigin):
        ...
        category (google.ads.googleads.v21.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        value_settings (google.ads.googleads.v21.resources.types.ConversionAction.ValueSettings):
            Settings related to the value for conversion
            events associated with this conversion action.
        counting_type (google.ads.googleads.v21.enums.types.ConversionActionCountingTypeEnum.ConversionActionCountingType):
            How to count conversion events for the
            conversion action.
        attribution_model_settings (google.ads.googleads.v21.resources.types.ConversionAction.AttributionModelSettings):
            Settings related to this conversion action's
            attribution model.
        tag_snippets (MutableSequence[google.ads.googleads.v21.common.types.TagSnippet]):
        ...
        mobile_app_vendor (google.ads.googleads.v21.enums.types.MobileAppVendorEnum.MobileAppVendor):
            Output only. Mobile app vendor for an app
            conversion action.
        firebase_settings (google.ads.googleads.v21.resources.types.ConversionAction.FirebaseSettings):
            Output only. Firebase settings for Firebase
            conversion types.
        third_party_app_analytics_settings (google.ads.googleads.v21.resources.types.ConversionAction.ThirdPartyAppAnalyticsSettings):
            Output only. Third Party App Analytics
            settings for third party conversion types.
        google_analytics_4_settings (google.ads.googleads.v21.resources.types.ConversionAction.GoogleAnalytics4Settings):
    ...
    class AttributionModelSettings(proto.Message):
        ...
        Attributes:
            attribution_model (google.ads.googleads.v21.enums.types.AttributionModelEnum.AttributionModel):
                The attribution model type of this conversion
                action.
            data_driven_model_status (google.ads.googleads.v21.enums.types.DataDrivenModelStatusEnum.DataDrivenModelStatus):
