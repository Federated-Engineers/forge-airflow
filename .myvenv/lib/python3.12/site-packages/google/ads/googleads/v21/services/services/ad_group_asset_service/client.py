...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AdGroupAssetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAdGroupAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAdGroupAssetsResponse:
