...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AssetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.AssetOperation]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAssetsResponse:
