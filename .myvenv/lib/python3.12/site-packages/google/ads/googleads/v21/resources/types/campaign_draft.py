...
from google.ads.googleads.v21.enums.types import campaign_draft_status
...
class CampaignDraft(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v21.enums.types.CampaignDraftStatusEnum.CampaignDraftStatus):
