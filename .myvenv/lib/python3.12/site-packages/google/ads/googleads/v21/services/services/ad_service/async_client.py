...
class AdServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v21.services.AdServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_ads(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v21.services.types.MutateAdsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v21.services.types.AdOperation]`):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAdsResponse:
