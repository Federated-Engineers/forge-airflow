...
from .base import DEFAULT_CLIENT_INFO, ConversionCustomVariableServiceTransport
        ...
        if "mutate_conversion_custom_variables" not in self._stubs:
            self._stubs["mutate_conversion_custom_variables"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v21.services.ConversionCustomVariableService/MutateConversionCustomVariables",
