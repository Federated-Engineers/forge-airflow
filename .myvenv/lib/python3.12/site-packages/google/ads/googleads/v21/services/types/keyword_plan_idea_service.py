...
from google.ads.googleads.v21.common.types import (criteria, dates,
                                                   keyword_plan_common)
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v21.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
            If not set, Google Search And Partners Network
            will be used.
        keyword_annotation (MutableSequence[google.ads.googleads.v21.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
            The keyword annotations to include in
            response.
        aggregate_metrics (google.ads.googleads.v21.common.types.KeywordPlanAggregateMetrics):
            The aggregate fields to include in response.
        historical_metrics_options (google.ads.googleads.v21.common.types.HistoricalMetricsOptions):
            The options for historical metrics data.
        keyword_and_url_seed (google.ads.googleads.v21.services.types.KeywordAndUrlSeed):
        ...
        keyword_seed (google.ads.googleads.v21.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            for example, cars.

            This field is a member of `oneof`_ ``seed``.
        url_seed (google.ads.googleads.v21.services.types.UrlSeed):
            A specific url to generate ideas from, for
            example, www.example.com/cars.

            This field is a member of `oneof`_ ``seed``.
        site_seed (google.ads.googleads.v21.services.types.SiteSeed):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.GenerateKeywordIdeaResult]):
            Results of generating keyword ideas.
        aggregate_metric_results (google.ads.googleads.v21.common.types.KeywordPlanAggregateMetricResults):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        ...
        keyword_idea_metrics (google.ads.googleads.v21.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword.
        keyword_annotations (google.ads.googleads.v21.common.types.KeywordAnnotations):
...
class GenerateKeywordHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.GenerateKeywordHistoricalMetricsResult]):
...
class GenerateKeywordHistoricalMetricsResult(proto.Message):
    ...
    Attributes:
        ...
        close_variants (MutableSequence[str]):
            ...
            GenerateKeywordHistoricalMetricsResult.
        keyword_metrics (google.ads.googleads.v21.common.types.KeywordPlanHistoricalMetrics):
...
class GenerateAdGroupThemesResponse(proto.Message):
    ...
    Attributes:
        ad_group_keyword_suggestions (MutableSequence[google.ads.googleads.v21.services.types.AdGroupKeywordSuggestion]):
            A list of suggested AdGroup/keyword pairings.
        unusable_ad_groups (MutableSequence[google.ads.googleads.v21.services.types.UnusableAdGroup]):
...
class AdGroupKeywordSuggestion(proto.Message):
    ...
    Attributes:
        ...
        suggested_match_type (google.ads.googleads.v21.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
...
class GenerateKeywordForecastMetricsRequest(proto.Message):
    ...
    Attributes:
        ...
        forecast_period (google.ads.googleads.v21.common.types.DateRange):
        ...
        campaign (google.ads.googleads.v21.services.types.CampaignToForecast):
...
class CampaignToForecast(proto.Message):
    ...
    Attributes:
        ...
        geo_modifiers (MutableSequence[google.ads.googleads.v21.services.types.CriterionBidModifier]):
            Locations to be targeted. Locations must be
            unique.
        keyword_plan_network (google.ads.googleads.v21.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Required. The network used for targeting.
        negative_keywords (MutableSequence[google.ads.googleads.v21.common.types.KeywordInfo]):
            The list of negative keywords to be used in
            the campaign when doing the forecast.
        bidding_strategy (google.ads.googleads.v21.services.types.CampaignToForecast.CampaignBiddingStrategy):
        ...
        ad_groups (MutableSequence[google.ads.googleads.v21.services.types.ForecastAdGroup]):
    ...
    class CampaignBiddingStrategy(proto.Message):
        ...
        Attributes:
            manual_cpc_bidding_strategy (google.ads.googleads.v21.services.types.ManualCpcBiddingStrategy):
                Use manual CPC bidding strategy for
                forecasting.

                This field is a member of `oneof`_ ``bidding_strategy``.
            maximize_clicks_bidding_strategy (google.ads.googleads.v21.services.types.MaximizeClicksBiddingStrategy):
                Use maximize clicks bidding strategy for
                forecasting.

                This field is a member of `oneof`_ ``bidding_strategy``.
            maximize_conversions_bidding_strategy (google.ads.googleads.v21.services.types.MaximizeConversionsBiddingStrategy):
...
class ForecastAdGroup(proto.Message):
    ...
    Attributes:
        ...
        biddable_keywords (MutableSequence[google.ads.googleads.v21.services.types.BiddableKeyword]):
...
class GenerateKeywordForecastMetricsResponse(proto.Message):
    ...
    Attributes:
        campaign_forecast_metrics (google.ads.googleads.v21.services.types.KeywordForecastMetrics):
