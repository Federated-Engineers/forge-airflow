...
class TargetingSetting(proto.Message):
    ...
    Attributes:
        target_restrictions (MutableSequence[google.ads.googleads.v21.common.types.TargetRestriction]):
            The per-targeting-dimension setting to
            restrict the reach of your campaign or ad group.
        target_restriction_operations (MutableSequence[google.ads.googleads.v21.common.types.TargetRestrictionOperation]):
...
class TargetRestriction(proto.Message):
    ...
    Attributes:
        targeting_dimension (google.ads.googleads.v21.enums.types.TargetingDimensionEnum.TargetingDimension):
...
class TargetRestrictionOperation(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v21.common.types.TargetRestrictionOperation.Operator):
            Type of list operation to perform.
        value (google.ads.googleads.v21.common.types.TargetRestriction):
