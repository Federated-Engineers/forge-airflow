...
class CustomerSkAdNetworkConversionValueSchemaOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v21.resources.types.CustomerSkAdNetworkConversionValueSchema):
...
class MutateCustomerSkAdNetworkConversionValueSchemaRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            being modified.
        operation (google.ads.googleads.v21.services.types.CustomerSkAdNetworkConversionValueSchemaOperation):
...
class MutateCustomerSkAdNetworkConversionValueSchemaResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v21.services.types.MutateCustomerSkAdNetworkConversionValueSchemaResult):
