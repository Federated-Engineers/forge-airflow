...
class AssetSetAssetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.AssetSetAsset):
...
class MutateAssetSetAssetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAssetSetAssetResult]):
