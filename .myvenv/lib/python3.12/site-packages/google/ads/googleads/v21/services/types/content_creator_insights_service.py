...
class GenerateCreatorInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        sub_country_locations (MutableSequence[google.ads.googleads.v21.common.types.LocationInfo]):
            ...
            criteria.
        search_attributes (google.ads.googleads.v21.services.types.GenerateCreatorInsightsRequest.SearchAttributes):
        ...
        search_brand (google.ads.googleads.v21.services.types.GenerateCreatorInsightsRequest.SearchBrand):
            A brand used to search for top creators. Data fetched is
            based on the list of countries specified in
            [country_locations][google.ads.googleads.v21.services.GenerateCreatorInsightsRequest.country_locations].

            This field is a member of `oneof`_ ``criteria``.
        search_channels (google.ads.googleads.v21.services.types.GenerateCreatorInsightsRequest.YouTubeChannels):
    ...
    class SearchAttributes(proto.Message):
        ...
        Attributes:
            ...
            creator_attributes (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsAttribute]):
    ...
    class SearchBrand(proto.Message):
        ...
        Attributes:
            brand_entities (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsAttribute]):
    ...
    class YouTubeChannels(proto.Message):
        ...
        Attributes:
            youtube_channels (MutableSequence[google.ads.googleads.v21.common.types.YouTubeChannelInfo]):
...
class GenerateCreatorInsightsResponse(proto.Message):
    ...
    Attributes:
        creator_insights (MutableSequence[google.ads.googleads.v21.services.types.YouTubeCreatorInsights]):
...
class GenerateTrendingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        search_audience (google.ads.googleads.v21.services.types.SearchAudience):
            An audience to search for trending content
            in.

            This field is a member of `oneof`_ ``criteria``.
        search_topics (google.ads.googleads.v21.services.types.SearchTopics):
...
class GenerateTrendingInsightsResponse(proto.Message):
    ...
    Attributes:
        trend_insights (MutableSequence[google.ads.googleads.v21.services.types.TrendInsight]):
...
class YouTubeCreatorInsights(proto.Message):
    ...
    Attributes:
        ...
        creator_channels (MutableSequence[google.ads.googleads.v21.services.types.YouTubeChannelInsights]):
...
class YouTubeChannelInsights(proto.Message):
    ...
    Attributes:
        ...
        country_location (google.ads.googleads.v21.common.types.LocationInfo):
            ...
            associated.
        channel_metrics (google.ads.googleads.v21.services.types.YouTubeMetrics):
            The metrics for a YouTube Channel.
        channel_audience_attributes (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsAttributeMetadata]):
        ...
        channel_attributes (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsAttributeMetadata]):
            The attributes associated with the content
            made by a channel.
        top_videos (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsAttributeMetadata]):
...
class SearchTopics(proto.Message):
    ...
    Attributes:
        entities (MutableSequence[google.ads.googleads.v21.common.types.AudienceInsightsEntity]):
...
class TrendInsight(proto.Message):
    ...
    Attributes:
        trend_attribute (google.ads.googleads.v21.common.types.AudienceInsightsAttributeMetadata):
            The attribute this trend is for.
        trend_metrics (google.ads.googleads.v21.services.types.TrendInsightMetrics):
            Metrics associated with this trend. These
            metrics are for the latest available month and
            the comparison period is 3 months.
        trend (google.ads.googleads.v21.enums.types.InsightsTrendEnum.InsightsTrend):
