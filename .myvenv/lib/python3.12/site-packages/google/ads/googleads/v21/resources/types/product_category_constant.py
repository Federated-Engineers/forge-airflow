...
from google.ads.googleads.v21.enums.types import (product_category_level,
...
class ProductCategoryConstant(proto.Message):
    ...
    Attributes:
        ...
        state (google.ads.googleads.v21.enums.types.ProductCategoryStateEnum.ProductCategoryState):
            Output only. State of the product category.
        localizations (MutableSequence[google.ads.googleads.v21.resources.types.ProductCategoryConstant.ProductCategoryLocalization]):
