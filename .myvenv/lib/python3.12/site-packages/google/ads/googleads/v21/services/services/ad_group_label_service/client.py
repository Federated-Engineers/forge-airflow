...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.AdGroupLabelServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateAdGroupLabelsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v21.services.types.MutateAdGroupLabelsResponse:
