...
from google.ads.googleads.v21.resources.types import ad_group_ad_label
...
class AdGroupAdLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.AdGroupAdLabel):
    ...
    create: ad_group_ad_label.AdGroupAdLabel = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateAdGroupAdLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAdGroupAdLabelResult]):
