...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.CampaignAssetSet):
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCampaignAssetSetResult]):
