...
class CustomizerAttributeOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCustomizerAttributeResult]):
