...
class CustomizerAttributeServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.CustomizerAttributeServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customizer_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateCustomizerAttributesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v21.services.types.CustomizerAttributeOperation]):
