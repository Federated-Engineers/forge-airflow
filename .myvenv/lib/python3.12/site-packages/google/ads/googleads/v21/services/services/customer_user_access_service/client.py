...
class CustomerUserAccessServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v21.services.CustomerUserAccessServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_user_access(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v21.services.types.MutateCustomerUserAccessRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v21.services.types.CustomerUserAccessOperation):
