...
class CampaignCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v21.enums.types.CampaignCriterionStatusEnum.CampaignCriterionStatus):
        ...
        device (google.ads.googleads.v21.common.types.DeviceInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        ad_schedule (google.ads.googleads.v21.common.types.AdScheduleInfo):
        ...
        topic (google.ads.googleads.v21.common.types.TopicInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        listing_scope (google.ads.googleads.v21.common.types.ListingScopeInfo):
        ...
        content_label (google.ads.googleads.v21.common.types.ContentLabelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        carrier (google.ads.googleads.v21.common.types.CarrierInfo):
            Immutable. Carrier.
        ...
        webpage (google.ads.googleads.v21.common.types.WebpageInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        operating_system_version (google.ads.googleads.v21.common.types.OperatingSystemVersionInfo):
            Immutable. Operating system version.

            This field is a member of `oneof`_ ``criterion``.
        mobile_device (google.ads.googleads.v21.common.types.MobileDeviceInfo):
            Immutable. Mobile Device.

            This field is a member of `oneof`_ ``criterion``.
        location_group (google.ads.googleads.v21.common.types.LocationGroupInfo):
        ...
        combined_audience (google.ads.googleads.v21.common.types.CombinedAudienceInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        keyword_theme (google.ads.googleads.v21.common.types.KeywordThemeInfo):
            Immutable. Smart Campaign Keyword Theme.

            This field is a member of `oneof`_ ``criterion``.
        local_service_id (google.ads.googleads.v21.common.types.LocalServiceIdInfo):
