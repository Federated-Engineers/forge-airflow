...
class CustomerAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v21.resources.types.CustomerAssetSet):
...
class MutateCustomerAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateCustomerAssetSetResult]):
