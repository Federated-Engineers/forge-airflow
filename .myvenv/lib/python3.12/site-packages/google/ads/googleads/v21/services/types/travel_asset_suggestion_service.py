...
from google.ads.googleads.v21.enums.types import (
    call_to_action_type, hotel_asset_suggestion_status)
...
class SuggestTravelAssetsResponse(proto.Message):
    ...
    Attributes:
        hotel_asset_suggestions (MutableSequence[google.ads.googleads.v21.services.types.HotelAssetSuggestion]):
...
class HotelAssetSuggestion(proto.Message):
    ...
    Attributes:
        ...
        call_to_action (google.ads.googleads.v21.enums.types.CallToActionTypeEnum.CallToActionType):
            Call to action type.
        text_assets (MutableSequence[google.ads.googleads.v21.services.types.HotelTextAsset]):
            Text assets such as headline, description,
            etc.
        image_assets (MutableSequence[google.ads.googleads.v21.services.types.HotelImageAsset]):
            Image assets such as
            landscape/portrait/square, etc.
        status (google.ads.googleads.v21.enums.types.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus):
