...
class ProductLinkInvitation(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v21.enums.types.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus):
            Output only. The status of the product link
            invitation. This field is read only.
        type_ (google.ads.googleads.v21.enums.types.LinkedProductTypeEnum.LinkedProductType):
        ...
        hotel_center (google.ads.googleads.v21.resources.types.HotelCenterLinkInvitationIdentifier):
            Output only. Hotel link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        merchant_center (google.ads.googleads.v21.resources.types.MerchantCenterLinkInvitationIdentifier):
            Output only. Merchant Center link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        advertising_partner (google.ads.googleads.v21.resources.types.AdvertisingPartnerLinkInvitationIdentifier):
