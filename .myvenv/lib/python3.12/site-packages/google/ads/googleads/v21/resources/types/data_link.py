...
from google.ads.googleads.v21.enums.types import (data_link_status,
                                                  data_link_type)
...
class DataLink(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v21.enums.types.DataLinkTypeEnum.DataLinkType):
            Output only. The type of the data.
        status (google.ads.googleads.v21.enums.types.DataLinkStatusEnum.DataLinkStatus):
            Output only. The status of the data link.
        youtube_video (google.ads.googleads.v21.resources.types.YoutubeVideoIdentifier):
