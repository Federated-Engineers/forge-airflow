...
from google.ads.googleads.v21.common.types import (ad_type_infos,
                                                   ...
                                                   final_app_url,
                                                   url_collection)
from google.ads.googleads.v21.enums.types import (ad_type, device,
...
class Ad(proto.Message):
    ...
    Attributes:
        ...
        final_app_urls (MutableSequence[google.ads.googleads.v21.common.types.FinalAppUrl]):
        ...
        type_ (google.ads.googleads.v21.enums.types.AdTypeEnum.AdType):
        ...
        device_preference (google.ads.googleads.v21.enums.types.DeviceEnum.Device):
        ...
        url_collections (MutableSequence[google.ads.googleads.v21.common.types.UrlCollection]):
        ...
        system_managed_resource_source (google.ads.googleads.v21.enums.types.SystemManagedResourceSourceEnum.SystemManagedResourceSource):
            Output only. If this ad is system managed,
            then this field will indicate the source. This
            field is read-only.
        text_ad (google.ads.googleads.v21.common.types.TextAdInfo):
        ...
        call_ad (google.ads.googleads.v21.common.types.CallAdInfo):
            ...
            This field is a member of `oneof`_ ``ad_data``.
        expanded_dynamic_search_ad (google.ads.googleads.v21.common.types.ExpandedDynamicSearchAdInfo):
            ...
            This field is a member of `oneof`_ ``ad_data``.
        hotel_ad (google.ads.googleads.v21.common.types.HotelAdInfo):
            Details pertaining to a hotel ad.

            This field is a member of `oneof`_ ``ad_data``.
        shopping_smart_ad (google.ads.googleads.v21.common.types.ShoppingSmartAdInfo):
            Details pertaining to a Smart Shopping ad.

            This field is a member of `oneof`_ ``ad_data``.
        shopping_product_ad (google.ads.googleads.v21.common.types.ShoppingProductAdInfo):
            Details pertaining to a Shopping product ad.

            This field is a member of `oneof`_ ``ad_data``.
        image_ad (google.ads.googleads.v21.common.types.ImageAdInfo):
            Immutable. Details pertaining to an Image ad.

            This field is a member of `oneof`_ ``ad_data``.
        video_ad (google.ads.googleads.v21.common.types.VideoAdInfo):
            Details pertaining to a Video ad.

            This field is a member of `oneof`_ ``ad_data``.
        video_responsive_ad (google.ads.googleads.v21.common.types.VideoResponsiveAdInfo):
            Details pertaining to a Video responsive ad.

            This field is a member of `oneof`_ ``ad_data``.
        responsive_search_ad (google.ads.googleads.v21.common.types.ResponsiveSearchAdInfo):
            Details pertaining to a responsive search ad.

            This field is a member of `oneof`_ ``ad_data``.
        legacy_responsive_display_ad (google.ads.googleads.v21.common.types.LegacyResponsiveDisplayAdInfo):
            Details pertaining to a legacy responsive
            display ad.

            This field is a member of `oneof`_ ``ad_data``.
        app_ad (google.ads.googleads.v21.common.types.AppAdInfo):
            Details pertaining to an app ad.

            This field is a member of `oneof`_ ``ad_data``.
        legacy_app_install_ad (google.ads.googleads.v21.common.types.LegacyAppInstallAdInfo):
            Immutable. Details pertaining to a legacy app
            install ad.

            This field is a member of `oneof`_ ``ad_data``.
        responsive_display_ad (google.ads.googleads.v21.common.types.ResponsiveDisplayAdInfo):
            Details pertaining to a responsive display
            ad.

            This field is a member of `oneof`_ ``ad_data``.
        local_ad (google.ads.googleads.v21.common.types.LocalAdInfo):
            Details pertaining to a local ad.

            This field is a member of `oneof`_ ``ad_data``.
        display_upload_ad (google.ads.googleads.v21.common.types.DisplayUploadAdInfo):
            Details pertaining to a display upload ad.

            This field is a member of `oneof`_ ``ad_data``.
        app_engagement_ad (google.ads.googleads.v21.common.types.AppEngagementAdInfo):
            Details pertaining to an app engagement ad.

            This field is a member of `oneof`_ ``ad_data``.
        shopping_comparison_listing_ad (google.ads.googleads.v21.common.types.ShoppingComparisonListingAdInfo):
            Details pertaining to a Shopping Comparison
            Listing ad.

            This field is a member of `oneof`_ ``ad_data``.
        smart_campaign_ad (google.ads.googleads.v21.common.types.SmartCampaignAdInfo):
            Details pertaining to a Smart campaign ad.

            This field is a member of `oneof`_ ``ad_data``.
        app_pre_registration_ad (google.ads.googleads.v21.common.types.AppPreRegistrationAdInfo):
            Details pertaining to an app pre-registration
            ad.

            This field is a member of `oneof`_ ``ad_data``.
        demand_gen_multi_asset_ad (google.ads.googleads.v21.common.types.DemandGenMultiAssetAdInfo):
            Details pertaining to a Demand Gen multi
            asset ad.

            This field is a member of `oneof`_ ``ad_data``.
        demand_gen_carousel_ad (google.ads.googleads.v21.common.types.DemandGenCarouselAdInfo):
            Details pertaining to a Demand Gen carousel
            ad.

            This field is a member of `oneof`_ ``ad_data``.
        demand_gen_video_responsive_ad (google.ads.googleads.v21.common.types.DemandGenVideoResponsiveAdInfo):
            Details pertaining to a Demand Gen video
            responsive ad.

            This field is a member of `oneof`_ ``ad_data``.
        demand_gen_product_ad (google.ads.googleads.v21.common.types.DemandGenProductAdInfo):
            Details pertaining to a Demand Gen product
            ad.

            This field is a member of `oneof`_ ``ad_data``.
        travel_ad (google.ads.googleads.v21.common.types.TravelAdInfo):
