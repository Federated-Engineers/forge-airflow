...
from google.ads.googleads.v21.enums.types import (
    customer_match_upload_key_type, lookalike_expansion_level,
    user_list_crm_data_source_type, user_list_date_rule_item_operator,
    user_list_flexible_rule_operator, user_list_logical_rule_operator,
    user_list_number_rule_item_operator, user_list_prepopulation_status,
    user_list_rule_type, user_list_string_rule_item_operator)
...
class LookalikeUserListInfo(proto.Message):
    ...
    Attributes:
        ...
        expansion_level (google.ads.googleads.v21.enums.types.LookalikeExpansionLevelEnum.LookalikeExpansionLevel):
...
class CrmBasedUserListInfo(proto.Message):
    ...
    Attributes:
        ...
        upload_key_type (google.ads.googleads.v21.enums.types.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType):
            Matching key type of the list.
            Mixed data types are not allowed on the same
            list. This field is required for an ADD
            operation.
        data_source_type (google.ads.googleads.v21.enums.types.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType):
...
class UserListRuleInfo(proto.Message):
    ...
    Attributes:
        rule_type (google.ads.googleads.v21.enums.types.UserListRuleTypeEnum.UserListRuleType):
        ...
        rule_item_groups (MutableSequence[google.ads.googleads.v21.common.types.UserListRuleItemGroupInfo]):
...
class UserListRuleItemGroupInfo(proto.Message):
    ...
    Attributes:
        rule_items (MutableSequence[google.ads.googleads.v21.common.types.UserListRuleItemInfo]):
...
class UserListRuleItemInfo(proto.Message):
    ...
    Attributes:
        ...
        number_rule_item (google.ads.googleads.v21.common.types.UserListNumberRuleItemInfo):
            An atomic rule item composed of a number
            operation.

            This field is a member of `oneof`_ ``rule_item``.
        string_rule_item (google.ads.googleads.v21.common.types.UserListStringRuleItemInfo):
            An atomic rule item composed of a string
            operation.

            This field is a member of `oneof`_ ``rule_item``.
        date_rule_item (google.ads.googleads.v21.common.types.UserListDateRuleItemInfo):
...
class UserListDateRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v21.enums.types.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator):
...
class UserListNumberRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v21.enums.types.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator):
...
class UserListStringRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v21.enums.types.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator):
...
class FlexibleRuleOperandInfo(proto.Message):
    ...
    Attributes:
        rule (google.ads.googleads.v21.common.types.UserListRuleInfo):
...
class FlexibleRuleUserListInfo(proto.Message):
    ...
    Attributes:
        inclusive_rule_operator (google.ads.googleads.v21.enums.types.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator):
            Operator that defines how the inclusive
            operands are combined.
        inclusive_operands (MutableSequence[google.ads.googleads.v21.common.types.FlexibleRuleOperandInfo]):
        ...
        exclusive_operands (MutableSequence[google.ads.googleads.v21.common.types.FlexibleRuleOperandInfo]):
...
class RuleBasedUserListInfo(proto.Message):
    ...
    Attributes:
        prepopulation_status (google.ads.googleads.v21.enums.types.UserListPrepopulationStatusEnum.UserListPrepopulationStatus):
            ...
            request fails.
        flexible_rule_user_list (google.ads.googleads.v21.common.types.FlexibleRuleUserListInfo):
...
class LogicalUserListInfo(proto.Message):
    ...
    Attributes:
        rules (MutableSequence[google.ads.googleads.v21.common.types.UserListLogicalRuleInfo]):
...
class UserListLogicalRuleInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v21.enums.types.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator):
            The logical operator of the rule.
        rule_operands (MutableSequence[google.ads.googleads.v21.common.types.LogicalUserListOperandInfo]):
...
class BasicUserListInfo(proto.Message):
    ...
    Attributes:
        actions (MutableSequence[google.ads.googleads.v21.common.types.UserListActionInfo]):
