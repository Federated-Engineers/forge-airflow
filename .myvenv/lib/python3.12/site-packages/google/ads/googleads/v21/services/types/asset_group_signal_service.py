...
class AssetGroupSignalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AssetGroupSignal):
...
class MutateAssetGroupSignalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAssetGroupSignalResult]):
