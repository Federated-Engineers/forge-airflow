...
from google.ads.googleads.v21.resources.types import asset_group_asset
...
class AssetGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v21.resources.types.AssetGroupAsset):
            Create operation: No resource name is
            expected for the new asset group asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v21.resources.types.AssetGroupAsset):
...
class MutateAssetGroupAssetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v21.services.types.MutateAssetGroupAssetResult]):
