...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.CampaignAssetSet):
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCampaignAssetSetResult]):
