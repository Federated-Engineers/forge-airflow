...
class RecommendationSubscriptionServiceTransport(abc.ABC):
    """Abstract transport class for RecommendationSubscriptionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_recommendation_subscription: gapic_v1.method.wrap_method(
