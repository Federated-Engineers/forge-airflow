...
class CustomerNegativeCriterionServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomerNegativeCriterionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CustomerNegativeCriterionServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CustomerNegativeCriterionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerNegativeCriterionServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerNegativeCriterionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomerNegativeCriterionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomerNegativeCriterionServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CustomerNegativeCriterionServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerNegativeCriterionServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CustomerNegativeCriterionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCustomerNegativeCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.CustomerNegativeCriterionOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_customer_negative_criteria
        ]
