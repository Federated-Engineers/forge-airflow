...
from google.ads.googleads.v24.enums.types import criterion_type
...
class SharedCriterion(proto.Message):
    ...
    Attributes:
        ...
        mobile_application (google.ads.googleads.v24.common.types.MobileApplicationInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        brand (google.ads.googleads.v24.common.types.BrandInfo):
            Immutable. Brand.
        ...
        webpage (google.ads.googleads.v24.common.types.WebpageInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        vertical_ads_item_group_rule (google.ads.googleads.v24.common.types.VerticalAdsItemGroupRuleInfo):
            Immutable. Vertical ads item group rule.

            This field is a member of `oneof`_ ``criterion``.
        retail_filter (google.ads.googleads.v24.common.types.RetailFilter):
    ...
    retail_filter: criteria.RetailFilter = proto.Field(
        proto.MESSAGE,
        number=181,
        oneof="criterion",
        message=criteria.RetailFilter,
    )
