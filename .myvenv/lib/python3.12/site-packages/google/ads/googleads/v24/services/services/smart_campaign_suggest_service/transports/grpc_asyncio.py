...
from .base import DEFAULT_CLIENT_INFO, SmartCampaignSuggestServiceTransport
...
class SmartCampaignSuggestServiceGrpcAsyncIOTransport(
    ...
    """gRPC AsyncIO backend transport for SmartCampaignSuggestService.
    ...
    def suggest_smart_campaign_budget_options(
        ...
        Returns:
            Callable[[~.SuggestSmartCampaignBudgetOptionsRequest],
                    Awaitable[~.SuggestSmartCampaignBudgetOptionsResponse]]:
        ...
        if "suggest_smart_campaign_budget_options" not in self._stubs:
            self._stubs["suggest_smart_campaign_budget_options"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.SmartCampaignSuggestService/SuggestSmartCampaignBudgetOptions",
    ...
    def suggest_smart_campaign_ad(
        ...
        Returns:
            Callable[[~.SuggestSmartCampaignAdRequest],
                    Awaitable[~.SuggestSmartCampaignAdResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "suggest_smart_campaign_ad" not in self._stubs:
            self._stubs["suggest_smart_campaign_ad"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.SmartCampaignSuggestService/SuggestSmartCampaignAd",
    ...
    def suggest_keyword_themes(
        ...
        Returns:
            Callable[[~.SuggestKeywordThemesRequest],
                    Awaitable[~.SuggestKeywordThemesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "suggest_keyword_themes" not in self._stubs:
            self._stubs["suggest_keyword_themes"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.SmartCampaignSuggestService/SuggestKeywordThemes",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.suggest_smart_campaign_budget_options: self._wrap_method(
                self.suggest_smart_campaign_budget_options,
                default_timeout=None,
                client_info=client_info,
            ),
            self.suggest_smart_campaign_ad: self._wrap_method(
                self.suggest_smart_campaign_ad,
                default_timeout=None,
                client_info=client_info,
            ),
            self.suggest_keyword_themes: self._wrap_method(
