...
from google.ads.googleads.v24.services.types import bidding_strategy_service
...
from .transports.grpc_asyncio import BiddingStrategyServiceGrpcAsyncIOTransport
...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def transport(self) -> BiddingStrategyServiceTransport:
        ...
        Returns:
            BiddingStrategyServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            BiddingStrategyServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = BiddingStrategyServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                BiddingStrategyServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = BiddingStrategyServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the bidding strategy service client.
        ...
        ) = BiddingStrategyServiceClient._read_environment_variables()
        self._client_cert_source = (
            BiddingStrategyServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            BiddingStrategyServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, BiddingStrategyServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(BiddingStrategyServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BiddingStrategyServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                BiddingStrategyServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., BiddingStrategyServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.BiddingStrategyServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.BiddingStrategyService",
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateBiddingStrategiesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.BiddingStrategyOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateBiddingStrategiesResponse:
