...
from .transports.grpc_asyncio import KeywordPlanIdeaServiceGrpcAsyncIOTransport
...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            KeywordPlanIdeaServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                KeywordPlanIdeaServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = KeywordPlanIdeaServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = KeywordPlanIdeaServiceClient._read_environment_variables()
        self._client_cert_source = (
            KeywordPlanIdeaServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            KeywordPlanIdeaServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, KeywordPlanIdeaServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(KeywordPlanIdeaServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanIdeaServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                KeywordPlanIdeaServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., KeywordPlanIdeaServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.KeywordPlanIdeaServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.KeywordPlanIdeaService",
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GenerateKeywordIdeasRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v24.services.services.keyword_plan_idea_service.pagers.GenerateKeywordIdeasPager:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.generate_keyword_ideas
        ]
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GenerateKeywordHistoricalMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.GenerateKeywordHistoricalMetricsResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics][google.ads.googleads.v24.services.KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_keyword_historical_metrics
        ]
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GenerateAdGroupThemesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.GenerateAdGroupThemesResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateAdGroupThemes][google.ads.googleads.v24.services.KeywordPlanIdeaService.GenerateAdGroupThemes].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_ad_group_themes
        ]
    ...
    def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GenerateKeywordForecastMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.GenerateKeywordForecastMetricsResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateKeywordForecastMetrics][google.ads.googleads.v24.services.KeywordPlanIdeaService.GenerateKeywordForecastMetrics].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_keyword_forecast_metrics
        ]
