...
from google.ads.googleads.v24.services.types import ad_group_criterion_service
...
class AdGroupCriterionServiceClient(
    metaclass=AdGroupCriterionServiceClientMeta
):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdGroupCriterionServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdGroupCriterionServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AdGroupCriterionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupCriterionServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupCriterionServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupCriterionServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AdGroupCriterionServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupCriterionServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(AdGroupCriterionServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupCriterionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupCriterionServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AdGroupCriterionServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AdGroupCriterionServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.AdGroupCriterionService",
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAdGroupCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AdGroupCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateAdGroupCriteriaResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_ad_group_criteria
        ]
