...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.PaymentsAccountServiceClient`.",
                    extra=(
                        {
    ...
    def list_payments_accounts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.ListPaymentsAccountsRequest, dict]):
