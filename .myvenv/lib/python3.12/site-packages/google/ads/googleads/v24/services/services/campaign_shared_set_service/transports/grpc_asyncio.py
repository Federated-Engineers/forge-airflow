...
from .base import DEFAULT_CLIENT_INFO, CampaignSharedSetServiceTransport
...
class CampaignSharedSetServiceGrpcAsyncIOTransport(
    CampaignSharedSetServiceTransport
):
    """gRPC AsyncIO backend transport for CampaignSharedSetService.
    ...
    def mutate_campaign_shared_sets(
        ...
        Returns:
            Callable[[~.MutateCampaignSharedSetsRequest],
                    Awaitable[~.MutateCampaignSharedSetsResponse]]:
        ...
        if "mutate_campaign_shared_sets" not in self._stubs:
            self._stubs["mutate_campaign_shared_sets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CampaignSharedSetService/MutateCampaignSharedSets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_shared_sets: self._wrap_method(
...
__all__ = ("CampaignSharedSetServiceGrpcAsyncIOTransport",)
