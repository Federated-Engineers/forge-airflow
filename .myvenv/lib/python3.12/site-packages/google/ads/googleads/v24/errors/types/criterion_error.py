    ...
    class CriterionError(proto.Enum):
        ...
        Values:
            ...
            INVALID_CAMPAIGN_TYPE_FOR_THIRD_PARTY_PARTNER_DATA_LIST (177):
                Targeting this UserList is not allowed for
                this campaign type.
            CANNOT_ADD_USER_LIST_PENDING_PRIVACY_REVIEW (178):
                The user list cannot be used while it is
                pending privacy review.
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST_DOES_NOT_EXIST (179):
                The referenced Vertical Ads item group rule
                list shared set does not exist.
            CANNOT_ADD_REMOVED_VERTICAL_ADS_ITEM_GROUP_RULE_LIST_SHARED_SET (180):
                Cannot add Vertical Ads Item Group Rule List
                with deleted shared set.
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_ENABLED_TRAVEL_FEED (181):
                Vertical Ads Item Group Rule List is not
                supported for campaigns that do not have an
                active travel feed.
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST_NOT_SUPPORTED_FOR_CAMPAIGNS_WITHOUT_AI_MAX (182):
                Vertical Ads Item Group Rule List is not
                supported for campaigns that do not have AI max
                enabled.
            VERTICAL_ADS_ITEM_GROUP_RULE_NOT_SUPPORTED_FOR_THE_VERTICAL_TYPE (183):
                The dimension of the Vertical Ads Item Group
                Rule criterion is not supported for the shared
                set vertical type.
            RETAIL_FILTER_EXPRESSION_DOES_NOT_EXIST (184):
                A RetailTag references a
                RetailFilterExpression name that does not exist.
