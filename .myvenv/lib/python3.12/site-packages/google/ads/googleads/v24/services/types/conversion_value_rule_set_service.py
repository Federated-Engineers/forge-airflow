...
class MutateConversionValueRuleSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v24.services.types.ConversionValueRuleSetOperation]):
...
class ConversionValueRuleSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.ConversionValueRuleSet):
            Create operation: No resource name is
            expected for the new conversion value rule set.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.ConversionValueRuleSet):
    ...
    update: gagr_conversion_value_rule_set.ConversionValueRuleSet = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_conversion_value_rule_set.ConversionValueRuleSet,
...
class MutateConversionValueRuleSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateConversionValueRuleSetResult]):
