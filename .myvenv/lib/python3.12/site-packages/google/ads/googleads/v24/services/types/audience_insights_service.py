...
from google.ads.googleads.v24.enums.types import (
    audience_insights_dimension, audience_insights_marketing_objective)
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    Attributes:
        ...
        baseline_audience (google.ads.googleads.v24.services.types.InsightsAudience):
            Required. A baseline audience for this
            report, typically all people in a region.
        specific_audience (google.ads.googleads.v24.services.types.InsightsAudience):
        ...
        insights_application_info (google.ads.googleads.v24.common.types.AdditionalApplicationInfo):
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v24.services.types.InsightsAudience):
        ...
        data_month (str):
            ...
            days of data.
        dimensions (MutableSequence[google.ads.googleads.v24.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
...
class GenerateAudienceCompositionInsightsResponse(proto.Message):
    ...
    Attributes:
        sections (MutableSequence[google.ads.googleads.v24.services.types.AudienceCompositionSection]):
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    r"""Request message for
    [AudienceInsightsService.GenerateSuggestedTargetingInsights][google.ads.googleads.v24.services.AudienceInsightsService.GenerateSuggestedTargetingInsights].
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v24.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        audience_definition (google.ads.googleads.v24.services.types.InsightsAudienceDefinition):
            Provide a seed audience to get suggestions
            for.

            This field is a member of `oneof`_ ``audience_input``.
        audience_description (google.ads.googleads.v24.services.types.InsightsAudienceDescription):
...
class GenerateSuggestedTargetingInsightsResponse(proto.Message):
    ...
    Attributes:
        suggestions (MutableSequence[google.ads.googleads.v24.services.types.TargetingSuggestionMetrics]):
...
class TargetingSuggestionMetrics(proto.Message):
    ...
    Attributes:
        locations (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata]):
            Suggested location targeting. These attributes all have
            dimension GEO_TARGET_COUNTRY or SUB_COUNTRY_LOCATION
        age_ranges (MutableSequence[google.ads.googleads.v24.common.types.AgeRangeInfo]):
            Suggested age targeting; may be empty
            indicating no age targeting.
        gender (google.ads.googleads.v24.common.types.GenderInfo):
            Suggested gender targeting.  If present, this
            attribute has dimension GENDER.
        parental_status (google.ads.googleads.v24.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).
        user_interests (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadataGroup]):
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        location_country_filters (MutableSequence[google.ads.googleads.v24.common.types.LocationInfo]):
            ...
            return an error.
        youtube_reach_location (google.ads.googleads.v24.common.types.LocationInfo):
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata]):
...
class ListInsightsEligibleDatesRequest(proto.Message):
    r"""Request message for
    [AudienceInsightsService.ListInsightsEligibleDates][google.ads.googleads.v24.services.AudienceInsightsService.ListInsightsEligibleDates].
...
class ListInsightsEligibleDatesResponse(proto.Message):
    ...
    Attributes:
        ...
        last_thirty_days (google.ads.googleads.v24.common.types.DateRange):
...
class GenerateAudienceOverlapInsightsResponse(proto.Message):
    ...
    Attributes:
        primary_attribute_metadata (google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata):
            Metadata for the primary attribute, including
            potential YouTube reach.
        dimension_results (MutableSequence[google.ads.googleads.v24.services.types.DimensionOverlapResult]):
...
class DimensionOverlapResult(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v24.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The dimension of all the attributes in this
            section.
        items (MutableSequence[google.ads.googleads.v24.services.types.AudienceOverlapItem]):
...
class AudienceOverlapItem(proto.Message):
    ...
    Attributes:
        attribute_metadata (google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata):
...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audiences (MutableSequence[google.ads.googleads.v24.services.types.InsightsAudience]):
...
class GenerateAudienceDefinitionResponse(proto.Message):
    ...
    Attributes:
        high_relevance_attributes (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata]):
            The attributes that make up the audience
            definition.
        medium_relevance_attributes (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsAttributeMetadata]):
...
class InsightsAudienceDescription(proto.Message):
    ...
    Attributes:
        ...
        audience_description (str):
            ...
            travel".
        marketing_objective (google.ads.googleads.v24.enums.types.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective):
        ...
        audience_dimensions (google.ads.googleads.v24.services.types.AudienceInsightsDimensions):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        country_locations (MutableSequence[google.ads.googleads.v24.common.types.LocationInfo]):
            Required. The countries for the audience.
        sub_country_locations (MutableSequence[google.ads.googleads.v24.common.types.LocationInfo]):
        ...
        parental_status (google.ads.googleads.v24.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (MutableSequence[google.ads.googleads.v24.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        lineups (MutableSequence[google.ads.googleads.v24.common.types.AudienceInsightsLineup]):
            Lineups representing the YouTube content
            viewed by the audience.
        user_list (google.ads.googleads.v24.common.types.UserListInfo):
            User list to be targeted by the audience.
        topic_audience_combinations (MutableSequence[google.ads.googleads.v24.common.types.InsightsAudienceAttributeGroup]):
            A list of audience attribute groups
            consisting of one or more Knowledge Graph
            entities, Product & Service Categories and user
            interests that describe an audience. The groups
            have a logical AND-of-ORs structure:

            1. Attributes within each
                InsightsAudienceAttributeGroup are combined
                with OR.

            2. The groups themselves are combined together
                with AND.

            For example, an audience (Interest A OR Interest
            B) AND (Entity C) is represented using two
            groups. The first group contains the two
            interests and the second group contains the
            entity.
    """
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (MutableSequence[google.ads.googleads.v24.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (MutableSequence[google.ads.googleads.v24.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v24.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (MutableSequence[google.ads.googleads.v24.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        ...
        metrics (google.ads.googleads.v24.services.types.AudienceCompositionMetrics):
