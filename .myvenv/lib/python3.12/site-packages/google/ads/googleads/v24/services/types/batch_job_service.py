...
class BatchJobOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.BatchJob):
...
class MutateBatchJobResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.MutateBatchJobResult):
...
class ListBatchJobResultsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.BatchJobResult]):
...
class BatchJobResult(proto.Message):
    ...
    Attributes:
        ...
        mutate_operation_response (google.ads.googleads.v24.services.types.MutateOperationResponse):
