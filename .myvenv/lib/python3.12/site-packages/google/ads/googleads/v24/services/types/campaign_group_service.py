...
class CampaignGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CampaignGroup):
            Create operation: No resource name is
            expected for the new campaign group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.CampaignGroup):
...
class MutateCampaignGroupsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCampaignGroupResult]):
