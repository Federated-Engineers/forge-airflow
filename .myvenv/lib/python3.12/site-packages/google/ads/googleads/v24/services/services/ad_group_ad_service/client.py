...
from google.ads.googleads.v24.services.types import ad_group_ad_service
from google.rpc import status_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, AdGroupAdServiceTransport
from .transports.grpc import AdGroupAdServiceGrpcTransport
from .transports.grpc_asyncio import AdGroupAdServiceGrpcAsyncIOTransport
...
class AdGroupAdServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = AdGroupAdServiceGrpcAsyncIOTransport
...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                AdGroupAdServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupAdServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupAdServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupAdServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AdGroupAdServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdGroupAdServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdGroupAdServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupAdServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupAdServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AdGroupAdServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AdGroupAdServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.AdGroupAdService",
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAdGroupAdsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AdGroupAdOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateAdGroupAdsResponse:
    ...
    def remove_automatically_created_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.RemoveAutomaticallyCreatedAssetsRequest, dict]):
                The request object. Request message for
            ...
            ad_group_ad (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            assets_with_field_type (MutableSequence[google.ads.googleads.v24.services.types.AssetsWithFieldType]):
