...
from google.ads.googleads.v24.enums.types import (interaction_event_type,
...
class Metrics(proto.Message):
    ...
    Attributes:
        ...
        historical_creative_quality_score (google.ads.googleads.v24.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
            The creative historical quality score.
        historical_landing_page_quality_score (google.ads.googleads.v24.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        historical_search_predicted_ctr (google.ads.googleads.v24.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        interaction_event_types (MutableSequence[google.ads.googleads.v24.enums.types.InteractionEventTypeEnum.InteractionEventType]):
        ...
        search_volume (google.ads.googleads.v24.common.types.SearchVolumeRange):
        ...
        all_average_cart_size (float):
            All average cart size is the average number of products in
            each order attributed to your ads. Includes the amount from
            the average_cart_size metric, plus avg. cart size from all
            your conversion actions, even if your campaigns are not
            actively optimizing towards them. It's calculated using
            product info from cart data to give more detail than
            conversion value alone.

            This field is a member of `oneof`_ ``_all_average_cart_size``.
        all_average_order_value_micros (int):
            All average order value is the average revenue you made per
            order attributed to your ads. Includes the amount from the
            average_order_value metric, plus avg. order value from all
            your conversion actions, even if your campaigns are not
            actively optimizing towards them. It's calculated using
            product info from cart data to give more detail than
            conversion value alone.

            This field is a member of `oneof`_ ``_all_average_order_value_micros``.
        all_cost_of_goods_sold_micros (int):
            All cost of goods sold is the total cost of the products you
            sold in orders attributed to your ads. Includes the amount
            from the cost_of_goods_sold_micros metric, plus cost of
            goods sold from all conversion actions, even if your
            campaigns are not actively optimizing towards them. It's
            calculated using product info from cart data to give more
            detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_cost_of_goods_sold_micros``.
        all_cross_sell_cost_of_goods_sold_micros (int):
            All cross-sell cost of goods sold is the total cost of
            products sold as a result of advertising a different
            product. Includes the amount from the
            cross_sell_cost_of_goods_sold_micros metric, plus cross-sell
            cost of goods sold from all your conversion actions, even if
            your campaigns are not actively optimizing towards them.
            It's calculated using product info from cart data to give
            more detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_cross_sell_cost_of_goods_sold_micros``.
        all_cross_sell_gross_profit_micros (int):
            All cross-sell gross profit is the profit you made from
            products sold as a result of advertising a different
            product, minus cost of goods sold (COGS). Includes the
            amount from the cross_sell_gross_profit_micros metric, plus
            cross-sell gross profit from all your conversion actions,
            even if your campaigns are not actively optimizing towards
            them. It's calculated using product info from cart data to
            give more detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_cross_sell_gross_profit_micros``.
        all_cross_sell_revenue_micros (int):
            All cross-sell revenue is the total amount you made from
            products sold as a result of advertising a different
            product. Includes the amount from the
            cross_sell_revenue_micros metric, plus cross-sell revenue
            from all your conversion actions, even if your campaigns are
            not actively optimizing towards them. It's calculated using
            product info from cart data to give more detail than
            conversion value alone.

            This field is a member of `oneof`_ ``_all_cross_sell_revenue_micros``.
        all_cross_sell_units_sold (float):
            All cross-sell units sold is the total number of products
            sold as a result of advertising a different product.
            Includes the amount shown in the cross_sell_units_sold
            metric, plus cross-sell units sold from all your conversion
            actions, even if your campaigns are not actively optimizing
            towards them. It's calculated using product info from cart
            data to give more detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_cross_sell_units_sold``.
        all_gross_profit_margin (float):
            All gross profit margin is the percentage gross profit you
            made from orders attributed to your ads, after taking out
            the cost of goods sold (COGS). This value is between 0.0 and
            1.0, where 1.0 means 100%. Includes the amount from the
            gross_profit_margin metric, plus gross profit margin across
            all conversion actions, even if your campaigns are not
            actively optimizing towards them. It's calculated using
            product info from cart data to give more detail than
            conversion value alone.

            This field is a member of `oneof`_ ``_all_gross_profit_margin``.
        all_gross_profit_micros (int):
            All gross profit is the total profit made from orders
            attributed to your ads minus the cost of goods sold (COGS).
            Includes the amount from the gross_profit_micros metric,
            plus gross profit from all your conversion actions, even if
            your campaigns are not actively optimizing towards them.
            It's calculated using product info from cart data to give
            more detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_gross_profit_micros``.
        all_lead_cost_of_goods_sold_micros (int):
            All lead cost of goods sold is the total cost of products
            sold as a result of advertising the same product. Includes
            the amount shown in the lead_cost_of_goods_sold_micros
            metric, plus lead cost of goods sold from all your
            conversion actions, even if your campaigns are not actively
            optimizing towards them. It's calculated using product info
            from cart data to give more detail than conversion value
            alone.

            This field is a member of `oneof`_ ``_all_lead_cost_of_goods_sold_micros``.
        all_lead_gross_profit_micros (int):
            All lead gross profit is the profit you made from products
            sold as a result of advertising the same product, minus cost
            of goods sold (COGS). Includes the amount from the
            lead_gross_profit_micros metric, plus lead gross profit from
            all your conversion actions, even if your campaigns are not
            actively optimizing towards them. It's calculated using
            product info from cart data to give more detail than
            conversion value alone.

            This field is a member of `oneof`_ ``_all_lead_gross_profit_micros``.
        all_lead_revenue_micros (int):
            All lead revenue is the total amount you made from products
            sold as a result of advertising the same product. Includes
            the amount shown in the lead_revenue_micros metric, plus
            lead revenue from all your conversion actions, even if your
            campaigns are not actively optimizing towards them. It's
            calculated using product info from cart data to give more
            detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_lead_revenue_micros``.
        all_lead_units_sold (float):
            All lead units sold is the total number of products sold as
            a result of advertising the same product. Includes the
            amount shown in the lead_units_sold metric, plus lead units
            sold from all your conversion actions, even if your
            campaigns are not actively optimizing towards them. It's
            calculated using product info from cart data to give more
            detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_lead_units_sold``.
        all_orders (float):
            All orders is total number of purchase
            conversions attributed to your ads. Includes the
            amount from the orders metric, plus orders from
            all your conversion actions, even if your
            campaigns are not actively optimizing towards
            them.
            It's calculated using product info from cart
            data to give more detail than conversion value
            alone.

            This field is a member of `oneof`_ ``_all_orders``.
        all_revenue_micros (int):
            All revenue is the total you made from orders attributed to
            your ads. Includes the amount from the revenue_micros
            metric, plus revenue from all your conversion actions, even
            if your campaigns are not actively optimizing towards them.
            It's calculated using product info from cart data to give
            more detail than conversion value alone.

            This field is a member of `oneof`_ ``_all_revenue_micros``.
        all_units_sold (float):
            All units sold is the total number of products sold from
            orders attributed to your ads. Includes the amount from the
            units_sold metric, plus units sold from all your conversion
            actions, even if your campaigns are not actively optimizing
            towards them. It's calculated using product info from cart
            data to give more detail than conversion value alone.
    ...
    all_average_cart_size: float = proto.Field(
        proto.DOUBLE,
        number=427,
        optional=True,
    )
    all_average_order_value_micros: int = proto.Field(
        proto.INT64,
        number=428,
        optional=True,
    )
    all_cost_of_goods_sold_micros: int = proto.Field(
        proto.INT64,
        number=429,
        optional=True,
    )
    all_cross_sell_cost_of_goods_sold_micros: int = proto.Field(
        proto.INT64,
        number=430,
        optional=True,
    )
    all_cross_sell_gross_profit_micros: int = proto.Field(
        proto.INT64,
        number=431,
        optional=True,
    )
    all_cross_sell_revenue_micros: int = proto.Field(
        proto.INT64,
        number=432,
        optional=True,
    )
    all_cross_sell_units_sold: float = proto.Field(
        proto.DOUBLE,
        number=433,
        optional=True,
    )
    all_gross_profit_margin: float = proto.Field(
        proto.DOUBLE,
        number=434,
        optional=True,
    )
    all_gross_profit_micros: int = proto.Field(
        proto.INT64,
        number=435,
        optional=True,
    )
    all_lead_cost_of_goods_sold_micros: int = proto.Field(
        proto.INT64,
        number=436,
        optional=True,
    )
    all_lead_gross_profit_micros: int = proto.Field(
        proto.INT64,
        number=437,
        optional=True,
    )
    all_lead_revenue_micros: int = proto.Field(
        proto.INT64,
        number=438,
        optional=True,
    )
    all_lead_units_sold: float = proto.Field(
        proto.DOUBLE,
        number=439,
        optional=True,
    )
    all_orders: float = proto.Field(
        proto.DOUBLE,
        number=440,
        optional=True,
    )
    all_revenue_micros: int = proto.Field(
        proto.INT64,
        number=441,
        optional=True,
    )
