...
class CpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.CpcBidSimulationPoint]):
...
class CpvBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.CpvBidSimulationPoint]):
...
class TargetCpaSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.TargetCpaSimulationPoint]):
...
class TargetRoasSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.TargetRoasSimulationPoint]):
...
class PercentCpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.PercentCpcBidSimulationPoint]):
...
class BudgetSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.BudgetSimulationPoint]):
...
class TargetImpressionShareSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v24.common.types.TargetImpressionShareSimulationPoint]):
