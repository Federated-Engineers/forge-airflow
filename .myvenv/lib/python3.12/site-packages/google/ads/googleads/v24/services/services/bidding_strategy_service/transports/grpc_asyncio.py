...
from .base import DEFAULT_CLIENT_INFO, BiddingStrategyServiceTransport
...
class BiddingStrategyServiceGrpcAsyncIOTransport(
    BiddingStrategyServiceTransport
):
    """gRPC AsyncIO backend transport for BiddingStrategyService.
    ...
    def mutate_bidding_strategies(
        ...
        Returns:
            Callable[[~.MutateBiddingStrategiesRequest],
                    Awaitable[~.MutateBiddingStrategiesResponse]]:
        ...
        if "mutate_bidding_strategies" not in self._stubs:
            self._stubs["mutate_bidding_strategies"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.BiddingStrategyService/MutateBiddingStrategies",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_bidding_strategies: self._wrap_method(
...
__all__ = ("BiddingStrategyServiceGrpcAsyncIOTransport",)
