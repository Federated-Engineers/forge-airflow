...
class QuoteCampaignsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            request.
        operation (google.ads.googleads.v24.actions.types.QuoteCampaignsOperation):
...
class QuoteCampaignsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.actions.types.QuoteCampaignsResult):
...
class BookCampaignsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer making the
            request.
        operation (google.ads.googleads.v24.actions.types.BookCampaignsOperation):
...
class BookCampaignsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.actions.types.BookCampaignsResult):
