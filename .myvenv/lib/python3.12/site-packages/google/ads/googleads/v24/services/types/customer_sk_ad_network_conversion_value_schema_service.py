...
class CustomerSkAdNetworkConversionValueSchemaOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v24.resources.types.CustomerSkAdNetworkConversionValueSchema):
...
class MutateCustomerSkAdNetworkConversionValueSchemaRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            being modified.
        operation (google.ads.googleads.v24.services.types.CustomerSkAdNetworkConversionValueSchemaOperation):
...
class MutateCustomerSkAdNetworkConversionValueSchemaResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.MutateCustomerSkAdNetworkConversionValueSchemaResult):
