...
from .base import DEFAULT_CLIENT_INFO, CampaignDraftServiceTransport
        ...
        if "mutate_campaign_drafts" not in self._stubs:
            self._stubs["mutate_campaign_drafts"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CampaignDraftService/MutateCampaignDrafts",
    ...
    def promote_campaign_draft(
        ...
        if "promote_campaign_draft" not in self._stubs:
            self._stubs["promote_campaign_draft"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CampaignDraftService/PromoteCampaignDraft",
    ...
    def list_campaign_draft_async_errors(
        ...
        if "list_campaign_draft_async_errors" not in self._stubs:
            self._stubs["list_campaign_draft_async_errors"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CampaignDraftService/ListCampaignDraftAsyncErrors",
