...
from google.ads.googleads.v24.enums.types import linked_product_type
...
class ProductLink(proto.Message):
    ...
    Attributes:
        ...
        data_partner (google.ads.googleads.v24.resources.types.DataPartnerIdentifier):
            Immutable. Data partner link.

            This field is a member of `oneof`_ ``linked_product``.
        google_ads (google.ads.googleads.v24.resources.types.GoogleAdsIdentifier):
            Immutable. Google Ads link.

            This field is a member of `oneof`_ ``linked_product``.
        merchant_center (google.ads.googleads.v24.resources.types.MerchantCenterIdentifier):
            Immutable. Google Merchant Center link.

            This field is a member of `oneof`_ ``linked_product``.
        advertising_partner (google.ads.googleads.v24.resources.types.AdvertisingPartnerIdentifier):
            Output only. Advertising Partner link.

            This field is a member of `oneof`_ ``linked_product``.
        advertising_partner_properties (google.ads.googleads.v24.resources.types.AdvertisingPartnerProperties):
            Output only. Advertising Partner link
