...
class CampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.Campaign):
            Create operation: No resource name is
            expected for the new campaign.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.Campaign):
...
class MutateCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCampaignResult]):
...
class EnableOperation(proto.Message):
    ...
    Attributes:
        ...
        brand_assets (google.ads.googleads.v24.services.types.BrandCampaignAssets):
...
class EnablePMaxBrandGuidelinesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.EnablementResult]):
