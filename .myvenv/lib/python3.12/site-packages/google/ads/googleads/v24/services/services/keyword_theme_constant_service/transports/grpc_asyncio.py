...
from .base import DEFAULT_CLIENT_INFO, KeywordThemeConstantServiceTransport
        ...
        if "suggest_keyword_theme_constants" not in self._stubs:
            self._stubs["suggest_keyword_theme_constants"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.KeywordThemeConstantService/SuggestKeywordThemeConstants",
