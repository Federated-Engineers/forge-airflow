    ...
    class UserListError(proto.Enum):
        ...
        Values:
            ...
            DUPLICATE_LOOKALIKE (46):
                Cannot create a Lookalike UserList which is a
                duplicate of an existing Lookalike.
            ...
            COMMERCE_PARTNER_NOT_ALLOWED (48):
                The commerce partner is only supported for
                COMMERCE_AUDIENCE.
            PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE (49):
                The partner audience info is not supported
                for the user list type.
            PARTNER_MANAGER_ACCOUNT_DISALLOWED (50):
                Manager account is not allowed to create this
                UserList.
            PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA (51):
                This UserList can only be created by
                allowlisted partners.
            ADVERTISER_TOS_NOT_ACCEPTED (52):
                The advertiser must accept the Terms of
                Service to create this UserList.
            ADVERTISER_PARTNER_LINK_MISSING (53):
                The advertiser must have an active link to
                the partner to create this UserList.
            ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA (54):
                This UserList can only be created for
                allowlisted advertisers.
            ACCOUNT_SETTING_TYPE_NOT_ALLOWED (55):
                This UserList is not allowed for this account
                type.
        """
