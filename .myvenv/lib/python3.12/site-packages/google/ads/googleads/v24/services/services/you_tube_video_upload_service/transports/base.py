...
class YouTubeVideoUploadServiceTransport(abc.ABC):
    """Abstract transport class for YouTubeVideoUploadService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_you_tube_video_upload: gapic_v1.method.wrap_method(
                self.create_you_tube_video_upload,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_you_tube_video_upload: gapic_v1.method.wrap_method(
                self.update_you_tube_video_upload,
                default_timeout=None,
                client_info=client_info,
            ),
            self.remove_you_tube_video_upload: gapic_v1.method.wrap_method(
