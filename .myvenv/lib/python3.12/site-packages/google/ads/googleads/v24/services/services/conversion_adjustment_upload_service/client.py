...
class ConversionAdjustmentUploadServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionAdjustmentUploadServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversionAdjustmentUploadServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        (
            ...
            ConversionAdjustmentUploadServiceClient._read_environment_variables()
        )
        ...
        self._universe_domain = (
            ConversionAdjustmentUploadServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionAdjustmentUploadServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ConversionAdjustmentUploadServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionAdjustmentUploadServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ConversionAdjustmentUploadServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.ConversionAdjustmentUploadService",
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.UploadConversionAdjustmentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            conversion_adjustments (MutableSequence[google.ads.googleads.v24.services.types.ConversionAdjustment]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.UploadConversionAdjustmentsResponse:
