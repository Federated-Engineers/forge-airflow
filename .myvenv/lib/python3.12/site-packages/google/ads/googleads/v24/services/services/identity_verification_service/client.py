...
from google.ads.googleads.v24.enums.types import identity_verification_program
...
from .transports.grpc import IdentityVerificationServiceGrpcTransport
...
class IdentityVerificationServiceClientMeta(type):
    """Metaclass for the IdentityVerificationService client.
...
class IdentityVerificationServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            IdentityVerificationServiceClient: The constructed client.
        """
    ...
    def transport(self) -> IdentityVerificationServiceTransport:
        ...
        Returns:
            IdentityVerificationServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                IdentityVerificationServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = IdentityVerificationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = IdentityVerificationServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the identity verification service client.
        ...
        ) = IdentityVerificationServiceClient._read_environment_variables()
        self._client_cert_source = (
            IdentityVerificationServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            IdentityVerificationServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, IdentityVerificationServiceTransport
        )
        if transport_provided:
            # transport is a IdentityVerificationServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                IdentityVerificationServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or IdentityVerificationServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                IdentityVerificationServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.IdentityVerificationServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.IdentityVerificationService",
    ...
    def start_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.StartIdentityVerificationRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            verification_program (google.ads.googleads.v24.enums.types.IdentityVerificationProgramEnum.IdentityVerificationProgram):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.start_identity_verification
        ]
    ...
    def get_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GetIdentityVerificationRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.GetIdentityVerificationResponse:
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.get_identity_verification
        ]
