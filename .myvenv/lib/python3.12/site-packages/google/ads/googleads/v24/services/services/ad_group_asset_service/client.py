...
from google.ads.googleads.v24.services.types import ad_group_asset_service
from google.rpc import status_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, AdGroupAssetServiceTransport
from .transports.grpc import AdGroupAssetServiceGrpcTransport
from .transports.grpc_asyncio import AdGroupAssetServiceGrpcAsyncIOTransport
...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def transport(self) -> AdGroupAssetServiceTransport:
        ...
        Returns:
            AdGroupAssetServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = AdGroupAssetServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdGroupAssetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AdGroupAssetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupAssetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the ad group asset service client.
        ...
        ) = AdGroupAssetServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupAssetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AdGroupAssetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdGroupAssetServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdGroupAssetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupAssetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupAssetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AdGroupAssetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AdGroupAssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.AdGroupAssetService",
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAdGroupAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AdGroupAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateAdGroupAssetsResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_ad_group_assets
        ]
