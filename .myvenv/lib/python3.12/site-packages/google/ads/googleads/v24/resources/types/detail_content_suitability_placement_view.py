...
class DetailContentSuitabilityPlacementView(proto.Message):
    r"""A detail content suitability placement view.

    Attributes:
        resource_name (str):
            Output only. The resource name of the detail content
            suitability placement view. Detail content suitability
        ...
        placement (str):
            ...
            at detail level, for example. website url,
            mobile application id, or a YouTube video id.
        placement_type (google.ads.googleads.v24.enums.types.PlacementTypeEnum.PlacementType):
