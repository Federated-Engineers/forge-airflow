...
from .transports.grpc import ConversionGoalCampaignConfigServiceGrpcTransport
from .transports.grpc_asyncio import \
    ConversionGoalCampaignConfigServiceGrpcAsyncIOTransport


class ConversionGoalCampaignConfigServiceClientMeta(type):
    """Metaclass for the ConversionGoalCampaignConfigService client.
...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ConversionGoalCampaignConfigServiceClient: The constructed client.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionGoalCampaignConfigServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ConversionGoalCampaignConfigServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        (
            ...
            ConversionGoalCampaignConfigServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            ConversionGoalCampaignConfigServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ConversionGoalCampaignConfigServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionGoalCampaignConfigServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ConversionGoalCampaignConfigServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionGoalCampaignConfigServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ConversionGoalCampaignConfigServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateConversionGoalCampaignConfigsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.ConversionGoalCampaignConfigOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_conversion_goal_campaign_configs
        ]
