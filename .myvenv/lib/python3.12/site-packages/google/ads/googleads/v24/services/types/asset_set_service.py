...
class AssetSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.AssetSet):
            Create operation: No resource name is
            expected for the new asset set

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.AssetSet):
    ...
    update: gagr_asset_set.AssetSet = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_asset_set.AssetSet,
...
class MutateAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateAssetSetResult]):
