...
from google.ads.googleads.v24.enums.types import (
    local_services_employee_status, local_services_employee_type)
...
class LocalServicesEmployee(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v24.enums.types.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus):
            Output only. Employee status, such as DELETED
            or ENABLED.
        type_ (google.ads.googleads.v24.enums.types.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType):
            Output only. Employee type.
        university_degrees (MutableSequence[google.ads.googleads.v24.resources.types.UniversityDegree]):
            Output only. A list of degrees this employee
            has obtained, and wants to feature.
        residencies (MutableSequence[google.ads.googleads.v24.resources.types.Residency]):
            Output only. The institutions where the
            employee has completed their residency.
        fellowships (MutableSequence[google.ads.googleads.v24.resources.types.Fellowship]):
            Output only. The institutions where the
