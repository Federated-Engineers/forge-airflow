...
from google.ads.googleads.v24.common.types import (additional_application_info,
                                                   criteria)
from google.ads.googleads.v24.common.types import dates as gagc_dates
from google.ads.googleads.v24.enums.types import benchmarks_marketing_objective
from google.ads.googleads.v24.enums.types import \
    benchmarks_source_type as gage_benchmarks_source_type
from google.ads.googleads.v24.enums.types import benchmarks_time_granularity
...
class ListBenchmarksAvailableDatesRequest(proto.Message):
    ...
    Attributes:
        application_info (google.ads.googleads.v24.common.types.AdditionalApplicationInfo):
...
class ListBenchmarksAvailableDatesResponse(proto.Message):
    ...
    Attributes:
        supported_dates (google.ads.googleads.v24.common.types.DateRange):
...
class ListBenchmarksLocationsResponse(proto.Message):
    ...
    Attributes:
        benchmarks_locations (MutableSequence[google.ads.googleads.v24.services.types.BenchmarksLocation]):
...
class BenchmarksLocation(proto.Message):
    ...
    Attributes:
        ...
        location_info (google.ads.googleads.v24.common.types.LocationInfo):
...
class ListBenchmarksProductsResponse(proto.Message):
    ...
    Attributes:
        benchmarks_products (MutableSequence[google.ads.googleads.v24.services.types.BenchmarksProductMetadata]):
...
class BenchmarksProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        marketing_objective (google.ads.googleads.v24.enums.types.BenchmarksMarketingObjectiveEnum.BenchmarksMarketingObjective):
...
class ListBenchmarksSourcesRequest(proto.Message):
    ...
    Attributes:
        benchmarks_sources (MutableSequence[google.ads.googleads.v24.enums.types.BenchmarksSourceTypeEnum.BenchmarksSourceType]):
...
class ListBenchmarksSourcesResponse(proto.Message):
    ...
    Attributes:
        benchmarks_sources (MutableSequence[google.ads.googleads.v24.services.types.BenchmarksSourceMetadata]):
...
class BenchmarksSourceMetadata(proto.Message):
    ...
    Attributes:
        benchmarks_source_type (google.ads.googleads.v24.enums.types.BenchmarksSourceTypeEnum.BenchmarksSourceType):
            The type of benchmarks source.
        industry_vertical_info (google.ads.googleads.v24.services.types.IndustryVerticalInfo):
...
class GenerateBenchmarksMetricsRequest(proto.Message):
    ...
    Attributes:
        ...
        location (google.ads.googleads.v24.common.types.LocationInfo):
            ...
            metrics for.
        benchmarks_source (google.ads.googleads.v24.services.types.BenchmarksSource):
            Required. The source used to generate
            benchmarks metrics for.
        product_filter (google.ads.googleads.v24.services.types.ProductFilter):
        ...
        breakdown_definition (google.ads.googleads.v24.services.types.BreakdownDefinition):
...
class ProductFilter(proto.Message):
    ...
    Attributes:
        product_list (google.ads.googleads.v24.services.types.ProductFilter.ProductList):
            The list of products.

            This field is a member of `oneof`_ ``filter_settings``.
        marketing_objective_list (google.ads.googleads.v24.services.types.ProductFilter.MarketingObjectiveList):
    ...
    class MarketingObjectiveList(proto.Message):
        ...
        Attributes:
            marketing_objectives (MutableSequence[google.ads.googleads.v24.enums.types.BenchmarksMarketingObjectiveEnum.BenchmarksMarketingObjective]):
...
class BreakdownDefinition(proto.Message):
    ...
    Attributes:
        date_breakdown (google.ads.googleads.v24.enums.types.BenchmarksTimeGranularityEnum.BenchmarksTimeGranularity):
            The granularity for segmenting metrics by date. When this
            field is set, a valid date_range in the
            GenerateBenchmarksMetricsRequest is required and must
            precisely align with the boundaries of the selected
            granularity.

            For example, a monthly breakdown must start on the first day
            of a month and end on the last day of a month. A quarterly
            breakdown must start on the first day of a quarter and end
            on the last day of a quarter. A weekly breakdown must start
            on a Sunday and end on a Saturday. This is different from
...
class GenerateBenchmarksMetricsResponse(proto.Message):
    ...
    Attributes:
        customer_metrics (google.ads.googleads.v24.services.types.Metrics):
            Metrics belonging to the customer.
        average_benchmarks_metrics (google.ads.googleads.v24.services.types.Metrics):
            Metrics for the selected benchmarks source.
        breakdown_metrics (MutableSequence[google.ads.googleads.v24.services.types.BreakdownMetrics]):
...
class BreakdownMetrics(proto.Message):
    ...
    Attributes:
        breakdown_key (google.ads.googleads.v24.services.types.BreakdownKey):
...
class BreakdownKey(proto.Message):
    ...
    Attributes:
        dates (google.ads.googleads.v24.common.types.DateRange):
...
class Metrics(proto.Message):
    ...
    Attributes:
        average_rate_metrics (google.ads.googleads.v24.services.types.RateMetrics):
