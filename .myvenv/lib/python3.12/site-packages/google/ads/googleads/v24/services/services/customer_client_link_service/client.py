...
class CustomerClientLinkServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomerClientLinkServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CustomerClientLinkServiceClient._DEFAULT_UNIVERSE
            )
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CustomerClientLinkServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CustomerClientLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerClientLinkServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerClientLinkServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerClientLinkServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomerClientLinkServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomerClientLinkServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CustomerClientLinkServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerClientLinkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerClientLinkServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomerClientLinkServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CustomerClientLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCustomerClientLinkRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v24.services.types.CustomerClientLinkOperation):
