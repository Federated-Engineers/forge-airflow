...
from google.ads.googleads.v24.resources.types import custom_audience
...
class CustomAudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CustomAudience):
...
class MutateCustomAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCustomAudienceResult]):
