...
class AccountBudgetProposalServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v24.services.AccountBudgetProposalServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.MutateAccountBudgetProposalRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v24.services.types.AccountBudgetProposalOperation`):
