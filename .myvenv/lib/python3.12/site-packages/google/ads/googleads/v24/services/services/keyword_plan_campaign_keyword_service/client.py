...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def transport(self) -> KeywordPlanCampaignKeywordServiceTransport:
        ...
        Returns:
            KeywordPlanCampaignKeywordServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            KeywordPlanCampaignKeywordServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = KeywordPlanCampaignKeywordServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the keyword plan campaign keyword service client.
        ...
        (
            ...
            KeywordPlanCampaignKeywordServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            KeywordPlanCampaignKeywordServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            KeywordPlanCampaignKeywordServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, KeywordPlanCampaignKeywordServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                KeywordPlanCampaignKeywordServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanCampaignKeywordServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.KeywordPlanCampaignKeywordServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.KeywordPlanCampaignKeywordOperation]):
