...
from .base import DEFAULT_CLIENT_INFO, ReachPlanServiceTransport
        ...
        if "generate_conversion_rates" not in self._stubs:
            self._stubs["generate_conversion_rates"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.ReachPlanService/GenerateConversionRates",
    ...
    def list_plannable_products(
        ...
        if "list_plannable_products" not in self._stubs:
            self._stubs["list_plannable_products"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.ReachPlanService/ListPlannableProducts",
    ...
    def list_plannable_user_lists(
        ...
        if "list_plannable_user_lists" not in self._stubs:
            self._stubs["list_plannable_user_lists"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.ReachPlanService/ListPlannableUserLists",
    ...
    def list_plannable_user_interests(
        ...
        if "list_plannable_user_interests" not in self._stubs:
            self._stubs["list_plannable_user_interests"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.ReachPlanService/ListPlannableUserInterests",
