...
class SharedCriterionOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.SharedCriterion):
    ...
    create: gagr_shared_criterion.SharedCriterion = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateSharedCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateSharedCriterionResult]):
