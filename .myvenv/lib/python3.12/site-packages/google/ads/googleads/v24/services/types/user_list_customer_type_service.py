...
from google.ads.googleads.v24.resources.types import user_list_customer_type
...
class UserListCustomerTypeOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.UserListCustomerType):
...
class MutateUserListCustomerTypesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateUserListCustomerTypeResult]):
