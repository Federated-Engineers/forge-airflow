...
from google.ads.googleads.v24.services.types import ad_group_ad_label_service
...
from .transports.grpc_asyncio import AdGroupAdLabelServiceGrpcAsyncIOTransport
...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdGroupAdLabelServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdGroupAdLabelServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AdGroupAdLabelServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupAdLabelServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupAdLabelServiceClient._read_environment_variables()
        ...
        self._universe_domain = (
            AdGroupAdLabelServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupAdLabelServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(AdGroupAdLabelServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupAdLabelServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupAdLabelServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AdGroupAdLabelServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AdGroupAdLabelServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.AdGroupAdLabelService",
    ...
    def mutate_ad_group_ad_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAdGroupAdLabelsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AdGroupAdLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateAdGroupAdLabelsResponse:
