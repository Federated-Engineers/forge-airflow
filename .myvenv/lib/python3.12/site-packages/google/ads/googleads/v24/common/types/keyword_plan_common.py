...
from google.ads.googleads.v24.enums.types import (
    keyword_plan_aggregate_metric_type, keyword_plan_competition_level,
    keyword_plan_concept_group_type, month_of_year)
...
class KeywordPlanHistoricalMetrics(proto.Message):
    ...
    Attributes:
        ...
        monthly_search_volumes (MutableSequence[google.ads.googleads.v24.common.types.MonthlySearchVolume]):
            Approximate number of searches on this query
            for the past twelve months.
        competition (google.ads.googleads.v24.enums.types.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel):
    ...
    competition: (
        keyword_plan_competition_level.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel
    ) = proto.Field(
        proto.ENUM,
        number=2,
...
class HistoricalMetricsOptions(proto.Message):
    ...
    Attributes:
        year_month_range (google.ads.googleads.v24.common.types.YearMonthRange):
...
class MonthlySearchVolume(proto.Message):
    ...
    Attributes:
        ...
        month (google.ads.googleads.v24.enums.types.MonthOfYearEnum.MonthOfYear):
...
class KeywordPlanAggregateMetrics(proto.Message):
    ...
    Attributes:
        aggregate_metric_types (MutableSequence[google.ads.googleads.v24.enums.types.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType]):
...
class KeywordPlanAggregateMetricResults(proto.Message):
    ...
    Attributes:
        device_searches (MutableSequence[google.ads.googleads.v24.common.types.KeywordPlanDeviceSearches]):
...
class KeywordAnnotations(proto.Message):
    ...
    Attributes:
        concepts (MutableSequence[google.ads.googleads.v24.common.types.KeywordConcept]):
...
class KeywordConcept(proto.Message):
    ...
    Attributes:
        ...
        concept_group (google.ads.googleads.v24.common.types.ConceptGroup):
...
class ConceptGroup(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v24.enums.types.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType):
    ...
    type_: (
        keyword_plan_concept_group_type.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType
    ) = proto.Field(
        proto.ENUM,
        number=2,
