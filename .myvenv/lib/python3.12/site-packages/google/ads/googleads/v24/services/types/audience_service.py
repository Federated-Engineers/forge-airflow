...
class MutateAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateAudienceResult]):
...
class AudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.Audience):
            Create operation: No resource name is
            expected for the new audience

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.Audience):
