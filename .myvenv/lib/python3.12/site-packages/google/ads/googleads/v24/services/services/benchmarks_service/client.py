...
from typing import (Callable, Dict, MutableSequence, Optional, Sequence, Tuple,
                    Type, Union, cast)
...
from google.ads.googleads.v24.enums.types import benchmarks_source_type
from google.ads.googleads.v24.services.types import benchmarks_service

from .transports.base import DEFAULT_CLIENT_INFO, BenchmarksServiceTransport
from .transports.grpc import BenchmarksServiceGrpcTransport
from .transports.grpc_asyncio import BenchmarksServiceGrpcAsyncIOTransport


class BenchmarksServiceClientMeta(type):
    """Metaclass for the BenchmarksService client.
    ...
    ) -> Type[BenchmarksServiceTransport]:
...
class BenchmarksServiceClient(metaclass=BenchmarksServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            BenchmarksServiceClient: The constructed client.
        """
    ...
    def transport(self) -> BenchmarksServiceTransport:
        ...
        Returns:
            BenchmarksServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = BenchmarksServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = BenchmarksServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                BenchmarksServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = BenchmarksServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the benchmarks service client.
        ...
        ) = BenchmarksServiceClient._read_environment_variables()
        self._client_cert_source = (
            BenchmarksServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = BenchmarksServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, BenchmarksServiceTransport)
        if transport_provided:
            # transport is a BenchmarksServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(BenchmarksServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or BenchmarksServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                BenchmarksServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., BenchmarksServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.BenchmarksServiceClient`.",
                    extra=(
                        {
    ...
    def list_benchmarks_available_dates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.ListBenchmarksAvailableDatesRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.ListBenchmarksAvailableDatesResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.list_benchmarks_available_dates
        ]
    ...
    def list_benchmarks_locations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.ListBenchmarksLocationsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.ListBenchmarksLocationsResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksLocations][google.ads.googleads.v24.services.BenchmarksService.ListBenchmarksLocations].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_benchmarks_locations
        ]
    ...
    def list_benchmarks_products(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.ListBenchmarksProductsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.ListBenchmarksProductsResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksProducts][google.ads.googleads.v24.services.BenchmarksService.ListBenchmarksProducts].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_benchmarks_products
        ]
    ...
    def list_benchmarks_sources(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.ListBenchmarksSourcesRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.ListBenchmarksSourcesResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksSources][google.ads.googleads.v24.services.BenchmarksService.ListBenchmarksSources].
        ...
        if not isinstance(
            ...
            # request, apply these.
            if benchmarks_sources is not None:
                request.benchmarks_sources = benchmarks_sources

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.list_benchmarks_sources
        ]
    ...
    def generate_benchmarks_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.GenerateBenchmarksMetricsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.GenerateBenchmarksMetricsResponse:
                Response message for
                   [BenchmarksService.GenerateBenchmarksMetrics][google.ads.googleads.v24.services.BenchmarksService.GenerateBenchmarksMetrics].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_benchmarks_metrics
        ]
