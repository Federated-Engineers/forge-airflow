...
from .base import DEFAULT_CLIENT_INFO, GoogleAdsServiceTransport
...
class GoogleAdsServiceGrpcAsyncIOTransport(GoogleAdsServiceTransport):
    ...
    def search_stream(
        ...
        if "search_stream" not in self._stubs:
            self._stubs["search_stream"] = self._logged_channel.unary_stream(
                "/google.ads.googleads.v24.services.GoogleAdsService/SearchStream",
    ...
    def mutate(
        ...
        Executes mutate and actions operations. Mutate operations
