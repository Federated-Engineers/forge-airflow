...
class AdGroupBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.AdGroupBidModifier):
            Create operation: No resource name is
            expected for the new ad group bid modifier.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.AdGroupBidModifier):
...
class MutateAdGroupBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateAdGroupBidModifierResult]):
