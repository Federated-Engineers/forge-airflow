...
from google.ads.googleads.v24.resources.types import campaign_goal_config
...
class CampaignGoalConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CampaignGoalConfig):
...
class MutateCampaignGoalConfigsResponse(proto.Message):
    ...
    Attributes:
        ...
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCampaignGoalConfigResult]):
