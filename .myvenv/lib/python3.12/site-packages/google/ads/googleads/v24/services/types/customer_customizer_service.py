...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.CustomerCustomizer):
    ...
    create: gagr_customer_customizer.CustomerCustomizer = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCustomerCustomizerResult]):
