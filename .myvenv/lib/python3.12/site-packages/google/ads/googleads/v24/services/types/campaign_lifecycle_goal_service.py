...
from google.ads.googleads.v24.resources.types import campaign_lifecycle_goal
...
class CampaignLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CampaignLifecycleGoal):
...
class ConfigureCampaignLifecycleGoalsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.ConfigureCampaignLifecycleGoalsResult):
