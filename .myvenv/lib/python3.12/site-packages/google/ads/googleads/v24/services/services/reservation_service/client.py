...
from google.ads.googleads.v24.services.types import reservation_service
...
class ReservationServiceClient(metaclass=ReservationServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = ReservationServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                ReservationServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ReservationServiceClient`.",
                    extra=(
                        {
    ...
    def quote_campaigns(
        self,
        request: Optional[
            Union[reservation_service.QuoteCampaignsRequest, dict]
        ] = None,
        *,
        ...
        r"""Proposes quotes for booking campaigns.
        This request can have a latency of 30 seconds.

        Args:
            request (Union[google.ads.googleads.v24.services.types.QuoteCampaignsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.QuoteCampaignsResponse:
        ...
        if not isinstance(request, reservation_service.QuoteCampaignsRequest):
            request = reservation_service.QuoteCampaignsRequest(request)
        ...
        rpc = self._transport._wrapped_methods[self._transport.quote_campaigns]
    ...
    def book_campaigns(
        self,
        request: Optional[
            Union[reservation_service.BookCampaignsRequest, dict]
        ] = None,
        *,
        customer_id: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        r"""Books the requested campaigns.
        This request can have a latency of 30 seconds.

        Args:
            request (Union[google.ads.googleads.v24.services.types.BookCampaignsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.BookCampaignsResponse:
                Response message for
                   [ReservationService.BookCampaigns][google.ads.googleads.v24.services.ReservationService.BookCampaigns].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, reservation_service.BookCampaignsRequest):
            request = reservation_service.BookCampaignsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if customer_id is not None:
                request.customer_id = customer_id
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.book_campaigns]
