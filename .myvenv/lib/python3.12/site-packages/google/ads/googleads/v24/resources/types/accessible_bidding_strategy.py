...
class AccessibleBiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            strategy.
        type_ (google.ads.googleads.v24.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        owner_descriptive_name (str):
            ...
            bidding strategy.
        maximize_conversion_value (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.MaximizeConversionValue):
        ...
        maximize_conversions (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.MaximizeConversions):
            Output only. An automated bidding strategy to
            help get the most conversions for your campaigns
            while spending your budget.

            This field is a member of `oneof`_ ``scheme``.
        target_cpa (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.TargetCpa):
            ...
            This field is a member of `oneof`_ ``scheme``.
        target_impression_share (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.TargetImpressionShare):
            Output only. A bidding strategy that
            automatically optimizes towards a chosen
            percentage of impressions.

            This field is a member of `oneof`_ ``scheme``.
        target_roas (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.TargetRoas):
            Output only. A bidding strategy that helps
            you maximize revenue while averaging a specific
            target Return On Ad Spend (ROAS).

            This field is a member of `oneof`_ ``scheme``.
        target_spend (google.ads.googleads.v24.resources.types.AccessibleBiddingStrategy.TargetSpend):
