...
from google.ads.googleads.v24.enums.types import (
    ad_strength_action_item_type,
    asset_coverage_video_aspect_ratio_requirement)
from google.ads.googleads.v24.enums.types import \
    asset_field_type as gage_asset_field_type
from google.ads.googleads.v24.enums.types import (
    asset_group_primary_status, asset_group_primary_status_reason,
    asset_group_status)
...
class AssetGroup(proto.Message):
    ...
    Attributes:
        ...
        final_mobile_urls (MutableSequence[str]):
            ...
            unless opted out.
        status (google.ads.googleads.v24.enums.types.AssetGroupStatusEnum.AssetGroupStatus):
            The status of the asset group.
        primary_status (google.ads.googleads.v24.enums.types.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus):
        ...
        primary_status_reasons (MutableSequence[google.ads.googleads.v24.enums.types.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason]):
        ...
        ad_strength (google.ads.googleads.v24.enums.types.AdStrengthEnum.AdStrength):
            ...
            asset group.
        asset_coverage (google.ads.googleads.v24.resources.types.AssetCoverage):
...
class AssetCoverage(proto.Message):
    ...
    Attributes:
        ad_strength_action_items (MutableSequence[google.ads.googleads.v24.resources.types.AdStrengthActionItem]):
...
class AdStrengthActionItem(proto.Message):
    ...
    Attributes:
        action_item_type (google.ads.googleads.v24.enums.types.AdStrengthActionItemTypeEnum.AdStrengthActionItemType):
            Output only. The action item type.
        add_asset_details (google.ads.googleads.v24.resources.types.AdStrengthActionItem.AddAssetDetails):
    ...
    class AddAssetDetails(proto.Message):
        ...
        Attributes:
            ...
            video_aspect_ratio_requirement (google.ads.googleads.v24.enums.types.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement):
