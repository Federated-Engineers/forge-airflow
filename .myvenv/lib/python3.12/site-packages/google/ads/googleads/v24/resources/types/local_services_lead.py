...
from google.ads.googleads.v24.enums.types import (
    local_services_lead_credit_state, local_services_lead_status,
    local_services_lead_type)
...
class LocalServicesLead(proto.Message):
    ...
    Attributes:
        ...
        contact_details (google.ads.googleads.v24.resources.types.ContactDetails):
            Output only. Lead's contact details.
        lead_type (google.ads.googleads.v24.enums.types.LocalServicesLeadTypeEnum.LeadType):
            Output only. Type of Local Services lead:
            phone, message, booking, etc.
        lead_status (google.ads.googleads.v24.enums.types.LocalServicesLeadStatusEnum.LeadStatus):
        ...
        note (google.ads.googleads.v24.resources.types.Note):
        ...
        credit_details (google.ads.googleads.v24.resources.types.CreditDetails):
...
class CreditDetails(proto.Message):
    ...
    Attributes:
        credit_state (google.ads.googleads.v24.enums.types.LocalServicesCreditStateEnum.CreditState):
