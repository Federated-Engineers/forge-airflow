...
from google.ads.googleads.v24.common.types import (asset_types,
                                                   custom_parameter, policy)
from google.ads.googleads.v24.enums.types import \
    asset_field_type as gage_asset_field_type
from google.ads.googleads.v24.enums.types import asset_orientation
from google.ads.googleads.v24.enums.types import \
    asset_source as gage_asset_source
from google.ads.googleads.v24.enums.types import (asset_type,
...
class Asset(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v24.enums.types.AssetTypeEnum.AssetType):
        ...
        source (google.ads.googleads.v24.enums.types.AssetSourceEnum.AssetSource):
            Output only. Source of the asset.
        policy_summary (google.ads.googleads.v24.resources.types.AssetPolicySummary):
            Output only. Policy information for the
            asset.
        field_type_policy_summaries (MutableSequence[google.ads.googleads.v24.resources.types.AssetFieldTypePolicySummary]):
            Output only. Policy information for the asset
            for each FieldType.
        orientation (google.ads.googleads.v24.enums.types.AssetOrientationEnum.AssetOrientation):
            Output only. Orientation of the asset. This
            is only supported for image and video assets.

            This field is a member of `oneof`_ ``_orientation``.
        youtube_video_asset (google.ads.googleads.v24.common.types.YoutubeVideoAsset):
            Immutable. A YouTube video asset.

            This field is a member of `oneof`_ ``asset_data``.
        media_bundle_asset (google.ads.googleads.v24.common.types.MediaBundleAsset):
            Immutable. A media bundle asset.

            This field is a member of `oneof`_ ``asset_data``.
        image_asset (google.ads.googleads.v24.common.types.ImageAsset):
            Output only. An image asset.

            This field is a member of `oneof`_ ``asset_data``.
        text_asset (google.ads.googleads.v24.common.types.TextAsset):
            Immutable. A text asset.

            This field is a member of `oneof`_ ``asset_data``.
        lead_form_asset (google.ads.googleads.v24.common.types.LeadFormAsset):
            A lead form asset.

            This field is a member of `oneof`_ ``asset_data``.
        book_on_google_asset (google.ads.googleads.v24.common.types.BookOnGoogleAsset):
            A book on google asset.

            This field is a member of `oneof`_ ``asset_data``.
        promotion_asset (google.ads.googleads.v24.common.types.PromotionAsset):
            A promotion asset.

            This field is a member of `oneof`_ ``asset_data``.
        callout_asset (google.ads.googleads.v24.common.types.CalloutAsset):
            A callout asset.

            This field is a member of `oneof`_ ``asset_data``.
        structured_snippet_asset (google.ads.googleads.v24.common.types.StructuredSnippetAsset):
            A structured snippet asset.

            This field is a member of `oneof`_ ``asset_data``.
        sitelink_asset (google.ads.googleads.v24.common.types.SitelinkAsset):
            A sitelink asset.

            This field is a member of `oneof`_ ``asset_data``.
        page_feed_asset (google.ads.googleads.v24.common.types.PageFeedAsset):
            A page feed asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_education_asset (google.ads.googleads.v24.common.types.DynamicEducationAsset):
            A dynamic education asset.

            This field is a member of `oneof`_ ``asset_data``.
        mobile_app_asset (google.ads.googleads.v24.common.types.MobileAppAsset):
            A mobile app asset.

            This field is a member of `oneof`_ ``asset_data``.
        hotel_callout_asset (google.ads.googleads.v24.common.types.HotelCalloutAsset):
            A hotel callout asset.

            This field is a member of `oneof`_ ``asset_data``.
        call_asset (google.ads.googleads.v24.common.types.CallAsset):
            A call asset.

            This field is a member of `oneof`_ ``asset_data``.
        price_asset (google.ads.googleads.v24.common.types.PriceAsset):
            A price asset.

            This field is a member of `oneof`_ ``asset_data``.
        call_to_action_asset (google.ads.googleads.v24.common.types.CallToActionAsset):
            Immutable. A call to action asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_real_estate_asset (google.ads.googleads.v24.common.types.DynamicRealEstateAsset):
            A dynamic real estate asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_custom_asset (google.ads.googleads.v24.common.types.DynamicCustomAsset):
            A dynamic custom asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_hotels_and_rentals_asset (google.ads.googleads.v24.common.types.DynamicHotelsAndRentalsAsset):
            A dynamic hotels and rentals asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_flights_asset (google.ads.googleads.v24.common.types.DynamicFlightsAsset):
            A dynamic flights asset.

            This field is a member of `oneof`_ ``asset_data``.
        demand_gen_carousel_card_asset (google.ads.googleads.v24.common.types.DemandGenCarouselCardAsset):
            Immutable. A Demand Gen carousel card asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_travel_asset (google.ads.googleads.v24.common.types.DynamicTravelAsset):
            A dynamic travel asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_local_asset (google.ads.googleads.v24.common.types.DynamicLocalAsset):
            A dynamic local asset.

            This field is a member of `oneof`_ ``asset_data``.
        dynamic_jobs_asset (google.ads.googleads.v24.common.types.DynamicJobsAsset):
            A dynamic jobs asset.

            This field is a member of `oneof`_ ``asset_data``.
        location_asset (google.ads.googleads.v24.common.types.LocationAsset):
            Output only. A location asset.

            This field is a member of `oneof`_ ``asset_data``.
        hotel_property_asset (google.ads.googleads.v24.common.types.HotelPropertyAsset):
            Immutable. A hotel property asset.

            This field is a member of `oneof`_ ``asset_data``.
        business_message_asset (google.ads.googleads.v24.common.types.BusinessMessageAsset):
            A business message asset.

            This field is a member of `oneof`_ ``asset_data``.
        app_deep_link_asset (google.ads.googleads.v24.common.types.AppDeepLinkAsset):
            Immutable. An app deep link asset.

            This field is a member of `oneof`_ ``asset_data``.
        youtube_video_list_asset (google.ads.googleads.v24.common.types.YouTubeVideoListAsset):
    ...
    orientation: asset_orientation.AssetOrientationEnum.AssetOrientation = (
        proto.Field(
            proto.ENUM,
            number=54,
            optional=True,
    ...
    business_message_asset: asset_types.BusinessMessageAsset = proto.Field(
        proto.MESSAGE,
        number=51,
        oneof="asset_data",
        message=asset_types.BusinessMessageAsset,
    )
    app_deep_link_asset: asset_types.AppDeepLinkAsset = proto.Field(
        proto.MESSAGE,
        number=52,
        oneof="asset_data",
        message=asset_types.AppDeepLinkAsset,
    )
    youtube_video_list_asset: asset_types.YouTubeVideoListAsset = proto.Field(
        proto.MESSAGE,
        number=53,
        oneof="asset_data",
        message=asset_types.YouTubeVideoListAsset,
    )
...
class AssetFieldTypePolicySummary(proto.Message):
    ...
    Attributes:
        asset_field_type (google.ads.googleads.v24.enums.types.AssetFieldTypeEnum.AssetFieldType):
            Output only. FieldType of this asset.

            This field is a member of `oneof`_ ``_asset_field_type``.
        asset_source (google.ads.googleads.v24.enums.types.AssetSourceEnum.AssetSource):
            Output only. Source of this asset.

            This field is a member of `oneof`_ ``_asset_source``.
        policy_summary_info (google.ads.googleads.v24.resources.types.AssetPolicySummary):
...
class AssetPolicySummary(proto.Message):
    ...
    Attributes:
        ...
        review_status (google.ads.googleads.v24.enums.types.PolicyReviewStatusEnum.PolicyReviewStatus):
            ...
            asset is.
        approval_status (google.ads.googleads.v24.enums.types.PolicyApprovalStatusEnum.PolicyApprovalStatus):
