...
class BenchmarksServiceTransport(abc.ABC):
    """Abstract transport class for BenchmarksService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_benchmarks_available_dates: gapic_v1.method.wrap_method(
                self.list_benchmarks_available_dates,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_benchmarks_locations: gapic_v1.method.wrap_method(
                self.list_benchmarks_locations,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_benchmarks_products: gapic_v1.method.wrap_method(
                self.list_benchmarks_products,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_benchmarks_sources: gapic_v1.method.wrap_method(
                self.list_benchmarks_sources,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_benchmarks_metrics: gapic_v1.method.wrap_method(
