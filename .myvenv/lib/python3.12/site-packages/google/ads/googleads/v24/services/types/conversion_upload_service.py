...
from google.ads.googleads.v24.common.types import offline_user_data
from google.ads.googleads.v24.enums.types import (conversion_customer_type,
                                                  conversion_environment_enum)
...
class UploadClickConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            See `Best practices for partial
            failures </google-ads/api/docs/best-practices/partial-failures>`__.
        results (MutableSequence[google.ads.googleads.v24.services.types.ClickConversionResult]):
...
class UploadCallConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            See `Best practices for partial
            failures </google-ads/api/docs/best-practices/partial-failures>`__.
        results (MutableSequence[google.ads.googleads.v24.services.types.CallConversionResult]):
            Returned for successfully processed conversions. Proto will
            be empty for rows that received an error. Results are not
            returned when ``validate_only`` is ``true``.
    """
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v24.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (MutableSequence[google.ads.googleads.v24.services.types.CustomVariable]):
            The custom variables associated with this
            conversion.
        cart_data (google.ads.googleads.v24.services.types.CartData):
        ...
        conversion_environment (google.ads.googleads.v24.enums.types.ConversionEnvironmentEnum.ConversionEnvironment):
        ...
        customer_type (google.ads.googleads.v24.enums.types.ConversionCustomerTypeEnum.ConversionCustomerType):
        ...
        session_attributes_key_value_pairs (google.ads.googleads.v24.services.types.SessionAttributesKeyValuePairs):
...
class CartData(proto.Message):
    ...
    Attributes:
        ...
        local_transaction_cost (float):
            ...
            message.
        items (MutableSequence[google.ads.googleads.v24.services.types.CartData.Item]):
...
class SessionAttributesKeyValuePairs(proto.Message):
    ...
    Attributes:
        key_value_pairs (MutableSequence[google.ads.googleads.v24.services.types.SessionAttributeKeyValuePair]):
