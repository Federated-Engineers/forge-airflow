...
from .base import DEFAULT_CLIENT_INFO, ConversionValueRuleSetServiceTransport
        ...
        if "mutate_conversion_value_rule_sets" not in self._stubs:
            self._stubs["mutate_conversion_value_rule_sets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.ConversionValueRuleSetService/MutateConversionValueRuleSets",
