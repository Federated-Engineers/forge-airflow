...
class ConversionValueRuleServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionValueRuleServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                ConversionValueRuleServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = ConversionValueRuleServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ConversionValueRuleServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = ConversionValueRuleServiceClient._read_environment_variables()
        self._client_cert_source = (
            ConversionValueRuleServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ConversionValueRuleServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionValueRuleServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ConversionValueRuleServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionValueRuleServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ConversionValueRuleServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ConversionValueRuleServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.ConversionValueRuleService",
    ...
    def mutate_conversion_value_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateConversionValueRulesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.ConversionValueRuleOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateConversionValueRulesResponse:
