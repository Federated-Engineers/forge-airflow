...
class AdGroupBidModifierServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AdGroupBidModifierServiceTransport]]
...
class AdGroupBidModifierServiceClient(
    metaclass=AdGroupBidModifierServiceClientMeta
):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AdGroupBidModifierServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                AdGroupBidModifierServiceClient._DEFAULT_UNIVERSE
            )
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = AdGroupBidModifierServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = AdGroupBidModifierServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupBidModifierServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupBidModifierServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupBidModifierServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AdGroupBidModifierServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupBidModifierServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                AdGroupBidModifierServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupBidModifierServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupBidModifierServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., AdGroupBidModifierServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AdGroupBidModifierServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAdGroupBidModifiersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AdGroupBidModifierOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_ad_group_bid_modifiers
        ]
    ...
    def __enter__(self) -> "AdGroupBidModifierServiceClient":
        return self
