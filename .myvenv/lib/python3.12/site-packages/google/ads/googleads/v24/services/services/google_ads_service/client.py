...
from typing import (Callable, Dict, Iterable, MutableSequence, Optional,
                    Sequence, Tuple, Type, Union, cast)

import google.protobuf
from google.ads.googleads.v24 import gapic_version as package_version
...
from google.ads.googleads.v24.services.services.google_ads_service import \
    pagers
from google.ads.googleads.v24.services.types import google_ads_service
from google.protobuf import field_mask_pb2  # type: ignore
from google.rpc import status_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, GoogleAdsServiceTransport
...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    @staticmethod
    def ai_max_search_term_ad_combination_view_path(
        customer_id: str,
        ad_group_id: str,
        search_term: str,
        landing_page: str,
        ...
        """Returns a fully-qualified ai_max_search_term_ad_combination_view string."""
        return "customers/{customer_id}/aiMaxSearchTermAdCombinationViews/{ad_group_id}~{search_term}~{landing_page}~{headline}".format(
            customer_id=customer_id,
            ad_group_id=ad_group_id,
    ...
    @staticmethod
    def parse_ai_max_search_term_ad_combination_view_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a ai_max_search_term_ad_combination_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/aiMaxSearchTermAdCombinationViews/(?P<ad_group_id>.+?)~(?P<search_term>.+?)~(?P<landing_page>.+?)~(?P<headline>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def android_privacy_shared_key_google_ad_group_path(
        customer_id: str,
        campaign_id: str,
        ad_group_id: str,
        android_privacy_interaction_type: str,
        android_privacy_network_type: str,
        android_privacy_interaction_date: str,
    ) -> str:
        """Returns a fully-qualified android_privacy_shared_key_google_ad_group string."""
        return "customers/{customer_id}/androidPrivacySharedKeyGoogleAdGroups/{campaign_id}~{ad_group_id}~{android_privacy_interaction_type}~{android_privacy_network_type}~{android_privacy_interaction_date}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            ad_group_id=ad_group_id,
            android_privacy_interaction_type=android_privacy_interaction_type,
            android_privacy_network_type=android_privacy_network_type,
            android_privacy_interaction_date=android_privacy_interaction_date,
        )

    @staticmethod
    def parse_android_privacy_shared_key_google_ad_group_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a android_privacy_shared_key_google_ad_group path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/androidPrivacySharedKeyGoogleAdGroups/(?P<campaign_id>.+?)~(?P<ad_group_id>.+?)~(?P<android_privacy_interaction_type>.+?)~(?P<android_privacy_network_type>.+?)~(?P<android_privacy_interaction_date>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def android_privacy_shared_key_google_campaign_path(
        customer_id: str,
        campaign_id: str,
        android_privacy_interaction_type: str,
        android_privacy_interaction_date: str,
    ) -> str:
        """Returns a fully-qualified android_privacy_shared_key_google_campaign string."""
        return "customers/{customer_id}/androidPrivacySharedKeyGoogleCampaigns/{campaign_id}~{android_privacy_interaction_type}~{android_privacy_interaction_date}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            android_privacy_interaction_type=android_privacy_interaction_type,
            android_privacy_interaction_date=android_privacy_interaction_date,
    ...
    @staticmethod
    def parse_android_privacy_shared_key_google_campaign_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a android_privacy_shared_key_google_campaign path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/androidPrivacySharedKeyGoogleCampaigns/(?P<campaign_id>.+?)~(?P<android_privacy_interaction_type>.+?)~(?P<android_privacy_interaction_date>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def android_privacy_shared_key_google_network_type_path(
        customer_id: str,
        campaign_id: str,
        android_privacy_interaction_type: str,
        android_privacy_network_type: str,
        ...
        """Returns a fully-qualified android_privacy_shared_key_google_network_type string."""
        return "customers/{customer_id}/androidPrivacySharedKeyGoogleNetworkTypes/{campaign_id}~{android_privacy_interaction_type}~{android_privacy_network_type}~{android_privacy_interaction_date}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            android_privacy_interaction_type=android_privacy_interaction_type,
            android_privacy_network_type=android_privacy_network_type,
    ...
    @staticmethod
    def parse_android_privacy_shared_key_google_network_type_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a android_privacy_shared_key_google_network_type path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/androidPrivacySharedKeyGoogleNetworkTypes/(?P<campaign_id>.+?)~(?P<android_privacy_interaction_type>.+?)~(?P<android_privacy_network_type>.+?)~(?P<android_privacy_interaction_date>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def applied_incentive_path(
        customer_id: str,
        coupon_code: str,
    ) -> str:
        """Returns a fully-qualified applied_incentive string."""
        return "customers/{customer_id}/appliedIncentives/{coupon_code}".format(
            customer_id=customer_id,
    ...
    def parse_applied_incentive_path(path: str) -> Dict[str, str]:
        """Parses a applied_incentive path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/appliedIncentives/(?P<coupon_code>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def asset_group_top_combination_view_path(
        customer_id: str,
        asset_group_id: str,
        asset_combination_category: str,
    ) -> str:
        """Returns a fully-qualified asset_group_top_combination_view string."""
        return "customers/{customer_id}/assetGroupTopCombinationViews/{asset_group_id}~{asset_combination_category}".format(
            customer_id=customer_id,
            asset_group_id=asset_group_id,
            asset_combination_category=asset_combination_category,
        )
    ...
    @staticmethod
    def parse_asset_group_top_combination_view_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a asset_group_top_combination_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/assetGroupTopCombinationViews/(?P<asset_group_id>.+?)~(?P<asset_combination_category>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def campaign_aggregate_asset_view_path(
        customer_id: str,
        campaign_id: str,
        asset_id: str,
        asset_link_source: str,
        field_type: str,
    ) -> str:
        """Returns a fully-qualified campaign_aggregate_asset_view string."""
        return "customers/{customer_id}/campaignAggregateAssetViews/{campaign_id}~{asset_id}~{asset_link_source}~{field_type}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            asset_id=asset_id,
            asset_link_source=asset_link_source,
            field_type=field_type,
        )

    @staticmethod
    def parse_campaign_aggregate_asset_view_path(path: str) -> Dict[str, str]:
        """Parses a campaign_aggregate_asset_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/campaignAggregateAssetViews/(?P<campaign_id>.+?)~(?P<asset_id>.+?)~(?P<asset_link_source>.+?)~(?P<field_type>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def campaign_goal_config_path(
        customer_id: str,
        campaign_id: str,
        unified_goal_id: str,
    ) -> str:
        """Returns a fully-qualified campaign_goal_config string."""
        return "customers/{customer_id}/campaignGoalConfigs/{campaign_id}~{unified_goal_id}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
    ...
    @staticmethod
    def parse_campaign_goal_config_path(path: str) -> Dict[str, str]:
        """Parses a campaign_goal_config path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/campaignGoalConfigs/(?P<campaign_id>.+?)~(?P<unified_goal_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def campaign_lifecycle_goal_path(
        customer_id: str,
        campaign_id: str,
    ) -> str:
        """Returns a fully-qualified campaign_lifecycle_goal string."""
        return "customers/{customer_id}/campaignLifecycleGoals/{campaign_id}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
        )
    ...
    def parse_campaign_lifecycle_goal_path(path: str) -> Dict[str, str]:
        """Parses a campaign_lifecycle_goal path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/campaignLifecycleGoals/(?P<campaign_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def campaign_search_term_view_path(
        customer_id: str,
        campaign_id: str,
        query: str,
    ) -> str:
        """Returns a fully-qualified campaign_search_term_view string."""
        return "customers/{customer_id}/campaignSearchTermViews/{campaign_id}~{query}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            query=query,
        )
    ...
    @staticmethod
    def parse_campaign_search_term_view_path(path: str) -> Dict[str, str]:
        """Parses a campaign_search_term_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/campaignSearchTermViews/(?P<campaign_id>.+?)~(?P<query>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def cart_data_sales_view_path(
        customer_id: str,
    ) -> str:
        """Returns a fully-qualified cart_data_sales_view string."""
        return "customers/{customer_id}/cartDataSalesView".format(
            customer_id=customer_id,
        )
    ...
    def parse_cart_data_sales_view_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/cartDataSalesView$", path
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def channel_aggregate_asset_view_path(
        customer_id: str,
        ...
        """Returns a fully-qualified channel_aggregate_asset_view string."""
        return "customers/{customer_id}/channelAggregateAssetViews/{advertising_channel_type}~{asset_id}~{asset_source}~{field_type}".format(
            customer_id=customer_id,
    ...
    @staticmethod
    def parse_channel_aggregate_asset_view_path(path: str) -> Dict[str, str]:
        """Parses a channel_aggregate_asset_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/channelAggregateAssetViews/(?P<advertising_channel_type>.+?)~(?P<asset_id>.+?)~(?P<asset_source>.+?)~(?P<field_type>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def content_criterion_view_path(
        customer_id: str,
        ad_group_id: str,
        criterion_id: str,
    ) -> str:
        """Returns a fully-qualified content_criterion_view string."""
        return "customers/{customer_id}/contentCriterionViews/{ad_group_id}~{criterion_id}".format(
            customer_id=customer_id,
            ad_group_id=ad_group_id,
            criterion_id=criterion_id,
        )
    ...
    @staticmethod
    def parse_content_criterion_view_path(path: str) -> Dict[str, str]:
        """Parses a content_criterion_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/contentCriterionViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def customer_lifecycle_goal_path(
        customer_id: str,
    ) -> str:
        """Returns a fully-qualified customer_lifecycle_goal string."""
        return "customers/{customer_id}/customerLifecycleGoals".format(
            customer_id=customer_id,
        )

    @staticmethod
    def parse_customer_lifecycle_goal_path(path: str) -> Dict[str, str]:
        """Parses a customer_lifecycle_goal path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/customerLifecycleGoals$", path
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def detail_content_suitability_placement_view_path(
        customer_id: str,
        placement_fingerprint: str,
    ) -> str:
        """Returns a fully-qualified detail_content_suitability_placement_view string."""
        return "customers/{customer_id}/detailContentSuitabilityPlacementViews/{placement_fingerprint}".format(
            customer_id=customer_id,
            placement_fingerprint=placement_fingerprint,
        )

    @staticmethod
    def parse_detail_content_suitability_placement_view_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a detail_content_suitability_placement_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/detailContentSuitabilityPlacementViews/(?P<placement_fingerprint>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def final_url_expansion_asset_view_path(
        customer_id: str,
        campaign_id: str,
        asset_id: str,
        field_type: str,
        ...
        """Returns a fully-qualified final_url_expansion_asset_view string."""
        return "customers/{customer_id}/finalUrlExpansionAssetViews/{campaign_id}~{asset_id}~{field_type}~{url_fp}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            asset_id=asset_id,
            field_type=field_type,
    ...
    @staticmethod
    def parse_final_url_expansion_asset_view_path(path: str) -> Dict[str, str]:
        """Parses a final_url_expansion_asset_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/finalUrlExpansionAssetViews/(?P<campaign_id>.+?)~(?P<asset_id>.+?)~(?P<field_type>.+?)~(?P<url_fp>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def group_content_suitability_placement_view_path(
        customer_id: str,
        placement_fingerprint: str,
    ) -> str:
        """Returns a fully-qualified group_content_suitability_placement_view string."""
        return "customers/{customer_id}/groupContentSuitabilityPlacementViews/{placement_fingerprint}".format(
            customer_id=customer_id,
            placement_fingerprint=placement_fingerprint,
        )

    @staticmethod
    def parse_group_content_suitability_placement_view_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a group_content_suitability_placement_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/groupContentSuitabilityPlacementViews/(?P<placement_fingerprint>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def local_services_employee_path(
        ...
        """Returns a fully-qualified local_services_employee string."""
        return "customers/{customer_id}/localServicesEmployees/{gls_employee_id}".format(
            customer_id=customer_id,
            gls_employee_id=gls_employee_id,
        )

    @staticmethod
    def parse_local_services_employee_path(path: str) -> Dict[str, str]:
        """Parses a local_services_employee path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/localServicesEmployees/(?P<gls_employee_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def local_services_lead_conversation_path(
        customer_id: str,
        local_services_lead_conversation_id: str,
    ) -> str:
        """Returns a fully-qualified local_services_lead_conversation string."""
        return "customers/{customer_id}/localServicesLeadConversations/{local_services_lead_conversation_id}".format(
            customer_id=customer_id,
            local_services_lead_conversation_id=local_services_lead_conversation_id,
        )

    @staticmethod
    def parse_local_services_lead_conversation_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a local_services_lead_conversation path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/localServicesLeadConversations/(?P<local_services_lead_conversation_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def local_services_verification_artifact_path(
        customer_id: str,
        gls_verification_artifact_id: str,
    ) -> str:
        """Returns a fully-qualified local_services_verification_artifact string."""
        return "customers/{customer_id}/localServicesVerificationArtifacts/{gls_verification_artifact_id}".format(
            customer_id=customer_id,
            gls_verification_artifact_id=gls_verification_artifact_id,
        )

    @staticmethod
    def parse_local_services_verification_artifact_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a local_services_verification_artifact path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/localServicesVerificationArtifacts/(?P<gls_verification_artifact_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}

    @staticmethod
    def location_interest_view_path(
        customer_id: str,
        campaign_id: str,
        ad_group_id: str,
        criterion_id: str,
    ) -> str:
        """Returns a fully-qualified location_interest_view string."""
        return "customers/{customer_id}/locationInterestViews/{campaign_id}~{ad_group_id}~{criterion_id}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            ad_group_id=ad_group_id,
            criterion_id=criterion_id,
    ...
    @staticmethod
    def parse_location_interest_view_path(path: str) -> Dict[str, str]:
        """Parses a location_interest_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/locationInterestViews/(?P<campaign_id>.+?)~(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def matched_location_interest_view_path(
        customer_id: str,
        country_criterion_id: str,
    ) -> str:
        """Returns a fully-qualified matched_location_interest_view string."""
        return "customers/{customer_id}/matchedLocationInterestViews/{country_criterion_id}".format(
            customer_id=customer_id,
            country_criterion_id=country_criterion_id,
        )

    @staticmethod
    def parse_matched_location_interest_view_path(path: str) -> Dict[str, str]:
        """Parses a matched_location_interest_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/matchedLocationInterestViews/(?P<country_criterion_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def offline_conversion_upload_client_summary_path(
        ...
        """Returns a fully-qualified offline_conversion_upload_client_summary string."""
        return "customers/{customer_id}/offlineConversionUploadClientSummaries/{client}".format(
            customer_id=customer_id,
            client=client,
        )

    @staticmethod
    def parse_offline_conversion_upload_client_summary_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a offline_conversion_upload_client_summary path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/offlineConversionUploadClientSummaries/(?P<client>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def performance_max_placement_view_path(
        customer_id: str,
        base_64_placement: str,
    ) -> str:
        """Returns a fully-qualified performance_max_placement_view string."""
        return "customers/{customer_id}/performanceMaxPlacementViews/{base_64_placement}".format(
            customer_id=customer_id,
            base_64_placement=base_64_placement,
        )

    @staticmethod
    def parse_performance_max_placement_view_path(path: str) -> Dict[str, str]:
        """Parses a performance_max_placement_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/performanceMaxPlacementViews/(?P<base_64_placement>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def product_category_constant_path(
        level: str,
        category_id: str,
    ) -> str:
        """Returns a fully-qualified product_category_constant string."""
        return "productCategoryConstants/{level}~{category_id}".format(
            level=level,
            category_id=category_id,
        )

    @staticmethod
    def parse_product_category_constant_path(path: str) -> Dict[str, str]:
        """Parses a product_category_constant path into its component segments."""
        m = re.match(
            r"^productCategoryConstants/(?P<level>.+?)~(?P<category_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def product_link_invitation_path(
        ...
        """Returns a fully-qualified product_link_invitation string."""
        return "customers/{customer_id}/productLinkInvitations/{customer_invitation_id}".format(
            customer_id=customer_id,
    ...
    def parse_product_link_invitation_path(path: str) -> Dict[str, str]:
        """Parses a product_link_invitation path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/productLinkInvitations/(?P<customer_invitation_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_qualifying_question_path(path: str) -> Dict[str, str]:
        """Parses a qualifying_question path into its component segments."""
        m = re.match(
            r"^qualifyingQuestions/(?P<qualifying_question_id>.+?)$", path
        )
        return m.groupdict() if m else {}
    ...
    def shopping_product_path(
        ...
        """Returns a fully-qualified shopping_product string."""
        return "customers/{customer_id}/shoppingProducts/{merchant_center_id}~{channel}~{language_code}~{feed_label}~{item_id}".format(
            customer_id=customer_id,
    ...
    @staticmethod
    def parse_shopping_product_path(path: str) -> Dict[str, str]:
        """Parses a shopping_product path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/shoppingProducts/(?P<merchant_center_id>.+?)~(?P<channel>.+?)~(?P<language_code>.+?)~(?P<feed_label>.+?)~(?P<item_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def targeting_expansion_view_path(
        customer_id: str,
        campaign_id: str,
        targeting_expansion_type: str,
    ) -> str:
        """Returns a fully-qualified targeting_expansion_view string."""
        return "customers/{customer_id}/targetingExpansionViews/{campaign_id}~{targeting_expansion_type}".format(
            customer_id=customer_id,
            campaign_id=campaign_id,
            targeting_expansion_type=targeting_expansion_type,
        )

    @staticmethod
    def parse_targeting_expansion_view_path(path: str) -> Dict[str, str]:
        """Parses a targeting_expansion_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/targetingExpansionViews/(?P<campaign_id>.+?)~(?P<targeting_expansion_type>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def parse_travel_activity_group_view_path(path: str) -> Dict[str, str]:
        """Parses a travel_activity_group_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/travelActivityGroupViews/(?P<ad_group_id>.+?)~(?P<criterion_id>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def parse_travel_activity_performance_view_path(
        path: str,
    ) -> Dict[str, str]:
        """Parses a travel_activity_performance_view path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/travelActivityPerformanceViews$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def user_list_customer_type_path(
        ...
        """Returns a fully-qualified user_list_customer_type string."""
        return "customers/{customer_id}/userListCustomerTypes/{user_list_id}~{semantic_label}".format(
            customer_id=customer_id,
            user_list_id=user_list_id,
    ...
    def parse_user_list_customer_type_path(path: str) -> Dict[str, str]:
        """Parses a user_list_customer_type path into its component segments."""
        m = re.match(
            r"^customers/(?P<customer_id>.+?)/userListCustomerTypes/(?P<user_list_id>.+?)~(?P<semantic_label>.+?)$",
            path,
        )
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = GoogleAdsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                GoogleAdsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = GoogleAdsServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = GoogleAdsServiceClient._read_environment_variables()
        self._client_cert_source = (
            GoogleAdsServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = GoogleAdsServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, GoogleAdsServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(GoogleAdsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or GoogleAdsServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                GoogleAdsServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., GoogleAdsServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.GoogleAdsServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.GoogleAdsService",
    ...
    def search(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.SearchGoogleAdsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v24.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.SearchGoogleAdsStreamRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            Iterable[google.ads.googleads.v24.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                   [GoogleAdsService.SearchStream][google.ads.googleads.v24.services.GoogleAdsService.SearchStream].
    ...
    def mutate(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateGoogleAdsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateGoogleAdsResponse:
                Response message for
                   [GoogleAdsService.Mutate][google.ads.googleads.v24.services.GoogleAdsService.Mutate].
