...
class CampaignBidModifierServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignBidModifierServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CampaignBidModifierServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CampaignBidModifierServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignBidModifierServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CampaignBidModifierServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignBidModifierServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CampaignBidModifierServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignBidModifierServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CampaignBidModifierServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignBidModifierServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignBidModifierServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CampaignBidModifierServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCampaignBidModifiersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.CampaignBidModifierOperation]):
