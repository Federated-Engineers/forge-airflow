...
from google.ads.googleads.v24.services.types import customer_asset_service
from google.rpc import status_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, CustomerAssetServiceTransport
from .transports.grpc import CustomerAssetServiceGrpcTransport
from .transports.grpc_asyncio import CustomerAssetServiceGrpcAsyncIOTransport
...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomerAssetServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CustomerAssetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CustomerAssetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerAssetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerAssetServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerAssetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CustomerAssetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomerAssetServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(CustomerAssetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerAssetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerAssetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomerAssetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CustomerAssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.CustomerAssetService",
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCustomerAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.CustomerAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateCustomerAssetsResponse:
