...
class KeywordPlanAdGroupServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.KeywordPlanAdGroupServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateKeywordPlanAdGroupsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.KeywordPlanAdGroupOperation]):
