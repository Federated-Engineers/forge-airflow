...
from google.ads.googleads.v24.services.types import keyword_plan_service
from google.rpc import status_pb2  # type: ignore

from .transports.base import DEFAULT_CLIENT_INFO, KeywordPlanServiceTransport
...
class KeywordPlanServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = KeywordPlanServiceGrpcAsyncIOTransport
...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = KeywordPlanServiceClient._use_client_cert_effective()
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                KeywordPlanServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = KeywordPlanServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = KeywordPlanServiceClient._read_environment_variables()
        self._client_cert_source = (
            KeywordPlanServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = KeywordPlanServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, KeywordPlanServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(KeywordPlanServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or KeywordPlanServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                KeywordPlanServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., KeywordPlanServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.KeywordPlanServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.KeywordPlanService",
    ...
    def mutate_keyword_plans(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateKeywordPlansRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.KeywordPlanOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateKeywordPlansResponse:
