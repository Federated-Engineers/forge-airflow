...
from .base import DEFAULT_CLIENT_INFO, LocalServicesLeadServiceTransport
...
class LocalServicesLeadServiceGrpcTransport(LocalServicesLeadServiceTransport):
    """gRPC backend transport for LocalServicesLeadService.
        ...
        if "append_lead_conversation" not in self._stubs:
            self._stubs["append_lead_conversation"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.LocalServicesLeadService/AppendLeadConversation",
    ...
    def provide_lead_feedback(
        ...
        if "provide_lead_feedback" not in self._stubs:
            self._stubs["provide_lead_feedback"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.LocalServicesLeadService/ProvideLeadFeedback",
...
__all__ = ("LocalServicesLeadServiceGrpcTransport",)
