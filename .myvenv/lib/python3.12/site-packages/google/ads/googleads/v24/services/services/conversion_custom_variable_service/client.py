...
class ConversionCustomVariableServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ConversionCustomVariableServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                ConversionCustomVariableServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = ConversionCustomVariableServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = ConversionCustomVariableServiceClient._read_environment_variables()
        self._client_cert_source = (
            ConversionCustomVariableServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ConversionCustomVariableServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ConversionCustomVariableServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ConversionCustomVariableServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ConversionCustomVariableServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ConversionCustomVariableServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_conversion_custom_variables(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateConversionCustomVariablesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.ConversionCustomVariableOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateConversionCustomVariablesResponse:
