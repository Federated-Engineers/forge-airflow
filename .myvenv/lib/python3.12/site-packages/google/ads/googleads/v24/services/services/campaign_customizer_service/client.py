...
class CampaignCustomizerServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CampaignCustomizerServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CampaignCustomizerServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CampaignCustomizerServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignCustomizerServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CampaignCustomizerServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignCustomizerServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CampaignCustomizerServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignCustomizerServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CampaignCustomizerServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignCustomizerServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignCustomizerServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignCustomizerServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CampaignCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCampaignCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.CampaignCustomizerOperation]):
