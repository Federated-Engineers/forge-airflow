...
from .base import DEFAULT_CLIENT_INFO, AudienceInsightsServiceTransport
...
class AudienceInsightsServiceGrpcAsyncIOTransport(
        ...
        if "generate_insights_finder_report" not in self._stubs:
            self._stubs["generate_insights_finder_report"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/GenerateInsightsFinderReport",
    ...
    def list_insights_eligible_dates(
        ...
        if "list_insights_eligible_dates" not in self._stubs:
            self._stubs["list_insights_eligible_dates"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/ListInsightsEligibleDates",
    ...
    def generate_audience_composition_insights(
        ...
        if "generate_audience_composition_insights" not in self._stubs:
            self._stubs["generate_audience_composition_insights"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceCompositionInsights",
    ...
    def generate_audience_definition(
        ...
        r"""Return a callable for the generate audience definition method over gRPC.

        Returns a collection of audience attributes using generative AI
        ...
        Returns:
            Callable[[~.GenerateAudienceDefinitionRequest],
                    Awaitable[~.GenerateAudienceDefinitionResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        # gRPC handles serialization and deserialization, so we just need
        # to pass in the functions for each.
        if "generate_audience_definition" not in self._stubs:
            self._stubs["generate_audience_definition"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceDefinition",
                    request_serializer=audience_insights_service.GenerateAudienceDefinitionRequest.serialize,
                    response_deserializer=audience_insights_service.GenerateAudienceDefinitionResponse.deserialize,
                )
            )
        return self._stubs["generate_audience_definition"]
    ...
    def generate_audience_overlap_insights(
        ...
        if "generate_audience_overlap_insights" not in self._stubs:
            self._stubs["generate_audience_overlap_insights"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/GenerateAudienceOverlapInsights",
    ...
    def generate_targeting_suggestion_metrics(
        ...
        if "generate_targeting_suggestion_metrics" not in self._stubs:
            self._stubs["generate_targeting_suggestion_metrics"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.generate_audience_definition: self._wrap_method(
