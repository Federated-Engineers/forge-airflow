...
from .base import DEFAULT_CLIENT_INFO, CustomInterestServiceTransport
...
class CustomInterestServiceGrpcAsyncIOTransport(CustomInterestServiceTransport):
    """gRPC AsyncIO backend transport for CustomInterestService.
    ...
    def mutate_custom_interests(
        ...
        Returns:
            Callable[[~.MutateCustomInterestsRequest],
                    Awaitable[~.MutateCustomInterestsResponse]]:
        ...
        if "mutate_custom_interests" not in self._stubs:
            self._stubs["mutate_custom_interests"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CustomInterestService/MutateCustomInterests",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_custom_interests: self._wrap_method(
...
__all__ = ("CustomInterestServiceGrpcAsyncIOTransport",)
