...
from google.ads.googleads.v24.enums.types import (
    brand_safety_suitability, conversion_tracking_status_enum,
    customer_pay_per_conversion_eligibility_failure_reason, customer_status,
    eu_political_advertising_status, local_services_verification_status)
...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v24.resources.types.CallReportingSetting):
            Call reporting setting for a customer. Only mutable in an
            ``update`` operation.
        conversion_tracking_setting (google.ads.googleads.v24.resources.types.ConversionTrackingSetting):
            Conversion tracking setting for a customer.
        remarketing_setting (google.ads.googleads.v24.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (MutableSequence[google.ads.googleads.v24.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        status (google.ads.googleads.v24.enums.types.CustomerStatusEnum.CustomerStatus):
        ...
        customer_agreement_setting (google.ads.googleads.v24.resources.types.CustomerAgreementSetting):
            Output only. Customer Agreement Setting for a
            customer.
        local_services_settings (google.ads.googleads.v24.resources.types.LocalServicesSettings):
            Output only. Settings for Local Services
            customer.
        video_brand_safety_suitability (google.ads.googleads.v24.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Brand Safety setting at the account level.
            Allows for selecting an inventory type to show
            your ads on content that is the right fit for
            your brand. See
            https://support.google.com/google-ads/answer/7515513.
        video_customer (google.ads.googleads.v24.resources.types.VideoCustomer):
...
class LocalServicesSettings(proto.Message):
    ...
    Attributes:
        granular_license_statuses (MutableSequence[google.ads.googleads.v24.resources.types.GranularLicenseStatus]):
            Output only. A read-only list of geo vertical
            level license statuses.
        granular_insurance_statuses (MutableSequence[google.ads.googleads.v24.resources.types.GranularInsuranceStatus]):
            Output only. A read-only list of geo vertical
...
class GranularLicenseStatus(proto.Message):
    ...
    Attributes:
        ...
        verification_status (google.ads.googleads.v24.enums.types.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus):
...
class VideoCustomer(proto.Message):
    ...
    Attributes:
        third_party_integration_partners (google.ads.googleads.v24.common.types.CustomerThirdPartyIntegrationPartners):
