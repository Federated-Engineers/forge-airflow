...
class CustomizerAttributeServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            CustomizerAttributeServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CustomizerAttributeServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CustomizerAttributeServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomizerAttributeServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomizerAttributeServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomizerAttributeServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomizerAttributeServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomizerAttributeServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CustomizerAttributeServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomizerAttributeServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomizerAttributeServiceClient.get_transport_class(transport)
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.CustomizerAttributeServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customizer_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateCustomizerAttributesRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.CustomizerAttributeOperation]):
