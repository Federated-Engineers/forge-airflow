...
from google.ads.googleads.v24.resources.types import account_budget_proposal
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.MutateAccountBudgetProposalResult):
