...
from google.ads.googleads.v24.resources.types import goal
...
class GoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.Goal):
            Create a new goal.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.Goal):
...
class MutateGoalsResponse(proto.Message):
    ...
    Attributes:
        ...
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateGoalResult]):
