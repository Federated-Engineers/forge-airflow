...
from google.ads.googleads.v24.resources.types import customer_lifecycle_goal
...
class CustomerLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CustomerLifecycleGoal):
...
class ConfigureCustomerLifecycleGoalsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.ConfigureCustomerLifecycleGoalsResult):
