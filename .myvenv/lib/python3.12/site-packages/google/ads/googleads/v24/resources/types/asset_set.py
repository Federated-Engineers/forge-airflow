...
from google.ads.googleads.v24.common.types import asset_set_types
from google.ads.googleads.v24.enums.types import (
    asset_set_status, asset_set_type, vertical_ads_item_vertical_type)
...
class AssetSet(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            length of 128.
        type_ (google.ads.googleads.v24.enums.types.AssetSetTypeEnum.AssetSetType):
            Required. Immutable. The type of the asset
            set. Required.
        status (google.ads.googleads.v24.enums.types.AssetSetStatusEnum.AssetSetStatus):
            Output only. The status of the asset set.
            Read-only.
        merchant_center_feed (google.ads.googleads.v24.resources.types.AssetSet.MerchantCenterFeed):
        ...
        location_group_parent_asset_set_id (int):
            ...
            AssetSet.
        hotel_property_data (google.ads.googleads.v24.resources.types.AssetSet.HotelPropertyData):
            Output only. For Performance Max for travel
            goals campaigns with a Hotel Center account
            link. Read-only.
        travel_feed_data (google.ads.googleads.v24.resources.types.AssetSet.TravelFeedData):
            Output only. Travel Feed data. Read-only
        location_set (google.ads.googleads.v24.common.types.LocationSet):
        ...
        business_profile_location_group (google.ads.googleads.v24.common.types.BusinessProfileLocationGroup):
            Business Profile location group asset set
            data.

            This field is a member of `oneof`_ ``asset_set_source``.
        chain_location_group (google.ads.googleads.v24.common.types.ChainLocationGroup):
    ...
    class TravelFeedData(proto.Message):
        ...
        Attributes:
            subset_id (int):
                Output only. Id representing a subset of the
                travel feed.
            travel_feed_vertical_type (google.ads.googleads.v24.enums.types.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType):
                Output only. Indicates the vertical type of
                the travel feed.
            hotel_center_account_id (int):
                Output only. The Hotel Center account ID used
                for a Hotel or Vacation Rental feed.

                This field is a member of `oneof`_ ``travel_feed_id``.
            merchant_center_id (int):
                Output only. The Merchant Center account ID
                used for a Things to Do feed.

                This field is a member of `oneof`_ ``travel_feed_id``.
            partner_center_id (int):
                Output only. The Partner Center ID used for a
                travel vertical feed, except for Hotel, Vacation
                Rental, and Things to Do feeds.

                This field is a member of `oneof`_ ``travel_feed_id``.
        """

        subset_id: int = proto.Field(
            proto.INT64,
            number=3,
        )
        ...
        hotel_center_account_id: int = proto.Field(
            proto.INT64,
            number=1,
            oneof="travel_feed_id",
        )
        ...
        partner_center_id: int = proto.Field(
            proto.INT64,
            number=5,
            oneof="travel_feed_id",
        )
    ...
    travel_feed_data: TravelFeedData = proto.Field(
        proto.MESSAGE,
        number=12,
        message=TravelFeedData,
    )
    ...
    business_profile_location_group: (
        asset_set_types.BusinessProfileLocationGroup
    ) = proto.Field(
        proto.MESSAGE,
        number=8,
        oneof="asset_set_source",
