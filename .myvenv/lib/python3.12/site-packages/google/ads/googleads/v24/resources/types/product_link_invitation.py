...
from google.ads.googleads.v24.enums.types import (
    linked_product_type, product_link_invitation_status)
...
class ProductLinkInvitation(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v24.enums.types.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus):
            Output only. The status of the product link
            invitation. This field is read only.
        type_ (google.ads.googleads.v24.enums.types.LinkedProductTypeEnum.LinkedProductType):
        ...
        hotel_center (google.ads.googleads.v24.resources.types.HotelCenterLinkInvitationIdentifier):
            Output only. Hotel link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        merchant_center (google.ads.googleads.v24.resources.types.MerchantCenterLinkInvitationIdentifier):
            Output only. Merchant Center link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        advertising_partner (google.ads.googleads.v24.resources.types.AdvertisingPartnerLinkInvitationIdentifier):
            Output only. Advertising Partner link
            invitation.

            This field is a member of `oneof`_ ``invited_account``.
        advertising_partner_properties (google.ads.googleads.v24.resources.types.AdvertisingPartnerLinkInvitationProperties):
            Output only. Advertising Partner link
