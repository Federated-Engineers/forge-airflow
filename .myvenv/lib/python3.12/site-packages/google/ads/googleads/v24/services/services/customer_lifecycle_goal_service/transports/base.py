...
class CustomerLifecycleGoalServiceTransport(abc.ABC):
    """Abstract transport class for CustomerLifecycleGoalService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.configure_customer_lifecycle_goals: gapic_v1.method.wrap_method(
...
__all__ = ("CustomerLifecycleGoalServiceTransport",)
