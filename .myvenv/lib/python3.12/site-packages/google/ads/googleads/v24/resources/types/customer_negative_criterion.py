...
class CustomerNegativeCriterion(proto.Message):
    ...
    Attributes:
        ...
        youtube_channel (google.ads.googleads.v24.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        negative_keyword_list (google.ads.googleads.v24.common.types.NegativeKeywordListInfo):
        ...
        ip_block (google.ads.googleads.v24.common.types.IpBlockInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        placement_list (google.ads.googleads.v24.common.types.PlacementListInfo):
