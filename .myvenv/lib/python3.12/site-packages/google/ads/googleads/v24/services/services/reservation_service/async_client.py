...
class ReservationServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = (
        ReservationServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    )
    ...
    common_folder_path = staticmethod(
        ReservationServiceClient.common_folder_path
    )
    ...
    common_project_path = staticmethod(
        ReservationServiceClient.common_project_path
    )
    parse_common_project_path = staticmethod(
        ReservationServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(
        ReservationServiceClient.common_location_path
    )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v24.services.ReservationServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def quote_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.QuoteCampaignsRequest, dict]]):
        ...
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.quote_campaigns
        ]
    ...
    async def book_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.BookCampaignsRequest, dict]]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.book_campaigns
        ]
