...
from .base import DEFAULT_CLIENT_INFO, CustomerUserAccessServiceTransport
...
class CustomerUserAccessServiceGrpcTransport(
    ...
    """gRPC backend transport for CustomerUserAccessService.
        ...
        if "mutate_customer_user_access" not in self._stubs:
            self._stubs["mutate_customer_user_access"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.CustomerUserAccessService/MutateCustomerUserAccess",
...
__all__ = ("CustomerUserAccessServiceGrpcTransport",)
