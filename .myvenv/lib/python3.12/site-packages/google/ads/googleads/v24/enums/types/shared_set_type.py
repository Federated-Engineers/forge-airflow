    ...
    class SharedSetType(proto.Enum):
        ...
        Values:
            ...
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST (7):
                A set of vertical ads item group rules that
                can be included or excluded from targeting in
                Vertical Ads (e.g., for hotel ads).
            RETAIL_FILTER (32):
                A set representing Retail Filter, which is
                used for filtering offers served in a campaign.
        """
