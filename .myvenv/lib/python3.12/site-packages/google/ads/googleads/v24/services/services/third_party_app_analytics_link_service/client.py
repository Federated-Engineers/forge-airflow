...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            ThirdPartyAppAnalyticsLinkServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ThirdPartyAppAnalyticsLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        (
            ...
            ThirdPartyAppAnalyticsLinkServiceClient._read_environment_variables()
        )
        ...
        self._universe_domain = (
            ThirdPartyAppAnalyticsLinkServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ThirdPartyAppAnalyticsLinkServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                ThirdPartyAppAnalyticsLinkServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ThirdPartyAppAnalyticsLinkServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.ThirdPartyAppAnalyticsLinkServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.ThirdPartyAppAnalyticsLinkService",
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.RegenerateShareableLinkIdRequest, dict]):
                The request object. Request message for
                [ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId][google.ads.googleads.v24.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId].
        ...
        Returns:
            google.ads.googleads.v24.services.types.RegenerateShareableLinkIdResponse:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.regenerate_shareable_link_id
        ]
