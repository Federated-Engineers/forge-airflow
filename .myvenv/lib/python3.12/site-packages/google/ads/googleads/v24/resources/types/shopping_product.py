...
from google.ads.googleads.v24.enums.types import (product_availability,
                                                  product_channel,
                                                  product_channel_exclusivity,
                                                  product_condition,
                                                  product_issue_severity,
                                                  product_status)
...
class ShoppingProduct(proto.Message):
    ...
    Attributes:
        ...
        product_image_uri (str):
            Output only. The URI of the product image as
            provided by the merchant.

            This field is a member of `oneof`_ ``_product_image_uri``.
        price_micros (int):
        ...
        availability (google.ads.googleads.v24.enums.types.ProductAvailabilityEnum.ProductAvailability):
        ...
        status (google.ads.googleads.v24.enums.types.ProductStatusEnum.ProductStatus):
        ...
        issues (MutableSequence[google.ads.googleads.v24.resources.types.ShoppingProduct.ProductIssue]):
            Output only. The list of issues affecting
            whether the product can show in ads. The value
            of this field is restricted to the scope
            specified in the query, see the documentation of
            the resource. This field can take up to 24 hours
            to update. This field is not supported for App
            campaigns.
        campaign (str):
    ...
    class ProductIssue(proto.Message):
        ...
        Attributes:
            error_code (str):
                ...
                the issue.
            ads_severity (google.ads.googleads.v24.enums.types.ProductIssueSeverityEnum.ProductIssueSeverity):
    ...
    product_image_uri: str = proto.Field(
        proto.STRING,
        number=36,
        optional=True,
    )
