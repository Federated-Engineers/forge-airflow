...
from google.ads.googleads.v24.enums.types import (shared_set_status,
                                                  shared_set_type)
from google.ads.googleads.v24.enums.types import \
    vertical_ads_item_vertical_type as gage_vertical_ads_item_vertical_type
...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v24.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v24.enums.types.SharedSetStatusEnum.SharedSetStatus):
        ...
        vertical_ads_item_vertical_type (google.ads.googleads.v24.enums.types.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType):
            Immutable. Shared sets of type
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST are associated with a
            particular vertical (e.g. hotels, things to do, flights,
            etc.). This field is required for shared sets of type
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST.

            This field is a member of `oneof`_ ``_vertical_ads_item_vertical_type``.
    """
    ...
    vertical_ads_item_vertical_type: (
        gage_vertical_ads_item_vertical_type.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType
    ) = proto.Field(
        proto.ENUM,
        number=12,
        optional=True,
