...
class AutomaticallyCreatedAssetRemovalServiceClientMeta(type):
    """Metaclass for the AutomaticallyCreatedAssetRemovalService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AutomaticallyCreatedAssetRemovalServiceTransport]]
...
class AutomaticallyCreatedAssetRemovalServiceClient(
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AutomaticallyCreatedAssetRemovalServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AutomaticallyCreatedAssetRemovalServiceTransport:
        ...
        Returns:
            AutomaticallyCreatedAssetRemovalServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AutomaticallyCreatedAssetRemovalServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AutomaticallyCreatedAssetRemovalServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the automatically created asset removal service client.
        ...
        (
            ...
            AutomaticallyCreatedAssetRemovalServiceClient._read_environment_variables()
        )
        self._client_cert_source = AutomaticallyCreatedAssetRemovalServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = (
            AutomaticallyCreatedAssetRemovalServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AutomaticallyCreatedAssetRemovalServiceTransport
        )
        if transport_provided:
            # transport is a AutomaticallyCreatedAssetRemovalServiceTransport instance.
            if (
                credentials
            ...
            self._transport = cast(
                AutomaticallyCreatedAssetRemovalServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AutomaticallyCreatedAssetRemovalServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AutomaticallyCreatedAssetRemovalServiceClient`.",
                    extra=(
                        {
    ...
    def remove_campaign_automatically_created_asset(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.RemoveCampaignAutomaticallyCreatedAssetRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.RemoveCampaignAutomaticallyCreatedAssetOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.remove_campaign_automatically_created_asset
        ]
