...
from google.ads.googleads.v24.enums.types import (
    asset_field_type, asset_link_primary_status,
    asset_link_primary_status_reason, asset_link_status, asset_source)
...
class AssetGroupAsset(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v24.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
            The status of the link between an asset and
            asset group.
        primary_status (google.ads.googleads.v24.enums.types.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus):
        ...
        primary_status_reasons (MutableSequence[google.ads.googleads.v24.enums.types.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason]):
            Output only. Provides a list of reasons for
            why an asset is not serving or not serving at
            full capacity.
        primary_status_details (MutableSequence[google.ads.googleads.v24.common.types.AssetLinkPrimaryStatusDetails]):
            Output only. Provides the details of the
            primary status and its associated reasons.
        policy_summary (google.ads.googleads.v24.common.types.PolicySummary):
