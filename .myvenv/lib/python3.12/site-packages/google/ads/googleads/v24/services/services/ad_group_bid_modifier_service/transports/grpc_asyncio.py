...
from .base import DEFAULT_CLIENT_INFO, AdGroupBidModifierServiceTransport
...
class AdGroupBidModifierServiceGrpcAsyncIOTransport(
    AdGroupBidModifierServiceTransport
):
    """gRPC AsyncIO backend transport for AdGroupBidModifierService.
    ...
    def mutate_ad_group_bid_modifiers(
        ...
        Returns:
            Callable[[~.MutateAdGroupBidModifiersRequest],
                    Awaitable[~.MutateAdGroupBidModifiersResponse]]:
        ...
        if "mutate_ad_group_bid_modifiers" not in self._stubs:
            self._stubs["mutate_ad_group_bid_modifiers"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AdGroupBidModifierService/MutateAdGroupBidModifiers",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_bid_modifiers: self._wrap_method(
...
__all__ = ("AdGroupBidModifierServiceGrpcAsyncIOTransport",)
