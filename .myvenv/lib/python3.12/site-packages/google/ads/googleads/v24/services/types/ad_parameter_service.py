...
class AdParameterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.AdParameter):
            Create operation: No resource name is
            expected for the new ad parameter.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.AdParameter):
...
class MutateAdParametersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateAdParameterResult]):
