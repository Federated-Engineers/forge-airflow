...
class MutateCampaignCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v24.services.types.CampaignCriterionOperation]):
...
class CampaignCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.CampaignCriterion):
            Create operation: No resource name is
            expected for the new criterion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.CampaignCriterion):
            Update operation: The criterion is expected
            to have a valid resource name. Note that for
            smart campaigns, you cannot use the update
            method to edit the geolocation target.
    ...
    update: gagr_campaign_criterion.CampaignCriterion = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_campaign_criterion.CampaignCriterion,
...
class MutateCampaignCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateCampaignCriterionResult]):
