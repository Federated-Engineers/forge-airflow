...
from .base import DEFAULT_CLIENT_INFO, UserListServiceTransport
...
class UserListServiceGrpcAsyncIOTransport(UserListServiceTransport):
    """gRPC AsyncIO backend transport for UserListService.
    ...
    def mutate_user_lists(
        ...
        Returns:
            Callable[[~.MutateUserListsRequest],
                    Awaitable[~.MutateUserListsResponse]]:
        ...
        if "mutate_user_lists" not in self._stubs:
            self._stubs["mutate_user_lists"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v24.services.UserListService/MutateUserLists",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_user_lists: self._wrap_method(
...
__all__ = ("UserListServiceGrpcAsyncIOTransport",)
