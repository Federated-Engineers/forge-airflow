...
class AssetGroupListingGroupFilterServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[AssetGroupListingGroupFilterServiceTransport]]
...
class AssetGroupListingGroupFilterServiceClient(
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            AssetGroupListingGroupFilterServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AssetGroupListingGroupFilterServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        (
            ...
            AssetGroupListingGroupFilterServiceClient._read_environment_variables()
        )
        self._client_cert_source = (
            AssetGroupListingGroupFilterServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AssetGroupListingGroupFilterServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AssetGroupListingGroupFilterServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                AssetGroupListingGroupFilterServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AssetGroupListingGroupFilterServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AssetGroupListingGroupFilterServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_asset_group_listing_group_filters(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAssetGroupListingGroupFiltersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AssetGroupListingGroupFilterOperation]):
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.mutate_asset_group_listing_group_filters
        ]
