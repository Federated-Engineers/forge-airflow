...
from google.ads.googleads.v24.services.types import asset_service
...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = (
            self._api_endpoint
            or AssetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[AssetServiceTransport],
                Callable[..., AssetServiceTransport],
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.AssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v24.services.AssetService",
    ...
    def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.MutateAssetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v24.services.types.AssetOperation]):
        ...
        Returns:
            google.ads.googleads.v24.services.types.MutateAssetsResponse:
