...
class GenerateTextRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            assets for. Required.
        asset_field_types (MutableSequence[google.ads.googleads.v24.enums.types.AssetFieldTypeEnum.AssetFieldType]):
        ...
        existing_generation_context (google.ads.googleads.v24.services.types.AssetGenerationExistingContext):
...
class GenerateTextResponse(proto.Message):
    ...
    Attributes:
        generated_text (MutableSequence[google.ads.googleads.v24.services.types.GeneratedText]):
...
class GenerateImagesRequest(proto.Message):
    ...
    Attributes:
        ...
        advertising_channel_type (google.ads.googleads.v24.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType):
            ...
            This field is a member of `oneof`_ ``context``.
        final_url_generation (google.ads.googleads.v24.services.types.FinalUrlImageGenerationInput):
            Optional. Generate images from a final url.

            This field is a member of `oneof`_ ``generation_type``.
        freeform_generation (google.ads.googleads.v24.services.types.FreeformImageGenerationInput):
            Optional. Generate images from a freeform
            prompt.

            This field is a member of `oneof`_ ``generation_type``.
        product_recontext_generation (google.ads.googleads.v24.services.types.ProductRecontextGenerationImageInput):
...
class ProductRecontextGenerationImageInput(proto.Message):
    ...
    Attributes:
        prompt (str):
            ...
            is 1500.
        source_images (MutableSequence[google.ads.googleads.v24.services.types.SourceImage]):
...
class GenerateImagesResponse(proto.Message):
    ...
    Attributes:
        generated_images (MutableSequence[google.ads.googleads.v24.services.types.GeneratedImage]):
