...
from .base import DEFAULT_CLIENT_INFO, GeoTargetConstantServiceTransport
        ...
        if "suggest_geo_target_constants" not in self._stubs:
            self._stubs["suggest_geo_target_constants"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.GeoTargetConstantService/SuggestGeoTargetConstants",
