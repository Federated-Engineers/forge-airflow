...
from google.ads.googleads.v24.common.types import consent as gagc_consent
...
class UserIdentifier(proto.Message):
    ...
    Attributes:
        user_identifier_source (google.ads.googleads.v24.enums.types.UserIdentifierSourceEnum.UserIdentifierSource):
        ...
        third_party_user_id (str):
            ...
            This field is a member of `oneof`_ ``identifier``.
        address_info (google.ads.googleads.v24.common.types.OfflineUserAddressInfo):
...
class TransactionAttribute(proto.Message):
    ...
    Attributes:
        ...
        order_id (str):
            Transaction order id. Useful to group
            transactions which are part of the same order.

            This field is a member of `oneof`_ ``_order_id``.
        store_attribute (google.ads.googleads.v24.common.types.StoreAttribute):
            Store attributes of the transaction.
        custom_value (str):
            Value of the custom variable for each
            transaction. Allowed only if a custom key is
            provided in the store sales metadata.

            This field is a member of `oneof`_ ``_custom_value``.
        item_attribute (google.ads.googleads.v24.common.types.ItemAttribute):
...
class ItemAttribute(proto.Message):
    ...
    Attributes:
        item_id (str):
            A unique identifier of a product. It must be
            the exact same Merchant Center Item ID you use
            in your Google Merchant Center for this product.
            Required.
        merchant_id (int):
        ...
        country_code (str):
            Common Locale Data Repository (CLDR) territory code of the
            country associated with the feed where your items are
            uploaded. See
            https://developers.google.com/google-ads/api/reference/data/codes-formats#country-codes
            for more information. This information is useful to
            differentiate product information in cases where a product
            (identified by item_id) is associated with multiple
            countries.
        language_code (str):
            ISO 639-1 code of the language associated with the feed
            where your items are uploaded. This information is useful to
            differentiate product information in cases where a product
            (identified by item_id) is associated with multiple
            languages.
        quantity (int):
...
class UserData(proto.Message):
    ...
    Attributes:
        user_identifiers (MutableSequence[google.ads.googleads.v24.common.types.UserIdentifier]):
            User identification info. Required.
        transaction_attribute (google.ads.googleads.v24.common.types.TransactionAttribute):
            Additional transactions/attributes associated
            with the user. Required when updating store
            sales data.
        user_attribute (google.ads.googleads.v24.common.types.UserAttribute):
            ...
            days.
        consent (google.ads.googleads.v24.common.types.Consent):
            The consent setting for the user. If set,
            will override the job level consent for this
            user.

            This field is a member of `oneof`_ ``_consent``.
    """
...
class UserAttribute(proto.Message):
    ...
    Attributes:
        ...
        acquisition_date_time (str):
            ...
            optional timezone offset from UTC. If the offset is absent,
            the API will use the account's timezone as default.
        shopping_loyalty (google.ads.googleads.v24.common.types.ShoppingLoyalty):
        ...
        first_purchase_date_time (str):
            ...
            default.
        event_attribute (MutableSequence[google.ads.googleads.v24.common.types.EventAttribute]):
...
class EventAttribute(proto.Message):
    ...
    Attributes:
        ...
        event_date_time (str):
            ...
            optional timezone offset from UTC. If the offset is absent,
            the API will use the account's timezone as default.
        item_attribute (MutableSequence[google.ads.googleads.v24.common.types.EventItemAttribute]):
...
class CustomerMatchUserListMetadata(proto.Message):
    ...
    Attributes:
        ...
        consent (google.ads.googleads.v24.common.types.Consent):
            The consent setting for all the users in this
            job.
...
class StoreSalesMetadata(proto.Message):
    ...
    Attributes:
        ...
        third_party_metadata (google.ads.googleads.v24.common.types.StoreSalesThirdPartyMetadata):
