...
class CustomerSkAdNetworkConversionValueSchemaServiceTransport(abc.ABC):
    """Abstract transport class for CustomerSkAdNetworkConversionValueSchemaService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_sk_ad_network_conversion_value_schema: gapic_v1.method.wrap_method(
