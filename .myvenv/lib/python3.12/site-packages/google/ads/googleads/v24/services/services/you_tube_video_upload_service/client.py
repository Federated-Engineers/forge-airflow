...
from typing import (BinaryIO, Callable, Dict, Optional, Sequence, Tuple, Type,
                    Union, cast)
...
from .transports.grpc import YouTubeVideoUploadServiceGrpcTransport
from .transports.grpc_asyncio import \
    YouTubeVideoUploadServiceGrpcAsyncIOTransport
from .transports.rest_resumable import \
    YouTubeVideoUploadServiceRestResumableTransport


class YouTubeVideoUploadServiceClientMeta(type):
    """Metaclass for the YouTubeVideoUploadService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[YouTubeVideoUploadServiceTransport]]
    _transport_registry["grpc"] = YouTubeVideoUploadServiceGrpcTransport
...
class YouTubeVideoUploadServiceClient(
    metaclass=YouTubeVideoUploadServiceClientMeta
):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            YouTubeVideoUploadServiceClient: The constructed client.
        """
    ...
    def transport(self) -> YouTubeVideoUploadServiceTransport:
        ...
        Returns:
            YouTubeVideoUploadServiceTransport: The transport used by the client
                instance.
        """
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        use_client_cert = (
            YouTubeVideoUploadServiceClient._use_client_cert_effective()
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                YouTubeVideoUploadServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = YouTubeVideoUploadServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = YouTubeVideoUploadServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the you tube video upload service client.
        ...
        Args:
            ...
            developer_token (Optional[str]): The developer token to use for the
                ...
                (create_you_tube_video_upload) ONLY!
            ...
            use_cloud_org_for_api_access (bool): Whether to use the cloud org for
                ...
                (create_you_tube_video_upload) ONLY!
            transport (Optional[Union[str,YouTubeVideoUploadServiceTransport,Callable[..., YouTubeVideoUploadServiceTransport]]]):
        ...
        ) = YouTubeVideoUploadServiceClient._read_environment_variables()
        self._client_cert_source = (
            YouTubeVideoUploadServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            YouTubeVideoUploadServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, YouTubeVideoUploadServiceTransport
        )
        if transport_provided:
            # transport is a YouTubeVideoUploadServiceTransport instance.
            ...
            self._transport = cast(
                YouTubeVideoUploadServiceTransport, transport
            )
            self._api_endpoint = self._transport.host
            resumable_creds = credentials or getattr(
                self._transport, "_credentials", None
            )

            if resumable_creds is None:
                raise ValueError(
                    "For the correct REST resumable transport initialization, either the credentials should be explicitly provided as a `credentials` parameter, or the transport passed should contain readable `_credentials` property. E.g. passing a GRPC channel as a transport does not satisfy this since the credentials cannot be extracted from it. This requirement is unique to the YouTubeVideoUploadService."
                )

            self._rest_resumable_transport = (
                YouTubeVideoUploadServiceRestResumableTransport(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or YouTubeVideoUploadServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                YouTubeVideoUploadServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., YouTubeVideoUploadServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v24.services.YouTubeVideoUploadServiceClient`.",
                    extra=(
                        {
    ...
    def create_you_tube_video_upload(
        ...
        *,
        ...
        you_tube_video_upload: Optional[
            youtube_video_upload.YouTubeVideoUpload
        ] = None,
        stream: BinaryIO,
        ...
        Args:
            request (Union[google.ads.googleads.v24.services.types.CreateYouTubeVideoUploadRequest, dict]):
            ...
            customer_id (str):
                Required. The customer ID requesting
                the upload. Required.
            ...
            you_tube_video_upload (google.ads.googleads.v24.resources.types.YouTubeVideoUpload):
                Required. The initial details of the
                video to upload. Required.

                This corresponds to the ``you_tube_video_upload`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            stream (BinaryIO):
        ...
        Returns:
            google.ads.googleads.v24.services.types.CreateYouTubeVideoUploadResponse:
        ...
        flattened_params = [customer_id, you_tube_video_upload]
        ...
        if not isinstance(
            ...
            if you_tube_video_upload is not None:
                request.you_tube_video_upload = you_tube_video_upload
        ...
        # Send the request.
        response = self._rest_resumable_transport.create_you_tube_video_upload_resumable(
            request=request,
            stream=stream,
            retry=retry,
            timeout=timeout,
    ...
    def update_you_tube_video_upload(
        ...
        *,
        ...
        r"""Updates YouTube video's metadata, but only for videos
        uploaded using this API.

        Args:
            request (Union[google.ads.googleads.v24.services.types.UpdateYouTubeVideoUploadRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                Required. The customer ID requesting
                the YouTube video upload update.
                Required.
                ...
                should not be set.
            you_tube_video_upload (google.ads.googleads.v24.resources.types.YouTubeVideoUpload):
                Required. The YouTube video upload
                resource to be updated. It's expected to
            ...
            update_mask (google.protobuf.field_mask_pb2.FieldMask):
                Required. FieldMask that determines
                which resource fields are modified in an
                update.
        ...
        Returns:
            google.ads.googleads.v24.services.types.UpdateYouTubeVideoUploadResponse:
                Response message for
                   [YouTubeVideoUploadService.UpdateYouTubeVideoUpload][google.ads.googleads.v24.services.YouTubeVideoUploadService.UpdateYouTubeVideoUpload].
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [customer_id, you_tube_video_upload, update_mask]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.update_you_tube_video_upload
        ]
    ...
    def remove_you_tube_video_upload(
        ...
        *,
        ...
        r"""Removes YouTube videos uploaded using this API.

        Args:
            request (Union[google.ads.googleads.v24.services.types.RemoveYouTubeVideoUploadRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                Required. The customer ID requesting
                the YouTube video upload deletion.
                Required.
        ...
        Returns:
            google.ads.googleads.v24.services.types.RemoveYouTubeVideoUploadResponse:
                Response message for
                   [YouTubeVideoUploadService.RemoveYouTubeVideoUpload][google.ads.googleads.v24.services.YouTubeVideoUploadService.RemoveYouTubeVideoUpload].
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.remove_you_tube_video_upload
        ]
