...
class AppendLeadConversationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            appended.
        conversations (MutableSequence[google.ads.googleads.v24.services.types.Conversation]):
...
class AppendLeadConversationResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.ads.googleads.v24.services.types.ConversationOrError]):
...
class SurveySatisfied(proto.Message):
    ...
    Attributes:
        survey_satisfied_reason (google.ads.googleads.v24.enums.types.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason):
...
class SurveyDissatisfied(proto.Message):
    ...
    Attributes:
        survey_dissatisfied_reason (google.ads.googleads.v24.enums.types.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason):
...
class ProvideLeadFeedbackRequest(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            being provided.
        survey_answer (google.ads.googleads.v24.enums.types.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer):
            Required. Survey answer for Local Services
            Ads Lead.
        survey_satisfied (google.ads.googleads.v24.services.types.SurveySatisfied):
            Details about various factors for being
            satisfied with the lead.

            This field is a member of `oneof`_ ``survey_details``.
        survey_dissatisfied (google.ads.googleads.v24.services.types.SurveyDissatisfied):
...
class ProvideLeadFeedbackResponse(proto.Message):
    ...
    Attributes:
        credit_issuance_decision (google.ads.googleads.v24.enums.types.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision):
