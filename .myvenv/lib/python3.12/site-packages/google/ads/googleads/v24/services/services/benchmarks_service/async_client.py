...
class BenchmarksServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v24.services.BenchmarksServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def list_benchmarks_available_dates(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.ListBenchmarksAvailableDatesRequest, dict]]):
    ...
    async def list_benchmarks_locations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.ListBenchmarksLocationsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_benchmarks_products(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.ListBenchmarksProductsRequest, dict]]):
                The request object. Request message for
    ...
    async def list_benchmarks_sources(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.ListBenchmarksSourcesRequest, dict]]):
                The request object. Request message for
                [BenchmarksService.ListBenchmarksSources][google.ads.googleads.v24.services.BenchmarksService.ListBenchmarksSources].
            benchmarks_sources (:class:`MutableSequence[google.ads.googleads.v24.enums.types.BenchmarksSourceTypeEnum.BenchmarksSourceType]`):
    ...
    async def generate_benchmarks_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v24.services.types.GenerateBenchmarksMetricsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            location (:class:`google.ads.googleads.v24.common.types.LocationInfo`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            benchmarks_source (:class:`google.ads.googleads.v24.services.types.BenchmarksSource`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            product_filter (:class:`google.ads.googleads.v24.services.types.ProductFilter`):
