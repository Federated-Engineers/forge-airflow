...
from google.ads.googleads.v24.enums.types import (
    fixed_cpm_goal, fixed_cpm_target_frequency_time_unit,
    target_frequency_time_unit, target_impression_share_location)
...
class TargetCpm(proto.Message):
    ...
    Attributes:
        target_frequency_goal (google.ads.googleads.v24.common.types.TargetCpmTargetFrequencyGoal):
...
class FixedCpm(proto.Message):
    ...
    Attributes:
        goal (google.ads.googleads.v24.enums.types.FixedCpmGoalEnum.FixedCpmGoal):
            Fixed CPM bidding goal. Determines the exact
            bidding optimization parameters.
        target_frequency_info (google.ads.googleads.v24.common.types.FixedCpmTargetFrequencyGoalInfo):
            Target frequency bidding goal details.
...
class FixedCpmTargetFrequencyGoalInfo(proto.Message):
    ...
    Attributes:
        ...
        time_unit (google.ads.googleads.v24.enums.types.FixedCpmTargetFrequencyTimeUnitEnum.FixedCpmTargetFrequencyTimeUnit):
            Time window expressing the period over which you want to
            reach the specified target_count.
    """
