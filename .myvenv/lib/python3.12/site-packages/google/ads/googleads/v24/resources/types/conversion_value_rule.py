...
class ConversionValueRule(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            rule.
        action (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleAction):
            Action applied when the rule is triggered.
        geo_location_condition (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleGeoLocationCondition):
            Condition for Geo location that must be
            satisfied for the value rule to apply.
        device_condition (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleDeviceCondition):
            Condition for device type that must be
            satisfied for the value rule to apply.
        audience_condition (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleAudienceCondition):
            Condition for audience that must be satisfied
            for the value rule to apply.
        itinerary_condition (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleItineraryCondition):
        ...
        owner_customer (str):
            ...
            \*\*
        status (google.ads.googleads.v24.enums.types.ConversionValueRuleStatusEnum.ConversionValueRuleStatus):
    ...
    class ValueRuleAction(proto.Message):
        ...
        Attributes:
            operation (google.ads.googleads.v24.enums.types.ValueRuleOperationEnum.ValueRuleOperation):
    ...
    class ValueRuleGeoLocationCondition(proto.Message):
        ...
        Attributes:
            excluded_geo_target_constants (MutableSequence[str]):
                ...
                exclude.
            excluded_geo_match_type (google.ads.googleads.v24.enums.types.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType):
                Excluded Geo location match type.
            geo_target_constants (MutableSequence[str]):
                Geo locations that advertisers want to
                include.
            geo_match_type (google.ads.googleads.v24.enums.types.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType):
    ...
    class ValueRuleDeviceCondition(proto.Message):
        ...
        Attributes:
            device_types (MutableSequence[google.ads.googleads.v24.enums.types.ValueRuleDeviceTypeEnum.ValueRuleDeviceType]):
    ...
    class ValueRuleItineraryCondition(proto.Message):
        ...
        Attributes:
            advance_booking_window (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow):
                Range for the number of days between the date
                of the booking and the start of the itinerary.
            travel_length (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleItineraryTravelLength):
                Range for the itinerary length in number of
                nights.
            travel_start_day (google.ads.googleads.v24.resources.types.ConversionValueRule.ValueRuleItineraryTravelStartDay):
