...
from google.ads.googleads.v24.common.types import asset_policy
from google.ads.googleads.v24.enums.types import \
    asset_performance_label as gage_asset_performance_label
from google.ads.googleads.v24.enums.types import served_asset_field_type
...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        ...
        pinned_field (google.ads.googleads.v24.enums.types.ServedAssetFieldTypeEnum.ServedAssetFieldType):
        ...
        asset_performance_label (google.ads.googleads.v24.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v24.common.types.AdAssetPolicySummary):
...
class AdVideoAsset(proto.Message):
    ...
    Attributes:
        asset (str):
            ...
            This field is a member of `oneof`_ ``_asset``.
        ad_video_asset_info (google.ads.googleads.v24.common.types.AdVideoAssetInfo):
...
class AdVideoAssetInfo(proto.Message):
    ...
    Attributes:
        ad_video_asset_inventory_preferences (google.ads.googleads.v24.common.types.AdVideoAssetInventoryPreferences):
        ...
        ad_video_asset_feature_control (google.ads.googleads.v24.common.types.AdVideoAssetLinkFeatureControl):
            Defines feature controls for this
            AdVideoAsset during serving time. For example,
            whether YouTube comments should be enabled for
            Partnership Ads served on YouTube Shorts.

            This field is a member of `oneof`_ ``_ad_video_asset_feature_control``.
    """
...
class AdVideoAssetLinkFeatureControl(proto.Message):
    r"""YouTube Video Asset feature controls.

    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

    Attributes:
        allow_youtube_comments (bool):
            Defines if YouTube comments should be enabled
            for the creative using this YouTube video asset
            served on YouTube Shorts.

            This field is a member of `oneof`_ ``_allow_youtube_comments``.
    """

    allow_youtube_comments: bool = proto.Field(
        proto.BOOL,
        number=1,
        optional=True,
    )
