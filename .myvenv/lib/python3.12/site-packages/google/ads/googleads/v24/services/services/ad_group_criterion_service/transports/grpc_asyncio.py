...
from .base import DEFAULT_CLIENT_INFO, AdGroupCriterionServiceTransport
...
class AdGroupCriterionServiceGrpcAsyncIOTransport(
    AdGroupCriterionServiceTransport
):
    """gRPC AsyncIO backend transport for AdGroupCriterionService.
    ...
    def mutate_ad_group_criteria(
        ...
        Returns:
            Callable[[~.MutateAdGroupCriteriaRequest],
                    Awaitable[~.MutateAdGroupCriteriaResponse]]:
        ...
        if "mutate_ad_group_criteria" not in self._stubs:
            self._stubs["mutate_ad_group_criteria"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.AdGroupCriterionService/MutateAdGroupCriteria",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_criteria: self._wrap_method(
...
__all__ = ("AdGroupCriterionServiceGrpcAsyncIOTransport",)
