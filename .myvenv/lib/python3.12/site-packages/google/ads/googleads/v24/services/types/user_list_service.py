...
from google.ads.googleads.v24.resources.types import user_list
...
class UserListOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v24.resources.types.UserList):
            Create operation: No resource name is
            expected for the new user list.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v24.resources.types.UserList):
...
class MutateUserListsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateUserListResult]):
