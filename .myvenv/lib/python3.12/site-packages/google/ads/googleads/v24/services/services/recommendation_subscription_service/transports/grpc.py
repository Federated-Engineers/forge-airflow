...
class RecommendationSubscriptionServiceGrpcTransport(
    RecommendationSubscriptionServiceTransport
):
    """gRPC backend transport for RecommendationSubscriptionService.
        ...
        if "mutate_recommendation_subscription" not in self._stubs:
            self._stubs["mutate_recommendation_subscription"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v24.services.RecommendationSubscriptionService/MutateRecommendationSubscription",
...
__all__ = ("RecommendationSubscriptionServiceGrpcTransport",)
