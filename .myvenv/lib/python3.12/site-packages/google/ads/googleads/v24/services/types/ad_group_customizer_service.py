...
class AdGroupCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v24.resources.types.AdGroupCustomizer):
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v24.services.types.MutateAdGroupCustomizerResult]):
