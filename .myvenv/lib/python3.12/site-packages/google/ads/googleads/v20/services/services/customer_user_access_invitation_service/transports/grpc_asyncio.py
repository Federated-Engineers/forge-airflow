...
class CustomerUserAccessInvitationServiceGrpcAsyncIOTransport(
    CustomerUserAccessInvitationServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerUserAccessInvitationService.
    ...
    def mutate_customer_user_access_invitation(
        ...
        Returns:
            Callable[[~.MutateCustomerUserAccessInvitationRequest],
                    Awaitable[~.MutateCustomerUserAccessInvitationResponse]]:
        ...
        if "mutate_customer_user_access_invitation" not in self._stubs:
            self._stubs["mutate_customer_user_access_invitation"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_user_access_invitation: self._wrap_method(
                self.mutate_customer_user_access_invitation,
