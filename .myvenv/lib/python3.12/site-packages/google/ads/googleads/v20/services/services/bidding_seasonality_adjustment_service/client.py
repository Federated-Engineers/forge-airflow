...
class BiddingSeasonalityAdjustmentServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict]):
