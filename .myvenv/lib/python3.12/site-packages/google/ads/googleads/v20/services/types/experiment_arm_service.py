...
class ExperimentArmOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.ExperimentArm):
            Create operation

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.ExperimentArm):
...
class MutateExperimentArmsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateExperimentArmResult]):
