...
from google.ads.googleads.v20.resources.types import campaign_label
...
class CampaignLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.resources.types.CampaignLabel):
...
class MutateCampaignLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateCampaignLabelResult]):
