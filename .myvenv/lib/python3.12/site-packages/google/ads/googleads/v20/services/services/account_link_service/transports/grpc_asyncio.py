...
from .base import DEFAULT_CLIENT_INFO, AccountLinkServiceTransport
        ...
        if "create_account_link" not in self._stubs:
            self._stubs["create_account_link"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.AccountLinkService/CreateAccountLink",
    ...
    def mutate_account_link(
        ...
        if "mutate_account_link" not in self._stubs:
            self._stubs["mutate_account_link"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.AccountLinkService/MutateAccountLink",
