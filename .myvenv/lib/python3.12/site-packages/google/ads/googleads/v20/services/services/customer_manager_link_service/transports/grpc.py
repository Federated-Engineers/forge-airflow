...
from .base import DEFAULT_CLIENT_INFO, CustomerManagerLinkServiceTransport
        ...
        if "mutate_customer_manager_link" not in self._stubs:
            self._stubs["mutate_customer_manager_link"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.CustomerManagerLinkService/MutateCustomerManagerLink",
    ...
    def move_manager_link(
        ...
        if "move_manager_link" not in self._stubs:
            self._stubs["move_manager_link"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v20.services.CustomerManagerLinkService/MoveManagerLink",
...
__all__ = ("CustomerManagerLinkServiceGrpcTransport",)
