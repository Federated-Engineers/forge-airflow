...
class AdGroupAdOperation(proto.Message):
    ...
    Attributes:
        ...
        policy_validation_parameter (google.ads.googleads.v20.common.types.PolicyValidationParameter):
            Configuration for how policies are validated.
        create (google.ads.googleads.v20.resources.types.AdGroupAd):
            Create operation: No resource name is
            expected for the new ad.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.AdGroupAd):
...
class MutateAdGroupAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateAdGroupAdResult]):
