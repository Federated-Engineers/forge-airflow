...
class PolicyValidationParameter(proto.Message):
    ...
    Attributes:
        ...
        exempt_policy_violation_keys (MutableSequence[google.ads.googleads.v20.common.types.PolicyViolationKey]):
...
class PolicyTopicEntry(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v20.enums.types.PolicyTopicEntryTypeEnum.PolicyTopicEntryType):
            Describes the negative or positive effect
            this policy will have on serving.
        evidences (MutableSequence[google.ads.googleads.v20.common.types.PolicyTopicEvidence]):
            Additional information that explains policy
            finding (for example, the brand name for a
            trademark finding).
        constraints (MutableSequence[google.ads.googleads.v20.common.types.PolicyTopicConstraint]):
...
class PolicyTopicEvidence(proto.Message):
    ...
    Attributes:
        website_list (google.ads.googleads.v20.common.types.PolicyTopicEvidence.WebsiteList):
            List of websites linked with this resource.

            This field is a member of `oneof`_ ``value``.
        text_list (google.ads.googleads.v20.common.types.PolicyTopicEvidence.TextList):
        ...
        language_code (str):
            ...
            This field is a member of `oneof`_ ``value``.
        destination_text_list (google.ads.googleads.v20.common.types.PolicyTopicEvidence.DestinationTextList):
            The text in the destination of the resource
            that is causing a policy finding.

            This field is a member of `oneof`_ ``value``.
        destination_mismatch (google.ads.googleads.v20.common.types.PolicyTopicEvidence.DestinationMismatch):
            Mismatch between the destinations of a
            resource's URLs.

            This field is a member of `oneof`_ ``value``.
        destination_not_working (google.ads.googleads.v20.common.types.PolicyTopicEvidence.DestinationNotWorking):
    ...
    class DestinationMismatch(proto.Message):
        ...
        Attributes:
            url_types (MutableSequence[google.ads.googleads.v20.enums.types.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType]):
    ...
    class DestinationNotWorking(proto.Message):
        ...
        Attributes:
            ...
            device (google.ads.googleads.v20.enums.types.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDevice):
            ...
            dns_error_type (google.ads.googleads.v20.enums.types.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorType):
...
class PolicyTopicConstraint(proto.Message):
    ...
    Attributes:
        country_constraint_list (google.ads.googleads.v20.common.types.PolicyTopicConstraint.CountryConstraintList):
            Countries where the resource cannot serve.

            This field is a member of `oneof`_ ``value``.
        reseller_constraint (google.ads.googleads.v20.common.types.PolicyTopicConstraint.ResellerConstraint):
            Reseller constraint.

            This field is a member of `oneof`_ ``value``.
        certificate_missing_in_country_list (google.ads.googleads.v20.common.types.PolicyTopicConstraint.CountryConstraintList):
            Countries where a certificate is required for
            serving.

            This field is a member of `oneof`_ ``value``.
        certificate_domain_mismatch_in_country_list (google.ads.googleads.v20.common.types.PolicyTopicConstraint.CountryConstraintList):
    ...
    class CountryConstraintList(proto.Message):
        ...
        Attributes:
            ...
            countries (MutableSequence[google.ads.googleads.v20.common.types.PolicyTopicConstraint.CountryConstraint]):
