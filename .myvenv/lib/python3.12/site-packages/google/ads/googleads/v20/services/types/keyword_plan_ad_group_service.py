...
from google.ads.googleads.v20.resources.types import keyword_plan_ad_group
...
class KeywordPlanAdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.KeywordPlanAdGroup):
            Create operation: No resource name is
            expected for the new Keyword Plan ad group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.KeywordPlanAdGroup):
...
class MutateKeywordPlanAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateKeywordPlanAdGroupResult]):
