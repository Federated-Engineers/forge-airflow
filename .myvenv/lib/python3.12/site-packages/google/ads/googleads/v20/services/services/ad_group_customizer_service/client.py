...
class AdGroupCustomizerServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.AdGroupCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateAdGroupCustomizersRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.AdGroupCustomizerOperation]):
