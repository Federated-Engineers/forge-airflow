...
class CampaignSharedSetServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignSharedSetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignSharedSetsRequest, dict]):
