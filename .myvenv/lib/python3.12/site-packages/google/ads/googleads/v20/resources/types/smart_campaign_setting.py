...
class SmartCampaignSetting(proto.Message):
    ...
    Attributes:
        ...
        campaign (str):
            ...
            settings apply.
        phone_number (google.ads.googleads.v20.resources.types.SmartCampaignSetting.PhoneNumber):
            Phone number and country code.
        advertising_language_code (str):
            The language code to advertise in from the set of [supported
            language codes]
        ...
        ad_optimized_business_profile_setting (google.ads.googleads.v20.resources.types.SmartCampaignSetting.AdOptimizedBusinessProfileSetting):
