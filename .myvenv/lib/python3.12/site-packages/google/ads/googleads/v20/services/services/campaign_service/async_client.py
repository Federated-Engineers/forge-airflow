...
class CampaignServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v20.services.CampaignServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.MutateCampaignsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v20.services.types.CampaignOperation]`):
    ...
    async def enable_p_max_brand_guidelines(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v20.services.types.EnablePMaxBrandGuidelinesRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v20.services.types.EnableOperation]`):
