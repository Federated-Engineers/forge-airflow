        ...
        if "append_lead_conversation" not in self._stubs:
            self._stubs["append_lead_conversation"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.LocalServicesLeadService/AppendLeadConversation",
    ...
    def provide_lead_feedback(
        ...
        if "provide_lead_feedback" not in self._stubs:
            self._stubs["provide_lead_feedback"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.LocalServicesLeadService/ProvideLeadFeedback",
