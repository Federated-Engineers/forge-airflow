...
from google.ads.googleads.v20.common.types import consent as gagc_consent
...
class UserIdentifier(proto.Message):
    ...
    Attributes:
        user_identifier_source (google.ads.googleads.v20.enums.types.UserIdentifierSourceEnum.UserIdentifierSource):
        ...
        third_party_user_id (str):
            ...
            This field is a member of `oneof`_ ``identifier``.
        address_info (google.ads.googleads.v20.common.types.OfflineUserAddressInfo):
...
class TransactionAttribute(proto.Message):
    ...
    Attributes:
        ...
        store_attribute (google.ads.googleads.v20.common.types.StoreAttribute):
        ...
        item_attribute (google.ads.googleads.v20.common.types.ItemAttribute):
...
class UserData(proto.Message):
    ...
    Attributes:
        user_identifiers (MutableSequence[google.ads.googleads.v20.common.types.UserIdentifier]):
            User identification info. Required.
        transaction_attribute (google.ads.googleads.v20.common.types.TransactionAttribute):
            Additional transactions/attributes associated
            with the user. Required when updating store
            sales data.
        user_attribute (google.ads.googleads.v20.common.types.UserAttribute):
            ...
            days.
        consent (google.ads.googleads.v20.common.types.Consent):
...
class UserAttribute(proto.Message):
    ...
    Attributes:
        ...
        acquisition_date_time (str):
            ...
            optional timezone offset from UTC. If the offset is absent,
            the API will use the account's timezone as default.
        shopping_loyalty (google.ads.googleads.v20.common.types.ShoppingLoyalty):
        ...
        first_purchase_date_time (str):
            ...
            default.
        event_attribute (MutableSequence[google.ads.googleads.v20.common.types.EventAttribute]):
...
class EventAttribute(proto.Message):
    ...
    Attributes:
        ...
        event_date_time (str):
            ...
            optional timezone offset from UTC. If the offset is absent,
            the API will use the account's timezone as default.
        item_attribute (MutableSequence[google.ads.googleads.v20.common.types.EventItemAttribute]):
...
class StoreSalesMetadata(proto.Message):
    ...
    Attributes:
        ...
        third_party_metadata (google.ads.googleads.v20.common.types.StoreSalesThirdPartyMetadata):
