...
class AssetLinkPrimaryStatusDetails(proto.Message):
    ...
    Attributes:
        reason (google.ads.googleads.v20.enums.types.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason):
            Provides the reason of this PrimaryStatus.

            This field is a member of `oneof`_ ``_reason``.
        status (google.ads.googleads.v20.enums.types.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus):
            Provides the PrimaryStatus of this status
            detail.

            This field is a member of `oneof`_ ``_status``.
        asset_disapproved (google.ads.googleads.v20.common.types.AssetDisapproved):
...
class AssetDisapproved(proto.Message):
    ...
    Attributes:
        offline_evaluation_error_reasons (MutableSequence[google.ads.googleads.v20.enums.types.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons]):
