...
class CustomerClientLinkServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CustomerClientLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCustomerClientLinkRequest, dict]):
