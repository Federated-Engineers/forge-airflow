...
from google.ads.googleads.v20.enums.types import campaign_draft_status
...
class CampaignDraft(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v20.enums.types.CampaignDraftStatusEnum.CampaignDraftStatus):
