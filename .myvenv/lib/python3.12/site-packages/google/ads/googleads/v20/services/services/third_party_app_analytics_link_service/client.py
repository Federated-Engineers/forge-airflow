...
class ThirdPartyAppAnalyticsLinkServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.ThirdPartyAppAnalyticsLinkServiceClient`.",
                    extra=(
                        {
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.RegenerateShareableLinkIdRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.RegenerateShareableLinkIdResponse:
