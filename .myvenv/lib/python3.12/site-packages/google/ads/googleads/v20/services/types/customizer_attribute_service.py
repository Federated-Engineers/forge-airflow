...
class CustomizerAttributeOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateCustomizerAttributeResult]):
