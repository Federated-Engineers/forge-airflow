...
class KeywordPlanCampaignServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.KeywordPlanCampaignServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateKeywordPlanCampaignsRequest, dict]):
