...
from google.ads.googleads.v20.resources.types import campaign_lifecycle_goal
...
class CampaignLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.CampaignLifecycleGoal):
            Create operation: Create a new campaign
            lifecycle goal. The campaign field should be set
            for this operation.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.CampaignLifecycleGoal):
...
class ConfigureCampaignLifecycleGoalsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v20.services.types.ConfigureCampaignLifecycleGoalsResult):
