...
class UserListCustomerTypeOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.resources.types.UserListCustomerType):
...
class MutateUserListCustomerTypesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateUserListCustomerTypeResult]):
