    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v20.services.RecommendationSubscriptionServiceAsyncClient`.",
                extra=(
                    {
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v20.services.types.RecommendationSubscriptionOperation]`):
