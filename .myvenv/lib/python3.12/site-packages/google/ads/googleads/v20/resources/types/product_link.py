...
class ProductLink(proto.Message):
    ...
    Attributes:
        ...
        data_partner (google.ads.googleads.v20.resources.types.DataPartnerIdentifier):
            Immutable. Data partner link.

            This field is a member of `oneof`_ ``linked_product``.
        google_ads (google.ads.googleads.v20.resources.types.GoogleAdsIdentifier):
            Immutable. Google Ads link.

            This field is a member of `oneof`_ ``linked_product``.
        merchant_center (google.ads.googleads.v20.resources.types.MerchantCenterIdentifier):
            Immutable. Google Merchant Center link.

            This field is a member of `oneof`_ ``linked_product``.
        advertising_partner (google.ads.googleads.v20.resources.types.AdvertisingPartnerIdentifier):
