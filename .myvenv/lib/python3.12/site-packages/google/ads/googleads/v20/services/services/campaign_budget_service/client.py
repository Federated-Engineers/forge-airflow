...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignBudgetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_budgets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignBudgetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.CampaignBudgetOperation]):
