...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        ...
        asset_performance_label (google.ads.googleads.v20.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v20.common.types.AdAssetPolicySummary):
...
class AdVideoAsset(proto.Message):
    ...
    Attributes:
        asset (str):
            ...
            This field is a member of `oneof`_ ``_asset``.
        ad_video_asset_info (google.ads.googleads.v20.common.types.AdVideoAssetInfo):
...
class AdVideoAssetInfo(proto.Message):
    ...
    Attributes:
        ad_video_asset_inventory_preferences (google.ads.googleads.v20.common.types.AdVideoAssetInventoryPreferences):
