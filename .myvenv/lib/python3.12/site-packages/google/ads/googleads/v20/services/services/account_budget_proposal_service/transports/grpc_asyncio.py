...
from .base import DEFAULT_CLIENT_INFO, AccountBudgetProposalServiceTransport
    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v20.services.AccountBudgetProposalService",
...
class AccountBudgetProposalServiceGrpcAsyncIOTransport(
    AccountBudgetProposalServiceTransport
):
    """gRPC AsyncIO backend transport for AccountBudgetProposalService.
    ...
    def mutate_account_budget_proposal(
        ...
        Returns:
            Callable[[~.MutateAccountBudgetProposalRequest],
                    Awaitable[~.MutateAccountBudgetProposalResponse]]:
        ...
        if "mutate_account_budget_proposal" not in self._stubs:
            self._stubs["mutate_account_budget_proposal"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.AccountBudgetProposalService/MutateAccountBudgetProposal",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_account_budget_proposal: self._wrap_method(
...
__all__ = ("AccountBudgetProposalServiceGrpcAsyncIOTransport",)
