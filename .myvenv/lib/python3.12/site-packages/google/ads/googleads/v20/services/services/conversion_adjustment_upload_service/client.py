...
class ConversionAdjustmentUploadServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.ConversionAdjustmentUploadServiceClient`.",
                    extra=(
                        {
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.UploadConversionAdjustmentsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            conversion_adjustments (MutableSequence[google.ads.googleads.v20.services.types.ConversionAdjustment]):
