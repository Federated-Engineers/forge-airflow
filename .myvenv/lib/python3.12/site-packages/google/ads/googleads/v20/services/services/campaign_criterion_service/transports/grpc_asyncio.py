...
from .base import DEFAULT_CLIENT_INFO, CampaignCriterionServiceTransport
...
class CampaignCriterionServiceGrpcAsyncIOTransport(
    CampaignCriterionServiceTransport
):
    """gRPC AsyncIO backend transport for CampaignCriterionService.
    ...
    def mutate_campaign_criteria(
        ...
        Returns:
            Callable[[~.MutateCampaignCriteriaRequest],
                    Awaitable[~.MutateCampaignCriteriaResponse]]:
        ...
        if "mutate_campaign_criteria" not in self._stubs:
            self._stubs["mutate_campaign_criteria"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.CampaignCriterionService/MutateCampaignCriteria",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_criteria: self._wrap_method(
...
__all__ = ("CampaignCriterionServiceGrpcAsyncIOTransport",)
