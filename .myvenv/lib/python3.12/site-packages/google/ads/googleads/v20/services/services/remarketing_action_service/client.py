...
class RemarketingActionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.RemarketingActionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_remarketing_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateRemarketingActionsRequest, dict]):
