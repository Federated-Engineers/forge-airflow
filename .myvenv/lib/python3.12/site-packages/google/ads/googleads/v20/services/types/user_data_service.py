...
class UploadUserDataRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v20.services.types.UserDataOperation]):
...
class UserDataOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.common.types.UserData):
            The list of user data to be appended to the
            user list.

            This field is a member of `oneof`_ ``operation``.
        remove (google.ads.googleads.v20.common.types.UserData):
