...
class GeoTargetConstantServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.GeoTargetConstantServiceClient`.",
                    extra=(
                        {
    ...
    def suggest_geo_target_constants(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.SuggestGeoTargetConstantsRequest, dict]):
