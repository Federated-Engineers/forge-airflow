...
from .base import DEFAULT_CLIENT_INFO, ConversionValueRuleServiceTransport
...
class ConversionValueRuleServiceGrpcAsyncIOTransport(
    ConversionValueRuleServiceTransport
):
    """gRPC AsyncIO backend transport for ConversionValueRuleService.
    ...
    def mutate_conversion_value_rules(
        ...
        Returns:
            Callable[[~.MutateConversionValueRulesRequest],
                    Awaitable[~.MutateConversionValueRulesResponse]]:
        ...
        if "mutate_conversion_value_rules" not in self._stubs:
            self._stubs["mutate_conversion_value_rules"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ConversionValueRuleService/MutateConversionValueRules",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_conversion_value_rules: self._wrap_method(
...
__all__ = ("ConversionValueRuleServiceGrpcAsyncIOTransport",)
