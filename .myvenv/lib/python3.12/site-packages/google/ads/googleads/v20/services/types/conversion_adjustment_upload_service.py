...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (MutableSequence[google.ads.googleads.v20.services.types.ConversionAdjustmentResult]):
...
class ConversionAdjustment(proto.Message):
    ...
    Attributes:
        gclid_date_time_pair (google.ads.googleads.v20.services.types.GclidDateTimePair):
        ...
        adjustment_type (google.ads.googleads.v20.enums.types.ConversionAdjustmentTypeEnum.ConversionAdjustmentType):
            The adjustment type.
        restatement_value (google.ads.googleads.v20.services.types.RestatementValue):
