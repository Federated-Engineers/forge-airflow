...
class SharedSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.SharedSet):
            Create operation: No resource name is
            expected for the new shared set.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.SharedSet):
...
class MutateSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateSharedSetResult]):
