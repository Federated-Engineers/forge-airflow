...
class AssetSetServiceClient(metaclass=AssetSetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.AssetSetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateAssetSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v20.services.types.AssetSetOperation]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateAssetSetsResponse:
