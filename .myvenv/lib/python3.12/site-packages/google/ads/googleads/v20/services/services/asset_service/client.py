...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.AssetServiceClient`.",
                    extra=(
                        {
                            "serviceName": "google.ads.googleads.v20.services.AssetService",
    ...
    def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateAssetsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v20.services.types.MutateAssetsResponse:
