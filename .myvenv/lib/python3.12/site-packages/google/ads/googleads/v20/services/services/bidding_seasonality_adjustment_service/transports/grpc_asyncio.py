...
class BiddingSeasonalityAdjustmentServiceGrpcAsyncIOTransport(
    BiddingSeasonalityAdjustmentServiceTransport
):
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        Returns:
            Callable[[~.MutateBiddingSeasonalityAdjustmentsRequest],
                    Awaitable[~.MutateBiddingSeasonalityAdjustmentsResponse]]:
        ...
        if "mutate_bidding_seasonality_adjustments" not in self._stubs:
            self._stubs["mutate_bidding_seasonality_adjustments"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_bidding_seasonality_adjustments: self._wrap_method(
...
__all__ = ("BiddingSeasonalityAdjustmentServiceGrpcAsyncIOTransport",)
