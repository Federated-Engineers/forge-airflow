...
from .base import DEFAULT_CLIENT_INFO, CustomConversionGoalServiceTransport
        ...
        if "mutate_custom_conversion_goals" not in self._stubs:
            self._stubs["mutate_custom_conversion_goals"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.CustomConversionGoalService/MutateCustomConversionGoals",
