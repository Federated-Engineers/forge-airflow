...
class CampaignCriterionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.CampaignCriterionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateCampaignCriteriaRequest, dict]):
