...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.AccountLinkServiceClient`.",
                    extra=(
                        {
    ...
    def create_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.CreateAccountLinkRequest, dict]):
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateAccountLinkRequest, dict]):
                The request object. Request message for
