...
class AssetSetAssetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v20.resources.types.AssetSetAsset):
...
class MutateAssetSetAssetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateAssetSetAssetResult]):
