        ...
        if "generate_conversion_rates" not in self._stubs:
            self._stubs["generate_conversion_rates"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ReachPlanService/GenerateConversionRates",
    ...
    def list_plannable_products(
        ...
        if "list_plannable_products" not in self._stubs:
            self._stubs["list_plannable_products"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ReachPlanService/ListPlannableProducts",
    ...
    def list_plannable_user_lists(
        ...
        if "list_plannable_user_lists" not in self._stubs:
            self._stubs["list_plannable_user_lists"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v20.services.ReachPlanService/ListPlannableUserLists",
