...
class RecommendationSubscriptionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v20.resources.types.RecommendationSubscription):
            Create operation: No resource name is
            expected for the new subscription.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v20.resources.types.RecommendationSubscription):
...
class MutateRecommendationSubscriptionResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v20.services.types.MutateRecommendationSubscriptionResult]):
