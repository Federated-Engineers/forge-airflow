...
class KeywordThemeConstantServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.KeywordThemeConstantServiceClient`.",
                    extra=(
                        {
    ...
    def suggest_keyword_theme_constants(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.SuggestKeywordThemeConstantsRequest, dict]):
