...
class BiddingDataExclusionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v20.services.BiddingDataExclusionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v20.services.types.MutateBiddingDataExclusionsRequest, dict]):
