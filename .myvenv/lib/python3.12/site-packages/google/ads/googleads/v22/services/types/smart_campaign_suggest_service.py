...
from google.ads.googleads.v22.common.types import ad_type_infos, criteria
...
class SuggestSmartCampaignBudgetOptionsRequest(proto.Message):
    ...
    Attributes:
        ...
        suggestion_info (google.ads.googleads.v22.services.types.SmartCampaignSuggestionInfo):
...
class SmartCampaignSuggestionInfo(proto.Message):
    ...
    Attributes:
        ...
        ad_schedules (MutableSequence[google.ads.googleads.v22.common.types.AdScheduleInfo]):
            Optional. The business ad schedule.
        keyword_themes (MutableSequence[google.ads.googleads.v22.common.types.KeywordThemeInfo]):
        ...
        business_context (google.ads.googleads.v22.services.types.SmartCampaignSuggestionInfo.BusinessContext):
        ...
        business_profile_location (str):
            ...
            This field is a member of `oneof`_ ``business_setting``.
        location_list (google.ads.googleads.v22.services.types.SmartCampaignSuggestionInfo.LocationList):
    ...
    class LocationList(proto.Message):
        ...
        Attributes:
            locations (MutableSequence[google.ads.googleads.v22.common.types.LocationInfo]):
                Required. Locations.
        """
...
class SuggestSmartCampaignBudgetOptionsResponse(proto.Message):
    ...
    Attributes:
        low (google.ads.googleads.v22.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
            Optional. The lowest budget option.

            This field is a member of `oneof`_ ``_low``.
        recommended (google.ads.googleads.v22.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
            Optional. The recommended budget option.

            This field is a member of `oneof`_ ``_recommended``.
        high (google.ads.googleads.v22.services.types.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption):
    ...
    class BudgetOption(proto.Message):
        ...
        Attributes:
            daily_amount_micros (int):
                ...
                currency unit.
            metrics (google.ads.googleads.v22.services.types.SuggestSmartCampaignBudgetOptionsResponse.Metrics):
...
class SuggestSmartCampaignAdResponse(proto.Message):
    ...
    Attributes:
        ad_info (google.ads.googleads.v22.common.types.SmartCampaignAdInfo):
...
class SuggestKeywordThemesResponse(proto.Message):
    ...
    Attributes:
        keyword_themes (MutableSequence[google.ads.googleads.v22.services.types.SuggestKeywordThemesResponse.KeywordTheme]):
