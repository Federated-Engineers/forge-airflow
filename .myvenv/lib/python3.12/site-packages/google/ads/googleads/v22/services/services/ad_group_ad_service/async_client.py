...
class AdGroupAdServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v22.services.AdGroupAdServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.MutateAdGroupAdsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v22.services.types.AdGroupAdOperation]`):
    ...
    async def remove_automatically_created_assets(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.RemoveAutomaticallyCreatedAssetsRequest, dict]]):
                The request object. Request message for
            ...
            ad_group_ad (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            assets_with_field_type (:class:`MutableSequence[google.ads.googleads.v22.services.types.AssetsWithFieldType]`):
