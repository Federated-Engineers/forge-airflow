...
class CriterionCategoryAvailability(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v22.common.types.CriterionCategoryChannelAvailability):
            Channel types and subtypes that are available
            to the category.
        locale (MutableSequence[google.ads.googleads.v22.common.types.CriterionCategoryLocaleAvailability]):
...
class CriterionCategoryChannelAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v22.enums.types.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode):
        ...
        advertising_channel_sub_type (MutableSequence[google.ads.googleads.v22.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType]):
...
class CriterionCategoryLocaleAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v22.enums.types.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode):
