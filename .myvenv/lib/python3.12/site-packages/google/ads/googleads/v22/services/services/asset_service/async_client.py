...
class AssetServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v22.services.AssetServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.MutateAssetsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v22.services.types.AssetOperation]`):
