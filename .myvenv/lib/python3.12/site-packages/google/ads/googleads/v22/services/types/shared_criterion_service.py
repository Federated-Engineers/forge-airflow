...
class MutateSharedCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v22.services.types.SharedCriterionOperation]):
...
class SharedCriterionOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.SharedCriterion):
...
class MutateSharedCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateSharedCriterionResult]):
