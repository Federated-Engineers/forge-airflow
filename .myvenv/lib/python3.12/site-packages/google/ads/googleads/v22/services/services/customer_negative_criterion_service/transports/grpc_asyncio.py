...
class CustomerNegativeCriterionServiceGrpcAsyncIOTransport(
    CustomerNegativeCriterionServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerNegativeCriterionService.
    ...
    def mutate_customer_negative_criteria(
        ...
        Returns:
            Callable[[~.MutateCustomerNegativeCriteriaRequest],
                    Awaitable[~.MutateCustomerNegativeCriteriaResponse]]:
        ...
        if "mutate_customer_negative_criteria" not in self._stubs:
            self._stubs["mutate_customer_negative_criteria"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_negative_criteria: self._wrap_method(
...
__all__ = ("CustomerNegativeCriterionServiceGrpcAsyncIOTransport",)
