...
from .base import DEFAULT_CLIENT_INFO, BatchJobServiceTransport
...
class BatchJobServiceGrpcAsyncIOTransport(BatchJobServiceTransport):
    """gRPC AsyncIO backend transport for BatchJobService.
    ...
    def mutate_batch_job(
        ...
        Returns:
            Callable[[~.MutateBatchJobRequest],
                    Awaitable[~.MutateBatchJobResponse]]:
    ...
    def list_batch_job_results(
        ...
        Returns:
            Callable[[~.ListBatchJobResultsRequest],
                    Awaitable[~.ListBatchJobResultsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "list_batch_job_results" not in self._stubs:
            self._stubs["list_batch_job_results"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.BatchJobService/ListBatchJobResults",
    ...
    def run_batch_job(
        ...
        if "run_batch_job" not in self._stubs:
            self._stubs["run_batch_job"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.BatchJobService/RunBatchJob",
    ...
    def add_batch_job_operations(
        ...
        Returns:
            Callable[[~.AddBatchJobOperationsRequest],
                    Awaitable[~.AddBatchJobOperationsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "add_batch_job_operations" not in self._stubs:
            self._stubs["add_batch_job_operations"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.BatchJobService/AddBatchJobOperations",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_batch_job: self._wrap_method(
                self.mutate_batch_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_batch_job_results: self._wrap_method(
                self.list_batch_job_results,
                default_timeout=None,
                client_info=client_info,
            ),
            self.run_batch_job: self._wrap_method(
                self.run_batch_job,
                default_timeout=None,
                client_info=client_info,
            ),
            self.add_batch_job_operations: self._wrap_method(
