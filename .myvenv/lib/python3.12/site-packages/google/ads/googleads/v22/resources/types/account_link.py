...
from google.ads.googleads.v22.enums.types import (account_link_status,
                                                  linked_account_type,
                                                  mobile_app_vendor)
...
class AccountLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v22.enums.types.AccountLinkStatusEnum.AccountLinkStatus):
            The status of the link.
        type_ (google.ads.googleads.v22.enums.types.LinkedAccountTypeEnum.LinkedAccountType):
            Output only. The type of the linked account.
        third_party_app_analytics (google.ads.googleads.v22.resources.types.ThirdPartyAppAnalyticsLinkIdentifier):
...
class ThirdPartyAppAnalyticsLinkIdentifier(proto.Message):
    ...
    Attributes:
        ...
        app_vendor (google.ads.googleads.v22.enums.types.MobileAppVendorEnum.MobileAppVendor):
