...
from google.ads.googleads.v22.enums.types import (
    conversion_action_category, conversion_value_rule_set_status,
    value_rule_set_attachment_type, value_rule_set_dimension)
...
class ConversionValueRuleSet(proto.Message):
    ...
    Attributes:
        ...
        dimensions (MutableSequence[google.ads.googleads.v22.enums.types.ValueRuleSetDimensionEnum.ValueRuleSetDimension]):
        ...
        owner_customer (str):
            ...
            \*\* Read-only \*\*
        attachment_type (google.ads.googleads.v22.enums.types.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType):
        ...
        campaign (str):
            ...
            campaign.
        status (google.ads.googleads.v22.enums.types.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus):
            Output only. The status of the conversion value rule set.
            \*\* Read-only \*\*
        conversion_action_categories (MutableSequence[google.ads.googleads.v22.enums.types.ConversionActionCategoryEnum.ConversionActionCategory]):
