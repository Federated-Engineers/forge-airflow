...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.BiddingStrategyServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateBiddingStrategiesRequest, dict]):
