...
class CampaignSharedSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CampaignSharedSet):
...
class MutateCampaignSharedSetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignSharedSetResult]):
