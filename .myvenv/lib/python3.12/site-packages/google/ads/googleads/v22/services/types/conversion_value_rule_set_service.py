...
class ConversionValueRuleSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.ConversionValueRuleSet):
            Create operation: No resource name is
            expected for the new conversion value rule set.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.ConversionValueRuleSet):
...
class MutateConversionValueRuleSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateConversionValueRuleSetResult]):
