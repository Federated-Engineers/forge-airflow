...
class RecommendationSubscriptionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.RecommendationSubscriptionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_recommendation_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateRecommendationSubscriptionRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.RecommendationSubscriptionOperation]):
