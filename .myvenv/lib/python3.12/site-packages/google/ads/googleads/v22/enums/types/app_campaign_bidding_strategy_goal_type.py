    ...
    class AppCampaignBiddingStrategyGoalType(proto.Enum):
        ...
        Values:
            ...
            OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA (8):
                Aim to maximize the selected in-app
                conversion's volume while spending the full
                budget. No advertiser-specific target CPA.
            OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS (9):
                Aim to maximize total conversion value, such
                as install and selected in-app conversions,
                while spending the full budget. No
