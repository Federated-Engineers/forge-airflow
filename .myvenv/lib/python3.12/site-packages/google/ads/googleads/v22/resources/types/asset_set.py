...
from google.ads.googleads.v22.common.types import asset_set_types
from google.ads.googleads.v22.enums.types import (asset_set_status,
                                                  asset_set_type)
...
class AssetSet(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            length of 128.
        type_ (google.ads.googleads.v22.enums.types.AssetSetTypeEnum.AssetSetType):
            Required. Immutable. The type of the asset
            set. Required.
        status (google.ads.googleads.v22.enums.types.AssetSetStatusEnum.AssetSetStatus):
            Output only. The status of the asset set.
            Read-only.
        merchant_center_feed (google.ads.googleads.v22.resources.types.AssetSet.MerchantCenterFeed):
        ...
        location_group_parent_asset_set_id (int):
            ...
            AssetSet.
        hotel_property_data (google.ads.googleads.v22.resources.types.AssetSet.HotelPropertyData):
            Output only. For Performance Max for travel
            goals campaigns with a Hotel Center account
            link. Read-only.
        location_set (google.ads.googleads.v22.common.types.LocationSet):
        ...
        business_profile_location_group (google.ads.googleads.v22.common.types.BusinessProfileLocationGroup):
            Business Profile location group asset set
            data.

            This field is a member of `oneof`_ ``asset_set_source``.
        chain_location_group (google.ads.googleads.v22.common.types.ChainLocationGroup):
