...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.SharedCriterionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateSharedCriteriaRequest, dict]):
