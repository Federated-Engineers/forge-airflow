...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.BillingSetupServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateBillingSetupRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v22.services.types.BillingSetupOperation):
