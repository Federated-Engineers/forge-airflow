...
class ShareablePreview(proto.Message):
    ...
    Attributes:
        asset_group_identifier (google.ads.googleads.v22.services.types.AssetGroupIdentifier):
...
class GenerateShareablePreviewsResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.ads.googleads.v22.services.types.ShareablePreviewOrError]):
...
class ShareablePreviewOrError(proto.Message):
    ...
    Attributes:
        ...
        shareable_preview_result (google.ads.googleads.v22.services.types.ShareablePreviewResult):
