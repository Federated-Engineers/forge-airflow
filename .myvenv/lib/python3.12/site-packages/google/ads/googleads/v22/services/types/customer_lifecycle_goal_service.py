...
from google.ads.googleads.v22.resources.types import customer_lifecycle_goal
...
class CustomerLifecycleGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.CustomerLifecycleGoal):
            Create operation: Create a new customer
            lifecycle goal.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.CustomerLifecycleGoal):
...
class ConfigureCustomerLifecycleGoalsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v22.services.types.ConfigureCustomerLifecycleGoalsResult):
