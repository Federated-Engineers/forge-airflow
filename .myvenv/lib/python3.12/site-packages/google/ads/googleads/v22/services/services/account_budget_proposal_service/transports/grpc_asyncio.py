    ...
    async def intercept_unary_unary(
        ...
        if logging_enabled:  # pragma: NO COVER
            ...
            _LOGGER.debug(
                ...
                extra={
                    "serviceName": "google.ads.googleads.v22.services.AccountBudgetProposalService",
        ...
        if "mutate_account_budget_proposal" not in self._stubs:
            self._stubs["mutate_account_budget_proposal"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.AccountBudgetProposalService/MutateAccountBudgetProposal",
