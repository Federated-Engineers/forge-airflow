...
from .base import DEFAULT_CLIENT_INFO, CampaignServiceTransport
...
class CampaignServiceGrpcAsyncIOTransport(CampaignServiceTransport):
    """gRPC AsyncIO backend transport for CampaignService.
    ...
    def mutate_campaigns(
        ...
        Returns:
            Callable[[~.MutateCampaignsRequest],
                    Awaitable[~.MutateCampaignsResponse]]:
        ...
        if "mutate_campaigns" not in self._stubs:
            self._stubs["mutate_campaigns"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.CampaignService/MutateCampaigns",
    ...
    def enable_p_max_brand_guidelines(
        ...
        Returns:
            Callable[[~.EnablePMaxBrandGuidelinesRequest],
                    Awaitable[~.EnablePMaxBrandGuidelinesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "enable_p_max_brand_guidelines" not in self._stubs:
            self._stubs["enable_p_max_brand_guidelines"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.CampaignService/EnablePMaxBrandGuidelines",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaigns: self._wrap_method(
                self.mutate_campaigns,
                default_timeout=None,
                client_info=client_info,
            ),
            self.enable_p_max_brand_guidelines: self._wrap_method(
                self.enable_p_max_brand_guidelines,
                default_timeout=None,
                client_info=client_info,
            ),
        }
...
__all__ = ("CampaignServiceGrpcAsyncIOTransport",)
