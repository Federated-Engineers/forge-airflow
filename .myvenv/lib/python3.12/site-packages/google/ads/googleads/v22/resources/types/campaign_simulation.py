...
class CampaignSimulation(proto.Message):
    ...
    Attributes:
        ...
        cpc_bid_point_list (google.ads.googleads.v22.common.types.CpcBidSimulationPointList):
        ...
        target_roas_point_list (google.ads.googleads.v22.common.types.TargetRoasSimulationPointList):
            ...
            This field is a member of `oneof`_ ``point_list``.
        target_impression_share_point_list (google.ads.googleads.v22.common.types.TargetImpressionShareSimulationPointList):
            Output only. Simulation points if the simulation type is
            TARGET_IMPRESSION_SHARE.

            This field is a member of `oneof`_ ``point_list``.
        budget_point_list (google.ads.googleads.v22.common.types.BudgetSimulationPointList):
