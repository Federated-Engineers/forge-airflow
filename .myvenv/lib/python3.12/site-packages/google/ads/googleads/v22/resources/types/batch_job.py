...
from google.ads.googleads.v22.enums.types import batch_job_status
...
class BatchJob(proto.Message):
    ...
    Attributes:
        ...
        metadata (google.ads.googleads.v22.resources.types.BatchJob.BatchJobMetadata):
            Output only. Contains additional information
            about this batch job.
        status (google.ads.googleads.v22.enums.types.BatchJobStatusEnum.BatchJobStatus):
    ...
    class BatchJobMetadata(proto.Message):
        ...
        Attributes:
            ...
            execution_limit_seconds (int):
                Immutable. The approximate upper bound for
                how long a batch job can be executed, in
                seconds. If the job runs more than the given
                upper bound, the job will be canceled.

                This field is a member of `oneof`_ ``_execution_limit_seconds``.
        """
