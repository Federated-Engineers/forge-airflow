...
class ProductLinkInvitation(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v22.enums.types.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus):
        ...
        hotel_center (google.ads.googleads.v22.resources.types.HotelCenterLinkInvitationIdentifier):
            Output only. Hotel link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        merchant_center (google.ads.googleads.v22.resources.types.MerchantCenterLinkInvitationIdentifier):
            Output only. Merchant Center link invitation.

            This field is a member of `oneof`_ ``invited_account``.
        advertising_partner (google.ads.googleads.v22.resources.types.AdvertisingPartnerLinkInvitationIdentifier):
