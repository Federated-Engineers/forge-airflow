...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CustomerUserAccessInvitation):
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v22.services.types.MutateCustomerUserAccessInvitationResult):
