...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.AccountLinkServiceClient`.",
                    extra=(
                        {
    ...
    def create_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.CreateAccountLinkRequest, dict]):
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateAccountLinkRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v22.services.types.AccountLinkOperation):
