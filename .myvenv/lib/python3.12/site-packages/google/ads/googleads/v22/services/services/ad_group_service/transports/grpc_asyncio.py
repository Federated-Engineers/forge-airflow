...
from .base import DEFAULT_CLIENT_INFO, AdGroupServiceTransport
...
class AdGroupServiceGrpcAsyncIOTransport(AdGroupServiceTransport):
    """gRPC AsyncIO backend transport for AdGroupService.
    ...
    def mutate_ad_groups(
        ...
        Creates, updates, or removes ad groups. Operation statuses are
        returned.
        ...
        Returns:
            Callable[[~.MutateAdGroupsRequest],
                    Awaitable[~.MutateAdGroupsResponse]]:
        ...
        if "mutate_ad_groups" not in self._stubs:
            self._stubs["mutate_ad_groups"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.AdGroupService/MutateAdGroups",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_groups: self._wrap_method(
...
__all__ = ("AdGroupServiceGrpcAsyncIOTransport",)
