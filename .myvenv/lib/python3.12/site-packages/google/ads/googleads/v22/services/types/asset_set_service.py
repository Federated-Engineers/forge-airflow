...
class AssetSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.AssetSet):
            Create operation: No resource name is
            expected for the new asset set

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v22.resources.types.AssetSet):
...
class MutateAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateAssetSetResult]):
