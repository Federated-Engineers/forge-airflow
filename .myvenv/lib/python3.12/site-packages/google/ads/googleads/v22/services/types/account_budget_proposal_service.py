...
from google.ads.googleads.v22.resources.types import account_budget_proposal
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v22.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v22.services.types.MutateAccountBudgetProposalResult):
