...
from google.ads.googleads.v22.resources.types import ad_group_ad_label
...
class AdGroupAdLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.AdGroupAdLabel):
...
class MutateAdGroupAdLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateAdGroupAdLabelResult]):
