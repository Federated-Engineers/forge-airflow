    ...
    class BiddingStrategyType(proto.Enum):
        ...
        Values:
            ...
            FIXED_SHARE_OF_VOICE (22):
                Fixed share of voice is a manual bidding
                strategy for YouTube Sponsorships that bills
                either on CPM or a fixed cost per day.
            INVALID (17):
            ...
            TARGET_CPA (6):
                ...
                (CPA) you set.
            TARGET_CPC (21):
                Target CPC is an automated bid strategy that
                sets bids to help get as many clicks as possible
                at the target cost-per-click (CPC) you set.
            TARGET_CPM (14):
