...
class CustomerAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CustomerAssetSet):
...
class MutateCustomerAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCustomerAssetSetResult]):
