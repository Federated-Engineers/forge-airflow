...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.KeywordPlanServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_keyword_plans(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateKeywordPlansRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.KeywordPlanOperation]):
