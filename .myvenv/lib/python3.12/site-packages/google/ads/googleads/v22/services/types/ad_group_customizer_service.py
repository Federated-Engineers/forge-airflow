...
class AdGroupCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.AdGroupCustomizer):
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateAdGroupCustomizerResult]):
