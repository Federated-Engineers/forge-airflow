...
class AdGroupAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.AdGroupAssetSet):
...
class MutateAdGroupAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateAdGroupAssetSetResult]):
