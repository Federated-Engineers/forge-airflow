...
class AdGroupCriterionCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.AdGroupCriterionCustomizer):
...
class MutateAdGroupCriterionCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateAdGroupCriterionCustomizerResult]):
