...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v22.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateConversionGoalCampaignConfigResult]):
