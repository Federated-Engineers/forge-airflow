...
class CampaignCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CampaignCustomizer):
...
class MutateCampaignCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCampaignCustomizerResult]):
