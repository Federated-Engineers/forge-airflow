...
class CustomerServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            CustomerServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(CustomerServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            CustomerServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            CustomerServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v22.services.CustomerServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.MutateCustomerRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v22.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v22.services.types.MutateCustomerResponse:
    ...
    async def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.ListAccessibleCustomersRequest, dict]]):
                The request object. Request message for
                [CustomerService.ListAccessibleCustomers][google.ads.googleads.v22.services.CustomerService.ListAccessibleCustomers].
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
        ...
        Returns:
            google.ads.googleads.v22.services.types.ListAccessibleCustomersResponse:
    ...
    async def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v22.services.types.CreateCustomerClientRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v22.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v22.services.types.CreateCustomerClientResponse:
                Response message for
