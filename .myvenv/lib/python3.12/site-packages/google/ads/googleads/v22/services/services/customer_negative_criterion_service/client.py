...
class CustomerNegativeCriterionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.CustomerNegativeCriterionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateCustomerNegativeCriteriaRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.CustomerNegativeCriterionOperation]):
