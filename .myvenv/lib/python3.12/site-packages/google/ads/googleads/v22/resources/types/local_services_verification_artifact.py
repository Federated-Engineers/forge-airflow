...
from google.ads.googleads.v22.common.types import local_services
...
class LocalServicesVerificationArtifact(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v22.enums.types.LocalServicesVerificationArtifactStatusEnum.LocalServicesVerificationArtifactStatus):
            Output only. The status of the verification
            artifact.
        artifact_type (google.ads.googleads.v22.enums.types.LocalServicesVerificationArtifactTypeEnum.LocalServicesVerificationArtifactType):
            Output only. The type of the verification
            artifact.
        background_check_verification_artifact (google.ads.googleads.v22.resources.types.BackgroundCheckVerificationArtifact):
            Output only. A background check verification
            artifact.

            This field is a member of `oneof`_ ``artifact_data``.
        insurance_verification_artifact (google.ads.googleads.v22.resources.types.InsuranceVerificationArtifact):
            Output only. An insurance verification
            artifact.

            This field is a member of `oneof`_ ``artifact_data``.
        license_verification_artifact (google.ads.googleads.v22.resources.types.LicenseVerificationArtifact):
            Output only. A license verification artifact.

            This field is a member of `oneof`_ ``artifact_data``.
        business_registration_check_verification_artifact (google.ads.googleads.v22.resources.types.BusinessRegistrationCheckVerificationArtifact):
...
class InsuranceVerificationArtifact(proto.Message):
    ...
    Attributes:
        ...
        rejection_reason (google.ads.googleads.v22.enums.types.LocalServicesInsuranceRejectionReasonEnum.LocalServicesInsuranceRejectionReason):
            Output only. Insurance document's rejection
            reason.

            This field is a member of `oneof`_ ``_rejection_reason``.
        insurance_document_readonly (google.ads.googleads.v22.common.types.LocalServicesDocumentReadOnly):
...
class LicenseVerificationArtifact(proto.Message):
    ...
    Attributes:
        ...
        rejection_reason (google.ads.googleads.v22.enums.types.LocalServicesLicenseRejectionReasonEnum.LocalServicesLicenseRejectionReason):
            Output only. License rejection reason.

            This field is a member of `oneof`_ ``_rejection_reason``.
        license_document_readonly (google.ads.googleads.v22.common.types.LocalServicesDocumentReadOnly):
            Output only. The readonly field containing
...
class BusinessRegistrationCheckVerificationArtifact(proto.Message):
    ...
    Attributes:
        registration_type (google.ads.googleads.v22.enums.types.LocalServicesBusinessRegistrationTypeEnum.LocalServicesBusinessRegistrationType):
        ...
        rejection_reason (google.ads.googleads.v22.enums.types.LocalServicesBusinessRegistrationCheckRejectionReasonEnum.LocalServicesBusinessRegistrationCheckRejectionReason):
            Output only. Registration document rejection
            reason.

            This field is a member of `oneof`_ ``_rejection_reason``.
        registration_number (google.ads.googleads.v22.resources.types.BusinessRegistrationNumber):
        ...
        registration_document (google.ads.googleads.v22.resources.types.BusinessRegistrationDocument):
...
class BusinessRegistrationDocument(proto.Message):
    ...
    Attributes:
        document_readonly (google.ads.googleads.v22.common.types.LocalServicesDocumentReadOnly):
            Output only. The readonly field containing
