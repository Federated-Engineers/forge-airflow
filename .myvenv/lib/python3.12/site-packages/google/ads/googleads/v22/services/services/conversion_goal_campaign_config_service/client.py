...
class ConversionGoalCampaignConfigServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.ConversionGoalCampaignConfigServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.MutateConversionGoalCampaignConfigsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v22.services.types.ConversionGoalCampaignConfigOperation]):
