...
class Recommendation(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v22.enums.types.RecommendationTypeEnum.RecommendationType):
            Output only. The type of recommendation.
        impact (google.ads.googleads.v22.resources.types.Recommendation.RecommendationImpact):
        ...
        campaign_budget_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The campaign budget
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        forecasting_campaign_budget_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The forecasting campaign budget
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        keyword_recommendation (google.ads.googleads.v22.resources.types.Recommendation.KeywordRecommendation):
            Output only. The keyword recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        text_ad_recommendation (google.ads.googleads.v22.resources.types.Recommendation.TextAdRecommendation):
            Output only. Add expanded text ad
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        target_cpa_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.TargetCpaOptInRecommendation):
            Output only. The TargetCPA opt-in
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        maximize_conversions_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.MaximizeConversionsOptInRecommendation):
            Output only. The MaximizeConversions Opt-In
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        enhanced_cpc_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.EnhancedCpcOptInRecommendation):
            Output only. The Enhanced Cost-Per-Click
            Opt-In recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        search_partners_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.SearchPartnersOptInRecommendation):
            Output only. The Search Partners Opt-In
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        maximize_clicks_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.MaximizeClicksOptInRecommendation):
            Output only. The MaximizeClicks Opt-In
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        optimize_ad_rotation_recommendation (google.ads.googleads.v22.resources.types.Recommendation.OptimizeAdRotationRecommendation):
            Output only. The Optimize Ad Rotation
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        keyword_match_type_recommendation (google.ads.googleads.v22.resources.types.Recommendation.KeywordMatchTypeRecommendation):
            Output only. The keyword match type
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        move_unused_budget_recommendation (google.ads.googleads.v22.resources.types.Recommendation.MoveUnusedBudgetRecommendation):
            Output only. The move unused budget
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        target_roas_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.TargetRoasOptInRecommendation):
            Output only. The Target ROAS opt-in
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        responsive_search_ad_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ResponsiveSearchAdRecommendation):
            Output only. The add responsive search ad
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        marginal_roi_campaign_budget_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CampaignBudgetRecommendation):
            Output only. The marginal ROI campaign budget
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        use_broad_match_keyword_recommendation (google.ads.googleads.v22.resources.types.Recommendation.UseBroadMatchKeywordRecommendation):
            Output only. The use broad match keyword
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        responsive_search_ad_asset_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ResponsiveSearchAdAssetRecommendation):
            Output only. The responsive search ad asset
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        upgrade_smart_shopping_campaign_to_performance_max_recommendation (google.ads.googleads.v22.resources.types.Recommendation.UpgradeSmartShoppingCampaignToPerformanceMaxRecommendation):
            Output only. The upgrade a Smart Shopping
            campaign to a Performance Max campaign
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        responsive_search_ad_improve_ad_strength_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ResponsiveSearchAdImproveAdStrengthRecommendation):
            Output only. The responsive search ad improve
            ad strength recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        display_expansion_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.DisplayExpansionOptInRecommendation):
            Output only. The Display Expansion opt-in
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        upgrade_local_campaign_to_performance_max_recommendation (google.ads.googleads.v22.resources.types.Recommendation.UpgradeLocalCampaignToPerformanceMaxRecommendation):
            Output only. The upgrade a Local campaign to
            a Performance Max campaign recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        raise_target_cpa_bid_too_low_recommendation (google.ads.googleads.v22.resources.types.Recommendation.RaiseTargetCpaBidTooLowRecommendation):
            Output only. The raise target CPA bid too low
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        forecasting_set_target_roas_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ForecastingSetTargetRoasRecommendation):
            Output only. The forecasting set target ROAS
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        callout_asset_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CalloutAssetRecommendation):
            Output only. The callout asset
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        sitelink_asset_recommendation (google.ads.googleads.v22.resources.types.Recommendation.SitelinkAssetRecommendation):
            Output only. The sitelink asset
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        call_asset_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CallAssetRecommendation):
            Output only. The call asset recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_age_group_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add age group
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_color_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add color
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_gender_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add gender
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_gtin_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add GTIN
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_more_identifiers_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add more
            identifiers recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_size_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingOfferAttributeRecommendation):
            Output only. The shopping add size
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_add_products_to_campaign_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingAddProductsToCampaignRecommendation):
            Output only. The shopping add products to
            campaign recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_fix_disapproved_products_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingFixDisapprovedProductsRecommendation):
            Output only. The shopping fix disapproved
            products recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_target_all_offers_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingTargetAllOffersRecommendation):
            Output only. The shopping target all offers
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_fix_suspended_merchant_center_account_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingMerchantCenterAccountSuspensionRecommendation):
            Output only. The shopping fix suspended
            Merchant Center account recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_fix_merchant_center_account_suspension_warning_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingMerchantCenterAccountSuspensionRecommendation):
            Output only. The shopping fix Merchant Center
            account suspension warning recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        shopping_migrate_regular_shopping_campaign_offers_to_performance_max_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ShoppingMigrateRegularShoppingCampaignOffersToPerformanceMaxRecommendation):
            Output only. The shopping migrate Regular
            Shopping Campaign offers to Performance Max
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        dynamic_image_extension_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.DynamicImageExtensionOptInRecommendation):
            ...
            This field is a member of `oneof`_ ``recommendation``.
        raise_target_cpa_recommendation (google.ads.googleads.v22.resources.types.Recommendation.RaiseTargetCpaRecommendation):
            Output only. Recommendation to raise Target
            CPA.

            This field is a member of `oneof`_ ``recommendation``.
        lower_target_roas_recommendation (google.ads.googleads.v22.resources.types.Recommendation.LowerTargetRoasRecommendation):
            Output only. Recommendation to lower Target
            ROAS.

            This field is a member of `oneof`_ ``recommendation``.
        performance_max_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.PerformanceMaxOptInRecommendation):
            Output only. The Performance Max Opt In
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        improve_performance_max_ad_strength_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ImprovePerformanceMaxAdStrengthRecommendation):
            Output only. The improve Performance Max ad
            strength recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        migrate_dynamic_search_ads_campaign_to_performance_max_recommendation (google.ads.googleads.v22.resources.types.Recommendation.MigrateDynamicSearchAdsCampaignToPerformanceMaxRecommendation):
            Output only. The Dynamic Search Ads to
            Performance Max migration recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        forecasting_set_target_cpa_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ForecastingSetTargetCpaRecommendation):
            Output only. The forecasting set target CPA
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        set_target_cpa_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ForecastingSetTargetCpaRecommendation):
            Output only. The set target CPA
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        set_target_roas_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ForecastingSetTargetRoasRecommendation):
            Output only. The set target ROAS
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        maximize_conversion_value_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.MaximizeConversionValueOptInRecommendation):
            Output only. The Maximize Conversion Value
            opt-in recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        improve_google_tag_coverage_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ImproveGoogleTagCoverageRecommendation):
            Output only. Recommendation to deploy Google
            Tag on more pages.

            This field is a member of `oneof`_ ``recommendation``.
        performance_max_final_url_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.PerformanceMaxFinalUrlOptInRecommendation):
            Output only. Recommendation to turn on Final
            URL expansion for your Performance Max
            campaigns.

            This field is a member of `oneof`_ ``recommendation``.
        refresh_customer_match_list_recommendation (google.ads.googleads.v22.resources.types.Recommendation.RefreshCustomerMatchListRecommendation):
            Output only. The refresh customer list
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        custom_audience_opt_in_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CustomAudienceOptInRecommendation):
            Output only. The custom audience opt in
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        lead_form_asset_recommendation (google.ads.googleads.v22.resources.types.Recommendation.LeadFormAssetRecommendation):
            Output only. The lead form asset
            recommendation.

            This field is a member of `oneof`_ ``recommendation``.
        improve_demand_gen_ad_strength_recommendation (google.ads.googleads.v22.resources.types.Recommendation.ImproveDemandGenAdStrengthRecommendation):
    ...
    class RecommendationImpact(proto.Message):
        ...
        Attributes:
            base_metrics (google.ads.googleads.v22.resources.types.Recommendation.RecommendationMetrics):
                Output only. Base metrics at the time the
                recommendation was generated.
            potential_metrics (google.ads.googleads.v22.resources.types.Recommendation.RecommendationMetrics):
    ...
    class CampaignBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_options (MutableSequence[google.ads.googleads.v22.resources.types.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption]):
    ...
    class KeywordRecommendation(proto.Message):
        ...
        Attributes:
            ...
            search_terms (MutableSequence[google.ads.googleads.v22.resources.types.Recommendation.KeywordRecommendation.SearchTerm]):
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        ...
        Attributes:
            options (MutableSequence[google.ads.googleads.v22.resources.types.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption]):
        ...
        class TargetCpaOptInRecommendationOption(proto.Message):
            ...
            Attributes:
                goal (google.ads.googleads.v22.enums.types.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal):
    ...
    class CalloutAssetRecommendation(proto.Message):
        ...
        Attributes:
            recommended_campaign_callout_assets (MutableSequence[google.ads.googleads.v22.resources.types.Asset]):
                Output only. New callout extension assets
                recommended at the campaign level.
            recommended_customer_callout_assets (MutableSequence[google.ads.googleads.v22.resources.types.Asset]):
                Output only. New callout extension assets
    ...
    class SitelinkAssetRecommendation(proto.Message):
        ...
        Attributes:
            recommended_campaign_sitelink_assets (MutableSequence[google.ads.googleads.v22.resources.types.Asset]):
                Output only. New sitelink assets recommended
                at the campaign level.
            recommended_customer_sitelink_assets (MutableSequence[google.ads.googleads.v22.resources.types.Asset]):
                Output only. New sitelink assets recommended
    ...
    class KeywordMatchTypeRecommendation(proto.Message):
        ...
        Attributes:
            ...
            recommended_match_type (google.ads.googleads.v22.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
    ...
    class MoveUnusedBudgetRecommendation(proto.Message):
        ...
        Attributes:
            ...
            budget_recommendation (google.ads.googleads.v22.resources.types.Recommendation.CampaignBudgetRecommendation):
    ...
    class ResponsiveSearchAdAssetRecommendation(proto.Message):
        ...
        Attributes:
            current_ad (google.ads.googleads.v22.resources.types.Ad):
                Output only. The current ad to be updated.
            recommended_assets (google.ads.googleads.v22.resources.types.Ad):
    ...
    class ResponsiveSearchAdImproveAdStrengthRecommendation(proto.Message):
        ...
        Attributes:
            current_ad (google.ads.googleads.v22.resources.types.Ad):
                Output only. The current ad to be updated.
            recommended_ad (google.ads.googleads.v22.resources.types.Ad):
    ...
    class UseBroadMatchKeywordRecommendation(proto.Message):
        ...
        Attributes:
            keyword (MutableSequence[google.ads.googleads.v22.common.types.KeywordInfo]):
    ...
    class ForecastingSetTargetRoasRecommendation(proto.Message):
        ...
        Attributes:
            recommended_target_roas (float):
                ...
                (revenue per unit of spend). The value is
                between 0.01 and 1000.0, inclusive.
            campaign_budget (google.ads.googleads.v22.resources.types.Recommendation.CampaignBudget):
                Output only. The campaign budget.
        """
    ...
    class ShoppingOfferAttributeRecommendation(proto.Message):
        ...
        Attributes:
            merchant (google.ads.googleads.v22.resources.types.Recommendation.MerchantInfo):
    ...
    class ShoppingAddProductsToCampaignRecommendation(proto.Message):
        ...
        Attributes:
            ...
            feed_label (str):
                Output only. The feed label for the campaign.
            reason (google.ads.googleads.v22.enums.types.ShoppingAddProductsToCampaignRecommendationEnum.Reason):
    ...
    class RaiseTargetCpaRecommendation(proto.Message):
        ...
        Attributes:
            target_adjustment (google.ads.googleads.v22.resources.types.Recommendation.TargetAdjustmentInfo):
                Output only. The relevant information
                describing the recommended target adjustment.
            app_bidding_goal (google.ads.googleads.v22.enums.types.AppBiddingGoalEnum.AppBiddingGoal):
    ...
    class RefreshCustomerMatchListRecommendation(proto.Message):
        ...
        Attributes:
            ...
            top_spending_account (MutableSequence[google.ads.googleads.v22.resources.types.Recommendation.AccountInfo]):
            ...
            owner_account (google.ads.googleads.v22.resources.types.Recommendation.AccountInfo):
    ...
    class CustomAudienceOptInRecommendation(proto.Message):
        ...
        Attributes:
            keywords (MutableSequence[google.ads.googleads.v22.common.types.KeywordInfo]):
