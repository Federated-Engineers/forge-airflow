...
class LeadFormSubmissionData(proto.Message):
    ...
    Attributes:
        ...
        campaign (str):
            ...
            submitted lead form.
        lead_form_submission_fields (MutableSequence[google.ads.googleads.v22.resources.types.LeadFormSubmissionField]):
            Output only. Submission data associated with
            a lead form.
        custom_lead_form_submission_fields (MutableSequence[google.ads.googleads.v22.resources.types.CustomLeadFormSubmissionField]):
            Output only. Submission data associated with
            a custom lead form.
        ad_group (str):
...
class LeadFormSubmissionField(proto.Message):
    ...
    Attributes:
        field_type (google.ads.googleads.v22.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
