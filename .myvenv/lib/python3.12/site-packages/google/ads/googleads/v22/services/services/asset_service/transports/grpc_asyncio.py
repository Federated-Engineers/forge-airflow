...
class AssetServiceGrpcAsyncIOTransport(AssetServiceTransport):
    ...
    def mutate_assets(
        ...
        Returns:
            Callable[[~.MutateAssetsRequest],
                    Awaitable[~.MutateAssetsResponse]]:
        ...
        if "mutate_assets" not in self._stubs:
            self._stubs["mutate_assets"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v22.services.AssetService/MutateAssets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_assets: self._wrap_method(
                self.mutate_assets,
