...
class TargetCpm(proto.Message):
    ...
    Attributes:
        target_frequency_goal (google.ads.googleads.v22.common.types.TargetCpmTargetFrequencyGoal):
...
class FixedCpm(proto.Message):
    ...
    Attributes:
        goal (google.ads.googleads.v22.enums.types.FixedCpmGoalEnum.FixedCpmGoal):
            Fixed CPM bidding goal. Determines the exact
            bidding optimization parameters.
        target_frequency_info (google.ads.googleads.v22.common.types.FixedCpmTargetFrequencyGoalInfo):
            Target frequency bidding goal details.
...
class FixedCpmTargetFrequencyGoalInfo(proto.Message):
    ...
    Attributes:
        ...
        time_unit (google.ads.googleads.v22.enums.types.FixedCpmTargetFrequencyTimeUnitEnum.FixedCpmTargetFrequencyTimeUnit):
            Time window expressing the period over which you want to
            reach the specified target_count.
    """
