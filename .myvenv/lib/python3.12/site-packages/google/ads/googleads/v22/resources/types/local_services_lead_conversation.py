...
class LocalServicesLeadConversation(proto.Message):
    ...
    Attributes:
        ...
        conversation_channel (google.ads.googleads.v22.enums.types.LocalServicesLeadConversationTypeEnum.ConversationType):
            Output only. Type of GLS lead conversation, EMAIL, MESSAGE,
            PHONE_CALL, SMS, etc.
        participant_type (google.ads.googleads.v22.enums.types.LocalServicesParticipantTypeEnum.ParticipantType):
        ...
        phone_call_details (google.ads.googleads.v22.resources.types.PhoneCallDetails):
            Output only. Details of phone call conversation in case of
            PHONE_CALL.

            This field is a member of `oneof`_ ``_phone_call_details``.
        message_details (google.ads.googleads.v22.resources.types.MessageDetails):
