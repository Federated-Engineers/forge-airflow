...
from .base import DEFAULT_CLIENT_INFO, CustomizerAttributeServiceTransport
...
class CustomizerAttributeServiceGrpcAsyncIOTransport(
    CustomizerAttributeServiceTransport
):
    """gRPC AsyncIO backend transport for CustomizerAttributeService.
    ...
    def mutate_customizer_attributes(
        ...
        Returns:
            Callable[[~.MutateCustomizerAttributesRequest],
                    Awaitable[~.MutateCustomizerAttributesResponse]]:
        ...
        if "mutate_customizer_attributes" not in self._stubs:
            self._stubs["mutate_customizer_attributes"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.CustomizerAttributeService/MutateCustomizerAttributes",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customizer_attributes: self._wrap_method(
...
__all__ = ("CustomizerAttributeServiceGrpcAsyncIOTransport",)
