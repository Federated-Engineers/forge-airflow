...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v22.resources.types.CustomerCustomizer):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateCustomerCustomizerResult]):
