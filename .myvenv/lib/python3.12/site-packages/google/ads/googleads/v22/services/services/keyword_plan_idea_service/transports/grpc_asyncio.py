...
from .base import DEFAULT_CLIENT_INFO, KeywordPlanIdeaServiceTransport
...
class KeywordPlanIdeaServiceGrpcAsyncIOTransport(
    KeywordPlanIdeaServiceTransport
):
    """gRPC AsyncIO backend transport for KeywordPlanIdeaService.
    ...
    def generate_keyword_ideas(
        ...
        Returns:
            Callable[[~.GenerateKeywordIdeasRequest],
                    Awaitable[~.GenerateKeywordIdeaResponse]]:
        ...
        if "generate_keyword_ideas" not in self._stubs:
            self._stubs["generate_keyword_ideas"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.KeywordPlanIdeaService/GenerateKeywordIdeas",
    ...
    def generate_keyword_historical_metrics(
        ...
        Returns:
            Callable[[~.GenerateKeywordHistoricalMetricsRequest],
                    Awaitable[~.GenerateKeywordHistoricalMetricsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "generate_keyword_historical_metrics" not in self._stubs:
            self._stubs["generate_keyword_historical_metrics"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.KeywordPlanIdeaService/GenerateKeywordHistoricalMetrics",
    ...
    def generate_ad_group_themes(
        ...
        Returns:
            Callable[[~.GenerateAdGroupThemesRequest],
                    Awaitable[~.GenerateAdGroupThemesResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "generate_ad_group_themes" not in self._stubs:
            self._stubs["generate_ad_group_themes"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.KeywordPlanIdeaService/GenerateAdGroupThemes",
    ...
    def generate_keyword_forecast_metrics(
        ...
        Returns:
            Callable[[~.GenerateKeywordForecastMetricsRequest],
                    Awaitable[~.GenerateKeywordForecastMetricsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
        ...
        if "generate_keyword_forecast_metrics" not in self._stubs:
            self._stubs["generate_keyword_forecast_metrics"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v22.services.KeywordPlanIdeaService/GenerateKeywordForecastMetrics",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.generate_keyword_ideas: self._wrap_method(
                self.generate_keyword_ideas,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_keyword_historical_metrics: self._wrap_method(
                self.generate_keyword_historical_metrics,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_ad_group_themes: self._wrap_method(
                self.generate_ad_group_themes,
                default_timeout=None,
                client_info=client_info,
            ),
            self.generate_keyword_forecast_metrics: self._wrap_method(
                self.generate_keyword_forecast_metrics,
                default_timeout=None,
                client_info=client_info,
            ),
        }
...
__all__ = ("KeywordPlanIdeaServiceGrpcAsyncIOTransport",)
