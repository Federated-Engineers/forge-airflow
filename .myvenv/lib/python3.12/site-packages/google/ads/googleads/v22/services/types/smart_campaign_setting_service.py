...
class SmartCampaignNotEligibleDetails(proto.Message):
    ...
    Attributes:
        not_eligible_reason (google.ads.googleads.v22.enums.types.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason):
...
class GetSmartCampaignStatusResponse(proto.Message):
    ...
    Attributes:
        smart_campaign_status (google.ads.googleads.v22.enums.types.SmartCampaignStatusEnum.SmartCampaignStatus):
            The status of this Smart campaign.
        not_eligible_details (google.ads.googleads.v22.services.types.SmartCampaignNotEligibleDetails):
            Details related to Smart campaigns that are
            ineligible to serve.

            This field is a member of `oneof`_ ``smart_campaign_status_details``.
        eligible_details (google.ads.googleads.v22.services.types.SmartCampaignEligibleDetails):
            Details related to Smart campaigns that are
            eligible to serve.

            This field is a member of `oneof`_ ``smart_campaign_status_details``.
        paused_details (google.ads.googleads.v22.services.types.SmartCampaignPausedDetails):
            Details related to paused Smart campaigns.

            This field is a member of `oneof`_ ``smart_campaign_status_details``.
        removed_details (google.ads.googleads.v22.services.types.SmartCampaignRemovedDetails):
            Details related to removed Smart campaigns.

            This field is a member of `oneof`_ ``smart_campaign_status_details``.
        ended_details (google.ads.googleads.v22.services.types.SmartCampaignEndedDetails):
...
class SmartCampaignSettingOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v22.resources.types.SmartCampaignSetting):
...
class MutateSmartCampaignSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v22.services.types.MutateSmartCampaignSettingResult]):
