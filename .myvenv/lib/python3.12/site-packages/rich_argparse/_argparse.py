...
from rich_argparse._common import (_HIGHLIGHTS, _fix_legacy_win_text,
                                   _strip_codes, rich_fill, rich_strip,
                                   rich_wrap)
...
class RichHelpFormatter(argparse.HelpFormatter):
    ...
    def _rich_split_lines(self, text: r.Text, width: int) -> r.Lines:
        return rich_wrap(self.console, self._rich_whitespace_sub(text), width)

    def _rich_fill_text(self, text: r.Text, width: int, indent: r.Text) -> r.Text:
        return rich_fill(self.console, self._rich_whitespace_sub(text), width, indent) + "\n\n"
