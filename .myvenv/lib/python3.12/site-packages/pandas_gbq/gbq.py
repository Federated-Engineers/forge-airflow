...
from pandas_gbq.exceptions import \
    InvalidPageToken  # noqa - backward compatible export
from pandas_gbq.exceptions import \
    InvalidSchema  # noqa - backward compatible export
from pandas_gbq.exceptions import \
    QueryTimeout  # noqa - backward compatible export
from pandas_gbq.exceptions import (  # noqa - backward compatible export
    DatasetCreationError, GenericGBQException, InvalidColumnOrder,
    InvalidIndexColumn, NotFoundException, TableCreationError)
from pandas_gbq.features import FEATURES
from pandas_gbq.gbq_connector import \
    GbqConnector  # noqa - backward compatible export
from pandas_gbq.gbq_connector import \
    _get_client  # noqa - backward compatible export
...
class _Table(GbqConnector):
    ...
    def create(
        ...
        """
        from google.cloud.bigquery import (DatasetReference, PartitionRange,
                                           RangePartitioning, Table,
