...
from sentry_sdk.utils import (_is_external_source, _is_in_project_root,
                              _module_in_list, capture_internal_exceptions,
                              filename_for_module, is_sentry_url,
                              is_valid_sample_rate, logger, match_regex_list,
                              qualname_from_function, safe_repr, to_string,
                              try_convert)
...
from sentry_sdk.traces import LOW_QUALITY_SEGMENT_SOURCES, StreamedSpan
from sentry_sdk.traces import start_span as start_streaming_span
# Circular imports
from sentry_sdk.tracing import (BAGGAGE_HEADER_NAME,
                                LOW_QUALITY_TRANSACTION_SOURCES,
                                SENTRY_TRACE_HEADER_NAME, Span)
