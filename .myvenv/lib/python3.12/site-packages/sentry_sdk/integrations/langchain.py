...
from sentry_sdk.ai.utils import (GEN_AI_ALLOWED_MESSAGE_ROLES,
                                 get_start_span_function,
                                 normalize_message_roles, set_data_normalized,
...
try:
    from langchain_openai import \
        OpenAIEmbeddings  # type: ignore[import-not-found]
except ImportError:
...
try:
    from langchain_aws import \
        BedrockEmbeddings  # type: ignore[import-not-found]
except ImportError:
    BedrockEmbeddings = None

try:
    from langchain_cohere import \
        CohereEmbeddings  # type: ignore[import-not-found]
except ImportError:
