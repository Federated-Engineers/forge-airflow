...
from sentry_sdk.utils import (SENSITIVE_DATA_SUBSTITUTE,
                              capture_internal_exceptions, logger, parse_url)

try:
    from pyreqwest.client import (  # type: ignore[import-not-found]
        ClientBuilder, SyncClientBuilder)
    from pyreqwest.middleware import Next  # type: ignore[import-not-found]
    from pyreqwest.middleware import SyncNext
    from pyreqwest.request import (  # type: ignore[import-not-found]
        OneOffRequestBuilder, Request, SyncOneOffRequestBuilder)
    from pyreqwest.response import Response  # type: ignore[import-not-found]
