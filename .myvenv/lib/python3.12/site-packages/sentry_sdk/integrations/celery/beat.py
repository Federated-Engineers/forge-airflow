...
from sentry_sdk.utils import logger, match_regex_list

if TYPE_CHECKING:
    from collections.abc import Callable
    from typing import Any, Optional, TypeVar, Union

    from sentry_sdk._types import (MonitorConfig, MonitorConfigScheduleType,
...
try:
    ...
    from celery.signals import (task_failure, task_retry,  # type: ignore
                                task_success)
except ImportError:
