...
from sentry_sdk.integrations._asgi_common import (_get_headers,
                                                  ...
                                                  _get_request_data, _get_url)
from sentry_sdk.integrations._wsgi_common import (
    DEFAULT_HTTP_METHODS_TO_CAPTURE, nullcontext)
...
from sentry_sdk.tracing import SOURCE_FOR_STYLE, Transaction, TransactionSource
from sentry_sdk.tracing_utils import has_span_streaming_enabled
from sentry_sdk.utils import (CONTEXTVARS_ERROR_MESSAGE, HAS_REAL_CONTEXTVARS,
                              ContextVar, _get_installed_modules,
                              capture_internal_exceptions,
                              event_from_exception, logger,
                              qualname_from_function, reraise,
