...
from sentry_sdk.ai._openai_completions_api import _get_text_items
from sentry_sdk.ai._openai_completions_api import \
...
from sentry_sdk.utils import (capture_internal_exceptions,
                              event_from_exception, reraise, safe_serialize)

if TYPE_CHECKING:
    from typing import (Any, AsyncIterator, Callable, Iterable, Iterator, List,
                        Optional, Union)

    from openai import Omit
    from openai.types import CompletionUsage
    from openai.types.responses import (ResponseInputParam,
                                        ResponseStreamEvent, SequenceNotStr)
