...
import sentry_sdk
from sentry_sdk.ai.utils import (normalize_message_roles, set_data_normalized,
                                 truncate_and_annotate_messages)
from sentry_sdk.consts import OP, SPANDATA
from sentry_sdk.utils import safe_serialize

from ..consts import SPAN_ORIGIN
from ..utils import (_get_model_name, _set_agent_data, _set_available_tools,
                     _set_model_data, _should_send_prompts, get_current_agent,
                     get_is_streaming)
from .utils import (_serialize_binary_content_item, _serialize_image_url_item,
                    _set_usage_data)
...
try:
    from pydantic_ai.messages import (BaseToolCallPart, BaseToolReturnPart,
