...
try:
    from quart import (Quart, Request, has_request_context,  # type: ignore
                       has_websocket_context, request, websocket)
    from quart.signals import got_background_exception  # type: ignore
    from quart.signals import (got_request_exception, got_websocket_exception,
                               request_started, websocket_started)
except ImportError:
