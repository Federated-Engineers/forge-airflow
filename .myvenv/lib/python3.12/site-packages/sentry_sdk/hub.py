...
from sentry_sdk import (get_client, get_current_scope, get_global_scope,
                        get_isolation_scope)
...
if TYPE_CHECKING:
    ...
    from sentry_sdk._types import (Breadcrumb, BreadcrumbHint, Event, ExcInfo,
                                   Hint, LogLevelStr, SamplingContext)
