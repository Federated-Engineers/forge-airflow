...
if TYPE_CHECKING:
    ...
    import sentry_sdk
    from sentry_sdk._types import (BreadcrumbProcessor, ContinuousProfilerMode,
                                   Event, EventProcessor, Hint,
                                   IgnoreSpansConfig, Log, Metric,
                                   ProfilerMode, TracesSampler,
