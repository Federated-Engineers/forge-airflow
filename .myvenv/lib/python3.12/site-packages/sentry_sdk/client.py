...
from sentry_sdk.consts import (DEFAULT_MAX_VALUE_LENGTH, DEFAULT_OPTIONS,
                               INSTRUMENTER, SPANDATA, VERSION,
                               ClientConstructor)
...
from sentry_sdk.transport import (AsyncHttpTransport, HttpTransportCore,
                                  make_transport)
from sentry_sdk.utils import (AnnotatedValue, ContextVar,
                              capture_internal_exceptions, current_stacktrace,
                              env_to_bool, format_timestamp,
                              get_before_send_log, get_before_send_metric,
                              get_default_release, get_sdk_name, get_type_name,
                              handle_in_app, has_logs_enabled,
...
if TYPE_CHECKING:
    ...
    from sentry_sdk._metrics_batcher import MetricsBatcher
    from sentry_sdk._types import (Event, EventDataCategory, Hint, Log, Metric,
                                   SDKInfo)
