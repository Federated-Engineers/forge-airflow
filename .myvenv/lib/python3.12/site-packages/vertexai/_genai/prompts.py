...
from google.genai import _api_module, _common, operations
...
from . import _prompt_management_utils, _prompt_optimizer_utils, types
        ...
        *,
        ...
        if prompt_id:
            raise DeprecationWarning(
                "The prompt_id argument is deprecated and will be ignored."
            )
