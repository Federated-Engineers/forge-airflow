...
from vertexai.example_stores._example_stores import (
    ContentSearchKey, ContentsExample, Example, ExamplesArrayFilter,
    ExampleStore, ExpectedContent, StoredContentsExample,
    StoredContentsExampleFilter, StoredContentsExampleParameters)
