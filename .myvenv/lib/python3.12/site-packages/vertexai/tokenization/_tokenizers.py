...
from vertexai.generative_models._generative_models import (
    ContentsType, Image, PartsType, Tool, _content_types_to_gapic_contents,
    _to_content, _validate_contents_type_as_valid_sequence)
from vertexai.tokenization._tokenizer_loading import (get_sentencepiece,
                                                      get_tokenizer_name,
                                                      load_model_proto)
