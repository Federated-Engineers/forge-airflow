...
from .langarabicmodel import (CP720_ARABIC_MODEL, CP864_ARABIC_MODEL,
                              ISO_8859_6_ARABIC_MODEL,
                              WINDOWS_1256_ARABIC_MODEL)
from .langbelarusianmodel import (CP866_BELARUSIAN_MODEL,
                                  ISO_8859_5_BELARUSIAN_MODEL,
                                  MACCYRILLIC_BELARUSIAN_MODEL,
                                  WINDOWS_1251_BELARUSIAN_MODEL)
from .langbretonmodel import (CP037_BRETON_MODEL, CP500_BRETON_MODEL,
                              ISO_8859_14_BRETON_MODEL)
from .langbulgarianmodel import (CP855_BULGARIAN_MODEL,
                                 ISO_8859_5_BULGARIAN_MODEL,
                                 MACCYRILLIC_BULGARIAN_MODEL,
                                 WINDOWS_1251_BULGARIAN_MODEL)
from .langcroatianmodel import (CP852_CROATIAN_MODEL,
...
from .langdanishmodel import (CP037_DANISH_MODEL, CP500_DANISH_MODEL,
                              CP850_DANISH_MODEL, CP858_DANISH_MODEL,
                              CP865_DANISH_MODEL, ISO_8859_1_DANISH_MODEL,
                              ISO_8859_15_DANISH_MODEL, MACROMAN_DANISH_MODEL,
                              WINDOWS_1252_DANISH_MODEL)
from .langdutchmodel import (CP037_DUTCH_MODEL, CP500_DUTCH_MODEL,
                             CP850_DUTCH_MODEL, CP858_DUTCH_MODEL,
                             ISO_8859_1_DUTCH_MODEL, ISO_8859_15_DUTCH_MODEL,
                             MACROMAN_DUTCH_MODEL, WINDOWS_1252_DUTCH_MODEL)
from .langenglishmodel import (CP037_ENGLISH_MODEL, CP437_ENGLISH_MODEL,
                               CP500_ENGLISH_MODEL, CP850_ENGLISH_MODEL,
                               CP858_ENGLISH_MODEL, ISO_8859_1_ENGLISH_MODEL,
...
from .langestonianmodel import (CP775_ESTONIAN_MODEL,
                                ISO_8859_4_ESTONIAN_MODEL,
                                ISO_8859_13_ESTONIAN_MODEL,
                                WINDOWS_1257_ESTONIAN_MODEL)
from .langfarsimodel import ISO_8859_6_FARSI_MODEL, WINDOWS_1256_FARSI_MODEL
from .langfinnishmodel import (CP037_FINNISH_MODEL, CP500_FINNISH_MODEL,
                               CP850_FINNISH_MODEL, CP858_FINNISH_MODEL,
                               ISO_8859_1_FINNISH_MODEL,
                               ISO_8859_15_FINNISH_MODEL,
                               MACROMAN_FINNISH_MODEL,
                               WINDOWS_1252_FINNISH_MODEL)
from .langfrenchmodel import (CP037_FRENCH_MODEL, CP500_FRENCH_MODEL,
                              CP850_FRENCH_MODEL, CP858_FRENCH_MODEL,
                              CP863_FRENCH_MODEL, ISO_8859_1_FRENCH_MODEL,
                              ISO_8859_15_FRENCH_MODEL, MACROMAN_FRENCH_MODEL,
                              WINDOWS_1252_FRENCH_MODEL)
from .langgermanmodel import (CP037_GERMAN_MODEL, CP500_GERMAN_MODEL,
                              CP850_GERMAN_MODEL, CP858_GERMAN_MODEL,
                              ISO_8859_1_GERMAN_MODEL,
                              ISO_8859_15_GERMAN_MODEL, MACROMAN_GERMAN_MODEL,
                              WINDOWS_1252_GERMAN_MODEL)
from .langgreekmodel import (CP737_GREEK_MODEL, CP869_GREEK_MODEL,
                             CP875_GREEK_MODEL, ISO_8859_7_GREEK_MODEL,
                             MACGREEK_GREEK_MODEL, WINDOWS_1253_GREEK_MODEL)
from .langhebrewmodel import (CP424_HEBREW_MODEL, CP856_HEBREW_MODEL,
                              CP862_HEBREW_MODEL, ISO_8859_8_HEBREW_MODEL,
                              WINDOWS_1255_HEBREW_MODEL)
from .langhungarianmodel import (CP852_HUNGARIAN_MODEL,
                                 ISO_8859_2_HUNGARIAN_MODEL,
                                 ISO_8859_16_HUNGARIAN_MODEL,
                                 MACLATIN2_HUNGARIAN_MODEL,
                                 WINDOWS_1250_HUNGARIAN_MODEL)
from .langicelandicmodel import (CP037_ICELANDIC_MODEL, CP500_ICELANDIC_MODEL,
                                 CP861_ICELANDIC_MODEL,
                                 ISO_8859_1_ICELANDIC_MODEL,
                                 ISO_8859_10_ICELANDIC_MODEL,
                                 MACICELAND_ICELANDIC_MODEL)
from .langindonesianmodel import (CP037_INDONESIAN_MODEL,
                                  CP500_INDONESIAN_MODEL,
                                  ISO_8859_1_INDONESIAN_MODEL,
                                  MACROMAN_INDONESIAN_MODEL,
                                  WINDOWS_1252_INDONESIAN_MODEL)
from .langirishmodel import (CP037_IRISH_MODEL, CP500_IRISH_MODEL,
                             ISO_8859_14_IRISH_MODEL)
from .langitalianmodel import (CP037_ITALIAN_MODEL, CP500_ITALIAN_MODEL,
                               CP850_ITALIAN_MODEL, CP858_ITALIAN_MODEL,
                               ISO_8859_1_ITALIAN_MODEL,
                               ISO_8859_15_ITALIAN_MODEL,
                               MACROMAN_ITALIAN_MODEL,
                               WINDOWS_1252_ITALIAN_MODEL)
from .langkazakhmodel import KZ1048_KAZAKH_MODEL, PTCP154_KAZAKH_MODEL
from .langlatvianmodel import (CP775_LATVIAN_MODEL, ISO_8859_4_LATVIAN_MODEL,
                               ISO_8859_13_LATVIAN_MODEL,
                               WINDOWS_1257_LATVIAN_MODEL)
from .langlithuanianmodel import (CP775_LITHUANIAN_MODEL,
                                  ISO_8859_4_LITHUANIAN_MODEL,
                                  ISO_8859_13_LITHUANIAN_MODEL,
                                  WINDOWS_1257_LITHUANIAN_MODEL)
from .langmacedonianmodel import (CP855_MACEDONIAN_MODEL,
                                  ISO_8859_5_MACEDONIAN_MODEL,
                                  MACCYRILLIC_MACEDONIAN_MODEL,
                                  WINDOWS_1251_MACEDONIAN_MODEL)
from .langmalaymodel import (CP037_MALAY_MODEL, CP500_MALAY_MODEL,
                             ISO_8859_1_MALAY_MODEL, MACROMAN_MALAY_MODEL,
                             WINDOWS_1252_MALAY_MODEL)
from .langmaltesemodel import ISO_8859_3_MALTESE_MODEL
from .langnorwegianmodel import (CP037_NORWEGIAN_MODEL, CP500_NORWEGIAN_MODEL,
                                 CP850_NORWEGIAN_MODEL, CP858_NORWEGIAN_MODEL,
...
from .langpolishmodel import (CP852_POLISH_MODEL, ISO_8859_2_POLISH_MODEL,
                              ISO_8859_16_POLISH_MODEL, MACLATIN2_POLISH_MODEL,
                              WINDOWS_1250_POLISH_MODEL)
from .langportuguesemodel import (CP037_PORTUGUESE_MODEL,
...
from .langromanianmodel import (CP852_ROMANIAN_MODEL,
                                ISO_8859_2_ROMANIAN_MODEL,
                                ISO_8859_16_ROMANIAN_MODEL,
                                MACLATIN2_ROMANIAN_MODEL,
                                WINDOWS_1250_ROMANIAN_MODEL)
from .langrussianmodel import (CP855_RUSSIAN_MODEL, CP866_RUSSIAN_MODEL,
                               ISO_8859_5_RUSSIAN_MODEL, KOI8_R_RUSSIAN_MODEL,
                               MACCYRILLIC_RUSSIAN_MODEL,
                               WINDOWS_1251_RUSSIAN_MODEL)
from .langscottishgaelicmodel import (CP037_SCOTTISH_GAELIC_MODEL,
                                      CP500_SCOTTISH_GAELIC_MODEL,
                                      ISO_8859_14_SCOTTISH_GAELIC_MODEL)
from .langserbianmodel import (CP855_SERBIAN_MODEL, ISO_8859_5_SERBIAN_MODEL,
                               MACCYRILLIC_SERBIAN_MODEL,
                               WINDOWS_1251_SERBIAN_MODEL)
from .langslovakmodel import (CP852_SLOVAK_MODEL, ISO_8859_2_SLOVAK_MODEL,
                              ISO_8859_16_SLOVAK_MODEL, MACLATIN2_SLOVAK_MODEL,
                              WINDOWS_1250_SLOVAK_MODEL)
from .langslovenemodel import (CP852_SLOVENE_MODEL, ISO_8859_2_SLOVENE_MODEL,
                               ISO_8859_16_SLOVENE_MODEL,
                               MACLATIN2_SLOVENE_MODEL,
                               WINDOWS_1250_SLOVENE_MODEL)
from .langspanishmodel import (CP037_SPANISH_MODEL, CP500_SPANISH_MODEL,
                               CP850_SPANISH_MODEL, CP858_SPANISH_MODEL,
                               ISO_8859_1_SPANISH_MODEL,
                               ISO_8859_15_SPANISH_MODEL,
                               MACROMAN_SPANISH_MODEL,
                               WINDOWS_1252_SPANISH_MODEL)
from .langswedishmodel import (CP037_SWEDISH_MODEL, CP500_SWEDISH_MODEL,
                               CP850_SWEDISH_MODEL, CP858_SWEDISH_MODEL,
...
from .langthaimodel import (CP874_THAI_MODEL, ISO_8859_11_THAI_MODEL,
                            TIS_620_THAI_MODEL)
from .langturkishmodel import (CP857_TURKISH_MODEL, CP1026_TURKISH_MODEL,
                               ISO_8859_3_TURKISH_MODEL,
                               ISO_8859_9_TURKISH_MODEL,
                               MACTURKISH_TURKISH_MODEL,
                               WINDOWS_1254_TURKISH_MODEL)
from .langukrainianmodel import (CP1125_UKRAINIAN_MODEL,
...
from .langwelshmodel import (CP037_WELSH_MODEL, CP500_WELSH_MODEL,
