...
from lxml.includes.tree cimport (const_xmlChar, xmlChar, xmlDict, xmlDoc,
                                 xmlDtd, xmlEntity, xmlInputCloseCallback,
                                 xmlInputReadCallback, xmlNode)
from lxml.includes.xmlerror cimport (xmlError, xmlErrorLevel,
