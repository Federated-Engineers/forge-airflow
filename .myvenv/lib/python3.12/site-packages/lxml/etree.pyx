...
from libc cimport \
    string as cstring_h  # not to be confused with stdlib 'string'
from libc.string cimport const_char
from lxml cimport python
from lxml.includes cimport c14n, config, tree, xpath
from lxml.includes.tree cimport (_getNs, _isElement, _xcstr, const_xmlChar,
                                 xmlAttr, xmlChar, xmlDoc, xmlNode, xmlNs)
