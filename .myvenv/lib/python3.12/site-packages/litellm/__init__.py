...
from typing import (TYPE_CHECKING, Any, Callable, Dict, List, Literal,
                    Optional, Tuple, Type, Union, get_args, overload)

import httpx
from litellm._logging import (_turn_on_debug, _turn_on_json, json_logs,
                              log_level, set_verbose, verbose_logger)
from litellm.constants import \
    OPENAI_CHAT_COMPLETION_PARAMS  # backwards compatibility
from litellm.constants import (BEDROCK_CONVERSE_MODELS,
                               BEDROCK_EMBEDDING_PROVIDERS_LITERAL,
                               BEDROCK_INVOKE_PROVIDERS_LITERAL,
                               DEFAULT_ALLOWED_FAILS, DEFAULT_BATCH_SIZE,
                               DEFAULT_FLUSH_INTERVAL_SECONDS,
                               DEFAULT_MAX_RETRIES, DEFAULT_MAX_TOKENS,
...
from litellm.constants import (REPEATED_STREAMING_CHUNK_LIMIT,
                               ROUTER_MAX_FALLBACKS, WANDB_MODELS,
                               _openai_like_providers, baseten_models,
                               bedrock_embedding_models, clarifai_models,
                               cohere_embedding_models, empower_models,
                               huggingface_models, known_tokenizer_config,
                               open_ai_embedding_models,
                               openai_compatible_endpoints,
                               openai_compatible_providers,
                               openai_text_completion_compatible_providers,
                               replicate_models, request_timeout,
                               together_ai_models)
...
from .evals.main import (acancel_eval, acancel_run, acreate_eval, acreate_run,
                         adelete_eval, adelete_run, aget_eval, aget_run,
                         alist_evals, alist_runs, cancel_eval, cancel_run,
                         create_eval, create_run, delete_eval, delete_run,
                         get_eval, get_run, list_evals, list_runs)
from .exceptions import (LITELLM_EXCEPTION_TYPES, APIConnectionError, APIError,
                         APIResponseValidationError, AuthenticationError,
                         BadGatewayError, BadRequestError, BudgetExceededError,
                         ContentPolicyViolationError,
                         ContextWindowExceededError, ImageFetchError,
                         InternalServerError, InvalidRequestError,
                         JSONSchemaValidationError, MockException,
...
from .realtime_api.main import (_arealtime, acreate_realtime_client_secret,
                                arealtime_calls)
...
# Skills API
from .skills.main import (acreate_skill, adelete_skill, aget_skill,
                          alist_skills, create_skill, delete_skill, get_skill,
                          list_skills)
### ADAPTERS ###
from .types.adapter import AdapterItem
from .vector_store_files.main import acreate as avector_store_file_create
from .vector_store_files.main import adelete as avector_store_file_delete
from .vector_store_files.main import alist as avector_store_file_list
from .vector_store_files.main import aretrieve as avector_store_file_retrieve
from .vector_store_files.main import \
    aretrieve_content as avector_store_file_content
from .vector_store_files.main import aupdate as avector_store_file_update
from .vector_store_files.main import create as vector_store_file_create
from .vector_store_files.main import delete as vector_store_file_delete
from .vector_store_files.main import list as vector_store_file_list
from .vector_store_files.main import retrieve as vector_store_file_retrieve
from .vector_store_files.main import \
    retrieve_content as vector_store_file_content
from .vector_store_files.main import update as vector_store_file_update
...
from .vector_stores.vector_store_registry import (VectorStoreIndexRegistry,
                                                  VectorStoreRegistry)
...
if TYPE_CHECKING:
    ...
    from .llms.azure.responses.o_series_transformation import \
        AzureOpenAIOSeriesResponsesAPIConfig as \
    ...
    from .llms.bedrock.embed.amazon_titan_multimodal_transformation import \
        AmazonTitanMultimodalEmbeddingG1Config as \
    ...
    from .llms.bedrock.messages.invoke_transformations.anthropic_claude3_transformation import \
        AmazonAnthropicClaudeMessagesConfig as \
    ...
    from .llms.bytez.chat.transformation import \
        BytezChatConfig as BytezChatConfig
    from .llms.clarifai.chat.transformation import \
        ClarifaiConfig as ClarifaiConfig
    from .llms.cloudflare.chat.transformation import \
        CloudflareChatConfig as CloudflareChatConfig
    from .llms.cohere.chat.transformation import \
        CohereChatConfig as CohereChatConfig
    ...
    from .llms.datarobot.chat.transformation import \
        DataRobotConfig as DataRobotConfig
    ...
    from .llms.empower.chat.transformation import \
        EmpowerChatConfig as EmpowerChatConfig
    ...
    from .llms.github.chat.transformation import \
        GithubChatConfig as GithubChatConfig
    ...
    from .llms.meta_llama.chat.transformation import \
        LlamaAPIConfig as LlamaAPIConfig
    from .llms.minimax.chat.transformation import \
        MinimaxChatConfig as MinimaxChatConfig
    from .llms.mistral.chat.transformation import \
    ...
    from .llms.nvidia_nim.chat.transformation import \
        NvidiaNimConfig as NvidiaNimConfig
    ...
    from .llms.ollama.chat.transformation import \
        OllamaChatConfig as OllamaChatConfig
    from .llms.ollama.completion.transformation import \
        OllamaConfig as OllamaConfig
    from .llms.oobabooga.chat.transformation import \
        OobaboogaConfig as OobaboogaConfig
    ...
    from .llms.openai.openai import OpenAIConfig as OpenAIConfig
    ...
    from .llms.openai.transcriptions.whisper_transformation import \
        OpenAIWhisperAudioTranscriptionConfig as \
    ...
    from .llms.petals.completion.transformation import \
        PetalsConfig as PetalsConfig
    from .llms.predibase.chat.transformation import \
        PredibaseConfig as PredibaseConfig
    from .llms.replicate.chat.transformation import \
        ReplicateConfig as ReplicateConfig
    ...
    from .llms.snowflake.chat.transformation import \
        SnowflakeConfig as SnowflakeConfig
    ...
    from .llms.deepinfra.chat.transformation import \
        DeepInfraConfig as _DeepInfraConfig
    ...
    from litellm.types.utils import (BudgetConfig, CredentialItem,
    ...
    from .llms.chatgpt.chat.transformation import \
    ...
    from .llms.cometapi.chat.transformation import \
        CometAPIConfig as CometAPIConfig
    ...
    from .llms.fireworks_ai.audio_transcription.transformation import \
        FireworksAIAudioTranscriptionConfig as \
    ...
    from .llms.gigachat.chat.transformation import \
        GigaChatConfig as GigaChatConfig
    ...
    from .llms.heroku.chat.transformation import \
        HerokuChatConfig as HerokuChatConfig
    ...
    from .llms.morph.chat.transformation import \
        MorphChatConfig as MorphChatConfig
    ...
    from .llms.ragflow.chat.transformation import \
        RAGFlowConfig as RAGFlowConfig
...
def __getattr__(name: str) -> Any:
    ...
    if name == "AzureOpenAIError":
        ...
        if "AzureOpenAIError" not in _globals:
            from .llms.azure.common_utils import \
                AzureOpenAIError as _AzureOpenAIError
    ...
    if name in [
        ...
        from litellm.evals.main import (acancel_eval, acancel_run,
                                        acreate_eval, acreate_run,
                                        adelete_eval, adelete_run, aget_eval,
                                        aget_run, alist_evals, alist_runs,
                                        aupdate_eval, cancel_eval, cancel_run,
                                        create_eval, create_run, delete_eval,
                                        delete_run, get_eval, get_run,
                                        list_evals, list_runs, update_eval)
