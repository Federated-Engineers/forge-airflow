...
from litellm.types.utils import (CacheCreationTokenDetails, CallTypes,
                                 CompletionTokensDetailsWrapper, ImageResponse,
                                 ModelInfo, PassthroughCallTypes,
                                 PromptTokensDetailsWrapper, ServiceTier,
                                 Usage)
