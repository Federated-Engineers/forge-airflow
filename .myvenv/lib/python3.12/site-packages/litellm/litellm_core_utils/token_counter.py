...
from litellm.constants import (DEFAULT_IMAGE_HEIGHT, DEFAULT_IMAGE_TOKEN_COUNT,
                               DEFAULT_IMAGE_WIDTH,
                               MAX_LONG_SIDE_FOR_IMAGE_HIGH_RES,
                               MAX_SHORT_SIDE_FOR_IMAGE_HIGH_RES,
                               MAX_TILE_HEIGHT, MAX_TILE_WIDTH)
from litellm.litellm_core_utils.default_encoding import \
    encoding as default_encoding
from litellm.llms.custom_httpx.http_handler import _get_httpx_client
from litellm.types.llms.anthropic import (AnthropicMessagesToolResultParam,
