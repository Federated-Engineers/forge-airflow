...
from litellm.types.llms.vertex_ai import \
    FunctionResponse as VertexFunctionResponse
from litellm.types.llms.vertex_ai import PartType as VertexPartType
from litellm.types.utils import GenericImageParsingChunk

from .common_utils import (convert_content_list_to_str,
...
async def ahf_chat_template(
    ...
    from litellm.litellm_core_utils.prompt_templates.huggingface_template_handler import (
        _aget_chat_template_file, _aget_tokenizer_config, strftime_now)
...
def hf_chat_template(model: str, messages: list, chat_template: Optional[Any] = None):
    ...
    from litellm.litellm_core_utils.prompt_templates.huggingface_template_handler import (
        _get_chat_template_file, _get_tokenizer_config, strftime_now)
...
from litellm.types.llms.cohere import (CallObject, ChatHistory,
                                       ChatHistoryChatBot, ChatHistorySystem,
                                       ChatHistoryToolResult, ChatHistoryUser,
                                       ToolCallObject, ToolResultObject)
...
from litellm.types.llms.bedrock import \
    ToolJsonSchemaBlock as BedrockToolJsonSchemaBlock
from litellm.types.llms.bedrock import \
...
def prompt_factory(
    ...
    if custom_llm_provider == "ollama":
        ...
        from litellm.llms.watsonx.chat.transformation import \
