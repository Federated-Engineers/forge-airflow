...
from typing import (TYPE_CHECKING, Any, AsyncIterator, Callable, Coroutine,
                    Dict, Iterable, List, Literal, Mapping, Optional, Tuple,
...
from litellm.litellm_core_utils.audio_utils.utils import (
    calculate_request_duration, get_audio_file_for_health_check)
from litellm.litellm_core_utils.dd_tracing import tracer
from litellm.litellm_core_utils.get_provider_specific_headers import \
    ProviderSpecificHeaderUtils
from litellm.litellm_core_utils.health_check_utils import (
    _create_health_check_response, _filter_model_params)
...
from litellm.types.utils import (CustomPricingLiteLLMParams,
                                 ModelResponseStream, RawRequestTypedDict,
                                 StreamingChoices)
from litellm.utils import (Choices, CustomStreamWrapper, EmbeddingResponse,
                           Message, ModelResponse, ProviderConfigManager,
                           TextChoices, TextCompletionResponse,
                           TextCompletionStreamWrapper, TranscriptionResponse,
                           Usage, _get_model_info_helper,
                           add_provider_specific_params_to_optional_params,
                           async_mock_completion_streaming_obj,
                           convert_to_model_response_object,
                           create_pretrained_tokenizer, create_tokenizer,
                           get_api_key, get_llm_provider, get_model_info,
                           get_non_default_completion_params,
                           get_non_default_transcription_params,
                           get_optional_params_embeddings,
                           get_optional_params_image_gen,
                           get_optional_params_transcription,
                           get_requester_metadata, get_secret,
                           get_standard_openai_params,
                           mock_completion_streaming_obj,
                           pre_process_non_default_params, read_config_args,
                           should_run_mock_completion, supports_httpx_timeout,
                           token_counter, validate_and_fix_openai_messages,
...
from .litellm_core_utils.fallback_utils import (
    async_completion_with_fallbacks, completion_with_fallbacks)
from .litellm_core_utils.prompt_templates.common_utils import (
    add_system_prompt_to_messages, get_completion_messages,
    update_messages_with_model_file_ids)
from .litellm_core_utils.prompt_templates.factory import (
    custom_prompt, function_call_prompt, map_system_message_pt, ollama_pt,
    prompt_factory, stringify_json_tool_call_content)
...
from .llms.nlp_cloud.chat.handler import \
    completion as nlp_cloud_chat_completion
...
from .llms.replicate.chat.handler import \
    completion as replicate_chat_completion
...
from .types.utils import (AdapterCompletionStreamWrapper,
                          ChatCompletionMessageToolCall,
                          CompletionTokensDetails, FileTypes, HiddenParams,
                          LlmProviders, PromptTokensDetails,
                          ProviderSpecificHeader, all_litellm_params)
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "azure":
            ...
            from litellm.llms.langgraph.chat.transformation import \
                LangGraphConfig
