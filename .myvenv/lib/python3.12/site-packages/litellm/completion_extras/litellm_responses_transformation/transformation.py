...
from typing import (TYPE_CHECKING, Any, AsyncIterator, Callable, Dict,
                    Iterable, Iterator, List, Literal, Optional, Tuple, Union,
                    cast)
...
if TYPE_CHECKING:
    ...
    from litellm.types.llms.openai import (ALL_RESPONSES_API_TOOL_PARAMS,
                                           AllMessageValues,
...
class OpenAiResponsesToChatCompletionStreamIterator(BaseModelResponseIterator):
    ...
    def translate_responses_chunk_to_openai_stream(  # noqa: PLR0915
        ...
        from litellm.types.utils import (ChatCompletionToolCallChunk, Delta,
