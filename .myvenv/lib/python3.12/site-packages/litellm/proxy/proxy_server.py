...
from litellm.proxy.common_request_processing import (
    ProxyBaseLLMRequestProcessing, _is_azure_model_router_request,
    create_response)
from litellm.proxy.common_utils.callback_utils import \
...
class ProxyConfig:
    ...
    async def _init_hashicorp_vault_config_override(self, prisma_client: PrismaClient):
        ...
        """
        from litellm.proxy.management_endpoints.config_override_endpoints import (
            HASHICORP_ENV_VAR_MAPPING, _clear_hashicorp_vault_state,
            _get_current_env_values, _parse_config_value, _set_env_vars)
...
class ProxyStartupEvent:
    ...
    async def _initialize_spend_tracking_background_jobs(
        ...
        from litellm.proxy.spend_tracking.vantage_endpoints import (
            _get_vantage_settings, is_vantage_setup,
            is_vantage_setup_in_config, is_vantage_setup_in_db)
