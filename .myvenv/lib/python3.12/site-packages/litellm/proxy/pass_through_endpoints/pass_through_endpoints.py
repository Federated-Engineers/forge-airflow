...
from fastapi import (APIRouter, Depends, FastAPI, HTTPException, Request,
                     Response, UploadFile, WebSocket, status)
...
from litellm.proxy._types import (CommonProxyErrors, ConfigFieldInfo,
                                  ConfigFieldUpdate, LiteLLMRoutes,
                                  PassThroughEndpointResponse,
                                  PassThroughGenericEndpoint, ProxyException,
                                  UserAPIKeyAuth)
...
from litellm.types.passthrough_endpoints.pass_through_endpoints import (
    EndpointType, PassthroughStandardLoggingPayload)
...
async def chat_completion_pass_through_endpoint(  # noqa: PLR0915
    ...
    from litellm.proxy.proxy_server import (add_litellm_data_to_request,
                                            general_settings, llm_router,
                                            proxy_config, proxy_logging_obj,
                                            user_api_base, user_max_tokens,
                                            user_model, user_request_timeout,
                                            user_temperature, version)
...
async def initialize_pass_through_endpoints(
    ...
    from litellm.proxy.proxy_server import (app, config_passthrough_endpoints,
                                            premium_user)
