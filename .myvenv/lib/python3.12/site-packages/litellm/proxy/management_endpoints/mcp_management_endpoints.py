...
from litellm.proxy._experimental.mcp_server.utils import \
    validate_and_normalize_mcp_server_payload as \
    _base_validate_and_normalize_mcp_server_payload
...
if MCP_AVAILABLE:
    ...
    from litellm.proxy._experimental.mcp_server.db import (
        approve_mcp_server, create_mcp_server, delete_mcp_server,
        delete_user_credential, get_all_mcp_servers_for_user, get_mcp_server,
        get_mcp_servers, get_mcp_submissions, get_user_oauth_credential,
        list_user_oauth_credentials, reject_mcp_server, store_user_credential,
        store_user_oauth_credential, update_mcp_server)
    from litellm.proxy._experimental.mcp_server.discoverable_endpoints import (
        authorize_with_server, exchange_token_with_server,
        get_request_base_url, register_client_with_server)
    from litellm.proxy._experimental.mcp_server.mcp_server_manager import \
        global_mcp_server_manager
    from litellm.proxy._experimental.mcp_server.ui_session_utils import \
        build_effective_auth_contexts
    from litellm.proxy._types import (LiteLLM_MCPServerTable, LitellmUserRoles,
                                      ...
                                      UpdateMCPServerRequest, UserAPIKeyAuth,
    ...
    async def _get_team_scoped_mcp_server_list(
        ...
        from litellm.proxy.management_helpers.object_permission_utils import (
            _get_allow_all_keys_server_ids, _get_team_allowed_mcp_servers)
        from litellm.proxy.proxy_server import (prisma_client,
                                                user_api_key_cache)
    ...
    async def fetch_all_mcp_servers(
        ...
        from litellm.proxy.proxy_server import \
            prisma_client as _byok_prisma_client
