...
from litellm.proxy.auth.auth_checks import (_delete_cache_key_object,
                                            ...
                                            get_org_object, get_project_object,
                                            get_team_object)
...
from litellm.proxy.utils import (PrismaClient, ProxyLogging,
                                 ...
                                 handle_exception_on_proxy, is_valid_api_key)
from litellm.router import Router
from litellm.secret_managers.main import get_secret
from litellm.types.proxy.management_endpoints.key_management_endpoints import (
    BulkUpdateKeyRequest, BulkUpdateKeyRequestItem, BulkUpdateKeyResponse,
    FailedKeyUpdate, SuccessfulKeyUpdate)
from litellm.types.router import Deployment
from litellm.types.utils import (BudgetConfig, PersonalUIKeyGenerationConfig,
...
async def regenerate_key_fn(  # noqa: PLR0915
    ...
    """
    try:
        from litellm.proxy.proxy_server import (hash_token, master_key,
...
async def reset_key_spend_fn(
    ...
    try:
        from litellm.proxy.proxy_server import (hash_token, prisma_client,
                                                proxy_logging_obj,
                                                user_api_key_cache)
