...
from litellm.proxy._types import (CommonProxyErrors, LiteLLM_UserTable,
                                  LitellmUserRoles, Member, NewTeamRequest,
                                  NewUserRequest, NewUserResponse,
                                  ProxyErrorTypes, ProxyException,
                                  SSOUserDefinedValues, TeamMemberAddRequest,
                                  UserAPIKeyAuth)
...
from litellm.proxy.common_utils.admin_ui_utils import (
    admin_ui_disabled, show_missing_vars_in_env)
...
from litellm.proxy.management_endpoints.sso_helper_utils import (
    check_is_admin_only_access, has_admin_ui_access)
from litellm.proxy.management_endpoints.team_endpoints import (new_team,
                                                               team_member_add)
from litellm.proxy.management_endpoints.types import (
    CustomOpenID, get_litellm_user_role, is_valid_litellm_user_role)
from litellm.proxy.utils import (PrismaClient, ProxyLogging, get_custom_url,
                                 get_server_root_path)
from litellm.secret_managers.main import get_secret_bool, str_to_bool
from litellm.types.proxy.management_endpoints.ui_sso import *  # noqa: F403, F401
from litellm.types.proxy.management_endpoints.ui_sso import (
    DefaultTeamSSOParams, MicrosoftGraphAPIUserGroupDirectoryObject,
    MicrosoftGraphAPIUserGroupResponse, MicrosoftServicePrincipalTeam,
    RoleMappings, TeamMappings)
    ...
    if user_custom_ui_sso_sign_in_handler is not None:
        try:
            from litellm_enterprise.proxy.auth.custom_sso_handler import \
                EnterpriseCustomSSOHandler  # type: ignore[import-untyped]
...
async def debug_sso_callback(request: Request):
    ...
    from litellm.proxy.auth.handle_jwt import JWTHandler
    from litellm.proxy.proxy_server import (general_settings, jwt_handler,
                                            prisma_client, user_api_key_cache)
