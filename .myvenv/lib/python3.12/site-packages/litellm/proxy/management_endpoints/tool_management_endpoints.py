...
from litellm.types.tool_management import (LiteLLM_ToolTableRow,
                                           ToolDetailResponse, ToolInputPolicy,
                                           ToolListResponse, ToolPolicyOption,
...
async def update_tool_policy(
    ...
    """
    from litellm.proxy.db.tool_registry_writer import (
        add_tool_to_object_permission_blocked, get_tool_policy_registry,
...
async def delete_tool_policy_override(
    ...
    """
    from litellm.proxy.db.tool_registry_writer import (
        get_tool_policy_registry, remove_tool_from_object_permission_blocked)
    from litellm.proxy.proxy_server import prisma_client
