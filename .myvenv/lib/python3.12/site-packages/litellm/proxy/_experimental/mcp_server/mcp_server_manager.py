...
from litellm.constants import (MCP_CLIENT_TIMEOUT, MCP_HEALTH_CHECK_TIMEOUT,
                               MCP_METADATA_TIMEOUT, MCP_TOOL_LISTING_TIMEOUT)
...
from litellm.proxy._experimental.mcp_server.utils import (
    MCP_TOOL_PREFIX_SEPARATOR, add_server_prefix_to_name, get_server_prefix,
    is_tool_name_prefixed, merge_mcp_headers, normalize_server_name,
    split_server_prefix_from_name, validate_mcp_server_name)
from litellm.proxy._types import (LiteLLM_MCPServerTable, MCPAuthType,
...
from mcp.types import (CallToolResult, GetPromptRequestParams, GetPromptResult,
                       Prompt, ResourceTemplate)
...
class MCPServerManager:
    ...
    async def _register_openapi_tools(
        ...
        from litellm.proxy._experimental.mcp_server.openapi_to_mcp_generator import (
            build_input_schema, create_tool_function)
        from litellm.proxy._experimental.mcp_server.openapi_to_mcp_generator import \
            get_base_url as get_openapi_base_url
        from litellm.proxy._experimental.mcp_server.openapi_to_mcp_generator import (
            load_openapi_spec_async, resolve_operation_params)
