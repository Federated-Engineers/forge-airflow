...
if MCP_AVAILABLE:
    ...
    from litellm.proxy._experimental.mcp_server.server import (
        ListMCPToolsRestAPIResponseObject, MCPServer, _tool_name_matches,
        execute_mcp_tool, filter_tools_by_allowed_tools)
    ...
    async def _preview_openapi_tools(spec_path: str) -> dict:
        ...
        from litellm.proxy._experimental.mcp_server.openapi_to_mcp_generator import (
            build_input_schema, load_openapi_spec_async,
