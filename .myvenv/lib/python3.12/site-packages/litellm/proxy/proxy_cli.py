...
def run_server(  # noqa: PLR0915
    ...
    args = locals()
    if local:
        from proxy_server import (KeyManagementSettings, ProxyConfig, app,
                                  save_worker_config)
    else:
        try:
            from .proxy_server import (KeyManagementSettings, ProxyConfig, app,
            ...
            if "litellm[proxy]" in str(e):
                ...
                from proxy_server import (KeyManagementSettings, ProxyConfig,
        ...
        if (
            ...
            if is_prisma_runnable:
                ...
                from litellm.proxy.db.prisma_client import (
                    PrismaManager, should_update_prisma_schema)
