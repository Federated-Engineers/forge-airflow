...
from litellm.proxy._types import (AlertType, CallInfo, EnterpriseLicenseData,
                                  Litellm_EntityType, ProxyErrorTypes,
                                  ProxyException, UserAPIKeyAuth, WebhookEvent)
from litellm.proxy.auth.user_api_key_auth import user_api_key_auth
from litellm.proxy.db.exception_handler import PrismaDBExceptionHandler
from litellm.proxy.health_check import (
    _clean_endpoint_data, _update_litellm_params_for_health_check,
    perform_health_check, run_with_timeout)
...
async def health_endpoint(
    ...
    from litellm.proxy.proxy_server import (health_check_concurrency,
