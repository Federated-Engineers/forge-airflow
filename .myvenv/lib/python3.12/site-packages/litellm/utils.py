...
from litellm.types.utils import (OPENAI_RESPONSE_HEADERS, CallTypes,
                                 ...
                                 RawRequestTypedDict, SearchProviders,
                                 SelectTokenizerResponse, StreamingChoices,
...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Iterable, List,
                    Literal, Mapping, Optional, Tuple, Type, Union, cast,
                    get_args)
...
class ProviderConfigManager:
    ...
    def get_provider_evals_api_config(
        ...
        """
        if litellm.LlmProviders.OPENAI == provider:
            from litellm.llms.openai.evals.transformation import \
                OpenAIEvalsConfig
    ...
    def get_provider_files_config(
        ...
        if LlmProviders.GEMINI == provider:
            ...
            from litellm.llms.manus.files.transformation import \
                ManusFilesConfig
    ...
    def get_provider_video_config(
        ...
        if LlmProviders.OPENAI == provider:
            ...
            from litellm.llms.gemini.videos.transformation import \
                GeminiVideoConfig
    ...
    def get_provider_image_edit_config(
        ...
        if LlmProviders.OPENAI == provider:
            ...
            from litellm.llms.gemini.image_edit import \
    ...
    def get_provider_ocr_config(
        ...
        if provider == litellm.LlmProviders.VERTEX_AI:
            from litellm.llms.vertex_ai.ocr.common_utils import \
    ...
    def get_provider_search_config(
        ...
        from litellm.llms.duckduckgo.search.transformation import \
            DuckDuckGoSearchConfig
        from litellm.llms.exa_ai.search.transformation import ExaAISearchConfig
        from litellm.llms.firecrawl.search.transformation import \
            FirecrawlSearchConfig
        from litellm.llms.google_pse.search.transformation import \
            GooglePSESearchConfig
        from litellm.llms.linkup.search.transformation import \
            LinkupSearchConfig
        ...
        from litellm.llms.searchapi.search.transformation import \
            SearchAPIConfig
        from litellm.llms.searxng.search.transformation import \
            SearXNGSearchConfig
        from litellm.llms.serper.search.transformation import \
            SerperSearchConfig
