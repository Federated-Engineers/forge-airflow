...
from typing import (TYPE_CHECKING, Any, AsyncGenerator, Callable, Dict,
                    Generator, List, Literal, Optional, Tuple, Union, cast)
...
from litellm.litellm_core_utils.core_helpers import (
    _get_parent_otel_span_from_kwargs, get_metadata_variable_name_from_kwargs)
...
from litellm.router_utils.add_retry_fallback_headers import (
    add_fallback_headers_to_response, add_retry_headers_to_response)
from litellm.router_utils.batch_utils import (
    _get_router_metadata_variable_name, replace_model_in_jsonl,
...
from litellm.router_utils.clientside_credential_handler import (
    get_dynamic_litellm_params, is_clientside_credential)
from litellm.router_utils.common_utils import (filter_team_based_models,
                                               filter_web_search_deployments)
from litellm.router_utils.cooldown_cache import CooldownCache
from litellm.router_utils.cooldown_handlers import (
    DEFAULT_COOLDOWN_TIME_SECONDS, _async_get_cooldown_deployments,
    _async_get_cooldown_deployments_with_debug_info, _get_cooldown_deployments,
    _set_cooldown_deployments)
from litellm.router_utils.fallback_event_handlers import (
    _check_non_standard_fallback_format, get_fallback_model_group,
    run_async_fallback)
...
from litellm.router_utils.handle_error import (
    async_raise_no_deployment_exception, send_llm_exception_alert)
...
from litellm.types.llms.openai import (AllMessageValues, FileTypes,
                                       OpenAIFileObject, OpenAIFilesPurpose)
from litellm.types.router import (CONFIGURABLE_CLIENTSIDE_AUTH_PARAMS,
                                  VALID_LITELLM_ENVIRONMENTS, AlertingConfig,
                                  AllowedFailsPolicy, AssistantsTypedDict,
                                  CredentialLiteLLMParams,
                                  CustomRoutingStrategyBase, Deployment,
                                  DeploymentTypedDict, GuardrailTypedDict,
                                  LiteLLM_Params, MockRouterTestingParams,
                                  ModelGroupInfo, OptionalPreCallChecks,
                                  RetryPolicy, RouterCacheEnum,
                                  RouterGeneralSettings,
                                  RouterModelGroupAliasItem,
                                  RouterRateLimitError,
                                  RouterRateLimitErrorBasic, RoutingStrategy,
                                  SearchToolTypedDict)
from litellm.types.services import ServiceTypes
from litellm.types.utils import (CustomPricingLiteLLMParams,
                                 GenericBudgetConfigType, LiteLLMBatch)
...
from litellm.utils import (CustomStreamWrapper, EmbeddingResponse,
                           ModelResponse, Rules, function_setup,
                           get_llm_provider, get_non_default_completion_params,
                           get_secret, get_utc_datetime, is_region_allowed)
...
if TYPE_CHECKING:
    from litellm.router_strategy.auto_router.auto_router import (
        AutoRouter, PreRoutingHookResponse)
...
class Router:
    ...
    def _initialize_vector_store_endpoints(self):
        ...
        from litellm.vector_stores.main import (adelete, alist, aretrieve,
                                                asearch, aupdate, create,
                                                delete, list, retrieve, search,
                                                update)
    ...
    def _initialize_video_endpoints(self):
        ...
        from litellm.videos import (avideo_content, avideo_create_character,
                                    avideo_edit, avideo_extension,
                                    avideo_generation, avideo_get_character,
                                    avideo_list, avideo_remix, avideo_status,
                                    video_content, video_create_character,
                                    video_edit, video_extension,
                                    video_generation, video_get_character,
                                    video_list, video_remix, video_status)
    ...
    def _initialize_container_endpoints(self):
        ...
        from litellm.containers import (acreate_container, adelete_container,
                                        alist_containers, aretrieve_container,
                                        create_container, delete_container,
                                        list_containers, retrieve_container)
        ...
        **kwargs,
        ...
        try:
            ...
            from litellm.vector_stores import \
                acreate as avector_store_create_sdk
