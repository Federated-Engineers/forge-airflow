...
from litellm.integrations.langfuse.langfuse_mock_client import (
    create_mock_langfuse_client, should_use_langfuse_mock)
from litellm.litellm_core_utils.core_helpers import (
    filter_exceptions_from_params, reconstruct_model_name, safe_deep_copy)
...
class LangFuseLogger:
    ...
    def _log_langfuse_v1(
        ...
        from langfuse.model import CreateGeneration  # type: ignore
...
def _add_prompt_to_generation_params(
    ...
    from langfuse import Langfuse
    from langfuse.model import (ChatPromptClient, Prompt_Chat, Prompt_Text,
                                TextPromptClient)
