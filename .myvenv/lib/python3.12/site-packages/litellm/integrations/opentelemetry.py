...
from litellm.integrations._types.open_inference import (
    OpenInferenceSpanKindValues, SpanAttributes)
from litellm.integrations.custom_logger import CustomLogger
from litellm.litellm_core_utils.safe_json_dumps import safe_dumps
from litellm.secret_managers.main import get_secret_bool, str_to_bool
from litellm.types.services import ServiceLoggerPayload
from litellm.types.utils import (ChatCompletionMessageToolCall, CostBreakdown,
                                 Function, LLMResponseTypes,
...
class OpenTelemetry(CustomLogger):
    ...
    def _emit_semantic_logs(self, kwargs, response_obj, span: Span):
        ...
        try:
            from opentelemetry.sdk._logs import \
                LogRecord as \
                SdkLogRecord  # type: ignore[attr-defined]  # OTEL < 1.39.0
        except ImportError:
    ...
    def _get_metric_reader(self):
        ...
        from opentelemetry.sdk.metrics.export import (
            AggregationTemporality, ConsoleMetricExporter,
