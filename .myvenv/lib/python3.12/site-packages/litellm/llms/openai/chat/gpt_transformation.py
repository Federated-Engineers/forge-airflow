...
from typing import (TYPE_CHECKING, Any, AsyncIterator, Coroutine, Dict,
                    Iterator, List, Literal, Optional, Tuple, Union, cast,
                    overload)
...
from litellm.litellm_core_utils.llm_response_utils.convert_dict_to_response import (
    _extract_reasoning_content, _handle_invalid_parallel_tool_calls,
    _should_convert_tool_call_to_json_mode)
from litellm.litellm_core_utils.prompt_templates.common_utils import \
    get_tool_call_names
from litellm.litellm_core_utils.prompt_templates.image_handling import (
    async_convert_url_to_base64, convert_url_to_base64)
