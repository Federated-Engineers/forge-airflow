...
from litellm.types.llms.openai import (AllMessageValues,
                                       ...
                                       ImageURLListItem, ImageURLObject,
                                       OpenAIChatCompletionFinishReason)
from litellm.types.llms.vertex_ai import (VERTEX_CREDENTIALS_TYPES, Candidates,
                                          ContentType, FunctionCallingConfig,
                                          FunctionDeclaration,
                                          GeminiThinkingConfig,
                                          GenerateContentResponseBody,
                                          HttpxPartType, LogprobsResult,
                                          ToolConfig, Tools, UsageMetadata,
                                          VertexToolName)
from litellm.types.utils import (ChatCompletionAudioResponse,
                                 ChatCompletionTokenLogprob, ChoiceLogprobs,
                                 CompletionTokensDetailsWrapper,
                                 PromptTokensDetailsWrapper, TopLogprob, Usage)
from litellm.utils import (CustomStreamWrapper, ModelResponse,
                           is_base64_encoded, supports_reasoning)

from ....utils import _remove_additional_properties, _remove_strict_from_schema
from ..common_utils import (VertexAIError, _build_json_schema,
                            _build_vertex_schema,
                            supports_response_json_schema)
from ..vertex_llm_base import VertexBase
from .transformation import (_gemini_convert_messages_with_history,
...
class VertexGeminiConfig(VertexAIBaseConfig, BaseConfig):
    ...
    def _map_audio_params(self, value: dict) -> dict:
        ...
        """
        from litellm.types.llms.vertex_ai import (PrebuiltVoiceConfig,
