...
from litellm.types.llms.watsonx import WatsonXAIEndpoint, WatsonXModelPattern
...
class IBMWatsonXChatConfig(IBMWatsonXMixin, OpenAIGPTConfig):
    ...
    def _apply_prompt_template_core(
        ...
        from litellm.litellm_core_utils.prompt_templates.factory import (
            custom_prompt, ibm_granite_pt, mistral_instruct_pt)
    ...
    async def aapply_prompt_template(
        ...
        import litellm
        from litellm.litellm_core_utils.prompt_templates.factory import (
            ahf_chat_template, custom_prompt, hf_chat_template, ibm_granite_pt,
            mistral_instruct_pt)
