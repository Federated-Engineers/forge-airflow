...
if TYPE_CHECKING:
    from litellm.types.google_genai.main import (
        GenerateContentConfigDict, GenerateContentContentListUnionDict,
        GenerateContentResponse, ToolConfigDict)
else:
...
class GoogleGenAIConfig(BaseGoogleGenAIGenerateContentConfig, VertexLLM):
    ...
    def transform_generate_content_request(
        ...
        from litellm.types.google_genai.main import (
            GenerateContentConfigDict, GenerateContentRequestDict)
