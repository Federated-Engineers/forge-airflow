...
def get_cost_for_web_search_request(
    ...
    if custom_llm_provider == "gemini":
        ...
        from .anthropic.cost_calculation import \
        ...
        from .vertex_ai.gemini.cost_calculator import \
            cost_per_web_search_request as \
            cost_per_web_search_request_vertex_ai
    ...
    try:
        ...
        try:
            from litellm.proxy._experimental.mcp_server.guardrail_translation import \
                guardrail_translation_mappings as \
                mcp_guardrail_translation_mappings
