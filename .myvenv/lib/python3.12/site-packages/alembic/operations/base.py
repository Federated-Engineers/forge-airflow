...
from typing import (TYPE_CHECKING, Any, Awaitable, Callable, Dict, Iterator,
                    Mapping, NoReturn, Optional, Tuple, TypeVar, Union,
                    overload)
...
from ..util.compat import (formatannotation_fwdref, inspect_formatargspec,
                           inspect_getfullargspec)
from ..util.sqla_compat import _literal_bindparam
from . import batch, schemaobj
...
if TYPE_CHECKING:
    ...
    from .ops import (AddColumnOp, AddConstraintOp, AlterColumnOp,
                      AlterTableOp, BulkInsertOp, CreateIndexOp,
                      CreateTableCommentOp, CreateTableOp, DropColumnOp,
                      DropConstraintOp, DropIndexOp, DropTableCommentOp,
                      DropTableOp, ExecuteSQLOp, MigrateOperation)
