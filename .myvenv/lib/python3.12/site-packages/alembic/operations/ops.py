...
from typing import (TYPE_CHECKING, Any, Callable, Dict, FrozenSet, Iterator,
                    List, MutableMapping, Optional, Sequence, Set, Tuple, Type,
                    TypeVar, Union, cast)
...
if TYPE_CHECKING:
    ...
    from sqlalchemy.sql.schema import (CheckConstraint, Column, Constraint,
                                       ...
                                       PrimaryKeyConstraint, SchemaItem, Table,
                                       UniqueConstraint)
