...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Iterable, Iterator,
                    Optional, Protocol, Set, Type, TypeVar, Union)

from sqlalchemy import __version__, schema, sql
from sqlalchemy import types as sqltypes
from sqlalchemy.schema import CheckConstraint, Column, ForeignKeyConstraint
...
from sqlalchemy.sql.naming import \
    _NONE_NAME as _NONE_NAME  # type: ignore[attr-defined] # noqa: E501
from sqlalchemy.sql.visitors import traverse
from typing_extensions import TypeGuard

if TYPE_CHECKING:
    from sqlalchemy import ClauseElement, Identity, Index, Table
    from sqlalchemy.engine import Connection, Dialect, Transaction
    from sqlalchemy.sql.base import ColumnCollection
    from sqlalchemy.sql.compiler import SQLCompiler
    from sqlalchemy.sql.elements import ColumnElement
    from sqlalchemy.sql.schema import Constraint, SchemaItem
