...
from typing import (TYPE_CHECKING, Any, Callable, Iterator, List, Tuple, Type,
                    Union)
...
if TYPE_CHECKING:
    from ..operations.ops import (AddColumnOp, AlterColumnOp, CreateTableOp,
                                  DowngradeOps, MigrateOperation,
                                  MigrationScript, ModifyTableOps, OpContainer,
                                  UpgradeOps)
