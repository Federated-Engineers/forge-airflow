...
from google.cloud.aiplatform.vertex_ray.util import (_gapic_utils,
                                                     _validation_utils,
                                                     resources)
from google.cloud.aiplatform.vertex_ray.util._validation_utils import (
    _V2_4_WARNING_MESSAGE, _V2_9_WARNING_MESSAGE)
...
from google.cloud.aiplatform_v1beta1.types.persistent_resource import (
    PersistentResource, RayLogsSpec, RayMetricSpec, RaySpec, ResourcePool,
    ResourceRuntimeSpec, ServiceAccountSpec)
