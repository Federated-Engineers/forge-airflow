...
import botocore
import pyathena
from pyathena.sqlalchemy.compiler import (AthenaDDLCompiler,
                                          AthenaStatementCompiler,
                                          AthenaTypeCompiler)
from pyathena.sqlalchemy.preparer import AthenaDMLIdentifierPreparer
from pyathena.sqlalchemy.types import (TINYINT, AthenaDate, AthenaStruct,
                                       AthenaTimestamp, get_double_type)
...
if TYPE_CHECKING:
    ...
    from sqlalchemy import (URL, ClauseElement, Connection,
