...
from numpy._typing import (  # type: ignore[deprecated]; Arrays; DTypes; Shapes; Scalars; `number` precision; NOTE: Do not remove the extended precision bit-types even if seemingly unused;; they're used by the mypy plugin; Character codes; Ufuncs
    ArrayLike, DTypeLike, NBitBase, NDArray, _8Bit, _16Bit, _32Bit, _64Bit,
    _96Bit, _128Bit, _AnyShape, _ArrayLike, _ArrayLikeBool_co,
    _ArrayLikeBytes_co, _ArrayLikeComplex128_co, _ArrayLikeComplex_co,
    _ArrayLikeDT64_co, _ArrayLikeFloat64_co, _ArrayLikeFloat_co, _ArrayLikeInt,
    _ArrayLikeInt_co, _ArrayLikeNumber_co, _ArrayLikeObject_co,
    _ArrayLikeStr_co, _ArrayLikeString_co, _ArrayLikeTD64_co,
    _ArrayLikeUInt_co, _BoolCodes, _ByteCodes, _BytesCodes, _CDoubleCodes,
    _CharacterCodes, _CharLike_co, _CLongDoubleCodes, _Complex64Codes,
    _Complex128Codes, _ComplexFloatingCodes, _CSingleCodes, _DoubleCodes,
    _DT64Codes, _DTypeLike, _DTypeLikeVoid, _Float16Codes, _Float32Codes,
    _Float64Codes, _FloatingCodes, _FloatLike_co, _GUFunc_Nin2_Nout1,
    _HalfCodes, _InexactCodes, _Int8Codes, _Int16Codes, _Int32Codes,
    _Int64Codes, _IntCCodes, _IntegerCodes, _IntLike_co, _IntPCodes,
    _LongCodes, _LongDoubleCodes, _LongLongCodes, _NBitByte, _NBitDouble,
    _NBitHalf, _NBitIntC, _NBitIntP, _NBitLong, _NBitLongDouble, _NBitLongLong,
    _NBitShort, _NBitSingle, _NestedSequence, _NumberLike_co, _ObjectCodes,
    _ScalarLike_co, _Shape, _ShapeLike, _ShortCodes, _SignedIntegerCodes,
    _SingleCodes, _StrCodes, _StringCodes, _SupportsArray, _TD64Codes,
    _TD64Like_co, _UByteCodes, _UFunc_Nin1_Nout1, _UFunc_Nin1_Nout2,
    _UFunc_Nin2_Nout1, _UFunc_Nin2_Nout2, _UInt8Codes, _UInt16Codes,
    _UInt32Codes, _UInt64Codes, _UIntCCodes, _UIntPCodes, _ULongCodes,
    _ULongLongCodes, _UnsignedIntegerCodes, _UShortCodes, _VoidCodes,
    _VoidDTypeLike)
# NOTE: Numpy's mypy plugin is used for removing the types unavailable to the specific platform
from numpy._typing._extended_precision import (complex192, complex256, float96,
                                               float128)
...
from typing import (LiteralString, Never, NoReturn, Protocol, Self,
                    SupportsComplex, SupportsFloat, SupportsIndex, SupportsInt,
                    TypeAlias, TypedDict, final, overload, type_check_only)
...
from _typeshed import (Incomplete, StrOrBytesPath, SupportsFlush,
                       SupportsLenAndGetItem, SupportsWrite)
# available through `__getattr__`, but not in `__all__` or `__dir__`
from numpy import __config__ as __config__
from numpy import (char, core, ctypeslib, dtypes, exceptions, f2py, fft, lib,
                   linalg, ma)
from numpy import matlib as matlib
from numpy import matrixlib as matrixlib
from numpy import polynomial, random, rec, strings, testing, typing
...
from numpy._core._ufunc_config import (errstate, getbufsize, geterr,
                                       geterrcall, setbufsize, seterr,
                                       seterrcall)
from numpy._core.arrayprint import (array2string, array_repr, array_str,
                                    format_float_positional,
                                    format_float_scientific, get_printoptions,
                                    printoptions, set_printoptions)
from numpy._core.einsumfunc import einsum, einsum_path
from numpy._core.fromnumeric import (all, amax, amin, any, argmax, argmin,
                                     argpartition, argsort, around, choose,
                                     clip, compress, cumprod, cumsum,
                                     cumulative_prod, cumulative_sum, diagonal,
                                     matrix_transpose, max, mean, min, ndim,
                                     nonzero, partition, prod, ptp, put, ravel,
                                     repeat, reshape, resize, round,
                                     searchsorted, shape, size, sort, squeeze,
                                     std, sum, swapaxes, take, trace,
                                     transpose, var)
from numpy._core.function_base import geomspace, linspace, logspace
from numpy._core.getlimits import finfo, iinfo
from numpy._core.multiarray import (arange, array, asanyarray, asarray,
                                    ascontiguousarray, asfortranarray,
                                    bincount, busday_count, busday_offset,
                                    can_cast, concatenate, copyto,
                                    datetime_as_string, datetime_data, dot,
                                    empty, empty_like, flagsobj, frombuffer,
                                    fromfile, fromiter, frompyfunc, fromstring,
                                    inner, is_busday, lexsort,
                                    may_share_memory, min_scalar_type,
                                    nested_iters, packbits, promote_types,
                                    putmask, result_type, shares_memory,
                                    unpackbits, vdot, where, zeros)
from numpy._core.numeric import (allclose, argwhere, array_equal, array_equiv,
                                 astype, base_repr, binary_repr, convolve,
                                 correlate, count_nonzero, cross, flatnonzero,
                                 fromfunction, full, full_like, identity,
                                 indices, isclose, isfortran, isscalar,
                                 moveaxis, ones, ones_like, outer, roll,
                                 rollaxis, tensordot, zeros_like)
...
from numpy._core.shape_base import (atleast_1d, atleast_2d, atleast_3d, block,
                                    hstack, stack, unstack, vstack)
from numpy.lib import scimath as emath
from numpy.lib._arraypad_impl import pad
from numpy.lib._arraysetops_impl import (ediff1d, intersect1d, isin, setdiff1d,
                                         setxor1d, union1d, unique, unique_all,
                                         unique_counts, unique_inverse,
                                         unique_values)
from numpy.lib._function_base_impl import angle  # type: ignore[deprecated]
from numpy.lib._function_base_impl import (append, asarray_chkfinite, average,
                                           bartlett, blackman, copy, corrcoef,
                                           cov, delete, diff, digitize,
                                           extract, flip, gradient, hamming,
                                           hanning, i0, insert, interp,
                                           iterable, kaiser, median, meshgrid,
                                           percentile, piecewise, place,
                                           quantile, rot90, select, sinc,
                                           sort_complex, trapezoid, trim_zeros,
                                           unwrap, vectorize)
from numpy.lib._histograms_impl import (histogram, histogram_bin_edges,
                                        histogramdd)
...
from numpy.lib._nanfunctions_impl import (nanargmax, nanargmin, nancumprod,
                                          nancumsum, nanmax, nanmean,
                                          nanmedian, nanmin, nanpercentile,
                                          nanprod, nanquantile, nanstd, nansum,
                                          nanvar)
from numpy.lib._npyio_impl import (fromregex, genfromtxt, load, loadtxt, save,
                                   savetxt, savez, savez_compressed)
from numpy.lib._polynomial_impl import (poly, polyadd, polyder, polydiv,
                                        polyfit, polyint, polymul, polysub,
                                        polyval, roots)
from numpy.lib._shape_base_impl import (  # type: ignore[deprecated]
    apply_along_axis, apply_over_axes, array_split, column_stack, dsplit,
...
from numpy.lib._stride_tricks_impl import (broadcast_arrays, broadcast_shapes,
                                           broadcast_to)
from numpy.lib._twodim_base_impl import (diag, diagflat, eye, fliplr, flipud,
                                         histogram2d, mask_indices, tri, tril,
                                         tril_indices, tril_indices_from, triu,
                                         triu_indices, triu_indices_from,
                                         vander)
from numpy.lib._type_check_impl import (common_type, imag, iscomplex,
...
from numpy.matrixlib import asmatrix, bmat, matrix

from ._expired_attrs_2_0 import \
    __expired_attributes__ as __expired_attributes__
from ._globals import _CopyMode as _CopyMode
from ._globals import _NoValue as _NoValue
from ._globals import _NoValueType
