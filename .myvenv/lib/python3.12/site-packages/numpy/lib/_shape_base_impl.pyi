...
from typing import (Any, Concatenate, ParamSpec, Protocol, SupportsIndex,
                    TypeVar, overload, type_check_only)

import numpy as np
from numpy import (_CastingKind, complexfloating, floating, generic, integer,
                   object_, signedinteger, ufunc, unsignedinteger)
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _ArrayLike,
                           ...
                           _ArrayLikeObject_co, _ArrayLikeUInt_co, _ShapeLike)
