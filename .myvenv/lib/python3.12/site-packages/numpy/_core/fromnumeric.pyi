...
from typing import (Any, Literal, Never, Protocol, SupportsIndex, TypeAlias,
                    TypedDict, TypeVar, Unpack, overload, type_check_only)

import numpy as np
from _typeshed import Incomplete
from numpy import (_AnyShapeT, _CastingKind, _ModeKind, _OrderACF, _OrderKACF,
                   _PartitionKind, _SortKind, _SortSide, complexfloating,
                   float16, floating, generic, int64, int_, intp, object_,
                   timedelta64, uint64)
from numpy._globals import _NoValueType
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _AnyShape,
                           _ArrayLike, _ArrayLikeBool_co, _ArrayLikeComplex_co,
                           _ArrayLikeFloat_co, _ArrayLikeInt, _ArrayLikeInt_co,
                           _ArrayLikeObject_co, _ArrayLikeUInt_co,
                           _BoolLike_co, _ComplexLike_co, _DTypeLike,
                           _IntLike_co, _NestedSequence, _NumberLike_co,
