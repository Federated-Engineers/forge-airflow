...
from numpy import (byte, double, dtype, generic, intc, long, longdouble,
                   longlong, ndarray, short, single, ubyte, uintc, ulong,
                   ulonglong, ushort, void)
from numpy._core._internal import _ctypes
from numpy._core.multiarray import flagsobj
from numpy._typing import (DTypeLike, NDArray, _AnyShape, _ArrayLike,
                           _BoolCodes, _ByteCodes, _DoubleCodes, _DTypeLike,
                           _IntCCodes, _LongCodes, _LongDoubleCodes,
                           _LongLongCodes, _ShapeLike, _ShortCodes,
                           _SingleCodes, _UByteCodes, _UIntCCodes, _ULongCodes,
