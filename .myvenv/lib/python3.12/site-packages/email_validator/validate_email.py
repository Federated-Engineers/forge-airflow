...
from .syntax import (split_email, validate_email_domain_literal,
                     validate_email_domain_name, validate_email_length,
...
def validate_email(
    ...
    *,  # subsequent arguments are keyword-only
    ...
    from . import (ALLOW_DISPLAY_NAME, ALLOW_DOMAIN_LITERAL, ALLOW_EMPTY_LOCAL,
                   ALLOW_QUOTED_LOCAL, ALLOW_SMTPUTF8, CHECK_DELIVERABILITY,
                   DEFAULT_TIMEOUT, GLOBALLY_DELIVERABLE, STRICT,
                   TEST_ENVIRONMENT)
