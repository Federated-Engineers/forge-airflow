...
from typing import (IO, TYPE_CHECKING, Any, BinaryIO, Literal, NoReturn,
                    TextIO, TypeVar, overload)
from urllib.parse import SplitResult, urlsplit

from fsspec.registry import get_filesystem_class
from fsspec.spec import AbstractFileSystem
from upath._chain import DEFAULT_CHAIN_PARSER, Chain, FSSpecChainParser
from upath._flavour import (LazyFlavourDescriptor, WrappedFileSystemFlavour,
                            upath_get_kwargs_from_url, upath_urijoin)
...
from upath.registry import (_get_implementation_protocols,
                            available_implementations, get_upath_class)
from upath.types import (UNSET_DEFAULT, JoinablePathLike, OnNameCollisionFunc,
                         PathInfo, ReadablePath, ReadablePathLike,
                         StatResultType, SupportsPathLike, UPathParser,
                         WritablePath, WritablePathLike)
...
class UPath(_UPathMixin, WritablePath, ReadablePath):
    ...
    def _copy_from(
        ...
        **kwargs: Any,
        ...
        from pathlib_abc import vfsopen, vfspath
        from pathlib_abc._os import copyfileobj, ensure_different_files
