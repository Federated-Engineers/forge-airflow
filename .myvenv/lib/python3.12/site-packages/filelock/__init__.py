...
if TYPE_CHECKING:
    from ._async_read_write import (AsyncAcquireReadWriteReturnProxy,
                                    AsyncReadWriteLock)
...
from ._soft_rw import (AsyncAcquireSoftReadWriteReturnProxy,
                       AsyncSoftReadWriteLock, SoftReadWriteLock)
from ._unix import UnixFileLock, has_fcntl
from ._windows import WindowsFileLock
from .asyncio import (AsyncAcquireReturnProxy, AsyncSoftFileLock,
                      AsyncUnixFileLock, AsyncWindowsFileLock,
                      BaseAsyncFileLock)
