...
from typing_extensions import Literal, Unpack, get_origin, override
...
from ._types import (AnyMapping, AsyncBinaryTypes, BinaryTypes, Body, Headers,
                     HttpxRequestFiles, HttpxSendArgs, ModelBuilderProtocol,
                     NotGiven, Omit, PostParser, Query, RequestFiles,
                     RequestOptions, ResponseT, Timeout, not_given)
