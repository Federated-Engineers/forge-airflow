...
from ._types import (HttpxSendArgs, NotGiven, Omit, ProxiesTypes,
                     RequestOptions, Timeout, Transport, not_given)
...
if TYPE_CHECKING:
    from .resources import (audio, batches, beta, chat, completions,
                            ...
                            realtime, responses, skills, uploads,
                            vector_stores, videos)
