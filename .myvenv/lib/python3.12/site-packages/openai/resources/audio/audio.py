...
from .speech import (AsyncSpeech, AsyncSpeechWithRawResponse,
                     AsyncSpeechWithStreamingResponse, Speech,
                     SpeechWithRawResponse, SpeechWithStreamingResponse)
from .transcriptions import (AsyncTranscriptions,
...
from .translations import (AsyncTranslations, AsyncTranslationsWithRawResponse,
