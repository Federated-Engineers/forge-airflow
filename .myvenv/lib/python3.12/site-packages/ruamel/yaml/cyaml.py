...
try:
    ...
    from _ruamel_yaml_clibz import CEmitter, CParser  # type: ignore
    __yaml_lib = 'clibz'

from ruamel.yaml.constructor import (BaseConstructor, Constructor,  # NOQA
                                     SafeConstructor)
from ruamel.yaml.representer import (BaseRepresenter, Representer,  # NOQA
                                     SafeRepresenter)
from ruamel.yaml.resolver import BaseResolver, Resolver  # NOQA
