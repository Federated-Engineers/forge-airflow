...
from pandas.io.common import (IOHandles, dedup_names, extension_to_compression,
                              file_exists, get_handle, is_fsspec_url,
                              is_potential_multi_index, is_url, stringify_path)
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (CompressionOptions, DtypeArg, DtypeBackend,
                                FilePath, IndexLabel, JSONEngine,
                                JSONSerializable, ReadBuffer, Self,
