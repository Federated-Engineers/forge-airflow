...
if TYPE_CHECKING:
    ...
    from pandas._typing import (Axis, AxisInt, FilePath, IndexLabel,
                                IntervalClosedType, Level,
                                QuantileInterpolation, Scalar, StorageOptions,
                                WriteBuffer, WriteExcelBuffer)
