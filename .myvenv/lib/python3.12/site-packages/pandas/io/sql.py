...
if TYPE_CHECKING:
    ...
    from pandas._typing import (DateTimeErrorChoices, DtypeArg, DtypeBackend,
                                IndexLabel, Self)
...
class SQLTable(PandasObject):
    ...
    def _sqlalchemy_type(self, col: Index | Series):
        ...
        from sqlalchemy.types import (TIMESTAMP, BigInteger, Boolean, Date,
                                      DateTime, Float, Integer, SmallInteger,
                                      Text, Time)
    ...
    def _get_dtype(self, sqltype):
        from sqlalchemy.types import (TIMESTAMP, Boolean, Date, DateTime,
