...
import pytest
from pandas import (NA, Categorical, CategoricalIndex, DataFrame,
                    IntervalIndex, MultiIndex, NaT, PeriodIndex, Series,
                    Timestamp, date_range, option_context, period_range)
