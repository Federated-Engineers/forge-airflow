...
from pandas._libs.tslibs import (BaseOffset, NaT, NaTType, Period, Timedelta,
                                 Timestamp, timezones, to_offset, tz_compare)
...
if TYPE_CHECKING:
    ...
    from pandas import (Categorical, CategoricalIndex, DatetimeIndex, Index,
                        IntervalIndex, PeriodIndex)
    from pandas._typing import (Dtype, DtypeObj, IntervalClosedType, Ordered,
                                Self, npt, type_t)
    from pandas.core.arrays import (BaseMaskedArray, DatetimeArray,
                                    IntervalArray, NumpyExtensionArray,
                                    PeriodArray, SparseArray)
...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def _hash_categories(self) -> int:
        from pandas.core.util.hashing import (combine_hash_arrays, hash_array,
                                              hash_tuples)
