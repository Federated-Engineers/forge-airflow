...
from pandas._config import get_option, using_copy_on_write, warn_copy_on_write
...
from pandas.compat._constants import REF_COUNT, WARNING_CHECK_DISABLED
from pandas.compat._optional import import_optional_dependency
from pandas.compat.numpy import function as nv
from pandas.core import algorithms
from pandas.core import common as com
from pandas.core import nanops, ops, roperator
from pandas.core.accessor import CachedAccessor
from pandas.core.apply import reconstruct_and_relabel_result
from pandas.core.array_algos.take import take_2d_multi
from pandas.core.arraylike import OpsMixin
from pandas.core.arrays import (BaseMaskedArray, DatetimeArray, ExtensionArray,
                                PeriodArray, TimedeltaArray)
from pandas.core.arrays.sparse import SparseFrameAccessor
from pandas.core.arrays.string_ import StringDtype
from pandas.core.construction import (ensure_wrapped_if_datetimelike,
                                      sanitize_array, sanitize_masked_array)
from pandas.core.dtypes.cast import (LossySetitemError, can_hold_element,
                                     construct_1d_arraylike_from_scalar,
                                     construct_2d_arraylike_from_scalar,
                                     find_common_type, infer_dtype_from_scalar,
                                     invalidate_string_dtypes,
                                     maybe_box_native, maybe_downcast_to_dtype)
from pandas.core.dtypes.common import (infer_dtype_from_object,
                                       is_1d_only_ea_dtype, is_array_like,
                                       is_bool_dtype, is_dataclass,
                                       is_dict_like, is_float, is_float_dtype,
                                       is_hashable, is_integer,
                                       is_integer_dtype, is_iterator,
                                       is_list_like, is_scalar, is_sequence,
...
from pandas.core.indexes.api import (DatetimeIndex, Index, PeriodIndex,
...
from pandas.core.internals.construction import (arrays_to_mgr,
                                                ...
                                                dict_to_mgr, mgr_to_mgr,
                                                ndarray_to_mgr,
                                                nested_data_to_arrays,
                                                rec_array_to_mgr,
                                                reorder_arrays, to_arrays,
                                                treat_as_nested)
...
from pandas.io.formats.info import (INFO_DOCSTRING, DataFrameInfo,
                                    frame_sub_kwargs)
from pandas.util._decorators import (Appender, Substitution,
                                     deprecate_nonkeyword_arguments, doc)
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (AggFuncType, AnyAll, AnyArrayLike, ArrayLike,
                                Axes, Axis, AxisInt, ColspaceArgType,
                                CompressionOptions, CorrelationMethod,
                                DropKeep, Dtype, DtypeObj, FilePath,
                                FloatFormatType, FormattersType, Frequency,
                                FromDictOrient, IgnoreRaise, IndexKeyFunc,
                                IndexLabel, JoinValidate, Level, MergeHow,
                                MergeValidate, MutableMappingT, NaAction,
                                NaPosition, NsmallestNlargestKeep,
                                PythonFuncType, QuantileInterpolation,
                                ReadBuffer, ReindexMethod, Renamer, Scalar,
                                Self, SequenceNotStr, SortKind, StorageOptions,
                                Suffixes, ToGbqIfexist, ToStataByteorder,
                                ToTimestampHow, UpdateJoin, ValueKeyFunc,
                                WriteBuffer, XMLParsers, npt)
        ...
        *,
        ...
        if version == 114:
            ...
            from pandas.io.stata import \
                StataWriter117 as statawriter  # type: ignore[assignment]
        else:  # versions 118 and 119
            # Incompatible import of "statawriter" (imported name has type
            # "Type[StataWriter117]", local name has type "Type[StataWriter]")
            from pandas.io.stata import \
                StataWriterUTF8 as statawriter  # type: ignore[assignment]
        ...
        if self._can_fast_transpose:
            ...
            if isinstance(dtypes[0], BaseMaskedDtype):
                ...
                from pandas.core.arrays.arrow.array import (
                    ArrowExtensionArray, transpose_homogeneous_pyarrow)
