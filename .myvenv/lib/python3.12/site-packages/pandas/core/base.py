...
from pandas._typing import (AxisInt, DtypeObj, IndexLabel, NDFrameT, Self,
                            Shape, npt)
...
from pandas.core.dtypes.generic import (ABCDataFrame, ABCIndex, ABCMultiIndex,
                                        ABCSeries)
...
if TYPE_CHECKING:
    ...
    from pandas._typing import (DropKeep, NumpySorter, NumpyValueArrayLike,
                                ScalarLike_co)
