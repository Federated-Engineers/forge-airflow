...
if TYPE_CHECKING:
    ...
    from pandas._typing import (ArrayLike, AxisInt, Dtype, DtypeObj,
                                NumpySorter, NumpyValueArrayLike, Scalar, Self,
                                npt, type_t)
...
class StringDtype(StorageExtensionDtype):
    ...
    def construct_array_type(  # type: ignore[override]
        ...
        from pandas.core.arrays.string_arrow import (
            ArrowStringArray, ArrowStringArrayNumpySemantics)
...
class StringArray(BaseStringArray, NumpyExtensionArray):  # type: ignore[misc]
    ...
    def _cmp_method(self, other, op):
        from pandas.arrays import ArrowExtensionArray, BooleanArray
